import { useSlots as a1, resolveComponent as W, openBlock as v, createElementBlock as f, normalizeClass as q, unref as C, createBlock as R, createCommentVNode as b, renderSlot as U, toDisplayString as V, Teleport as f2, createVNode as E, Transition as W0, withCtx as J, normalizeStyle as L1, createElementVNode as g, createTextVNode as v0, inject as Q, Fragment as G, computed as Y, pushScopeId as q0, popScopeId as I0, ref as H, onMounted as r0, onBeforeUnmount as m2, withDirectives as x0, vShow as k1, watch as R1, vModelText as r1, renderList as K, mergeProps as H1, isRef as U0, vModelDynamic as y2, TransitionGroup as W1, onUnmounted as b2, createStaticVNode as M2, resolveDynamicComponent as g2, normalizeProps as z2 } from "vue";
...
const Z = (e, c) => {
  ...
  setup(e) {
    const c = e, t = a1();
    return (o, s) => {
      const a = W("NiceLoading"), i = W("NiceIcon");
      return v(), f("button", {
...
}), h0 = /* @__PURE__ */ Z(k2, [["__scopeId", "data-v-e4a4e33d"]]);
const N2 = {
  name: "NiceModal",
  props: {
    name: {
...
function D2(e, c, t, o, s, a) {
  const i = W("NiceButton");
  return v(), R(f2, { to: "body" }, [
    E(W0, { name: "fade" }, {
      default: J(() => [
        s.isOpen ? (v(), f("div", {
          key: 0,
...
const Z1 = /* @__PURE__ */ Z(N2, [["render", D2], ["__scopeId", "data-v-7a604657"]]), T2 = { class: "nice-actions" }, E2 = {
...
const q2 = { class: "nice-actions" }, I2 = /* @__PURE__ */ g("div", { class: "f-grow" }, null, -1), A2 = {
  name: "NiceActions"
...
const t4 = {
  ...
  setup(e) {
    const c = e, t = Y(() => G2(Y0(c.hash || c.text))), o = Y(() => {
      const a = c.text.split(" ");
      return a.length > 1 ? a[0][0] + a[1][0] : c.text[0] + c.text[1];
    }), s = Y(() => "https://www.gravatar.com/avatar/" + Y0(c.gavatar.trim().toLowerCase()) + "?s=50");
    return (a, i) => (v(), f("div", {
      class: q(["nice-avatar", [
        c.size ? "size-" + c.size : "",
...
const a4 = (e) => (q0("data-v-5e755ef6"), e = e(), I0(), e), r4 = { class: "nice-checkbox-box" }, d4 = {
  key: 0,
  viewBox: "0 0 20 20"
}, u4 = /* @__PURE__ */ a4(() => /* @__PURE__ */ g("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), h4 = [
  u4
  ...
  setup(e, { emit: c }) {
    const t = e, o = Math.random().toString(36).slice(2, 7), s = Y({
      get() {
        return t.modelValue;
      },
      set(i) {
    ...
    return (i, n) => (v(), f("div", {
      class: q(["nice-component nice-checkbox", { "no-margin": t.noMargin, active: C(s), disabled: t.disabled }]),
      onClick: a
    }, [
      g("div", r4, [
...
}), O0 = /* @__PURE__ */ Z(m4, [["__scopeId", "data-v-5e755ef6"]]);
const y4 = {
...
function w4(e, c, t, o, s, a) {
  return t.title || t.caption ? (v(), f("div", b4, [
    ...
    t.caption ? (v(), f("div", z4, V(t.caption), 1)) : b("", !0)
  ])) : b("", !0);
}
const z0 = /* @__PURE__ */ Z(y4, [["render", w4], ["__scopeId", "data-v-6687b2d5"]]);
var e0 = "top", o0 = "bottom", n0 = "right", t0 = "left", X0 = "auto", A0 = [e0, o0, n0, t0], _0 = "start", T0 = "end", x4 = "clippingParents", Q1 = "viewport", S0 = "popper", _4 = "reference", S1 = /* @__PURE__ */ A0.reduce(function(e, c) {
  return e.concat([c + "-" + _0, c + "-" + T0]);
}, []), K1 = /* @__PURE__ */ [].concat(A0, [X0]).reduce(function(e, c) {
  return e.concat([c, c + "-" + _0, c + "-" + T0]);
...
var M0 = Math.max, Z0 = Math.min, C0 = Math.round;
function l1() {
...
function B0(e, c, t) {
  ...
  c && c0(e) && (s = e.offsetWidth > 0 && C0(o.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && C0(o.height) / e.offsetHeight || 1);
...
function u1(e) {
  var c = B0(e), t = e.offsetWidth, o = e.offsetHeight;
...
var P4 = function(c, t) {
  ...
  })) : c, c2(typeof c != "number" ? c : s2(c, A0));
};
function j4(e) {
  ...
  if (!(!a || !i)) {
    var u = P4(s.padding, t), h = u1(a), p = d === "y" ? e0 : t0, B = d === "y" ? o0 : n0, w = t.rects.reference[l] + t.rects.reference[d] - i[d] - t.rects.popper[l], z = i[d] - t.rects.reference[d], S = F0(a), P = S ? d === "y" ? S.clientHeight || 0 : S.clientWidth || 0 : 0, A = w / 2 - z / 2, y = u[p], _ = P - h[l] - u[B], $ = P / 2 - h[l] / 2 + A, T = V0(y, $, _), j = d;
    t.modifiersData[o] = (c = {}, c[j] = T, c.centerOffset = T - $, c);
  }
}
function L4(e) {
...
function V1(e) {
  var c, t = e.popper, o = e.popperRect, s = e.placement, a = e.variation, i = e.offsets, n = e.position, d = e.gpuAcceleration, r = e.adaptive, l = e.roundOffsets, u = e.isFixed, h = i.x, p = h === void 0 ? 0 : h, B = i.y, w = B === void 0 ? 0 : B, z = typeof l == "function" ? l({
    x: p,
    y: w
  }) : {
    x: p,
  ...
  p = z.x, w = z.y;
  var S = i.hasOwnProperty("x"), P = i.hasOwnProperty("y"), A = t0, y = e0, _ = window;
  if (r) {
    var $ = F0(t), T = "clientHeight", j = "clientWidth";
    if ($ === s0(t) && ($ = p0(t), i0($).position !== "static" && n === "absolute" && (T = "scrollHeight", j = "scrollWidth")), $ = $, s === e0 || (s === t0 || s === n0) && a === T0) {
      y = o0;
      var I = u && $ === _ && _.visualViewport ? _.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        $[T]
      );
      w -= I - o.height, w *= d ? 1 : -1;
    }
    if (s === t0 || (s === e0 || s === o0) && a === T0) {
      A = n0;
      var L = u && $ === _ && _.visualViewport ? _.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        $[j]
      );
      p -= L - o.width, p *= d ? 1 : -1;
  ...
  if (p = D.x, w = D.y, d) {
    var N;
    return Object.assign({}, m, (N = {}, N[y] = P ? "0" : "", N[A] = S ? "0" : "", N.transform = (_.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + w + "px)" : "translate3d(" + p + "px, " + w + "px, 0)", N));
  }
  return Object.assign({}, m, (c = {}, c[y] = P ? w + "px" : "", c[A] = S ? p + "px" : "", c.transform = "", c));
}
function U4(e) {
...
function Z4(e) {
  ...
  return a && r.forEach(function(l) {
    l.addEventListener("scroll", t.update, R0);
  }), n && d.addEventListener("resize", t.update, R0), function() {
    a && r.forEach(function(l) {
      l.removeEventListener("scroll", t.update, R0);
    }), n && d.removeEventListener("resize", t.update, R0);
  };
}
const X4 = {
  name: "eventListeners",
...
function p1(e) {
  return B0(p0(e)).left + v1(e).scrollLeft;
}
function K4(e, c) {
  var t = s0(e), o = p0(e), s = t.visualViewport, a = o.clientWidth, i = o.clientHeight, n = 0, d = 0;
  if (s) {
...
function J4(e) {
  var c, t = p0(e), o = v1(e), s = (c = e.ownerDocument) == null ? void 0 : c.body, a = M0(t.scrollWidth, t.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), i = M0(t.scrollHeight, t.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), n = -o.scrollLeft + p1(e), d = -o.scrollTop;
...
function o2(e) {
  return ["html", "body", "#document"].indexOf(a0(e)) >= 0 ? e.ownerDocument.body : c0(e) && f1(e) ? e : o2(G0(e));
}
function D0(e, c) {
  var t;
  c === void 0 && (c = []);
...
function e3(e, c) {
  var t = B0(e, !1, c === "fixed");
  return t.top = t.top + e.clientTop, t.left = t.left + e.clientLeft, t.bottom = t.top + e.clientHeight, t.right = t.left + e.clientWidth, t.width = e.clientWidth, t.height = e.clientHeight, t.x = t.left, t.y = t.top, t;
}
function T1(e, c, t) {
  return c === Q1 ? i1(K4(e, t)) : g0(c) ? e3(c, t) : i1(J4(p0(e)));
}
function t3(e) {
  var c = D0(G0(e)), t = ["absolute", "fixed"].indexOf(i0(e).position) >= 0, o = t && c0(e) ? F0(e) : e;
...
function c3(e, c, t, o) {
  var s = c === "clippingParents" ? t3(e) : [].concat(c), a = [].concat(s, [t]), i = a[0], n = a.reduce(function(d, r) {
    var l = T1(e, r, o);
    return d.top = M0(l.top, d.top), d.right = Z0(l.right, d.right), d.bottom = Z0(l.bottom, d.bottom), d.left = M0(l.left, d.left), d;
  }, T1(e, i, o));
  return n.width = n.right - n.left, n.height = n.bottom - n.top, n.x = n.left, n.y = n.top, n;
}
function n2(e) {
  var c = e.reference, t = e.element, o = e.placement, s = o ? l0(o) : null, a = o ? k0(o) : null, i = c.x + c.width / 2 - t.width / 2, n = c.y + c.height / 2 - t.height / 2, d;
  switch (s) {
    case e0:
      d = {
        x: i,
...
function E0(e, c) {
  c === void 0 && (c = {});
  var t = c, o = t.placement, s = o === void 0 ? e.placement : o, a = t.strategy, i = a === void 0 ? e.strategy : a, n = t.boundary, d = n === void 0 ? x4 : n, r = t.rootBoundary, l = r === void 0 ? Q1 : r, u = t.elementContext, h = u === void 0 ? S0 : u, p = t.altBoundary, B = p === void 0 ? !1 : p, w = t.padding, z = w === void 0 ? 0 : w, S = c2(typeof z != "number" ? z : s2(z, A0)), P = h === S0 ? _4 : S0, A = e.rects.popper, y = e.elements[B ? P : h], _ = c3(g0(y) ? y : y.contextElement || p0(e.elements.popper), d, l, i), $ = B0(e.elements.reference), T = n2({
    reference: $,
    element: A,
    strategy: "absolute",
    placement: s
  }), j = i1(Object.assign({}, A, T)), I = h === S0 ? j : $, L = {
    top: _.top - I.top + S.top,
    bottom: I.bottom - _.bottom + S.bottom,
    left: _.left - I.left + S.left,
    right: I.right - _.right + S.right
  }, m = e.modifiersData.offset;
  if (h === S0 && m) {
    var D = m[s];
    Object.keys(L).forEach(function(N) {
      var k = [n0, o0].indexOf(N) >= 0 ? 1 : -1, O = [e0, o0].indexOf(N) >= 0 ? "y" : "x";
      L[N] += D[O] * k;
    });
  }
  return L;
...
function s3(e, c) {
  c === void 0 && (c = {});
  var t = c, o = t.placement, s = t.boundary, a = t.rootBoundary, i = t.padding, n = t.flipVariations, d = t.allowedAutoPlacements, r = d === void 0 ? K1 : d, l = k0(o), u = l ? n ? S1 : S1.filter(function(B) {
    return k0(B) === l;
  }) : A0, h = u.filter(function(B) {
  ...
  return Object.keys(p).sort(function(B, w) {
    return p[B] - p[w];
  });
}
function o3(e) {
...
function n3(e) {
  ...
  if (!c.modifiersData[o]._skip) {
    for (var s = t.mainAxis, a = s === void 0 ? !0 : s, i = t.altAxis, n = i === void 0 ? !0 : i, d = t.fallbackPlacements, r = t.padding, l = t.boundary, u = t.rootBoundary, h = t.altBoundary, p = t.flipVariations, B = p === void 0 ? !0 : p, w = t.allowedAutoPlacements, z = c.options.placement, S = l0(z), P = S === z, A = d || (P || !B ? [H0(z)] : o3(z)), y = [z].concat(A).reduce(function(w0, d0) {
      return w0.concat(l0(d0) === X0 ? s3(c, {
        placement: d0,
        boundary: l,
        rootBoundary: u,
        padding: r,
    ...
    }, []), _ = c.rects.reference, $ = c.rects.popper, T = /* @__PURE__ */ new Map(), j = !0, I = y[0], L = 0; L < y.length; L++) {
      var m = y[L], D = l0(m), N = k0(m) === _0, k = [e0, o0].indexOf(D) >= 0, O = k ? "width" : "height", F = E0(c, {
        placement: m,
        boundary: l,
        rootBoundary: u,
        altBoundary: h,
      ...
      _[O] > $[O] && (M = H0(M));
      var x = H0(M), X = [];
      if (a && X.push(F[D] <= 0), n && X.push(F[M] <= 0, F[x] <= 0), X.every(function(w0) {
        return w0;
      })) {
        I = m, j = !1;
        break;
    ...
    if (j)
      for (var f0 = B ? 3 : 1, K0 = function(d0) {
        var $0 = y.find(function(j0) {
          var m0 = T.get(j0);
          if (m0)
            return m0.slice(0, d0).every(function(J0) {
              return J0;
            });
        });
        if ($0)
    ...
    c.placement !== I && (c.modifiersData[o]._skip = !0, c.placement = I, c.reset = !0);
  }
}
const l3 = {
  name: "flip",
...
function i3(e) {
  var c = e.state, t = e.name, o = c.rects.reference, s = c.rects.popper, a = c.modifiersData.preventOverflow, i = E0(c, {
...
function f3(e) {
  var c = e.state, t = e.options, o = e.name, s = t.mainAxis, a = s === void 0 ? !0 : s, i = t.altAxis, n = i === void 0 ? !1 : i, d = t.boundary, r = t.rootBoundary, l = t.altBoundary, u = t.padding, h = t.tether, p = h === void 0 ? !0 : h, B = t.tetherOffset, w = B === void 0 ? 0 : B, z = E0(c, {
    boundary: d,
    rootBoundary: r,
    padding: u,
    altBoundary: l
  }), S = l0(c.placement), P = k0(c.placement), A = !P, y = h1(S), _ = p3(y), $ = c.modifiersData.popperOffsets, T = c.rects.reference, j = c.rects.popper, I = typeof w == "function" ? w(Object.assign({}, c.rects, {
    placement: c.placement
  })) : w, L = typeof I == "number" ? {
    mainAxis: I,
    altAxis: I
    ...
    mainAxis: 0,
    altAxis: 0
  }, I), m = c.modifiersData.offset ? c.modifiersData.offset[c.placement] : null, D = {
    x: 0,
    y: 0
  };
  if ($) {
    if (a) {
      var N, k = y === "y" ? e0 : t0, O = y === "y" ? o0 : n0, F = y === "y" ? "height" : "width", M = $[y], x = M + z[k], X = M - z[O], f0 = p ? -j[F] / 2 : 0, K0 = P === _0 ? T[F] : j[F], N0 = P === _0 ? -j[F] : -T[F], P0 = c.elements.arrow, w0 = p && P0 ? u1(P0) : {
        width: 0,
        height: 0
      }, d0 = c.modifiersData["arrow#persistent"] ? c.modifiersData["arrow#persistent"].padding : t2(), $0 = d0[k], j0 = d0[O], m0 = V0(0, T[F], w0[F]), J0 = A ? T[F] / 2 - f0 - m0 - $0 - L.mainAxis : K0 - m0 - $0 - L.mainAxis, r2 = A ? -T[F] / 2 + f0 + m0 + j0 + L.mainAxis : N0 + m0 + j0 + L.mainAxis, e1 = c.elements.arrow && F0(c.elements.arrow), d2 = e1 ? y === "y" ? e1.clientTop || 0 : e1.clientLeft || 0 : 0, b1 = (N = m == null ? void 0 : m[y]) != null ? N : 0, u2 = M + J0 - b1 - d2, h2 = M + r2 - b1, M1 = V0(p ? Z0(x, u2) : x, M, p ? M0(X, h2) : X);
      $[y] = M1, D[y] = M1 - M;
    }
    if (n) {
      var g1, v2 = y === "x" ? e0 : t0, p2 = y === "x" ? o0 : n0, y0 = $[_], L0 = _ === "y" ? "height" : "width", z1 = y0 + z[v2], w1 = y0 - z[p2], t1 = [e0, t0].indexOf(S) !== -1, x1 = (g1 = m == null ? void 0 : m[_]) != null ? g1 : 0, _1 = t1 ? z1 : y0 - T[L0] - j[L0] - x1 + L.altAxis, C1 = t1 ? y0 + T[L0] + j[L0] - x1 - L.altAxis : w1, B1 = p && t1 ? F4(_1, y0, C1) : V0(p ? _1 : z1, y0, p ? C1 : w1);
      $[_] = B1, D[_] = B1 - y0;
    }
    c.modifiersData[o] = D;
  }
...
function M3(e) {
  var c = e.getBoundingClientRect(), t = C0(c.width) / e.offsetWidth || 1, o = C0(c.height) / e.offsetHeight || 1;
  return t !== 1 || o !== 1;
}
function g3(e, c, t) {
  t === void 0 && (t = !1);
  var o = c0(c), s = c0(c) && M3(c), a = p0(c), i = B0(e, s, t), n = {
    scrollLeft: 0,
    scrollTop: 0
  }, d = {
    x: 0,
  ...
  f1(a)) && (n = b3(c)), c0(c) ? (d = B0(c, !0), d.x += c.clientLeft, d.y += c.clientTop) : a && (d.x = p1(a))), {
...
function C3(e) {
  e.forEach(function(c) {
    [].concat(Object.keys(c), I1).filter(function(t, o, s) {
      ...
      switch (t) {
        case "name":
          typeof c.name != "string" && console.error(u0(b0, String(c.name), '"name"', '"string"', '"' + String(c.name) + '"'));
          break;
        case "enabled":
          typeof c.enabled != "boolean" && console.error(u0(b0, c.name, '"enabled"', '"boolean"', '"' + String(c.enabled) + '"'));
          break;
        case "phase":
          n1.indexOf(c.phase) < 0 && console.error(u0(b0, c.name, '"phase"', "either " + n1.join(", "), '"' + String(c.phase) + '"'));
          break;
        case "fn":
          typeof c.fn != "function" && console.error(u0(b0, c.name, '"fn"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "effect":
          c.effect != null && typeof c.effect != "function" && console.error(u0(b0, c.name, '"effect"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "requires":
          c.requires != null && !Array.isArray(c.requires) && console.error(u0(b0, c.name, '"requires"', '"array"', '"' + String(c.requires) + '"'));
          break;
        case "requiresIfExists":
          Array.isArray(c.requiresIfExists) || console.error(u0(b0, c.name, '"requiresIfExists"', '"array"', '"' + String(c.requiresIfExists) + '"'));
          break;
        case "options":
        case "data":
          break;
  ...
  return function(n, d, r) {
    ...
    var l = {
      ...
      setOptions: function(S) {
        var P = typeof S == "function" ? S(l.options) : S;
        w(), l.options = Object.assign({}, a, l.options, P), l.scrollParents = {
          reference: g0(n) ? D0(n) : n.contextElement ? D0(n.contextElement) : [],
          popper: D0(d)
        };
        var A = w3(k3([].concat(o, l.options.modifiers)));
        if (l.orderedModifiers = A.filter(function(m) {
          return m.enabled;
        }), process.env.NODE_ENV !== "production") {
          var y = B3([].concat(A, l.options.modifiers), function(m) {
            var D = m.name;
            return D;
          });
          if (C3(y), l0(l.options.placement) === X0) {
            var _ = l.orderedModifiers.find(function(m) {
              var D = m.name;
              return D === "flip";
            });
            _ || console.error(['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
          }
          var $ = i0(d), T = $.marginTop, j = $.marginRight, I = $.marginBottom, L = $.marginLeft;
          [T, j, I, L].some(function(m) {
            return parseFloat(m);
      ...
      forceUpdate: function() {
        if (!h) {
          var S = l.elements, P = S.reference, A = S.popper;
          if (!P1(P, A)) {
            process.env.NODE_ENV !== "production" && console.error(A1);
            return;
          }
          l.rects = {
            reference: g3(P, F0(A), l.options.strategy === "fixed"),
            popper: u1(A)
          ...
          for (var y = 0, _ = 0; _ < l.orderedModifiers.length; _++) {
            ...
            var $ = l.orderedModifiers[_], T = $.fn, j = $.options, I = j === void 0 ? {} : j, L = $.name;
    ...
    function B() {
      l.orderedModifiers.forEach(function(z) {
        var S = z.name, P = z.options, A = P === void 0 ? {} : P, y = z.effect;
...
const V3 = {
  ...
  setup(e, { expose: c, emit: t }) {
    const o = e, s = H(!1), a = H(!1);
    let i = null;
    const n = H(null), d = H(null), r = H(null), l = H(null);
    r0(() => {
      const z = [
        {
          name: "preventOverflow",
    ...
    return c({ close: h, toggle: u }), (z, S) => (v(), f("div", {
      class: q(["nice-popup", { "nice-popup-open": s.value, "nice-popup-focused": a.value, disabled: o.disabled }]),
      ref_key: "$el",
      ref: l
    }, [
      g("div", {
      ...
      x0(g("div", {
        ...
        g("div", {
          class: q(["nice-popup-content", { "no-padding": o.noPadding }])
        }, [
...
}), Q0 = /* @__PURE__ */ Z(D3, [["__scopeId", "data-v-a9d9d2e1"]]);
const m1 = (e) => (q0("data-v-fedf6eb3"), e = e(), I0(), e), T3 = { class: "input-group" }, E3 = ["placeholder", "disabled", "required"], q3 = { class: "nice-dropdown" }, I3 = { class: "month-wrapper" }, A3 = { class: "value" }, F3 = { class: "year" }, P3 = { class: "month" }, j3 = { class: "calendar" }, L3 = { class: "header" }, R3 = { class: "month" }, H3 = ["onClick", "title"], W3 = {
  key: 0,
  class: "time"
}, U3 = { class: "select-wrapper" }, Y3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ g("div", { class: "arrow-down" }, null, -1)), Z3 = ["value", "selected"], X3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ g("div", null, ":", -1)), G3 = { class: "select-wrapper" }, Q3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ g("div", { class: "arrow-down" }, null, -1)), K3 = ["value", "selected"], J3 = {
  name: "NiceDate"
  ...
  emits: ["change", "update:modelValue"],
  setup(e, { emit: c }) {
    const t = e, o = Q("$t"), s = H(null), a = H(""), i = H(/* @__PURE__ */ new Date()), n = H([]), d = H(null), r = [
      0,
      1,
      2,
      3,
    ...
    R1(() => t.modelValue, () => {
      t.modelValue && B(t.modelValue) && (s.value = new Date(t.modelValue), i.value = new Date(t.modelValue), N());
    }), r0(() => {
      T();
    });
    function B(k) {
    ...
    function P() {
      N(), c("update:modelValue", s.value), c("change", s.value);
    }
    function A() {
      if (a.value && a.value != "") {
        ...
        if (O.setDate(F[0]), O.setMonth(F[1] - 1), O.setFullYear(F[2]), t.time) {
          let M = k[1].split(":");
          O.setHours(M[0]), O.setMinutes(M[1]), O.setSeconds(0, 0);
        } else
    ...
    function y(k) {
      ...
      i.value.setHours(O), s.value.setHours(O), P();
    }
    function _(k) {
      let O = k.target.value;
      i.value.setMinutes(O), s.value.setMinutes(O), P();
    }
    function $(k) {
      s.value.setYear(k.year), s.value.setMonth(k.month), s.value.setDate(k.day), P();
    }
    function T() {
      t.modelValue || (s.value = /* @__PURE__ */ new Date(), s.value.setSeconds(0, 0)), t.modelValue && B(t.modelValue) && (s.value = new Date(t.modelValue), s.value.setSeconds(0, 0), a.value = D(s.value));
    }
    function j(k) {
      let O = i.value.getMonth();
      k ? O += 1 : O -= 1, i.value.setMonth(O), I();
    }
    function I() {
      n.value = [];
      let k = new Date(
    ...
    function L(k, O, F) {
      const M = /* @__PURE__ */ new Date(), x = new Date(k, O, F);
      return {
        id: x.toString(),
        date: x,
        year: x.getFullYear(),
        ...
        day: x.getDate(),
        dayInWeek: x.getDay(),
        currentMonth: x.getMonth() == i.value.getMonth(),
    ...
    function D(k) {
      let O = k.getDate(), F = k.getMonth() + 1, M = k.getFullYear(), x = k.getHours(), X = k.getMinutes();
      return X < 10 && (X = "0" + X), t.time ? `${O}.${F}.${M} • ${x}:${X}` : `${O}.${F}.${M}`;
    }
    function N() {
      s.value || (s.value = /* @__PURE__ */ new Date()), p.day = s.value.getDate(), p.month = s.value.getMonth(), p.year = s.value.getFullYear(), p.hour = s.value.getHours(), p.minute = s.value.getMinutes(), a.value = D(s.value), i.value.year = p.year, i.value.month = p.month, I();
    }
    return (k, O) => {
      const F = W("NiceIcon"), M = W("NiceButton");
      return v(), f("div", {
          ...
          content: J(() => [
            g("div", q3, [
              g("div", I3, [
                E(M, {
                  class: "left",
                  onClick: O[1] || (O[1] = (x) => j(!1)),
                  icon: "icon-chevron-left",
                  naked: ""
                }),
                g("div", A3, [
                  g("div", F3, V(i.value.getFullYear()), 1),
                  g("div", P3, V(h[i.value.getMonth() + 1]), 1)
                ]),
                E(M, {
                  class: "right",
                  onClick: O[2] || (O[2] = (x) => j(!0)),
              ...
              g("div", j3, [
                ...
                g("div", R3, [
                  (v(!0), f(G, null, K(n.value, (x) => (v(), f("div", {
                    class: q(["day", {
              ...
              e.time ? (v(), f("div", W3, [
                g("div", U3, [
                  Y3,
                  g("select", { onChange: y }, [
                    (v(), f(G, null, K(r, (x) => g("option", {
                      value: x,
                      key: x,
                      selected: x == i.value.getHours()
                    }, V(x), 9, Z3)), 64))
                  ], 32)
                ]),
                X3,
                g("div", G3, [
                  Q3,
                  g("select", { onChange: _ }, [
                    (v(), f(G, null, K(l, (x) => g("option", {
                      value: x,
                      key: x,
                      selected: x == i.value.getMinutes()
                    }, V(x), 9, K3)), 64))
                  ], 32)
                ]),
                E(F, {
...
}), t7 = /* @__PURE__ */ Z(e7, [["__scopeId", "data-v-fedf6eb3"]]);
const c7 = { class: "input-group" }, s7 = ["required", "disabled", "modelValue"], o7 = ["selected"], n7 = ["value"], l7 = {
  ...
  setup(e, { emit: c }) {
    ...
    return (d, r) => {
      const l = W("NiceLoading"), u = W("NiceIcon");
      return v(), f("div", {
        ...
        g("div", c7, [
          g("div", {
            class: q(["select-wrapper", { "no-value": C(s) == null }])
          }, [
            g("select", {
              required: e.required,
              disabled: e.disabled,
...
}), d7 = /* @__PURE__ */ Z(r7, [["__scopeId", "data-v-5dd89c41"]]);
...
}), y1 = /* @__PURE__ */ Z(p7, [["__scopeId", "data-v-59133a53"]]);
const f7 = { class: "nice-dropdown-wrapper" }, m7 = { class: "input-group" }, y7 = { class: "select-wrapper" }, b7 = ["required", "value", "disabled"], M7 = {
  ...
  setup(e, { emit: c }) {
    const t = e, o = Q("$t");
    let s = null;
    const a = 500, i = H(!1), n = H(null), d = H(null), r = H(null), l = H(null), u = H(!1), h = H(null), p = H(null), B = Y(() => t.keyOnly && !t.multiple ? h.value ? h.value.find((N) => N[t.keyName] == t.modelValue) : {} : (t.multiple && S(), t.modelValue)), w = Y(() => t.disabled ? !1 : !!t.modelValue && !!t.nullable), z = Y(() => h.value != null ? h.value.filter((N) => N._selected) : []), S = function() {
      h.value && t.modelValue != null && t.multiple && h.value.forEach((N) => {
        N._selected = !!t.modelValue.find((k) => k[t.keyName] == N[t.keyName]);
      });
    };
    r0(async () => {
      await m(), j();
    ...
    function P(N) {
      var k;
      (N.code == "Enter" || N.code == "Space") && (N.preventDefault(), (k = r.value) == null || k.toggle());
    }
    function A() {
      var N;
    ...
    async function $(N) {
      N ? (h.value || await m(), p.value != null ? l.value = h.value.findIndex(
        (k) => k[t.keyName] == p.value[t.keyName]
      ) : l.value = -1, setTimeout(() => {
        var k;
        (k = d.value) == null || k.focus();
      }, 100), document.addEventListener("keydown", D)) : (n.value = null, u.value = !1, document.removeEventListener("keydown", D));
    }
    function T(N) {
      if (N) {
        const k = N[t.keyName], O = h.value.find((F) => F[t.keyName] == k);
        I(O || null);
      } else
        I(null);
      t.multiple || A();
    ...
    function j() {
      h.value && h.value.length > 0 && !t.nullable && !t.modelValue ? I(h.value[0]) : S();
    }
    function I(N) {
      N ? t.multiple ? (N._selected = !N._selected, t.keyOnly ? (c("update:modelValue", z.value.filter.map((k) => k[t.keyName])), c("change", z.value.map((k) => k[t.keyName]))) : (c("update:modelValue", z.value), c("change", z.value))) : t.keyOnly ? (c("update:modelValue", N[t.keyName]), c("change", N[t.keyName])) : (c("update:modelValue", N), c("change", N)) : (c("update:modelValue", null), c("change", null));
    }
    function L() {
    ...
    async function m() {
      if (t.values && (h.value = t.values), t.searchFunction) {
        u.value = !0;
        const N = await t.searchFunction(n.value);
        return l.value = 0, u.value = !1, h.value = N, N;
      } else
        return null;
    }
    function D(N) {
      N.key == "ArrowDown" ? (l.value < h.value.length - 1 && (l.value += 1), N.preventDefault()) : N.key == "ArrowUp" ? (l.value > 0 && (l.value -= 1), N.preventDefault()) : N.key == "Escape" ? (A(), N.preventDefault()) : N.key == "Enter" && (I(h.value[l.value]), A(), N.preventDefault());
    }
    return (N, k) => {
      const O = W("nice-icon"), F = W("NiceIcon");
      return v(), f("div", {
                ...
                g("div", y7, [
                  g("div", {
                    ...
                    g("input", {
                      ...
                      value: e.modelValue,
                      class: "hidden-input",
                      onFocus: k[0] || (k[0] = (M) => i.value = !0),
                      onBlur: k[1] || (k[1] = (M) => i.value = !1),
                      onKeypress: P,
                      disabled: e.disabled
                    }, null, 40, b7),
                    !e.loading && e.modelValue && !t.multiple ? (v(), f("div", M7, [
                      U(N.$slots, "selected-option", { item: e.modelValue }, () => [
                        g("span", null, V(e.formatFunction ? e.formatFunction(e.modelValue) : C(B)[e.valueName]), 1)
                      ], !0)
                    ])) : b("", !0),
                    t.multiple ? (v(), f("div", g7, [
                      (v(!0), f(G, null, K(C(z), (M) => (v(), f("div", {
                        class: "option",
                        key: M
                      }, [
                        U(N.$slots, "selected-option", H1({ item: M }, M), () => [
                          g("span", null, V(e.formatFunction ? e.formatFunction(M) : M[t.valueName]), 1)
                        ], !0),
                        g("button", {
                    ...
                    !e.loading && !e.modelValue || t.multiple && !C(z).length ? (v(), f("div", w7, V(e.nullText || C(o)("Nice", "None")), 1)) : b("", !0),
                    e.loading ? (v(), f("div", x7, V(C(o)("Nice", "Loading")), 1)) : b("", !0),
                    E(F, {
                      class: "arrow-down",
                      icon: "icon-chevron-down"
                    }),
            ...
            content: J(() => [
              g("div", _7, [
                e.searchFunction && !e.noSearch ? (v(), f("div", C7, [
                  x0(g("input", {
                    "onUpdate:modelValue": k[2] || (k[2] = (M) => n.value = M),
                    type: "text",
                ...
                g("div", k7, [
                  e.nullable ? (v(), f("div", {
                    ...
                    onClick: k[3] || (k[3] = (M) => T(void 0))
                  }, V(e.nullText || C(o)("Nice", "None")), 3)) : b("", !0),
                  (v(!0), f(G, null, K(h.value, (M, x) => (v(), f("div", {
                    class: q(["element", {
                      hover: l.value == x,
                      selected: e.modelValue && (!t.multiple && M[e.keyName] == C(B)[e.keyName] || M._selected)
                    }]),
                    key: M[e.keyName],
                    onClick: (X) => T(M)
                  }, [
                    e.multiple ? (v(), R(O0, {
                      key: 0,
                      modelValue: M._selected,
                      noMargin: !0,
                      class: "nice-dropdown-item-checkbox"
                    }, null, 8, ["modelValue"])) : b("", !0),
                    U(N.$slots, "option", { item: M }, () => [
                      v0(V(e.formatFunction ? e.formatFunction(M) : M[e.valueName]), 1)
                    ], !0)
                  ], 10, N7))), 128)),
                  !u.value && (!h.value || h.value.length == 0) ? (v(), f("div", $7, V(C(o)("Nice", "No options")), 1)) : b("", !0)
                ])
              ])
            ]),
            _: 3
...
}), V7 = /* @__PURE__ */ Z(O7, [["__scopeId", "data-v-a495e156"]]);
const D7 = (e) => (q0("data-v-8be411b4"), e = e(), I0(), e), T7 = { class: "nice-filters-wrapper" }, E7 = { class: "nice-component nice-filters" }, q7 = {
  key: 0,
  class: "nice-filters-options"
}, I7 = /* @__PURE__ */ D7(() => /* @__PURE__ */ g("div", { class: "f-grow" }, null, -1)), A7 = {
  key: 0,
  ...
  setup(e, { emit: c }) {
    const t = e, o = Q("clone"), s = Q("$t"), a = U1(), i = Y1(), n = H(""), d = H(t.modelValue), r = [
      { id: "true", name: s("Nice", "Yes") },
      { id: "false", name: s("Nice", "No") }
    ], l = (y) => y ? r.filter(
      (_) => _.name.toLowerCase().includes(y.toLowerCase())
    ) : r, u = Y(() => d.value ? d.value.filter((y) => y.value != null) : []), h = Y(() => {
      if (!d.value)
        return {};
      const y = {};
    ...
    function p(y) {
      const _ = new Date(y.value), $ = _.getDate(), T = _.getMonth() + 1, j = _.getFullYear(), I = _.getHours(), L = _.getMinutes();
      return `${$}.${T}.${j} ${I}:${L < 10 ? "0" : ""}${L}`;
    }
    function B(y) {
      var _, $;
      return y.formatter ? y.formatter(y.value) : y.type == "date" ? p(y) : y.type == "boolean" ? y.value ? s("Nice", "Yes") : s("Nice", "No") : y.valueName ? y.value[y.valueName] : (_ = y.value) != null && _.name ? y.value.name : ($ = y.value) != null && $.value ? y.value.value : y.value;
    }
    function w(y) {
      var _;
      return y ? y.type == "date" ? !y.value || isNaN(new Date(y.value)) ? null : y.value ? new Date(y.value).toISOString() : null : y.valueRaw || (y.getKey ? y.getKey(y.value) : null) || ((_ = y.value) == null ? void 0 : _.id) || y.value : null;
    }
    async function z() {
      await i.isReady();
      const y = o(a.query);
      d.value.forEach(async (_) => {
        ...
        if (_.type == "yesno") {
          ...
          y[_.key] || (T = null), _.value = T;
        } else if (_.type == "date")
          _.value = new Date($);
        else if (_.type == "boolean")
          _.value = $ == "true";
        else if (_.type == "select" && _.fetch) {
          const T = await _.fetch($);
          _.value = T;
        } else
          console.log("[NiceFilters] Query not handled: ", _.key, $);
      }), setTimeout(() => {
        c("update:modelValue", d), c("change", d);
      });
    }
    async function S() {
      setTimeout(async () => {
        ...
        const _ = Object.keys(y).filter(($) => y[$] != null && y[$] != "").reduce(($, T) => ({ ...$, [T]: y[T] }), {});
    ...
    return (y, _) => {
      const $ = W("NiceInput"), T = W("NiceSwitch"), j = W("NiceDate"), I = W("NiceDropdown"), L = W("NiceButton");
      return v(), f("div", T7, [
        g("div", E7, [
          E($, {
          ...
          d.value ? (v(), f("div", q7, [
            (v(!0), f(G, null, K(d.value, (m) => (v(), f("div", {
              class: "nice-filters-filter",
              key: m.key
            }, [
              m.type == "boolean" ? (v(), R(T, {
                key: 0,
                modelValue: m.value,
        ...
        e.showPills && C(u) && C(u).length ? (v(), f("div", A7, [
          (v(!0), f(G, null, K(C(u), (m) => (v(), f("div", {
            class: "nice-filters-pill badge badge-primary",
            key: m.key,
            title: m.description
          }, [
            g("div", null, [
              g("small", null, V(m.name), 1),
              g("div", null, V(B(m)), 1)
            ]),
            E(L, {
              icon: "icon-x",
...
}), L7 = /* @__PURE__ */ Z(j7, [["__scopeId", "data-v-8be411b4"]]);
...
}), l2 = /* @__PURE__ */ Z(U7, [["__scopeId", "data-v-beba321d"]]);
var i2 = Y7;
function Y7(e, c, t) {
  if (!e)
    return t;
  ...
  setup(e, { emit: c }) {
    ...
    return (l, u) => {
      ...
      return v(), f("div", {
        ...
        g("div", Z7, [
          C(o).suffix || t.suffixText ? (v(), f("div", {
            key: 0,
          ...
          x0(g("input", {
            ...
            "onUpdate:modelValue": u[2] || (u[2] = (p) => U0(a) ? a.value = p : null),
          ...
          C(o).append || t.appendText ? (v(), f("div", {
            key: 2,
        ...
        C(d) ? (v(), f("div", K7, V(C(d)), 1)) : b("", !0)
      ], 2);
    };
  }
}), t8 = /* @__PURE__ */ Z(e8, [["__scopeId", "data-v-da046f90"]]);
  ...
  setup(e) {
    ...
    return r0(() => {
      ...
      E(W1, {
        ...
        default: J(() => [
          (v(!0), f(G, null, K(s.value, (r) => (v(), R(a2, {
            key: r.id,
            notification: r,
            timeoutTime: o,
            onRemove: (l) => i(r)
...
}), d8 = /* @__PURE__ */ Z(r8, [["__scopeId", "data-v-a3b90f70"]]);
const u8 = {
  name: "NicePanel"
  ...
  emits: ["close"],
  setup(e, { expose: c, emit: t }) {
    const o = e, s = Q("nice"), a = H(!1), i = H(!1), n = H(500), d = H(null);
    r0(() => {
      document.addEventListener("keyup", p), s.onPanel((B) => {
        o.name == B.name && (a.value = B.isOpen), B.isOpen && l();
      });
    }), b2(() => {
    ...
    function l() {
      setTimeout(() => {
        var w;
        const B = (w = d.value) == null ? void 0 : w.querySelectorAll("input");
    ...
    function h(B) {
      if (i.value) {
        let w = 300;
        o.position == "right" ? w = document.body.clientWidth - B.clientX : o.position == "left" ? w = B.clientX : o.position == "top" ? w = B.clientY : o.position == "bottom" && (w = document.body.clientHeight - B.clientY), w >= 300 && r(w);
      }
    }
    function p(B) {
      B.key == "Escape" && u();
    }
    return c({ close: u }), (B, w) => (v(), f("div", {
...
const M8 = /* @__PURE__ */ Z(f8, [["render", b8]]);
const g8 = (e) => (q0("data-v-d03e3ab1"), e = e(), I0(), e), z8 = { class: "nice-switch-box-wrapper" }, w8 = ["disabled"], x8 = /* @__PURE__ */ g8(() => /* @__PURE__ */ g("div", { class: "nice-switch-handle" }, null, -1)), _8 = [
  x8
...
}), $8 = /* @__PURE__ */ Z(N8, [["__scopeId", "data-v-d03e3ab1"]]);
const S8 = { class: "nice-table" }, O8 = { class: "nice-table-table-wrapper" }, V8 = { class: "nice-table-table" }, D8 = {
  ...
  setup(e, { emit: c }) {
    ...
    const u = Y(() => {
      var m, D;
      return ((D = (m = t.data) == null ? void 0 : m._metadata) == null ? void 0 : D.count) || 0;
    }), h = Y(() => Math.ceil(u.value / n) || 1), p = Y(() => Array.from({ length: h.value }, (m, D) => ({ id: D + 1, value: D + 1 }))), B = Y(() => t.columns), w = Y(() => B.value.filter((m) => !m.disabled)), z = Y(() => {
      let m = t.data;
      if (m.forEach((D) => {
        D._selected === void 0 && (D._selected = !1);
      }), i !== void 0) {
        const D = i.replace("-", "");
        m.sort((N, k) => {
          if (i[0] != "-") {
          ...
          return String(N[D]).localeCompare(String(k[D]));
        });
      }
      return m;
    }), S = Y(() => z.value.filter((m) => m._selected)), P = Y(() => S.value.length == z.value.length);
    function A() {
      let m = !0;
      P.value && (m = !1), z.value.forEach((D) => D._selected = m), _();
    }
    function y(m) {
      m._selected = !m._selected, _();
    }
    function _() {
      c("selected", S.value);
    }
    ...
    function T(m) {
      m.key == i ? i = "-" + m.key : i && i[0] === "-" && i === "-" + m.key ? i = void 0 : i = m.key, s.push({
        query: { ...o.query, ordering: i }
      }), c("orderChange", i), c("filterChange");
    }
    async function j(m) {
      r = m, s.replace({
        path: o.path,
    ...
    return r0(async () => {
      const m = await a();
      i = m.ordering, t.paginated && (n = Number(m.limit) || 50, r = Number(m.page) || 1, l = Number(m.page) || 1, j(r));
    }), (m, D) => {
      const N = W("NiceIcon"), k = W("router-link"), O = W("NiceNoData"), F = W("NiceDropdown");
      return v(), f("div", S8, [
        g("div", O8, [
          g("table", V8, [
            g("thead", null, [
              g("tr", null, [
                ...
                (v(!0), f(G, null, K(C(w), (M) => (v(), f("th", {
                  ...
                  t.showOrder ? (v(), f("div", {
                    key: 0,
                    class: q(["table-th", {
                      "active asc": C(i) == M.key,
                      "active desc": C(i) == "-" + M.key
                    }]),
                    onClick: (x) => T(M)
                  }, [
                    g("span", null, V(M.name), 1),
                    t.showOrder ? (v(), R(N, {
                      key: 0,
                      icon: "icon-bar-chart",
                      class: "table-order"
                    })) : b("", !0)
                  ], 10, T8)) : (v(), f("span", E8, V(M.name), 1))
                ], 2))), 128)),
                t.actions.length ? (v(), f("th", {
                  key: 1,
                  class: q(["actions-td w-0", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  !t.showToggleColumns && !t.showFooter && C(z) && C(z).length ? (v(), f("span", q8, [
                    g("span", null, V(C(z).length), 1),
                    C(z)._metadata ? (v(), f("span", I8, " / " + V(C(z)._metadata.count), 1)) : b("", !0)
                  ])) : b("", !0),
                  t.showToggleColumns ? (v(), R(Q0, {
                    ...
                    trigger: J(() => [
                      E(N, { icon: "icon-plus-circle" })
                    ]),
                    content: J(() => [
                      g("div", A8, [
                        (v(!0), f(G, null, K(C(B), (M) => (v(), f("div", {
                          class: "element",
                          key: M.key,
                          onClick: (x) => $(M)
                        }, [
            ...
            g("tbody", null, [
              (v(!0), f(G, null, K(C(z), (M) => (v(), f("tr", {
                ...
                (v(!0), f(G, null, K(C(w), (x) => {
                  var X, f0;
                  return v(), f("td", {
                    key: x.key,
                    class: q(x.class)
                  }, [
                    x.component ? (v(), R(g2((X = x.component()) == null ? void 0 : X.instance), z2(H1({ key: 0 }, (f0 = x.component(M[x.key], M)) == null ? void 0 : f0.props)), null, 16)) : b("", !0),
                    !x.component && x.html ? (v(), f("span", {
                      key: 1,
                      innerHTML: x.html(M[x.key], M)
                    }, null, 8, j8)) : b("", !0),
                    !x.component && !x.html ? (v(), f("span", {
                      key: 2,
                      class: q(x.fieldClass ? x.fieldClass(M[x.key], M) : "")
                    }, V(x.formatter ? x.formatter(M[x.key], M) : M[x.key]), 3)) : b("", !0)
                  ], 2);
                }), 128)),
                t.actions.length ? (v(), f("td", {
                  ...
                  (v(!0), f(G, null, K(t.actions, (x) => (v(), f("div", { key: x }, [
                    x.to ? (v(), R(k, {
                      key: 0,
                      to: x.to(M)
                    }, {
        ...
        e.loading ? (v(), R(y1, { key: 0 })) : b("", !0),
        !e.loading && t.data.length == 0 ? (v(), R(O, { key: 1 })) : b("", !0),
        t.showFooter ? (v(), f("div", L8, [
          g("div", R8, V(C(u)) + " " + V(m.$t("Nice", "total")), 1),
          t.paginated && C(h) > 1 && C(h) < 5 ? (v(), f("div", H8, [
            (v(!0), f(G, null, K(C(h), (M) => (v(), R(h0, {
              size: "small",
              plain: C(r) !== M,
              key: M,
              class: q(C(r) === M ? "btn-primary" : "btn-default"),
              onClick: (x) => j(M)
            }, {
              default: J(() => [
                v0(V(M), 1)
          ...
          t.paginated && C(h) > 1 && C(h) > 5 ? (v(), f("div", W8, [
            E(F, {
              modelValue: C(l),
              "onUpdate:modelValue": D[0] || (D[0] = (M) => U0(l) ? l.value = M : l = M),
              values: C(p),
              keyOnly: "",
              noMargin: "",
              onChange: j
          ...
          t.showLimit ? (v(), R(F, {
            key: 2,
            modelValue: C(n),
            "onUpdate:modelValue": D[1] || (D[1] = (M) => U0(n) ? n.value = M : n = M),
            class: q({ "dropdown-small": C(h) > 1 && C(h) < 5 }),
            values: d,
            keyOnly: "",
            noMargin: "",
            onChange: I
...
}), Z8 = /* @__PURE__ */ Z(Y8, [["__scopeId", "data-v-b63d81c0"]]);
const X8 = { class: "input-group" }, G8 = {
  ...
  setup(e, { emit: c }) {
    ...
    return (s, a) => {
      const i = W("NiceComponentHeader");
      return v(), f("div", {
        class: q(["nice-component nice-textarea", { "no-margin": e.noMargin, active: C(o), disabled: e.disabled }])
      }, [
        E(i, {
          title: e.title,
          required: e.required,
        ...
        g("div", X8, [
          ...
          x0(g("textarea", {
            "onUpdate:modelValue": a[0] || (a[0] = (n) => U0(o) ? o.value = n : null),
            placeholder: e.placeholder,
            autocomplete: e.autocomplete,
            type: e.type,
            rows: e.rows,
...
}), s5 = /* @__PURE__ */ Z(c5, [["__scopeId", "data-v-e6aa932a"]]);
...
}), i5 = /* @__PURE__ */ Z(l5, [["__scopeId", "data-v-e3d891a3"]]);
const a5 = {
  name: "NiceUpload",
  components: {
...
function v5(e, c, t, o, s, a) {
  const i = W("NiceComponentHeader"), n = W("NiceIcon"), d = W("NiceLoading");
  return v(), f("div", {
    ...
    g("div", {
      class: q(["input-group", { dragging: s.isDragging, "on-target": s.isOnTarget }]),
      ...
      a.localValue ? (v(), f("div", h5, [
        ...
        E(n, { icon: "icon-upload" }),
        g("div", u5, V(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      s.loading ? (v(), R(d, {
        key: 2,
        "full-div": ""
...
const p5 = /* @__PURE__ */ Z(a5, [["render", v5], ["__scopeId", "data-v-00a559c0"]]);
const f5 = {
  key: 0,
  ...
  setup(e) {
    const c = e, t = a1(), o = Y(() => t.title || c.title || c.icon);
    return (s, a) => {
      const i = W("NiceIcon"), n = W("NiceLoading");
      return v(), f("div", {
        class: q(["nice-view", { "nice-view-no-header": !C(o), "nice-view-flex-body": e.flexBody }])
      }, [
        C(o) ? (v(), f("div", f5, [
          e.icon && !e.loading ? (v(), R(i, {
            key: 0,
            icon: e.icon,
...
}), g5 = /* @__PURE__ */ Z(M5, [["__scopeId", "data-v-affb0933"]]);
const z5 = (e) => (q0("data-v-0a8cbce5"), e = e(), I0(), e), w5 = {
  key: 0,
...
}, B5 = /* @__PURE__ */ z5(() => /* @__PURE__ */ g("div", { class: "flex-grow" }, null, -1)), k5 = {
  key: 2,
  ...
  setup(e) {
    ...
    return (s, a) => (v(), f("div", {
      ...
      t.value ? (v(), f("div", {
        key: 1,
        class: q(["wrapper-body", { "no-top-padding": s.$slots.header || e.title || e.subtitle, "no-padding": e.noBodyPadding }])
      }, [
        U(s.$slots, "default", {}, void 0, !0)
      ], 2)) : b("", !0),
...
}), S5 = /* @__PURE__ */ Z($5, [["__scopeId", "data-v-0a8cbce5"]]);
const O5 = { class: "nice-no-data" }, V5 = { class: "nice-no-data-message" }, D5 = {
  ...
  setup(e) {
    const c = e, t = Q("$t"), o = H(c.message || t("Nice", "No data"));
    return (s, a) => {
      const i = W("NiceIcon");
      return v(), f("div", O5, [
        E(i, {
        ...
        g("div", V5, V(o.value), 1)
      ]);
    };
  }
}), E5 = /* @__PURE__ */ Z(T5, [["__scopeId", "data-v-63c3abc0"]]), j1 = {
  NiceActions: F2,
  NiceAvatar: i4,
  NiceButton: h0,
  NiceCheckbox: O0,
