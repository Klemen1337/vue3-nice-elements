import { useSlots as B1, resolveComponent as U, openBlock as h, createElementBlock as p, normalizeClass as I, unref as x, createBlock as W, createCommentVNode as y, renderSlot as X, toDisplayString as C, Teleport as W2, createVNode as L, Transition as r1, withCtx as c0, resolveDynamicComponent as J0, normalizeStyle as N1, withModifiers as j2, createElementVNode as m, createTextVNode as m0, inject as a0, Fragment as e0, computed as K, pushScopeId as W0, popScopeId as j0, ref as Y, onMounted as b0, onBeforeUnmount as Y2, withDirectives as k0, vShow as U1, watch as u1, renderList as n0, vModelText as t1, mergeProps as p2, isRef as $1, vModelDynamic as H2, TransitionGroup as m2, onUnmounted as R2, createStaticVNode as S1, normalizeProps as U2 } from "vue";
import { useRoute as y2, useRouter as g2 } from "vue-router";
function Z2(e) {
  return { all: e = e || /* @__PURE__ */ new Map(), on: function(c, t) {
    var n = e.get(c);
    n ? n.push(t) : e.set(c, [t]);
  }, off: function(c, t) {
    var n = e.get(c);
    n && (t ? n.splice(n.indexOf(t) >>> 0, 1) : e.set(c, []));
  }, emit: function(c, t) {
    var n = e.get(c);
...
const t0 = (e, c) => {
  ...
  for (const [n, s] of c)
    t[n] = s;
  return t;
}, X2 = ["type", "disabled"], Q2 = { key: 2 }, G2 = { key: 3 }, J2 = {
  name: "NiceButton"
}, K2 = /* @__PURE__ */ Object.assign(J2, {
  props: {
    addClass: {
      type: String,
      default: null
  ...
  setup(e) {
    const c = e, t = B1();
    return (n, s) => {
      const a = U("NiceLoading"), l = U("NiceIcon");
      return h(), p("button", {
        ...
        x(t).default ? (h(), p("span", Q2, [
          X(n.$slots, "default", {}, void 0, !0)
        ])) : y("", !0),
        c.text ? (h(), p("span", G2, C(c.text), 1)) : y("", !0),
        c.appendIcon ? (h(), W(l, {
          key: 4,
          icon: c.appendIcon
        }, null, 8, ["icon"])) : y("", !0)
...
}), p0 = /* @__PURE__ */ t0(K2, [["__scopeId", "data-v-e4a4e33d"]]);
const e4 = {
  name: "NiceModal",
  props: {
    name: {
...
}, c4 = { class: "nice-modal-title" }, n4 = { class: "nice-modal-subtitle" }, s4 = {
  key: 1,
  class: "nice-modal-footer"
};
function a4(e, c, t, n, s, a) {
  const l = U("NiceButton");
  return h(), W(W2, { to: "body" }, [
    L(r1, { name: "fade" }, {
      default: c0(() => [
        s.isOpen ? (h(), p("div", {
          key: 0,
          class: "nice-modal-overlay",
          onClick: c[0] || (c[0] = (...o) => a.close && a.close(...o))
        })) : y("", !0)
      ]),
      _: 1
    }),
    L(r1, { name: "flyin" }, {
      default: c0(() => [
        s.isOpen ? (h(), W(J0(t.isForm ? "form" : "div"), {
          key: 0,
          class: I(["nice-modal", t.modalClass]),
          style: N1([{ width: t.width, height: t.height }, s.startingPosition]),
          onSubmit: c[1] || (c[1] = j2((o) => e.$emit("submit"), ["prevent"]))
        }, {
          default: c0(() => [
            e.$slots.title || t.title || e.$slots.subtitle || t.subtitle ? (h(), p("div", t4, [
              m("div", c4, [
...
const b2 = /* @__PURE__ */ t0(e4, [["render", a4], ["__scopeId", "data-v-93768299"]]), o4 = { class: "p-0 m-0" }, l4 = {
  name: "NiceConfirmModal"
}, M2 = /* @__PURE__ */ Object.assign(l4, {
  props: {
    name: {
      type: String,
...
const i4 = { class: "nice-actions" }, r4 = /* @__PURE__ */ m("div", { class: "f-grow" }, null, -1), u4 = {
  name: "NiceActions"
}, d4 = /* @__PURE__ */ Object.assign(u4, {
  props: {
    form: String,
    loading: Boolean,
    showDelete: Boolean,
  ...
  setup(e, { emit: c }) {
    ...
    function a() {
      n.modal("delete-prompt", !0);
    }
    function l() {
      n.modal("delete-prompt", !1), c("delete");
    }
    function o() {
      c("cancel");
    }
    return (u, r) => {
      const i = U("NiceButton");
      return h(), p(e0, null, [
        m("div", i4, [
          t.showDelete ? (h(), W(i, {
            key: 0,
          ...
          L(i, {
            "native-type": "submit",
            onClick: s,
            text: t.submitText ? t.submitText : u.$t("Nice", "Submit"),
            form: t.form,
        ...
        L(M2, {
          name: "delete-prompt",
          onConfirm: l,
          title: u.$t("Nice", "Delete"),
          message: t.deleteText ? t.deleteText : u.$t("Nice", "Are you sure you want to delete?")
...
var p4 = f4;
const g1 = (e, c, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (c - e) * 6 * t : t < 1 / 2 ? c : t < 2 / 3 ? e + (c - e) * (2 / 3 - t) * 6 : e), m4 = (e, c, t) => {
  let n, s, a;
  if (e = e / 360, c == 0)
    n = s = a = t;
  else {
    const l = t < 0.5 ? t * (1 + c) : t + c - t * c, o = 2 * t - l;
    n = g1(o, l, e + 1 / 3), s = g1(o, l, e), a = g1(o, l, e - 1 / 3);
  }
  return [
...
var y4 = m4;
const g4 = v4, b4 = p4, Z1 = y4, M4 = () => Math.floor(Math.random() * Date.now()), z4 = (e, c) => {
  const t = g4(e), n = b4(t % 360, 1, 0.5), s = Z1(n[0][0], n[0][1], n[0][2]), a = Z1(n[1][0], n[1][1], n[1][2]), l = `rgb(${s[0]}, ${s[1]}, ${s[2]})`, o = `rgb(${a[0]}, ${a[1]}, ${a[2]})`, u = M4();
...
<svg ${c != null ? `width="${c}px" height="${c}px"` : ""} viewBox="0 0 80 80" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
    <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="${u}">
      ...
      <stop stop-color="${o}" offset="100%"></stop>
    </linearGradient>
  </defs>
...
(function() {
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = {
    ...
    bytesToWords: function(t) {
      for (var n = [], s = 0, a = 0; s < t.length; s++, a += 8)
        n[a >>> 5] |= t[s] << 24 - a % 32;
      return n;
    },
    // Convert big-endian 32-bit words to a byte array
    wordsToBytes: function(t) {
      for (var n = [], s = 0; s < t.length * 32; s += 8)
        n.push(t[s >>> 5] >>> 24 - s % 32 & 255);
      return n;
    },
    // Convert a byte array to a hex string
    bytesToHex: function(t) {
      for (var n = [], s = 0; s < t.length; s++)
        n.push((t[s] >>> 4).toString(16)), n.push((t[s] & 15).toString(16));
      return n.join("");
    },
    // Convert a hex string to a byte array
    hexToBytes: function(t) {
      for (var n = [], s = 0; s < t.length; s += 2)
        n.push(parseInt(t.substr(s, 2), 16));
      return n;
    },
    // Convert a byte array to a base-64 string
    bytesToBase64: function(t) {
      for (var n = [], s = 0; s < t.length; s += 3)
        for (var a = t[s] << 16 | t[s + 1] << 8 | t[s + 2], l = 0; l < 4; l++)
          s * 8 + l * 6 <= t.length * 8 ? n.push(e.charAt(a >>> 6 * (3 - l) & 63)) : n.push("=");
      return n.join("");
    },
    ...
    base64ToBytes: function(t) {
      ...
      for (var n = [], s = 0, a = 0; s < t.length; a = ++s % 4)
        a != 0 && n.push((e.indexOf(t.charAt(s - 1)) & Math.pow(2, -2 * a + 8) - 1) << a * 2 | e.indexOf(t.charAt(s)) >>> 6 - a * 2);
      return n;
    }
  };
  C4.exports = c;
...
var z1 = {
  ...
  utf8: {
    ...
    stringToBytes: function(e) {
      return z1.bin.stringToBytes(unescape(encodeURIComponent(e)));
    },
    // Convert a byte array to a string
    bytesToString: function(e) {
      return decodeURIComponent(escape(z1.bin.bytesToString(e)));
    }
  },
  // Binary encoding
  bin: {
 ...
 */
var _4 = function(e) {
  return e != null && (z2(e) || k4(e) || !!e._isBuffer);
};
function z2(e) {
  return !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
}
function k4(e) {
  return typeof e.readFloatLE == "function" && typeof e.slice == "function" && z2(e.slice(0, 0));
}
(function() {
  var e = M1, c = X1.utf8, t = _4, n = X1.bin, s = function(a, l) {
    a.constructor == String ? l && l.encoding === "binary" ? a = n.stringToBytes(a) : a = c.stringToBytes(a) : t(a) ? a = Array.prototype.slice.call(a, 0) : !Array.isArray(a) && a.constructor !== Uint8Array && (a = a.toString());
    for (var o = e.bytesToWords(a), u = a.length * 8, r = 1732584193, i = -271733879, d = -1732584194, v = 271733878, f = 0; f < o.length; f++)
      o[f] = (o[f] << 8 | o[f] >>> 24) & 16711935 | (o[f] << 24 | o[f] >>> 8) & 4278255360;
    o[u >>> 5] |= 128 << u % 32, o[(u + 64 >>> 9 << 4) + 14] = u;
    for (var M = s._ff, b = s._gg, z = s._hh, S = s._ii, f = 0; f < o.length; f += 16) {
      var D = r, P = i, g = d, w = v;
      r = M(r, i, d, v, o[f + 0], 7, -680876936), v = M(v, r, i, d, o[f + 1], 12, -389564586), d = M(d, v, r, i, o[f + 2], 17, 606105819), i = M(i, d, v, r, o[f + 3], 22, -1044525330), r = M(r, i, d, v, o[f + 4], 7, -176418897), v = M(v, r, i, d, o[f + 5], 12, 1200080426), d = M(d, v, r, i, o[f + 6], 17, -1473231341), i = M(i, d, v, r, o[f + 7], 22, -45705983), r = M(r, i, d, v, o[f + 8], 7, 1770035416), v = M(v, r, i, d, o[f + 9], 12, -1958414417), d = M(d, v, r, i, o[f + 10], 17, -42063), i = M(i, d, v, r, o[f + 11], 22, -1990404162), r = M(r, i, d, v, o[f + 12], 7, 1804603682), v = M(v, r, i, d, o[f + 13], 12, -40341101), d = M(d, v, r, i, o[f + 14], 17, -1502002290), i = M(i, d, v, r, o[f + 15], 22, 1236535329), r = b(r, i, d, v, o[f + 1], 5, -165796510), v = b(v, r, i, d, o[f + 6], 9, -1069501632), d = b(d, v, r, i, o[f + 11], 14, 643717713), i = b(i, d, v, r, o[f + 0], 20, -373897302), r = b(r, i, d, v, o[f + 5], 5, -701558691), v = b(v, r, i, d, o[f + 10], 9, 38016083), d = b(d, v, r, i, o[f + 15], 14, -660478335), i = b(i, d, v, r, o[f + 4], 20, -405537848), r = b(r, i, d, v, o[f + 9], 5, 568446438), v = b(v, r, i, d, o[f + 14], 9, -1019803690), d = b(d, v, r, i, o[f + 3], 14, -187363961), i = b(i, d, v, r, o[f + 8], 20, 1163531501), r = b(r, i, d, v, o[f + 13], 5, -1444681467), v = b(v, r, i, d, o[f + 2], 9, -51403784), d = b(d, v, r, i, o[f + 7], 14, 1735328473), i = b(i, d, v, r, o[f + 12], 20, -1926607734), r = z(r, i, d, v, o[f + 5], 4, -378558), v = z(v, r, i, d, o[f + 8], 11, -2022574463), d = z(d, v, r, i, o[f + 11], 16, 1839030562), i = z(i, d, v, r, o[f + 14], 23, -35309556), r = z(r, i, d, v, o[f + 1], 4, -1530992060), v = z(v, r, i, d, o[f + 4], 11, 1272893353), d = z(d, v, r, i, o[f + 7], 16, -155497632), i = z(i, d, v, r, o[f + 10], 23, -1094730640), r = z(r, i, d, v, o[f + 13], 4, 681279174), v = z(v, r, i, d, o[f + 0], 11, -358537222), d = z(d, v, r, i, o[f + 3], 16, -722521979), i = z(i, d, v, r, o[f + 6], 23, 76029189), r = z(r, i, d, v, o[f + 9], 4, -640364487), v = z(v, r, i, d, o[f + 12], 11, -421815835), d = z(d, v, r, i, o[f + 15], 16, 530742520), i = z(i, d, v, r, o[f + 2], 23, -995338651), r = S(r, i, d, v, o[f + 0], 6, -198630844), v = S(v, r, i, d, o[f + 7], 10, 1126891415), d = S(d, v, r, i, o[f + 14], 15, -1416354905), i = S(i, d, v, r, o[f + 5], 21, -57434055), r = S(r, i, d, v, o[f + 12], 6, 1700485571), v = S(v, r, i, d, o[f + 3], 10, -1894986606), d = S(d, v, r, i, o[f + 10], 15, -1051523), i = S(i, d, v, r, o[f + 1], 21, -2054922799), r = S(r, i, d, v, o[f + 8], 6, 1873313359), v = S(v, r, i, d, o[f + 15], 10, -30611744), d = S(d, v, r, i, o[f + 6], 15, -1560198380), i = S(i, d, v, r, o[f + 13], 21, 1309151649), r = S(r, i, d, v, o[f + 4], 6, -145523070), v = S(v, r, i, d, o[f + 11], 10, -1120210379), d = S(d, v, r, i, o[f + 2], 15, 718787259), i = S(i, d, v, r, o[f + 9], 21, -343485551), r = r + D >>> 0, i = i + P >>> 0, d = d + g >>> 0, v = v + w >>> 0;
    }
    return e.endian([r, i, d, v]);
  };
  s._ff = function(a, l, o, u, r, i, d) {
    var v = a + (l & o | ~l & u) + (r >>> 0) + d;
    return (v << i | v >>> 32 - i) + l;
  }, s._gg = function(a, l, o, u, r, i, d) {
    var v = a + (l & u | o & ~u) + (r >>> 0) + d;
    return (v << i | v >>> 32 - i) + l;
  }, s._hh = function(a, l, o, u, r, i, d) {
    var v = a + (l ^ o ^ u) + (r >>> 0) + d;
    return (v << i | v >>> 32 - i) + l;
  }, s._ii = function(a, l, o, u, r, i, d) {
    var v = a + (o ^ (l | ~u)) + (r >>> 0) + d;
    return (v << i | v >>> 32 - i) + l;
  }, s._blocksize = 16, s._digestsize = 16, x4.exports = function(a, l) {
    if (a == null)
      throw new Error("Illegal argument " + a);
    var o = e.wordsToBytes(s(a, l));
    return l && l.asBytes ? o : l && l.asString ? n.bytesToString(o) : e.bytesToHex(o);
  };
})();
const B4 = {
  key: 0,
  class: "status"
}, N4 = ["innerHTML"], $4 = ["src"], S4 = ["src"], O4 = {
  key: 4,
  class: "text"
}, D4 = {
  name: "NiceAvatar"
}, T4 = /* @__PURE__ */ Object.assign(D4, {
  props: {
    text: {
      type: String,
      required: !1
  ...
  setup(e) {
    const c = e, t = K(() => w4(d1(c.hash || c.text))), n = K(() => {
      const a = c.text.split(" ");
      return a.length > 1 ? a[0][0] + a[1][0] : c.text[0] + c.text[1];
    }), s = K(() => "https://www.gravatar.com/avatar/" + d1(c.gavatar.trim().toLowerCase()) + "?s=50");
    return (a, l) => (h(), p("div", {
      class: I(["nice-avatar", [
        c.size ? "size-" + c.size : "",
      ...
      c.text ? (h(), p("div", O4, C(x(n)), 1)) : y("", !0)
    ], 2));
  }
});
const L4 = (e) => (W0("data-v-e579bb36"), e = e(), j0(), e), V4 = { class: "nice-checkbox-box" }, P4 = {
  key: 0,
  viewBox: "0 0 20 20"
}, F4 = /* @__PURE__ */ L4(() => /* @__PURE__ */ m("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), q4 = [
  F4
], E4 = ["for"], I4 = ["id", "disabled"], A4 = {
  name: "NiceCheckbox"
  ...
  setup(e, { emit: c }) {
    const t = e, n = Math.random().toString(36).slice(2, 7), s = K({
      get() {
        return t.modelValue;
      },
      set(l) {
    ...
    return (l, o) => (h(), p("div", {
      class: I(["nice-component nice-checkbox", { "no-margin": t.noMargin, active: x(s), disabled: t.disabled }]),
      onClick: a
    }, [
      m("div", V4, [
        x(s) ? (h(), p("svg", P4, q4)) : y("", !0)
      ]),
      t.title ? (h(), p("div", {
        key: 0,
        class: "nice-checkbox-title",
        for: "nice-checkbox" + x(n)
      }, C(t.title), 9, E4)) : y("", !0),
      m("input", {
        type: "checkbox",
        id: "nice-checkbox" + x(n),
        disabled: t.disabled
      }, null, 8, I4)
    ], 2));
  }
}), X0 = /* @__PURE__ */ t0(W4, [["__scopeId", "data-v-e579bb36"]]);
const j4 = {
...
function Z4(e, c, t, n, s, a) {
  return t.title || t.caption ? (h(), p("div", Y4, [
    t.title ? (h(), p("div", H4, [
      m0(C(t.title) + " ", 1),
      t.required ? (h(), p("span", R4, " *")) : y("", !0)
    ])) : y("", !0),
    t.caption ? (h(), p("div", U4, C(t.caption), 1)) : y("", !0)
  ])) : y("", !0);
}
const B0 = /* @__PURE__ */ t0(j4, [["render", Z4]]);
var i0 = "top", v0 = "bottom", f0 = "right", r0 = "left", p1 = "auto", c1 = [i0, v0, f0, r0], F0 = "start", K0 = "end", X4 = "clippingParents", w2 = "viewport", R0 = "popper", Q4 = "reference", Q1 = /* @__PURE__ */ c1.reduce(function(e, c) {
  return e.concat([c + "-" + F0, c + "-" + K0]);
}, []), x2 = /* @__PURE__ */ [].concat(c1, [p1]).reduce(function(e, c) {
  return e.concat([c, c + "-" + F0, c + "-" + K0]);
}, []), G4 = "beforeRead", J4 = "read", K4 = "afterRead", e3 = "beforeMain", t3 = "main", c3 = "afterMain", n3 = "beforeWrite", s3 = "write", a3 = "afterWrite", w1 = [G4, J4, K4, e3, t3, c3, n3, s3, a3];
function M0(e) {
...
function o3(e) {
  ...
  Object.keys(c.elements).forEach(function(t) {
    var n = c.styles[t] || {}, s = c.attributes[t] || {}, a = c.elements[t];
    !d0(a) || !M0(a) || (Object.assign(a.style, n), Object.keys(s).forEach(function(l) {
      var o = s[l];
...
function l3(e) {
  ...
  return Object.assign(c.elements.popper.style, t.popper), c.styles = t, c.elements.arrow && Object.assign(c.elements.arrow.style, t.arrow), function() {
    Object.keys(c.elements).forEach(function(n) {
      var s = c.elements[n], a = c.attributes[n] || {}, l = Object.keys(c.styles.hasOwnProperty(n) ? c.styles[n] : t[n]), o = l.reduce(function(u, r) {
        return u[r] = "", u;
      }, {});
      !d0(s) || !M0(s) || (Object.assign(s.style, o), Object.keys(a).forEach(function(u) {
        s.removeAttribute(u);
      }));
    });
  };
...
var T0 = Math.max, h1 = Math.min, q0 = Math.round;
function x1() {
...
function E0(e, c, t) {
  ...
  c && d0(e) && (s = e.offsetWidth > 0 && q0(n.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && q0(n.height) / e.offsetHeight || 1);
  var l = L0(e) ? h0(e) : window, o = l.visualViewport, u = !C2() && t, r = (n.left + (u && o ? o.offsetLeft : 0)) / s, i = (n.top + (u && o ? o.offsetTop : 0)) / a, d = n.width / s, v = n.height / a;
  return {
    width: d,
    height: v,
    top: i,
...
function D1(e) {
  var c = E0(e), t = e.offsetWidth, n = e.offsetHeight;
  return Math.abs(c.width - t) <= 1 && (t = c.width), Math.abs(c.height - n) <= 1 && (n = c.height), {
    x: e.offsetLeft,
    y: e.offsetTop,
    width: t,
    height: n
...
function r3(e) {
  return ["table", "td", "th"].indexOf(M0(e)) >= 0;
}
function N0(e) {
...
function G1(e) {
  return !d0(e) || // https://github.com/popperjs/popper-core/issues/837
  g0(e).position === "fixed" ? null : e.offsetParent;
}
function u3(e) {
  ...
  var s = m1(e);
  for (O1(s) && (s = s.host); d0(s) && ["html", "body"].indexOf(M0(s)) < 0; ) {
    var a = g0(s);
...
function n1(e) {
  for (var c = h0(e), t = G1(e); t && r3(t) && g0(t).position === "static"; )
    t = G1(t);
  return t && (M0(t) === "html" || M0(t) === "body" && g0(t).position === "static") ? c : t || u3(e) || c;
}
function T1(e) {
...
var h3 = function(c, t) {
  ...
  })) : c, B2(typeof c != "number" ? c : N2(c, c1));
};
function v3(e) {
  var c, t = e.state, n = e.name, s = e.options, a = t.elements.arrow, l = t.modifiersData.popperOffsets, o = y0(t.placement), u = T1(o), r = [r0, f0].indexOf(o) >= 0, i = r ? "height" : "width";
  if (!(!a || !l)) {
    var d = h3(s.padding, t), v = D1(a), f = u === "y" ? i0 : r0, M = u === "y" ? v0 : f0, b = t.rects.reference[i] + t.rects.reference[u] - l[u] - t.rects.popper[i], z = l[u] - t.rects.reference[u], S = n1(a), D = S ? u === "y" ? S.clientHeight || 0 : S.clientWidth || 0 : 0, P = b / 2 - z / 2, g = d[f], w = D - v[i] - d[M], T = D / 2 - v[i] / 2 + P, q = Q0(g, T, w), j = u;
    t.modifiersData[n] = (c = {}, c[j] = q, c.centerOffset = q - T, c);
  }
}
function f3(e) {
  var c = e.state, t = e.options, n = t.element, s = n === void 0 ? "[data-popper-arrow]" : n;
  if (s != null && !(typeof s == "string" && (s = c.elements.popper.querySelector(s), !s))) {
    if (process.env.NODE_ENV !== "production" && (d0(s) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !_2(c.elements.popper, s)) {
...
function y3(e, c) {
  var t = e.x, n = e.y, s = c.devicePixelRatio || 1;
  return {
    x: q0(t * s) / s || 0,
    y: q0(n * s) / s || 0
  };
...
function J1(e) {
  var c, t = e.popper, n = e.popperRect, s = e.placement, a = e.variation, l = e.offsets, o = e.position, u = e.gpuAcceleration, r = e.adaptive, i = e.roundOffsets, d = e.isFixed, v = l.x, f = v === void 0 ? 0 : v, M = l.y, b = M === void 0 ? 0 : M, z = typeof i == "function" ? i({
    x: f,
    y: b
  }) : {
    x: f,
  ...
  f = z.x, b = z.y;
  var S = l.hasOwnProperty("x"), D = l.hasOwnProperty("y"), P = r0, g = i0, w = window;
  if (r) {
    var T = n1(t), q = "clientHeight", j = "clientWidth";
    if (T === h0(t) && (T = N0(t), g0(T).position !== "static" && o === "absolute" && (q = "scrollHeight", j = "scrollWidth")), T = T, s === i0 || (s === r0 || s === f0) && a === K0) {
      g = v0;
      var A = d && T === w && w.visualViewport ? w.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        T[q]
      );
      b -= A - n.height, b *= u ? 1 : -1;
    }
    if (s === r0 || (s === i0 || s === v0) && a === K0) {
      P = f0;
      var R = d && T === w && w.visualViewport ? w.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        T[j]
      );
      f -= R - n.width, f *= u ? 1 : -1;
  ...
  if (f = Z.x, b = Z.y, u) {
    var N;
    return Object.assign({}, B, (N = {}, N[g] = D ? "0" : "", N[P] = S ? "0" : "", N.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + b + "px)" : "translate3d(" + f + "px, " + b + "px, 0)", N));
  }
  return Object.assign({}, B, (c = {}, c[g] = D ? b + "px" : "", c[P] = S ? f + "px" : "", c.transform = "", c));
}
function g3(e) {
  var c = e.state, t = e.options, n = t.gpuAcceleration, s = n === void 0 ? !0 : n, a = t.adaptive, l = a === void 0 ? !0 : a, o = t.roundOffsets, u = o === void 0 ? !0 : o;
  if (process.env.NODE_ENV !== "production") {
    var r = g0(c.elements.popper).transitionProperty || "";
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
  ...
  c.modifiersData.popperOffsets != null && (c.styles.popper = Object.assign({}, c.styles.popper, J1(Object.assign({}, i, {
    offsets: c.modifiersData.popperOffsets,
    position: c.options.strategy,
    adaptive: l,
    roundOffsets: u
  })))), c.modifiersData.arrow != null && (c.styles.arrow = Object.assign({}, c.styles.arrow, J1(Object.assign({}, i, {
...
function M3(e) {
  var c = e.state, t = e.instance, n = e.options, s = n.scroll, a = s === void 0 ? !0 : s, l = n.resize, o = l === void 0 ? !0 : l, u = h0(c.elements.popper), r = [].concat(c.scrollParents.reference, c.scrollParents.popper);
  return a && r.forEach(function(i) {
    i.addEventListener("scroll", t.update, l1);
  }), o && u.addEventListener("resize", t.update, l1), function() {
    a && r.forEach(function(i) {
      i.removeEventListener("scroll", t.update, l1);
    }), o && u.removeEventListener("resize", t.update, l1);
  };
}
const z3 = {
  name: "eventListeners",
...
function L1(e) {
  var c = h0(e), t = c.pageXOffset, n = c.pageYOffset;
  return {
    scrollLeft: t,
    scrollTop: n
  };
...
function V1(e) {
  return E0(N0(e)).left + L1(e).scrollLeft;
}
function C3(e, c) {
  var t = h0(e), n = N0(e), s = t.visualViewport, a = n.clientWidth, l = n.clientHeight, o = 0, u = 0;
  if (s) {
    a = s.width, l = s.height;
    var r = C2();
    (r || !r && c === "fixed") && (o = s.offsetLeft, u = s.offsetTop);
  }
  return {
    width: a,
    height: l,
...
function _3(e) {
  var c, t = N0(e), n = L1(e), s = (c = e.ownerDocument) == null ? void 0 : c.body, a = T0(t.scrollWidth, t.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), l = T0(t.scrollHeight, t.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), o = -n.scrollLeft + V1(e), u = -n.scrollTop;
  return g0(s || t).direction === "rtl" && (o += T0(t.clientWidth, s ? s.clientWidth : 0) - a), {
    width: a,
    height: l,
    x: o,
    y: u
...
function P1(e) {
  var c = g0(e), t = c.overflow, n = c.overflowX, s = c.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + s + n);
}
function $2(e) {
  return ["html", "body", "#document"].indexOf(M0(e)) >= 0 ? e.ownerDocument.body : d0(e) && P1(e) ? e : $2(m1(e));
}
function G0(e, c) {
  var t;
  c === void 0 && (c = []);
  var n = $2(e), s = n === ((t = e.ownerDocument) == null ? void 0 : t.body), a = h0(n), l = s ? [a].concat(a.visualViewport || [], P1(n) ? n : []) : n, o = c.concat(l);
  return s ? o : (
...
function e2(e, c, t) {
  return c === w2 ? C1(C3(e, t)) : L0(c) ? k3(c, t) : C1(_3(N0(e)));
}
function B3(e) {
  var c = G0(m1(e)), t = ["absolute", "fixed"].indexOf(g0(e).position) >= 0, n = t && d0(e) ? n1(e) : e;
  return L0(n) ? c.filter(function(s) {
    return L0(s) && _2(s, n) && M0(s) !== "body";
  }) : [];
}
function N3(e, c, t, n) {
  var s = c === "clippingParents" ? B3(e) : [].concat(c), a = [].concat(s, [t]), l = a[0], o = a.reduce(function(u, r) {
    var i = e2(e, r, n);
    return u.top = T0(i.top, u.top), u.right = h1(i.right, u.right), u.bottom = h1(i.bottom, u.bottom), u.left = T0(i.left, u.left), u;
  }, e2(e, l, n));
  return o.width = o.right - o.left, o.height = o.bottom - o.top, o.x = o.left, o.y = o.top, o;
}
function S2(e) {
  var c = e.reference, t = e.element, n = e.placement, s = n ? y0(n) : null, a = n ? I0(n) : null, l = c.x + c.width / 2 - t.width / 2, o = c.y + c.height / 2 - t.height / 2, u;
  switch (s) {
    case i0:
      u = {
        x: l,
...
function e1(e, c) {
  c === void 0 && (c = {});
  var t = c, n = t.placement, s = n === void 0 ? e.placement : n, a = t.strategy, l = a === void 0 ? e.strategy : a, o = t.boundary, u = o === void 0 ? X4 : o, r = t.rootBoundary, i = r === void 0 ? w2 : r, d = t.elementContext, v = d === void 0 ? R0 : d, f = t.altBoundary, M = f === void 0 ? !1 : f, b = t.padding, z = b === void 0 ? 0 : b, S = B2(typeof z != "number" ? z : N2(z, c1)), D = v === R0 ? Q4 : R0, P = e.rects.popper, g = e.elements[M ? D : v], w = N3(L0(g) ? g : g.contextElement || N0(e.elements.popper), u, i, l), T = E0(e.elements.reference), q = S2({
    reference: T,
    element: P,
    strategy: "absolute",
    placement: s
  }), j = C1(Object.assign({}, P, q)), A = v === R0 ? j : T, R = {
  ...
  if (v === R0 && B) {
    ...
    Object.keys(R).forEach(function(N) {
      var H = [f0, v0].indexOf(N) >= 0 ? 1 : -1, E = [i0, v0].indexOf(N) >= 0 ? "y" : "x";
      R[N] += Z[E] * H;
    });
  }
  return R;
...
function $3(e, c) {
  c === void 0 && (c = {});
  var t = c, n = t.placement, s = t.boundary, a = t.rootBoundary, l = t.padding, o = t.flipVariations, u = t.allowedAutoPlacements, r = u === void 0 ? x2 : u, i = I0(n), d = i ? o ? Q1 : Q1.filter(function(M) {
    return I0(M) === i;
  }) : c1, v = d.filter(function(M) {
...
function O3(e) {
  var c = e.state, t = e.options, n = e.name;
  if (!c.modifiersData[n]._skip) {
    for (var s = t.mainAxis, a = s === void 0 ? !0 : s, l = t.altAxis, o = l === void 0 ? !0 : l, u = t.fallbackPlacements, r = t.padding, i = t.boundary, d = t.rootBoundary, v = t.altBoundary, f = t.flipVariations, M = f === void 0 ? !0 : f, b = t.allowedAutoPlacements, z = c.options.placement, S = y0(z), D = S === z, P = u || (D || !M ? [i1(z)] : S3(z)), g = [z].concat(P).reduce(function(l0, o0) {
      return l0.concat(y0(o0) === p1 ? $3(c, {
        placement: o0,
        boundary: i,
        rootBoundary: d,
        padding: r,
    ...
    }, []), w = c.rects.reference, T = c.rects.popper, q = /* @__PURE__ */ new Map(), j = !0, A = g[0], R = 0; R < g.length; R++) {
      var B = g[R], Z = y0(B), N = I0(B) === F0, H = [i0, v0].indexOf(Z) >= 0, E = H ? "width" : "height", O = e1(c, {
        placement: B,
        boundary: i,
        rootBoundary: d,
        altBoundary: v,
      ...
      w[E] > T[E] && (F = i1(F));
      var G = i1(F), _ = [];
      if (a && _.push(O[Z] <= 0), o && _.push(O[F] <= 0, O[G] <= 0), _.every(function(l0) {
        return l0;
      })) {
        A = B, j = !1;
        break;
    ...
    if (j)
      for (var u0 = M ? 3 : 1, x0 = function(o0) {
        var w0 = g.find(function($0) {
          var k = q.get($0);
          if (k)
            return k.slice(0, o0).every(function(V) {
              return V;
            });
        });
        if (w0)
    ...
    c.placement !== A && (c.modifiersData[n]._skip = !0, c.placement = A, c.reset = !0);
  }
}
const D3 = {
  name: "flip",
...
function c2(e) {
  return [i0, f0, v0, r0].some(function(c) {
    return e[c] >= 0;
  });
}
function T3(e) {
  var c = e.state, t = e.name, n = c.rects.reference, s = c.rects.popper, a = c.modifiersData.preventOverflow, l = e1(c, {
    elementContext: "reference"
  }), o = e1(c, {
    altBoundary: !0
  }), u = t2(l, n), r = t2(o, s, a), i = c2(u), d = c2(r);
  c.modifiersData[t] = {
...
function V3(e, c, t) {
  var n = y0(e), s = [r0, i0].indexOf(n) >= 0 ? -1 : 1, a = typeof t == "function" ? t(Object.assign({}, c, {
    placement: e
  })) : t, l = a[0], o = a[1];
  return l = l || 0, o = (o || 0) * s, [r0, f0].indexOf(n) >= 0 ? {
    x: o,
    y: l
  } : {
    x: l,
...
function P3(e) {
  var c = e.state, t = e.options, n = e.name, s = t.offset, a = s === void 0 ? [0, 0] : s, l = x2.reduce(function(i, d) {
    return i[d] = V3(d, c.rects, a), i;
  }, {}), o = l[c.placement], u = o.x, r = o.y;
  c.modifiersData.popperOffsets != null && (c.modifiersData.popperOffsets.x += u, c.modifiersData.popperOffsets.y += r), c.modifiersData[n] = l;
}
const F3 = {
  name: "offset",
  enabled: !0,
...
function A3(e) {
  var c = e.state, t = e.options, n = e.name, s = t.mainAxis, a = s === void 0 ? !0 : s, l = t.altAxis, o = l === void 0 ? !1 : l, u = t.boundary, r = t.rootBoundary, i = t.altBoundary, d = t.padding, v = t.tether, f = v === void 0 ? !0 : v, M = t.tetherOffset, b = M === void 0 ? 0 : M, z = e1(c, {
    boundary: u,
    rootBoundary: r,
    padding: d,
    altBoundary: i
  }), S = y0(c.placement), D = I0(c.placement), P = !D, g = T1(S), w = I3(g), T = c.modifiersData.popperOffsets, q = c.rects.reference, j = c.rects.popper, A = typeof b == "function" ? b(Object.assign({}, c.rects, {
    placement: c.placement
  })) : b, R = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
    ...
    mainAxis: 0,
    altAxis: 0
  }, A), B = c.modifiersData.offset ? c.modifiersData.offset[c.placement] : null, Z = {
    x: 0,
    y: 0
  };
  if (T) {
    if (a) {
      var N, H = g === "y" ? i0 : r0, E = g === "y" ? v0 : f0, O = g === "y" ? "height" : "width", F = T[g], G = F + z[H], _ = F - z[E], u0 = f ? -j[O] / 2 : 0, x0 = D === F0 ? q[O] : j[O], $ = D === F0 ? -j[O] : -q[O], J = c.elements.arrow, l0 = f && J ? D1(J) : {
        width: 0,
        height: 0
      }, o0 = c.modifiersData["arrow#persistent"] ? c.modifiersData["arrow#persistent"].padding : k2(), w0 = o0[H], $0 = o0[E], k = Q0(0, q[O], l0[O]), V = P ? q[O] / 2 - u0 - k - w0 - R.mainAxis : x0 - k - w0 - R.mainAxis, H0 = P ? -q[O] / 2 + u0 + k + $0 + R.mainAxis : $ + k + $0 + R.mainAxis, V0 = c.elements.arrow && n1(c.elements.arrow), F2 = V0 ? g === "y" ? V0.clientTop || 0 : V0.clientLeft || 0 : 0, q1 = (N = B == null ? void 0 : B[g]) != null ? N : 0, q2 = F + V - q1 - F2, E2 = F + H0 - q1, E1 = Q0(f ? h1(G, q2) : G, F, f ? T0(_, E2) : _);
      T[g] = E1, Z[g] = E1 - F;
    }
    if (o) {
      var I1, I2 = g === "x" ? i0 : r0, A2 = g === "x" ? v0 : f0, S0 = T[w], o1 = w === "y" ? "height" : "width", A1 = S0 + z[I2], W1 = S0 - z[A2], y1 = [i0, r0].indexOf(S) !== -1, j1 = (I1 = B == null ? void 0 : B[w]) != null ? I1 : 0, Y1 = y1 ? A1 : S0 - q[o1] - j[o1] - j1 + R.altAxis, H1 = y1 ? S0 + q[o1] + j[o1] - j1 - R.altAxis : W1, R1 = f && y1 ? d3(Y1, S0, H1) : Q0(f ? Y1 : A1, S0, f ? H1 : W1);
      T[w] = R1, Z[w] = R1 - S0;
    }
    c.modifiersData[n] = Z;
  }
...
function Y3(e) {
  return e === h0(e) || !d0(e) ? L1(e) : j3(e);
}
function H3(e) {
  var c = e.getBoundingClientRect(), t = q0(c.width) / e.offsetWidth || 1, n = q0(c.height) / e.offsetHeight || 1;
  return t !== 1 || n !== 1;
}
function R3(e, c, t) {
  t === void 0 && (t = !1);
  var n = d0(c), s = d0(c) && H3(c), a = N0(c), l = E0(e, s, t), o = {
    scrollLeft: 0,
    scrollTop: 0
  }, u = {
    x: 0,
  ...
  return (n || !n && !t) && ((M0(c) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  P1(a)) && (o = Y3(c)), d0(c) ? (u = E0(c, !0), u.x += c.clientLeft, u.y += c.clientTop) : a && (u.x = V1(a))), {
    x: l.left + o.scrollLeft - u.x,
    y: l.top + o.scrollTop - u.y,
    width: l.width,
    height: l.height
  };
}
function U3(e) {
  var c = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Set(), n = [];
...
function C0(e) {
  for (var c = arguments.length, t = new Array(c > 1 ? c - 1 : 0), n = 1; n < c; n++)
    t[n - 1] = arguments[n];
  return [].concat(t).reduce(function(s, a) {
    return s.replace(/%s/, a);
  }, e);
}
var O0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', Q3 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', n2 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function G3(e) {
  e.forEach(function(c) {
    [].concat(Object.keys(c), n2).filter(function(t, n, s) {
      return s.indexOf(t) === n;
    }).forEach(function(t) {
      switch (t) {
        case "name":
          typeof c.name != "string" && console.error(C0(O0, String(c.name), '"name"', '"string"', '"' + String(c.name) + '"'));
          break;
        case "enabled":
          typeof c.enabled != "boolean" && console.error(C0(O0, c.name, '"enabled"', '"boolean"', '"' + String(c.enabled) + '"'));
          break;
        case "phase":
          w1.indexOf(c.phase) < 0 && console.error(C0(O0, c.name, '"phase"', "either " + w1.join(", "), '"' + String(c.phase) + '"'));
          break;
        case "fn":
          typeof c.fn != "function" && console.error(C0(O0, c.name, '"fn"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "effect":
          c.effect != null && typeof c.effect != "function" && console.error(C0(O0, c.name, '"effect"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "requires":
          c.requires != null && !Array.isArray(c.requires) && console.error(C0(O0, c.name, '"requires"', '"array"', '"' + String(c.requires) + '"'));
          break;
        case "requiresIfExists":
          Array.isArray(c.requiresIfExists) || console.error(C0(O0, c.name, '"requiresIfExists"', '"array"', '"' + String(c.requiresIfExists) + '"'));
          break;
        case "options":
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + c.name + '" modifier, valid properties are ' + n2.map(function(n) {
            return '"' + n + '"';
          }).join(", ") + '; but "' + t + '" was provided.');
      }
      c.requires && c.requires.forEach(function(n) {
        e.find(function(s) {
          return s.name === n;
        }) == null && console.error(C0(Q3, String(c.name), n, n));
      });
    });
  });
}
...
var s2 = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.", e7 = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.", a2 = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
};
...
function t7(e) {
  e === void 0 && (e = {});
  var c = e, t = c.defaultModifiers, n = t === void 0 ? [] : t, s = c.defaultOptions, a = s === void 0 ? a2 : s;
  return function(o, u, r) {
    r === void 0 && (r = a);
    var i = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, a2, a),
      modifiersData: {},
      elements: {
        reference: o,
        popper: u
      ...
      setOptions: function(S) {
        var D = typeof S == "function" ? S(i.options) : S;
        b(), i.options = Object.assign({}, a, i.options, D), i.scrollParents = {
          reference: L0(o) ? G0(o) : o.contextElement ? G0(o.contextElement) : [],
          popper: G0(u)
        };
        var P = Z3(K3([].concat(n, i.options.modifiers)));
        if (i.orderedModifiers = P.filter(function(B) {
          return B.enabled;
        }), process.env.NODE_ENV !== "production") {
          var g = J3([].concat(P, i.options.modifiers), function(B) {
            var Z = B.name;
            return Z;
          });
          if (G3(g), y0(i.options.placement) === p1) {
            var w = i.orderedModifiers.find(function(B) {
              var Z = B.name;
              return Z === "flip";
            });
            w || console.error(['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
          }
          var T = g0(u), q = T.marginTop, j = T.marginRight, A = T.marginBottom, R = T.marginLeft;
          [q, j, A, R].some(function(B) {
            return parseFloat(B);
      ...
      forceUpdate: function() {
        if (!v) {
          var S = i.elements, D = S.reference, P = S.popper;
          if (!o2(D, P)) {
            process.env.NODE_ENV !== "production" && console.error(s2);
            return;
          }
          i.rects = {
            reference: R3(D, n1(P), i.options.strategy === "fixed"),
            popper: D1(P)
          }, i.reset = !1, i.placement = i.options.placement, i.orderedModifiers.forEach(function(B) {
            return i.modifiersData[B.name] = Object.assign({}, B.data);
          });
          for (var g = 0, w = 0; w < i.orderedModifiers.length; w++) {
            ...
            var T = i.orderedModifiers[w], q = T.fn, j = T.options, A = j === void 0 ? {} : j, R = T.name;
    ...
    if (!o2(o, u))
      return process.env.NODE_ENV !== "production" && console.error(s2), f;
    f.setOptions(r).then(function(z) {
      !v && r.onFirstUpdate && r.onFirstUpdate(z);
    });
    function M() {
      i.orderedModifiers.forEach(function(z) {
        var S = z.name, D = z.options, P = D === void 0 ? {} : D, g = z.effect;
...
var c7 = [z3, E3, b3, i3, F3, D3, W3, p3, L3], n7 = /* @__PURE__ */ t7({
  defaultModifiers: c7
});
const s7 = {
  name: "NicePopup"
}, a7 = /* @__PURE__ */ Object.assign(s7, {
  props: {
    noPadding: {
      type: Boolean,
      default: !1
  ...
  setup(e, { expose: c, emit: t }) {
    const n = e, s = Y(!1), a = Y(!1);
    let l = null;
    const o = Y(null), u = Y(null), r = Y(null), i = Y(null);
    b0(() => {
      const z = [
        {
          name: "preventOverflow",
      ...
      }), l = n7(u.value, r.value, {
        strategy: "fixed",
        placement: n.placement,
        modifiers: z
      }), document.addEventListener("click", b), document.addEventListener("touchend", b);
    }), Y2(() => {
      document.removeEventListener("click", b), document.removeEventListener("touchend", b);
    });
    function d() {
      n.disabled || (s.value = !s.value, l.update(), t("change", s));
    }
    function v() {
      s.value = !1, t("change", s);
    }
    function f() {
      !n.openOnHover || n.disabled || (a.value = !0, s.value = !0, l.update());
    }
    function M() {
      !n.openOnHover || n.disabled || (a.value = !1, s.value = !1);
    }
    function b(z) {
      n.openOnHover || n.disabled || s.value && !z.composedPath().includes(i.value) && !z.composedPath().includes(u.value) && v();
    }
    return c({ close: v, toggle: d }), (z, S) => (h(), p("div", {
      class: I(["nice-popup", { "nice-popup-open": s.value, "nice-popup-focused": a.value, disabled: n.disabled }]),
      ref_key: "$el",
      ref: i
    }, [
      m("div", {
      ...
      k0(m("div", {
        ...
        m("div", {
          class: I(["nice-popup-content", { "no-padding": n.noPadding }])
        }, [
...
}), s1 = /* @__PURE__ */ t0(a7, [["__scopeId", "data-v-a9d9d2e1"]]), O2 = 6048e5, o7 = 864e5, l2 = Symbol.for("constructDateFrom");
function z0(e, c) {
  return typeof e == "function" ? e(c) : e && typeof e == "object" && l2 in e ? e[l2](c) : e instanceof Date ? new e.constructor(c) : new Date(c);
}
function s0(e, c) {
  return z0(c || e, e);
}
...
function A0(e, c) {
  var o, u, r, i;
  const t = a1(), n = (c == null ? void 0 : c.weekStartsOn) ?? ((u = (o = c == null ? void 0 : c.locale) == null ? void 0 : o.options) == null ? void 0 : u.weekStartsOn) ?? t.weekStartsOn ?? ((i = (r = t.locale) == null ? void 0 : r.options) == null ? void 0 : i.weekStartsOn) ?? 0, s = s0(e, c == null ? void 0 : c.in), a = s.getDay(), l = (a < n ? 7 : 0) + a - n;
...
function D2(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), n = t.getFullYear(), s = z0(t, 0);
  s.setFullYear(n + 1, 0, 4), s.setHours(0, 0, 0, 0);
  const a = v1(s), l = z0(t, 0);
...
function r7(e, c, t) {
  const [n, s] = i7(
    ...
    e,
    c
  ), a = _1(n), l = _1(s), o = +a - i2(a), u = +l - i2(l);
  return Math.round((o - u) / o7);
}
function u7(e, c) {
  const t = D2(e, c), n = z0((c == null ? void 0 : c.in) || e, 0);
  return n.setFullYear(t, 0, 4), n.setHours(0, 0, 0, 0), v1(n);
}
function k1(e) {
  return z0(e, Date.now());
}
function d7(e) {
  return e instanceof Date || typeof e == "object" && Object.prototype.toString.call(e) === "[object Date]";
}
function h7(e) {
  return !(!d7(e) && typeof e != "number" || isNaN(+s0(e)));
}
function v7(e, c) {
  const t = s0(e, c == null ? void 0 : c.in);
...
function f7(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), n = t.getMonth();
...
function y7(e, c) {
  var o, u, r, i;
  const t = a1(), n = (c == null ? void 0 : c.weekStartsOn) ?? ((u = (o = c == null ? void 0 : c.locale) == null ? void 0 : o.options) == null ? void 0 : u.weekStartsOn) ?? t.weekStartsOn ?? ((i = (r = t.locale) == null ? void 0 : r.options) == null ? void 0 : i.weekStartsOn) ?? 0, s = s0(e, c == null ? void 0 : c.in), a = s.getDay(), l = (a < n ? -7 : 0) + 6 - (a - n);
  return s.setDate(s.getDate() + l), s.setHours(23, 59, 59, 999), s;
}
function g7(e) {
  const c = k1(e == null ? void 0 : e.in), t = z0(e == null ? void 0 : e.in, 0);
...
const b7 = {
  ...
  let n;
  const s = b7[e];
  return typeof s == "string" ? n = s : c === 1 ? n = s.one : n = s.other.replace("{{count}}", c.toString()), t != null && t.addSuffix ? t.comparison && t.comparison > 0 ? "in " + n : n + " ago" : n;
};
function b1(e) {
  return (c = {}) => {
...
function Z0(e) {
  return (c, t = {}) => {
    const n = t.width, s = n && e.matchPatterns[n] || e.matchPatterns[e.defaultMatchWidth], a = c.match(s);
    if (!a)
      return null;
    const l = a[0], o = n && e.parsePatterns[n] || e.parsePatterns[e.defaultParseWidth], u = Array.isArray(o) ? P7(o, (d) => d.test(l)) : (
      // [TODO] -- I challenge you to fix the type
      V7(o, (d) => d.test(l))
    );
    let r;
    r = e.valueCallback ? e.valueCallback(u) : u, r = t.valueCallback ? (
      // [TODO] -- I challenge you to fix the type
      t.valueCallback(r)
    ) : r;
    const i = c.slice(l.length);
...
function F7(e) {
  return (c, t = {}) => {
    const n = c.match(e.matchPattern);
    if (!n)
      return null;
    const s = n[0], a = c.match(e.parsePattern);
    if (!a)
      return null;
    let l = e.valueCallback ? e.valueCallback(a[0]) : a[0];
    l = t.valueCallback ? t.valueCallback(l) : l;
    const o = c.slice(s.length);
    return { value: l, rest: o };
  };
}
const q7 = /^(\d+)(th|st|nd|rd)?/i, E7 = /\d+/i, I7 = {
  narrow: /^(b|a)/i,
...
function K7(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), n = +v1(t) - +u7(t);
  return Math.round(n / O2) + 1;
}
function T2(e, c) {
  var i, d, v, f;
  const t = s0(e, c == null ? void 0 : c.in), n = t.getFullYear(), s = a1(), a = (c == null ? void 0 : c.firstWeekContainsDate) ?? ((d = (i = c == null ? void 0 : c.locale) == null ? void 0 : i.options) == null ? void 0 : d.firstWeekContainsDate) ?? s.firstWeekContainsDate ?? ((f = (v = s.locale) == null ? void 0 : v.options) == null ? void 0 : f.firstWeekContainsDate) ?? 1, l = z0((c == null ? void 0 : c.in) || e, 0);
  l.setFullYear(n + 1, 0, a), l.setHours(0, 0, 0, 0);
  const o = A0(l, c), u = z0((c == null ? void 0 : c.in) || e, 0);
  u.setFullYear(n, 0, a), u.setHours(0, 0, 0, 0);
  const r = A0(u, c);
  return +t >= +o ? n + 1 : +t >= +r ? n : n - 1;
}
function e5(e, c) {
  var o, u, r, i;
  const t = a1(), n = (c == null ? void 0 : c.firstWeekContainsDate) ?? ((u = (o = c == null ? void 0 : c.locale) == null ? void 0 : o.options) == null ? void 0 : u.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((i = (r = t.locale) == null ? void 0 : r.options) == null ? void 0 : i.firstWeekContainsDate) ?? 1, s = T2(e, c), a = z0((c == null ? void 0 : c.in) || e, 0);
  return a.setFullYear(s, 0, n), a.setHours(0, 0, 0, 0), A0(a, c);
}
function t5(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), n = +A0(t, c) - +e5(t, c);
  return Math.round(n / O2) + 1;
}
function Q(e, c) {
  const t = e < 0 ? "-" : "", n = Math.abs(e).toString().padStart(c, "0");
  return t + n;
}
const _0 = {
  // Year
  y(e, c) {
    ...
    return Q(c === "yy" ? n % 100 : n, c.length);
  },
  // Month
  M(e, c) {
    const t = e.getMonth();
  ...
  // Fraction of second
  S(e, c) {
    const t = c.length, n = e.getMilliseconds(), s = Math.trunc(
      n * Math.pow(10, t - 3)
    );
    return Q(s, c.length);
  }
  ...
  Y: function(e, c, t, n) {
    const s = T2(e, n), a = s > 0 ? s : 1 - s;
    if (c === "YY") {
      const l = a % 100;
      return Q(l, 2);
    }
    return c === "Yo" ? t.ordinalNumber(a, { unit: "year" }) : Q(a, c.length);
  },
  ...
  I: function(e, c, t) {
    const n = K7(e);
    return c === "Io" ? t.ordinalNumber(n, { unit: "week" }) : Q(n, c.length);
  },
  // Day of the month
  d: function(e, c, t) {
    return c === "do" ? t.ordinalNumber(e.getDate(), { unit: "date" }) : _0.d(e, c);
  },
  // Day of year
  D: function(e, c, t) {
    const n = J7(e);
    return c === "Do" ? t.ordinalNumber(n, { unit: "dayOfYear" }) : Q(n, c.length);
  },
  // Day of week
  E: function(e, c, t) {
    const n = e.getDay();
  ...
  b: function(e, c, t) {
    const n = e.getHours();
    let s;
    switch (n === 12 ? s = P0.noon : n === 0 ? s = P0.midnight : s = n / 12 >= 1 ? "pm" : "am", c) {
      case "b":
      case "bb":
        return t.dayPeriod(s, {
          width: "abbreviated",
  ...
  B: function(e, c, t) {
    const n = e.getHours();
    let s;
    switch (n >= 17 ? s = P0.evening : n >= 12 ? s = P0.afternoon : n >= 4 ? s = P0.morning : s = P0.night, c) {
      case "B":
      case "BB":
      case "BBB":
        return t.dayPeriod(s, {
  ...
  // Hour [0-23]
  H: function(e, c, t) {
    return c === "Ho" ? t.ordinalNumber(e.getHours(), { unit: "hour" }) : _0.H(e, c);
  },
  // Hour [0-11]
  K: function(e, c, t) {
    const n = e.getHours() % 12;
    return c === "Ko" ? t.ordinalNumber(n, { unit: "hour" }) : Q(n, c.length);
  },
  // Hour [1-24]
  k: function(e, c, t) {
    let n = e.getHours();
    return n === 0 && (n = 24), c === "ko" ? t.ordinalNumber(n, { unit: "hour" }) : Q(n, c.length);
  },
  // Minute
  m: function(e, c, t) {
    return c === "mo" ? t.ordinalNumber(e.getMinutes(), { unit: "minute" }) : _0.m(e, c);
  },
  // Second
  s: function(e, c, t) {
    return c === "so" ? t.ordinalNumber(e.getSeconds(), { unit: "second" }) : _0.s(e, c);
  },
  // Fraction of second
  S: function(e, c) {
    return _0.S(e, c);
...
function u2(e, c = "") {
  ...
  return a === 0 ? t + String(s) : t + String(s) + c + Q(a, 2);
}
function d2(e, c) {
  return e % 60 === 0 ? (e > 0 ? "-" : "+") + Q(Math.abs(e) / 60, 2) : D0(e, c);
}
function D0(e, c = "") {
  const t = e > 0 ? "-" : "+", n = Math.abs(e), s = Q(Math.trunc(n / 60), 2), a = Q(n % 60, 2);
  return t + s + c + a;
}
const h2 = (e, c) => {
  switch (e) {
  ...
  return a.replace("{{date}}", h2(n, c)).replace("{{time}}", L2(s, c));
}, n5 = {
  p: L2,
  P: c5
}, s5 = /^D+$/, a5 = /^Y+$/, o5 = ["D", "DD", "YY", "YYYY"];
function l5(e) {
  return s5.test(e);
}
function i5(e) {
...
function r5(e, c, t) {
  const n = u5(e, c, t);
  if (console.warn(n), o5.includes(e))
    throw new RangeError(n);
}
function u5(e, c, t) {
  const n = e[0] === "Y" ? "years" : "days of the month";
  return `Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${c}\`) for formatting ${n} to the input \`${t}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`;
}
const d5 = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, h5 = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, v5 = /^'([^]*?)'?$/, f5 = /''/g, p5 = /[a-zA-Z]/;
function v2(e, c, t) {
  var i, d, v, f, M, b, z, S;
  const n = a1(), s = (t == null ? void 0 : t.locale) ?? n.locale ?? G7, a = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((d = (i = t == null ? void 0 : t.locale) == null ? void 0 : i.options) == null ? void 0 : d.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((f = (v = n.locale) == null ? void 0 : v.options) == null ? void 0 : f.firstWeekContainsDate) ?? 1, l = (t == null ? void 0 : t.weekStartsOn) ?? ((b = (M = t == null ? void 0 : t.locale) == null ? void 0 : M.options) == null ? void 0 : b.weekStartsOn) ?? n.weekStartsOn ?? ((S = (z = n.locale) == null ? void 0 : z.options) == null ? void 0 : S.weekStartsOn) ?? 0, o = s0(e, t == null ? void 0 : t.in);
  if (!h7(o))
    throw new RangeError("Invalid time value");
  let u = c.match(h5).map((D) => {
    const P = D[0];
    if (P === "p" || P === "P") {
      const g = n5[P];
  ...
  return u.map((D) => {
    if (!D.isToken)
      return D.value;
    const P = D.value;
    (!(t != null && t.useAdditionalWeekYearTokens) && i5(P) || !(t != null && t.useAdditionalDayOfYearTokens) && l5(P)) && r5(P, c, String(e));
    const g = r2[P[0]];
    return g(o, P, s.localize, r);
  }).join("");
}
function m5(e) {
  const c = e.match(v5);
  return c ? c[1].replace(f5, "'") : e;
}
function y5(e, c) {
  return +s0(e) < +s0(c);
}
function g5(e, c, t) {
  const n = +s0(e, t == null ? void 0 : t.in), [s, a] = [
...
function b5(e) {
  const c = k1(e == null ? void 0 : e.in), t = c.getFullYear(), n = c.getMonth(), s = c.getDate(), a = k1(e == null ? void 0 : e.in);
  return a.setFullYear(t, n, s - 1), a.setHours(0, 0, 0, 0), a;
}
const Y0 = (e) => (W0("data-v-4c905654"), e = e(), j0(), e), M5 = {
  key: 0,
  class: "nice-dropdown"
}, z5 = { class: "month-wrapper" }, w5 = { class: "value" }, x5 = { class: "year" }, C5 = { class: "month" }, _5 = { class: "calendar" }, k5 = { class: "header" }, B5 = { class: "month" }, N5 = ["onClick", "title"], $5 = {
  key: 0,
  class: "time"
}, S5 = { class: "select-wrapper" }, O5 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ m("div", { class: "arrow-down" }, null, -1)), D5 = ["value", "selected"], T5 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ m("div", null, ":", -1)), L5 = { class: "select-wrapper" }, V5 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ m("div", { class: "arrow-down" }, null, -1)), P5 = ["value", "selected"], F5 = { class: "input-group" }, q5 = ["placeholder", "disabled", "required"], E5 = { class: "nice-dropdown" }, I5 = { class: "month-wrapper" }, A5 = { class: "value" }, W5 = { class: "year" }, j5 = { class: "month" }, Y5 = { class: "calendar" }, H5 = { class: "header" }, R5 = { class: "month" }, U5 = ["onClick", "title"], Z5 = {
  key: 0,
  class: "time"
}, X5 = { class: "select-wrapper" }, Q5 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ m("div", { class: "arrow-down" }, null, -1)), G5 = ["value", "selected"], J5 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ m("div", null, ":", -1)), K5 = { class: "select-wrapper" }, e8 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ m("div", { class: "arrow-down" }, null, -1)), t8 = ["value", "selected"], c8 = {
  name: "NiceDate"
}, n8 = /* @__PURE__ */ Object.assign(c8, {
  props: {
    modelValue: {
  ...
  emits: ["change", "update:modelValue"],
  setup(e, { emit: c }) {
    const t = e, n = a0("$t"), s = Y(null), a = Y(""), l = Y(/* @__PURE__ */ new Date()), o = Y([]), u = Y(null), r = [
      0,
      1,
      2,
      3,
    ...
    u1(() => t.modelValue, () => {
      t.modelValue && M(t.modelValue) && (s.value = new Date(t.modelValue), l.value = new Date(t.modelValue), H());
    }), u1(() => t.highlightTo, () => {
      A();
    }), b0(() => {
      q();
    ...
    function b() {
      u == null || u.value.close();
    }
    function z() {
      a.value = "", c("update:modelValue", null), c("change", null), setTimeout(() => {
        b();
      });
    }
    function S(E) {
    ...
    function D() {
      H(), c("update:modelValue", s.value), c("change", s.value);
    }
    function P() {
      if (a.value && a.value != "") {
        let E = a.value.split(" • "), O = /* @__PURE__ */ new Date(), F = E[0].split(".");
        if (O.setDate(F[0]), O.setMonth(F[1] - 1), O.setFullYear(F[2]), t.time) {
          let G = E[1].split(":");
          O.setHours(G[0]), O.setMinutes(G[1]), O.setSeconds(0, 0);
        } else
    ...
    function g(E) {
      ...
      l.value.setHours(O), s.value.setHours(O), D();
    }
    function w(E) {
      let O = E.target.value;
      l.value.setMinutes(O), s.value.setMinutes(O), D();
    }
    function T(E) {
      s.value.setYear(E.year), s.value.setMonth(E.month), s.value.setDate(E.day), D();
    }
    function q() {
      t.modelValue || (s.value = /* @__PURE__ */ new Date(), s.value.setSeconds(0, 0)), t.modelValue && M(t.modelValue) && (s.value = new Date(t.modelValue), s.value.setSeconds(0, 0), a.value = N(s.value)), t.isInline && A();
    }
    function j(E) {
      let O = l.value.getMonth();
      E ? O += 1 : O -= 1, l.value.setMonth(O), A();
    }
    function A() {
      o.value = [];
      let E = new Date(
    ...
    function R(E, O, F) {
      const G = /* @__PURE__ */ new Date(), _ = new Date(E, O, F);
      return {
        id: _.toString(),
        date: _,
        year: _.getFullYear(),
        ...
        day: _.getDate(),
        dayInWeek: _.getDay(),
        currentMonth: _.getMonth() == l.value.getMonth(),
        selected: Z(s.value, _),
        today: Z(G, _),
        highlighted: B(_),
        text: N(_)
      };
    ...
    function B(E) {
      return !!(t.highlightTo && g5(E, { end: t.highlightTo, start: l.value }));
    }
    function Z(E, O) {
      return E.getDate() == O.getDate() && E.getMonth() == O.getMonth() && E.getFullYear() == O.getFullYear();
    }
    function N(E) {
      let O = E.getDate(), F = E.getMonth() + 1, G = E.getFullYear(), _ = E.getHours(), u0 = E.getMinutes();
      return u0 < 10 && (u0 = "0" + u0), t.time ? `${O}.${F}.${G} • ${_}:${u0}` : `${O}.${F}.${G}`;
    }
    function H() {
      s.value || (s.value = /* @__PURE__ */ new Date()), f.day = s.value.getDate(), f.month = s.value.getMonth(), f.year = s.value.getFullYear(), f.hour = s.value.getHours(), f.minute = s.value.getMinutes(), a.value = N(s.value), l.value.year = f.year, l.value.month = f.month, A();
    }
    return (E, O) => {
      const F = U("NiceButton"), G = U("NiceIcon");
      return h(), p("div", {
        ...
        e.isInline ? (h(), p("div", M5, [
          m("div", z5, [
            L(F, {
              class: "left",
              onClick: O[0] || (O[0] = (_) => j(!1)),
              icon: "icon-chevron-left",
              naked: ""
            }),
            m("div", w5, [
              m("div", x5, C(l.value.getFullYear()), 1),
              m("div", C5, C(v[l.value.getMonth() + 1]), 1)
            ]),
            L(F, {
              class: "right",
              onClick: O[1] || (O[1] = (_) => j(!0)),
          ...
          m("div", _5, [
            ...
            m("div", B5, [
              (h(!0), p(e0, null, n0(o.value, (_) => (h(), p("div", {
                class: I(["day", {
                  "previous-month": !_.currentMonth,
                  "day-highlighted": _.highlighted,
                  today: _.today,
                  selected: _.selected
                }]),
                onClick: (u0) => T(_),
          ...
          e.time ? (h(), p("div", $5, [
            m("div", S5, [
              O5,
              m("select", { onChange: g }, [
                (h(), p(e0, null, n0(r, (_) => m("option", {
                  value: _,
                  key: _,
                  selected: _ == l.value.getHours()
                }, C(_), 9, D5)), 64))
              ], 32)
            ]),
            T5,
            m("div", L5, [
              V5,
              m("select", { onChange: w }, [
                (h(), p(e0, null, n0(i, (_) => m("option", {
                  value: _,
                  key: _,
                  selected: _ == l.value.getMinutes()
                }, C(_), 9, P5)), 64))
              ], 32)
            ]),
            L(G, {
        ...
        e.isInline ? y("", !0) : (h(), W(s1, {
          ...
          trigger: c0(() => [
            m("div", F5, [
              k0(m("input", {
                "onUpdate:modelValue": O[2] || (O[2] = (_) => a.value = _),
                placeholder: e.placeholder || x(n)("Nice", "None"),
                disabled: e.disabled,
                required: e.required,
                onBlur: P
              }, null, 40, q5), [
          ...
          content: c0(() => [
            m("div", E5, [
              m("div", I5, [
                L(F, {
                  class: "left",
                  onClick: O[3] || (O[3] = (_) => j(!1)),
                  icon: "icon-chevron-left",
                  naked: ""
                }),
                m("div", A5, [
                  m("div", W5, C(l.value.getFullYear()), 1),
                  m("div", j5, C(v[l.value.getMonth() + 1]), 1)
                ]),
                L(F, {
                  class: "right",
                  onClick: O[4] || (O[4] = (_) => j(!0)),
                  icon: "icon-chevron-right",
                  naked: ""
                })
              ]),
...
}), s8 = /* @__PURE__ */ t0(n8, [["__scopeId", "data-v-4c905654"]]);
const a8 = { class: "input-group" }, o8 = ["required", "disabled", "modelValue"], l8 = ["selected"], i8 = ["value"], r8 = {
  key: 0,
  class: "no-options"
}, u8 = ["disabled"], d8 = {
  name: "NiceDropdownSimple"
}, h8 = /* @__PURE__ */ Object.assign(d8, {
  props: {
    modelValue: {
  ...
  setup(e, { emit: c }) {
    ...
    function a(u) {
      const r = t.values.find((i) => i[t.keyName] == u.target.value);
      o(r || void 0);
    }
    function l() {
      setTimeout(() => {
        !s.value && t.values.length > 0 && !t.nullable && o(t.values[0]);
      });
    }
    function o(u) {
      u ? t.keyOnly ? s.value = u[t.keyName] : s.value = u : s.value = void 0;
    }
    return (u, r) => {
      const i = U("NiceLoading"), d = U("NiceIcon");
      return h(), p("div", {
        ...
        m("div", a8, [
          m("div", {
            class: I(["select-wrapper", { "no-value": x(s) == null }])
          }, [
            m("select", {
              required: e.required,
              disabled: e.disabled,
              ...
              e.nullable ? (h(), p("option", {
                ...
                value: null,
                selected: !x(s)
              }, C(e.nullText || x(n)("Nice", "None")), 9, l8)) : y("", !0),
              (h(!0), p(e0, null, n0(e.values, (v) => (h(), p("option", {
                value: v[e.keyName],
                key: v[e.keyName]
              }, C(v[e.valueName]), 9, i8))), 128))
            ], 40, o8),
            !e.nullable && !e.loading && (!e.values || e.values.length == 0) ? (h(), p("div", r8, C(x(n)("Nice", "No options")), 1)) : y("", !0),
            e.loading ? (h(), W(i, {
              key: 1,
              class: "no-options"
            })) : y("", !0),
...
}), v8 = /* @__PURE__ */ t0(h8, [["__scopeId", "data-v-5dd89c41"]]);
const f8 = { class: "nice-loading-wrapper" }, p8 = {
  key: 0,
  class: "nice-loading-message"
}, m8 = {
  name: "NiceLoading"
}, y8 = /* @__PURE__ */ Object.assign(m8, {
  props: {
    message: {
      type: String,
      default: null
  ...
  setup(e) {
    ...
    return (t, n) => {
      ...
      return h(), p("div", {
        ...
        m("div", f8, [
          L(s, { icon: "icon-half-loading" }),
          L(s, { icon: "icon-half-loading" })
        ]),
        c.message ? (h(), p("div", p8, C(c.message), 1)) : y("", !0)
      ], 2);
    };
  }
}), f1 = /* @__PURE__ */ t0(y8, [["__scopeId", "data-v-59133a53"]]);
const g8 = ["title"], b8 = { class: "nice-dropdown-wrapper" }, M8 = { class: "input-group" }, z8 = { class: "select-wrapper" }, w8 = ["required", "value", "disabled"], x8 = {
  key: 0,
  class: "option"
}, C8 = {
  key: 1,
  ...
  key: 3,
  class: "no-options"
}, N8 = { class: "nice-dropdown-popup" }, $8 = {
  key: 0,
  class: "input-group"
}, S8 = ["placeholder", "name", "disabled"], O8 = { class: "list" }, D8 = ["onClick"], T8 = {
  key: 1,
  ...
  setup(e, { emit: c }) {
    const t = e, n = a0("$t");
    let s = null;
    const a = 500, l = Y(!1), o = Y(null), u = Y(null), r = Y(null), i = Y(null), d = Y(!1), v = Y(null), f = Y(null), M = K(() => t.keyOnly && !t.multiple ? v.value ? v.value.find((N) => N[t.keyName] == t.modelValue) : {} : (t.multiple && S(), t.modelValue)), b = K(() => t.disabled ? !1 : !!t.modelValue && !!t.nullable), z = K(() => v.value != null ? v.value.filter((N) => N._selected) : []), S = function() {
      v.value && t.modelValue != null && t.multiple && v.value.forEach((N) => {
        N._selected = !!t.modelValue.find((H) => H[t.keyName] == N[t.keyName]);
      });
    };
    b0(async () => {
      await B(), j();
    ...
    function D(N) {
      var H;
      (N.code == "Enter" || N.code == "Space") && (N.preventDefault(), (H = r.value) == null || H.toggle());
    }
    function P() {
      var N;
      (N = r.value) == null || N.close();
    }
    function g() {
      q(null), setTimeout(() => {
        P();
    ...
    async function T(N) {
      N ? (v.value || await B(), f.value != null ? i.value = v.value.findIndex(
        (H) => H[t.keyName] == f.value[t.keyName]
      ) : i.value = -1, setTimeout(() => {
        var H;
        (H = u.value) == null || H.focus();
      }, 100), document.addEventListener("keydown", Z)) : (o.value = null, d.value = !1, document.removeEventListener("keydown", Z));
    }
    function q(N) {
      if (N) {
        const H = N[t.keyName], E = v.value.find((O) => O[t.keyName] == H);
        A(E || null);
      } else
        A(null);
      t.multiple || P();
    ...
    function A(N) {
      N ? t.multiple ? (N._selected = !N._selected, t.keyOnly ? (c("update:modelValue", z.value.filter.map((H) => H[t.keyName])), c("change", z.value.map((H) => H[t.keyName]))) : (c("update:modelValue", z.value), c("change", z.value))) : t.keyOnly ? (c("update:modelValue", N[t.keyName]), c("change", N[t.keyName])) : (c("update:modelValue", N), c("change", N)) : (c("update:modelValue", null), c("change", null));
    }
    function R() {
    ...
    async function B() {
      if (t.values && (v.value = t.values), t.searchFunction) {
        d.value = !0;
        const N = await t.searchFunction(o.value);
        return i.value = 0, d.value = !1, v.value = N, N;
      } else
        return null;
    }
    function Z(N) {
      N.key == "ArrowDown" ? (i.value < v.value.length - 1 && (i.value += 1), N.preventDefault()) : N.key == "ArrowUp" ? (i.value > 0 && (i.value -= 1), N.preventDefault()) : N.key == "Escape" ? (P(), N.preventDefault()) : N.key == "Enter" && (A(v.value[i.value]), P(), N.preventDefault());
    }
    return (N, H) => {
      const E = U("nice-icon"), O = U("NiceIcon");
      return h(), p("div", {
        title: e.nativeTitle,
        ...
        m("div", b8, [
          L(s1, {
                ...
                m("div", z8, [
                  m("div", {
                    ...
                    m("input", {
                      ...
                      value: e.modelValue,
                      class: "hidden-input",
                      onFocus: H[0] || (H[0] = (F) => l.value = !0),
                      onBlur: H[1] || (H[1] = (F) => l.value = !1),
                      onKeypress: D,
                      disabled: e.disabled
                    }, null, 40, w8),
                    !e.loading && e.modelValue && !t.multiple ? (h(), p("div", x8, [
                      X(N.$slots, "selected-option", { item: x(M) }, () => [
                        m("span", null, C(e.formatFunction ? e.formatFunction(e.modelValue) : x(M) ? x(M)[e.valueName] || x(M) : e.modelValue), 1)
                      ], !0)
                    ])) : y("", !0),
                    t.multiple ? (h(), p("div", C8, [
                      (h(!0), p(e0, null, n0(x(z), (F) => (h(), p("div", {
                        class: "option",
                        key: F
                      }, [
                        X(N.$slots, "selected-option", p2({ item: F }, F), () => [
                          m("span", null, C(e.formatFunction ? e.formatFunction(F) : F[t.valueName] || F), 1)
                        ], !0),
                        m("button", {
                          type: "button",
                    ...
                    !e.loading && !e.modelValue || t.multiple && !x(z).length ? (h(), p("div", k8, C(e.nullText || x(n)("Nice", "None")), 1)) : y("", !0),
                    e.loading ? (h(), p("div", B8, C(x(n)("Nice", "Loading")), 1)) : y("", !0),
                    L(O, {
                      class: "arrow-down",
                      icon: "icon-chevron-down"
                    }),
            ...
            content: c0(() => [
              m("div", N8, [
                e.searchFunction && !e.noSearch ? (h(), p("div", $8, [
                  k0(m("input", {
                    "onUpdate:modelValue": H[2] || (H[2] = (F) => o.value = F),
                    type: "text",
                    placeholder: x(n)("Nice", "Search..."),
                    name: x(n)("Nice", "Search"),
                    onInput: R,
                ...
                m("div", O8, [
                  e.nullable ? (h(), p("div", {
                    ...
                    onClick: H[3] || (H[3] = (F) => q(void 0))
                  }, C(e.nullText || x(n)("Nice", "None")), 3)) : y("", !0),
                  (h(!0), p(e0, null, n0(v.value, (F, G) => (h(), p("div", {
                    class: I(["element", {
                      hover: i.value == G,
                      selected: e.modelValue && (!t.multiple && F[e.keyName] == x(M)[e.keyName] || F._selected)
                    }]),
                    key: F[e.keyName],
                    onClick: (_) => q(F)
                  }, [
                    e.multiple ? (h(), W(X0, {
                      key: 0,
                      modelValue: F._selected,
                      noMargin: !0,
                      class: "nice-dropdown-item-checkbox"
                    }, null, 8, ["modelValue"])) : y("", !0),
                    X(N.$slots, "option", { item: F }, () => [
                      m0(C(e.formatFunction ? e.formatFunction(F) : F[e.valueName]), 1)
                    ], !0)
                  ], 10, D8))), 128)),
                  !d.value && (!v.value || v.value.length == 0) ? (h(), p("div", T8, C(x(n)("Nice", "No options")), 1)) : y("", !0)
                ])
              ])
            ]),
            _: 3
          }, 8, ["disabled"]),
          e.addFunction ? (h(), W(p0, {
            key: 0,
...
}), P8 = /* @__PURE__ */ t0(V8, [["__scopeId", "data-v-9b3d7ba4"]]);
const F8 = (e) => (W0("data-v-b3e06448"), e = e(), j0(), e), q8 = { class: "nice-filters-wrapper" }, E8 = { class: "nice-component nice-filters" }, I8 = {
  key: 0,
  class: "nice-filters-options"
}, A8 = /* @__PURE__ */ F8(() => /* @__PURE__ */ m("div", { class: "f-grow" }, null, -1)), W8 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, j8 = ["title"], Y8 = {
  name: "NiceFilters"
}, H8 = /* @__PURE__ */ Object.assign(Y8, {
  props: {
    // filters: {
    //   type: Object,
    //   required: false,
  ...
  setup(e, { emit: c }) {
    const t = e, n = a0("clone"), s = a0("$t"), a = y2(), l = g2(), o = Y(""), u = Y(t.modelValue), r = [
      { id: "true", name: s("Nice", "Yes") },
      { id: "false", name: s("Nice", "No") }
    ], i = (g) => g ? r.filter(
      (w) => w.name.toLowerCase().includes(g.toLowerCase())
    ) : r, d = K(() => u.value ? u.value.filter((g) => g.value != null) : []), v = K(() => {
      if (!u.value)
        return {};
      const g = {};
    ...
    function f(g) {
      const w = new Date(g.value), T = w.getDate(), q = w.getMonth() + 1, j = w.getFullYear(), A = w.getHours(), R = w.getMinutes();
      return `${T}.${q}.${j} ${A}:${R < 10 ? "0" : ""}${R}`;
    }
    function M(g) {
      var w, T;
      return g.formatter ? g.formatter(g.value) : g.type == "date" ? f(g) : g.type == "boolean" ? g.value ? s("Nice", "Yes") : s("Nice", "No") : g.valueName ? g.value[g.valueName] : (w = g.value) != null && w.name ? g.value.name : (T = g.value) != null && T.value ? g.value.value : g.value;
    }
    function b(g) {
      var w;
    ...
    async function z() {
      await l.isReady();
      const g = n(a.query);
      g.search && (o.value = g.search), u.value.forEach(async (w) => {
        const T = g[w.key];
        if (w.type == "yesno") {
          let q = r.find(
            (j) => j.id == g[w.key]
          );
          g[w.key] || (q = null), w.value = q;
        } else if (w.type == "date")
          w.value = new Date(T);
        else if (w.type == "boolean")
          w.value = T == "true";
        else if (w.type == "select" && w.fetch) {
          const q = await w.fetch(T);
          w.value = q;
        } else if (w.type == "select" && w.searchFunction) {
          const q = await w.searchFunction();
          w.value = q.find((j) => j[w.keyName || "id"] == T);
        } else
    ...
    async function S() {
      setTimeout(async () => {
        ...
        const w = Object.keys(g).filter((T) => g[T] != null && g[T] != "").reduce((T, q) => ({ ...T, [q]: g[q] }), {});
        l.push({ query: w }), await l.isReady(), setTimeout(() => {
          c("update:modelValue", u.value), c("change", u.value);
        });
      });
    }
    async function D() {
      const g = { ...a.query, id: "new" };
      l.push({ query: g }), await l.isReady(), c("create");
    }
    function P(g) {
      g.value = null, S();
    }
    return (g, w) => {
      const T = U("NiceInput"), q = U("NiceSwitch"), j = U("NiceDate"), A = U("NiceDropdown"), R = U("NiceButton");
      return h(), p("div", q8, [
        m("div", E8, [
          L(T, {
          ...
          u.value ? (h(), p("div", I8, [
            (h(!0), p(e0, null, n0(u.value, (B) => (h(), p("div", {
              class: "nice-filters-filter",
              key: B.key
            }, [
              B.type == "boolean" ? (h(), W(q, {
                key: 0,
                modelValue: B.value,
              ...
              B.type == "select" ? (h(), W(A, {
                ...
                "onUpdate:modelValue": (Z) => B.value = Z,
                title: B.name,
                "search-function": B.searchFunction,
                valueName: B.valueName,
                keyName: B.keyName,
                formatFunction: B.formatter,
                onChange: S,
                nullable: "",
                noMargin: ""
        ...
        e.showPills && x(d) && x(d).length ? (h(), p("div", W8, [
          (h(!0), p(e0, null, n0(x(d), (B) => (h(), p("div", {
            class: "nice-filters-pill badge badge-primary",
            key: B.key,
            title: B.description
          }, [
            m("div", null, [
              m("small", null, C(B.name), 1),
              m("div", null, C(M(B)), 1)
            ]),
            L(R, {
              icon: "icon-x",
...
}), R8 = /* @__PURE__ */ t0(H8, [["__scopeId", "data-v-b3e06448"]]);
const U8 = ["xlink:href"], Z8 = {
  name: "NiceIcon"
}, X8 = /* @__PURE__ */ Object.assign(Z8, {
  props: {
    icon: {
      type: String,
      required: !0
  ...
  setup(e) {
    ...
    return (t, n) => (h(), p("svg", {
      class: "nice-icon",
      style: N1({ height: e.size + "px", width: e.size + "px" })
    }, [
      m("use", {
        "xlink:href": "#" + c.icon
      }, null, 8, U8)
...
}), F1 = /* @__PURE__ */ t0(X8, [["__scopeId", "data-v-8e01a683"]]);
var V2 = Q8;
function Q8(e, c, t) {
  if (!e)
    return t;
  var n, s;
  if (Array.isArray(c) && (n = c.slice(0)), typeof c == "string" && (n = c.split(".")), typeof c == "symbol" && (n = [c]), !Array.isArray(n))
    throw new Error("props arg must be an array, a string or a symbol");
  for (; n.length; )
    if (s = n.shift(), !e || (e = e[s], e === void 0))
      return t;
  return e;
}
const G8 = { class: "input-group" }, J8 = ["placeholder", "autocomplete", "type", "required", "disabled", "min", "max", "min-length", "max-length", "regex-pattern"], K8 = {
  key: 1,
  ...
  setup(e, { emit: c }) {
    ...
    const a = K({
      get() {
        return !l.value || !t.formatter ? t.modelValue : t.formatter(t.modelValue);
      },
      set(i) {
    ...
    const u = K(() => {
      if (typeof t.error == "string")
        return t.error;
      const i = V2(t.error, ["response", "data", t.prop]);
    ...
    return (i, d) => {
      const v = U("NiceIcon");
      return h(), p("div", {
        class: I(["nice-component nice-input", { "no-margin": e.noMargin, active: x(a), disabled: e.disabled }])
      }, [
        L(B0, {
          title: e.title,
          required: e.required,
        ...
        m("div", G8, [
          x(n).suffix || t.suffixText ? (h(), p("div", {
            key: 0,
          ...
          k0(m("input", {
            onBlur: d[0] || (d[0] = (f) => o(!0)),
            onFocus: d[1] || (d[1] = (f) => o(!1)),
            "onUpdate:modelValue": d[2] || (d[2] = (f) => $1(a) ? a.value = f : null),
          ...
          x(n).append || t.appendText ? (h(), p("div", {
            key: 2,
        ...
        e.message ? (h(), p("div", e6, C(e.message), 1)) : y("", !0),
        x(u) ? (h(), p("div", t6, C(x(u)), 1)) : y("", !0)
      ], 2);
    };
  }
}), s6 = /* @__PURE__ */ t0(n6, [["__scopeId", "data-v-6e752325"]]);
const a6 = { class: "notification-info" }, o6 = {
  key: 0,
  ...
  setup(e, { emit: c }) {
    ...
    return b0(() => {
      ...
      return h(), p("div", {
        ...
        t.notification.icon ? (h(), W(u, {
          key: 0,
          class: "notification-icon",
          icon: t.notification.icon
        }, null, 8, ["icon"])) : y("", !0),
        m("div", a6, [
          t.notification.title ? (h(), p("div", o6, C(t.notification.title), 1)) : y("", !0),
          t.notification.message ? (h(), p("div", l6, C(t.notification.message), 1)) : y("", !0)
        ])
      ], 34);
    };
  }
}), P2 = /* @__PURE__ */ t0(r6, [["__scopeId", "data-v-18229dc5"]]);
const u6 = { class: "nice-notifications" }, d6 = {
  name: "NiceNotifications"
}, h6 = /* @__PURE__ */ Object.assign(d6, {
  setup(e) {
    const c = a0("$t"), t = a0("nice"), n = 3e3, s = Y([]);
    function a({ message: o, type: u, title: r, icon: i }) {
      var d = {
      ...
      r || (u == "danger" ? (d.title = c("Nice", "Error"), d.icon = "icon-alert-triangle") : u == "success" ? (d.title = c("Nice", "Success"), d.icon = "icon-smile") : u == "warning" && (d.title = c("Nice", "Warning"), d.icon = "icon-alert-circle")), s.value.unshift(d);
    }
    function l(o) {
      let u = s.value.findIndex((r) => r.id == o.id);
      u >= 0 && s.value.splice(u, 1);
    }
    return b0(() => {
      t.onNotification((o, u, r) => {
        a(o);
      });
    }), (o, u) => (h(), p("div", u6, [
      L(m2, {
        ...
        default: c0(() => [
          (h(!0), p(e0, null, n0(s.value, (r) => (h(), W(P2, {
            key: r.id,
            notification: r,
            timeoutTime: n,
            onRemove: (i) => l(r)
...
}), v6 = /* @__PURE__ */ t0(h6, [["__scopeId", "data-v-a3b90f70"]]);
const f6 = {
  name: "NicePanel"
}, p6 = /* @__PURE__ */ Object.assign(f6, {
  props: {
    name: {
      type: String,
      required: !0
  ...
  emits: ["close"],
  setup(e, { expose: c, emit: t }) {
    const n = e, s = a0("nice"), a = Y(!1), l = Y(!1), o = Y(500), u = Y(null);
    b0(() => {
      document.addEventListener("keyup", f), s.onPanel((M) => {
        n.name == M.name && (a.value = M.isOpen), M.isOpen && i();
      });
    }), R2(() => {
    ...
    function i() {
      setTimeout(() => {
        var b;
        const M = (b = u.value) == null ? void 0 : b.querySelectorAll("input");
        M && M[0] && M[0].focus && M[0].focus();
      });
    }
    function d() {
      t("close"), s.panel(n.name, !1);
    }
    function v(M) {
      if (l.value) {
        let b = 300;
        n.position == "right" ? b = document.body.clientWidth - M.clientX : n.position == "left" ? b = M.clientX : n.position == "top" ? b = M.clientY : n.position == "bottom" && (b = document.body.clientHeight - M.clientY), b >= 300 && r(b);
      }
    }
    function f(M) {
      M.key == "Escape" && d();
    }
    return c({ close: d }), (M, b) => (h(), W(J0(e.isForm ? "form" : "div"), {
      class: I(["nice-side-view", [e.position, { "no-select": l.value }]]),
      onMousemove: v,
      onMouseup: b[1] || (b[1] = (z) => l.value = !1),
        ...
        L(r1, { name: "side-view" }, {
          default: c0(() => [
            a.value ? (h(), p("div", {
              ...
              style: N1({ "--side-view-width": o.value + "px" })
            }, [
              m("div", {
                class: I(["handle", { active: l.value }]),
                ref: "handle",
                onMousedown: b[0] || (b[0] = (z) => l.value = !0)
              }, null, 34),
              X(M.$slots, "default")
            ], 6)) : y("", !0)
          ]),
  ...
  setup(e) {
    const c = e;
    return (t, n) => (h(), p("svg", g6, [
      m("defs", null, [
        b6,
        m("symbol", M6, [
          z6,
          c.isDevelopment ? (h(), p("g", w6, C6)) : y("", !0)
        ]),
        X(t.$slots, "default")
      ])
    ]));
...
const B6 = (e) => (W0("data-v-9cdc82e5"), e = e(), j0(), e), N6 = { class: "nice-switch-box-wrapper" }, $6 = ["disabled"], S6 = /* @__PURE__ */ B6(() => /* @__PURE__ */ m("div", { class: "nice-switch-handle" }, null, -1)), O6 = [
  S6
], D6 = ["for"], T6 = ["id", "disabled"], L6 = {
  name: "NiceSwitch"
}, V6 = /* @__PURE__ */ Object.assign(L6, {
  props: {
    modelValue: {
      type: [Boolean, null],
      required: !0
...
}), P6 = /* @__PURE__ */ t0(V6, [["__scopeId", "data-v-9cdc82e5"]]);
const F6 = (e) => (W0("data-v-f585ca6e"), e = e(), j0(), e), q6 = { class: "nice-table" }, E6 = { class: "nice-table-table-wrapper" }, I6 = { class: "nice-table-table" }, A6 = {
  key: 0,
  class: "w-0"
}, W6 = { key: 0 }, j6 = ["onClick"], Y6 = { key: 1 }, H6 = ["placeholder", "onUpdate:modelValue"], R6 = ["onClick"], U6 = ["onClick"], Z6 = { key: 0 }, X6 = { key: 0 }, Q6 = { class: "list" }, G6 = ["onClick"], J6 = { key: 0 }, K6 = {
  key: 0,
  class: "w-0"
}, e9 = ["innerHTML"], t9 = { class: "actions-td-inner" }, c9 = {
  key: 2,
  class: "nice-table-footer"
}, n9 = { class: "pagination-info" }, s9 = /* @__PURE__ */ F6(() => /* @__PURE__ */ m("div", { class: "f-grow" }, null, -1)), a9 = {
  key: 1,
  class: "pagination"
}, o9 = {
  key: 2,
  ...
  setup(e, { emit: c }) {
    const t = e, n = y2(), s = g2(), a = a0("getQuery"), l = Y(void 0), o = Y(50), u = [
      { id: 10, value: 10 },
      { id: 20, value: 20 },
      { id: 50, value: 50 },
      { id: 100, value: 100 }
    ...
    let d = null;
    const v = K(() => (r.value - 1) * o.value), f = K(() => {
      var $, J;
      return ((J = ($ = t.data) == null ? void 0 : $._metadata) == null ? void 0 : J.count) || 0;
    }), M = K(() => Math.ceil(f.value / o.value) || 1), b = K(() => Array.from({ length: M.value }, ($, J) => ({ id: String(J + 1), value: String(J + 1) }))), z = K(() => t.columns), S = K(() => z.value.filter(($) => !$.disabled)), D = K(() => {
      let $ = t.data;
      if ($.forEach((J) => {
        J._selected === void 0 && (J._selected = !1);
      }), t.orderLocally && l.value !== void 0) {
        const J = l.value.replace("-", "");
        $.sort((l0, o0) => {
          if (l.value[0] != "-") {
            const w0 = l0;
            l0 = o0, o0 = w0;
          }
          return String(l0[J]).localeCompare(String(o0[J]));
        });
      }
      return $;
    }), P = K(() => D.value.filter(($) => $._selected)), g = K(() => P.value.length == D.value.length);
    function w($) {
      return $.to != null ? "router-link" : $.href != null ? "a" : "div";
    }
    function T() {
      let $ = !0;
      g.value && ($ = !1), D.value.forEach((J) => J._selected = $), j();
    }
    function q($) {
      $._selected = !$._selected, j();
    }
    function j() {
      c("selected", P.value);
    }
    ...
    function R() {
      clearTimeout(A), A = setTimeout(() => {
        s.push({
          query: { ...n.query, ...i.value }
        }), x0();
      }, 500);
    }
    function B($) {
      i.value[$.key] = void 0, R();
    }
    function Z($) {
      $.disabled = !$.disabled;
    }
    function N($) {
      $.key == l.value ? l.value = "-" + $.key : l.value && l.value[0] === "-" && l.value === "-" + $.key ? l.value = void 0 : l.value = $.key, s.push({
        query: { ...n.query, ordering: l.value }
      }), setTimeout(() => {
        c("orderChange", l.value);
      }), x0();
    }
    function H() {
      _(1);
    ...
    async function _($) {
      n.query.page != $ && (r.value = $, s.replace({
        path: n.path,
        query: { ...n.query, page: r.value, offset: v.value, limit: o.value }
      }), setTimeout(() => {
        c("pageChange", $), x0();
      }));
    }
    function u0($) {
      n.query.limit != $ && (o.value = $, s.push({
        path: n.path,
        query: { ...n.query, limit: o.value }
      }), setTimeout(() => {
        c("limitChange", o);
      }), x0());
    }
    function x0() {
      setTimeout(() => {
        c("filterChange", { ordering: l.value, page: r.value, offset: v.value, limit: o.value, ...i.value });
      });
    }
    return b0(async () => {
      const $ = await a();
      ...
      t.paginated && (o.value = Number($.limit) || 50, r.value = Number($.page) || 1, d = b[String($.page) || "1"] || { id: "1", value: "1" }, _(r.value));
    }), ($, J) => {
      const l0 = U("NiceIcon"), o0 = U("nice-icon"), w0 = U("NiceNoData"), $0 = U("NiceDropdown");
      return h(), p("div", q6, [
        m("div", E6, [
          m("table", I6, [
            m("thead", null, [
              m("tr", null, [
                t.selectMultiple ? (h(), p("th", A6, [
                  L(X0, {
                    modelValue: x(g),
                    "no-margin": "",
                    onClick: T
                ...
                (h(!0), p(e0, null, n0(x(S), (k) => (h(), p("th", {
                  key: k.key,
                  class: I([k.class, "nice-table-th-wrapper"])
                }, [
                  k.hasOrder ? (h(), p("div", W6, [
                    m("div", {
                      class: I(["nice-table-th", {
                        "active asc": l.value == k.key,
                        "active desc": l.value == "-" + k.key
                      }]),
                      onClick: (V) => N(k)
                    }, [
                      m("span", null, C(k.name), 1),
                      L(l0, {
                        icon: "icon-bar-chart",
                        class: "table-order"
                      })
                    ], 10, j6)
                  ])) : (h(), p("span", Y6, C(k.name), 1)),
                  k.hasSearch ? (h(), p("div", {
                    key: 2,
                    class: I(["nice-table-th-search", { visible: i.value[k.key] }])
                  }, [
                    k0(m("input", {
                      placeholder: k.name,
                      "onUpdate:modelValue": (V) => i.value[k.key] = V,
                      onInput: R
                    }, null, 40, H6), [
                      [t1, i.value[k.key]]
                    ]),
                    i.value[k.key] ? (h(), p("button", {
                      key: 0,
                      title: "Clear",
                      type: "button",
                    ...
                    k.hasOrder ? (h(), p("button", {
                      ...
                      l.value != k.key && l.value != "-" + k.key ? (h(), W(o0, {
                        key: 0,
                        icon: "icon-filter"
                      })) : y("", !0),
                      l.value == k.key ? (h(), W(o0, {
                        key: 1,
                        class: "asc",
                        icon: "icon-bar-chart"
                      })) : y("", !0),
                ...
                t.actions.length ? (h(), p("th", {
                  ...
                  !t.showToggleColumns && !t.showFooter && x(D) && x(D).length ? (h(), p("span", Z6, [
                    m("span", null, C(x(D).length), 1),
                    x(D)._metadata ? (h(), p("span", X6, " / " + C(x(D)._metadata.count), 1)) : y("", !0)
                  ])) : y("", !0),
                  t.showToggleColumns ? (h(), W(s1, {
                    key: 1,
                    ...
                    trigger: c0(() => [
                      L(l0, { icon: "icon-plus-circle" })
                    ]),
                    content: c0(() => [
                      m("div", Q6, [
                        (h(!0), p(e0, null, n0(x(z), (k) => (h(), p("div", {
                          class: "element",
                          key: k.key,
                          onClick: (V) => Z(k)
                        }, [
                          L(X0, {
                            modelValue: !k.disabled,
                            title: k.name,
                            "no-margin": ""
            ...
            x(D) && x(D).length ? (h(), p("tbody", J6, [
              (h(!0), p(e0, null, n0(x(D), (k) => (h(), p("tr", {
                key: k.id
              }, [
                t.selectMultiple ? (h(), p("td", K6, [
                  L(X0, {
                    modelValue: k._selected,
                    onClick: (V) => q(k),
                    "no-margin": ""
                  }, null, 8, ["modelValue", "onClick"])
                ])) : y("", !0),
                (h(!0), p(e0, null, n0(x(S), (V) => {
                  var H0, V0;
                  return h(), p("td", {
                    key: V.key,
                    class: I(V.class)
                  }, [
                    V.component ? (h(), W(J0((H0 = V.component()) == null ? void 0 : H0.instance), U2(p2({ key: 0 }, (V0 = V.component(k[V.key], k)) == null ? void 0 : V0.props)), null, 16)) : y("", !0),
                    !V.component && V.html ? (h(), p("span", {
                      key: 1,
                      innerHTML: V.html(k[V.key], k)
                    }, null, 8, e9)) : y("", !0),
                    !V.component && !V.html ? (h(), p("span", {
                      key: 2,
                      class: I(V.fieldClass ? V.fieldClass(k[V.key], k) : "")
                    }, C(V.formatter ? V.formatter(k[V.key], k) : k[V.key]), 3)) : y("", !0)
                  ], 2);
                }), 128)),
                t.actions.length ? (h(), p("td", {
                  ...
                  m("div", t9, [
                    (h(!0), p(e0, null, n0(t.actions, (V) => (h(), p(e0, { key: V }, [
                      V.hidden && V.hidden(k) ? y("", !0) : (h(), W(J0(w(V)), {
                        key: 0,
                        to: V.to && V.to(k),
                        disabled: V.disabled && V.disabled(k),
                        href: V.href && V.href(k),
                        target: V.href ? "blank" : null
                      }, {
                        default: c0(() => [
                          V.hidden && V.hidden(k) ? y("", !0) : (h(), W(p0, {
                            key: 0,
                            icon: V.icon && V.icon(k),
                            type: V.type && V.type(k),
                            text: V.text && V.text(k).toString(),
                            plain: V.plain && V.plain(k),
                            loading: V.loading && V.loading(k),
                            disabled: V.disabled && V.disabled(k),
                            title: V.title && V.title(k),
                            onClick: (H0) => V.function && V.function(k),
                            size: "small"
                          }, null, 8, ["icon", "type", "text", "plain", "loading", "disabled", "title", "onClick"]))
                        ]),
                        _: 2
                      }, 1032, ["to", "disabled", "href", "target"]))
                    ], 64))), 128))
                  ])
                ], 2)) : y("", !0)
              ]))), 128))
        ...
        x(D) && !x(D).length && e.loading ? (h(), W(f1, {
          key: 0,
          class: "nice-table-loading"
        })) : y("", !0),
        !e.loading && t.data.length == 0 ? (h(), W(w0, { key: 1 })) : y("", !0),
        t.showFooter ? (h(), p("div", c9, [
          e.loading ? (h(), W(f1, {
            key: 0,
            class: "nice-table-footer-loading"
          })) : y("", !0),
          m("div", n9, C(x(f)) + " " + C($.$t("Nice", "total")), 1),
          s9,
          t.paginated && x(M) > 1 && x(M) <= 5 ? (h(), p("div", a9, [
            L(p0, {
            ...
            (h(!0), p(e0, null, n0(x(M), (k) => (h(), W(p0, {
              size: "small",
              plain: r.value !== k,
              key: k,
              class: I(r.value === k ? "active" : ""),
              onClick: (V) => _(k)
            }, {
              default: c0(() => [
                m0(C(k), 1)
          ...
          t.paginated && x(M) > 1 && x(M) > 5 ? (h(), p("div", o9, [
            L($0, {
              nativeTitle: $.$t("Nice", "Page"),
              modelValue: x(d),
              "onUpdate:modelValue": J[0] || (J[0] = (k) => $1(d) ? d.value = k : d = k),
              values: x(b),
              noMargin: "",
              onChange: G
          ...
          t.showLimit ? (h(), W($0, {
            ...
            modelValue: o.value,
            "onUpdate:modelValue": J[1] || (J[1] = (k) => o.value = k),
            values: u,
            keyOnly: "",
            noMargin: "",
            onChange: u0
...
}), r9 = /* @__PURE__ */ t0(i9, [["__scopeId", "data-v-f585ca6e"]]);
const u9 = { class: "input-group" }, d9 = {
  key: 0,
  class: "input-group-suffix"
}, h9 = ["placeholder", "autocomplete", "type", "rows", "disabled"], v9 = {
  key: 1,
  class: "input-group-append input-group-icon"
}, f9 = {
  key: 2,
  ...
  setup(e, { emit: c }) {
    ...
    return (s, a) => {
      const l = U("NiceComponentHeader");
      return h(), p("div", {
        class: I(["nice-component nice-textarea", { "no-margin": e.noMargin, active: x(n), disabled: e.disabled }])
      }, [
        L(l, {
          title: e.title,
          required: e.required,
        ...
        m("div", u9, [
          s.$slots.suffix ? (h(), p("div", d9, [
            X(s.$slots, "suffix", {}, void 0, !0)
          ])) : y("", !0),
          k0(m("textarea", {
            "onUpdate:modelValue": a[0] || (a[0] = (o) => $1(n) ? n.value = o : null),
            placeholder: e.placeholder,
            autocomplete: e.autocomplete,
            type: e.type,
            rows: e.rows,
          ...
          e.icon ? (h(), p("div", v9, [
            L(F1, { icon: e.icon }, null, 8, ["icon"])
          ])) : y("", !0),
          s.$slots.append ? (h(), p("div", f9, [
            X(s.$slots, "append", {}, void 0, !0)
          ])) : y("", !0)
        ]),
        e.message ? (h(), p("div", p9, C(e.message), 1)) : y("", !0)
      ], 2);
    };
  }
}), g9 = /* @__PURE__ */ t0(y9, [["__scopeId", "data-v-e6aa932a"]]);
const b9 = { class: "nice-toasts" }, M9 = {
  name: "NiceToast"
}, z9 = /* @__PURE__ */ Object.assign(M9, {
  setup(e) {
    const t = Y([]), n = a0("nice");
    b0(() => {
      n.onToast(({ message: l, type: o }) => {
        s(l, o);
      });
    });
    function s(l, o) {
    ...
    function a(l) {
      const o = t.value.findIndex((u) => u.id == l.id);
      o >= 0 && t.value.splice(o, 1);
    }
    return (l, o) => (h(), p("div", b9, [
      L(m2, {
        name: "toast",
        key: "div"
      }, {
        default: c0(() => [
          (h(!0), p(e0, null, n0(t.value, (u) => (h(), p("div", {
            class: I(["nice-toast", ["nice-toast-" + u.type]]),
            key: u.id
          }, C(u.message), 3))), 128))
        ]),
        _: 1
...
}), w9 = /* @__PURE__ */ t0(z9, [["__scopeId", "data-v-e3d891a3"]]);
const x9 = {
  name: "NiceUpload",
  components: {
  ...
  computed: {
    ...
    errorMessage() {
      if (typeof this.error == "string")
        return this.error;
      const e = V2(this.error, ["response", "data", this.prop]);
  ...
  // },
}, C9 = ["modelValue", "placeholder", "required", "accept", "disabled"], _9 = {
  key: 0,
  class: "nice-upload-overlay"
}, k9 = { class: "nice-upload-overlay-message" }, B9 = {
  key: 1,
  class: "nice-upload-overlay"
}, N9 = {
  key: 2,
  class: "nice-upload-overlay"
}, $9 = { class: "nice-upload-overlay-message" }, S9 = {
  key: 3,
  class: "nice-upload-overlay"
}, O9 = ["src"], D9 = {
  key: 4,
  class: "nice-upload-overlay"
}, T9 = ["src"], L9 = { class: "nice-upload-overlay-message" }, V9 = ["disabled"];
function P9(e, c, t, n, s, a) {
  const l = U("NiceComponentHeader"), o = U("NiceIcon"), u = U("NiceLoading");
  return h(), p("div", {
    class: I(["nice-component nice-upload", { "no-margin": t.noMargin, active: a.localValue, disabled: t.disabled }])
  }, [
    L(l, {
      title: t.title,
      required: t.required,
    ...
    m("div", {
      ...
      onDragenter: c[2] || (c[2] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDragleave: c[3] || (c[3] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDragover: c[4] || (c[4] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDragend: c[5] || (c[5] = (...r) => a.dragChanged && a.dragChanged(...r)),
      ...
      m("input", {
        ...
        accept: t.accept,
        type: "file",
        onChange: c[0] || (c[0] = (...r) => a.fileChanged && a.fileChanged(...r)),
        disabled: t.disabled
      }, null, 40, C9),
      a.localValue ? y("", !0) : (h(), p("div", _9, [
        L(o, { icon: "icon-upload" }),
        m("div", k9, C(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      a.localValue && a.localValueType == "FileList" ? (h(), p("div", B9, [
        L(o, { icon: "icon-file" }),
        (h(!0), p(e0, null, n0(a.localValue, (r) => (h(), p("div", {
          class: "nice-upload-overlay-message",
          key: r.name
        }, C(r.name), 1))), 128))
      ])) : y("", !0),
      a.localValue && a.localValueType == "string" ? (h(), p("div", N9, [
        L(o, { icon: "icon-file" }),
        m("div", $9, C(a.localValue), 1)
      ])) : y("", !0),
      a.localValue && a.localValueType == "image" ? (h(), p("div", S9, [
        m("img", {
          class: "nice-upload-overlay-image",
          src: a.localValue
        }, null, 8, O9)
      ])) : y("", !0),
      a.localValue && a.localValueType == "none" ? (h(), p("div", D9, [
        m("img", {
          class: "nice-upload-overlay-image",
          src: a.localValue
        }, null, 8, T9),
        m("div", L9, C(e.$t("Nice", "File selected")), 1)
      ])) : y("", !0),
      a.localValue ? (h(), p("button", {
        key: 5,
        type: "button",
        class: "nice-upload-button btn btn-white btn-plain",
        onClick: c[1] || (c[1] = (...r) => a.clear && a.clear(...r)),
        disabled: t.disabled
      }, [
        L(o, { icon: "icon-x" })
      ], 8, V9)) : y("", !0),
...
const F9 = /* @__PURE__ */ t0(x9, [["render", P9], ["__scopeId", "data-v-17f8d133"]]);
const q9 = {
  key: 0,
  ...
  setup(e) {
    const c = e, t = B1(), n = K(() => t.title || c.title || t.subTitle || c.subTitle || t.aboveTitle || c.aboveTitle);
    return (s, a) => {
      const l = U("NiceIcon"), o = U("NiceLoading");
      return h(), W(J0(e.isForm ? "form" : "div"), {
        class: I(["nice-view", { "nice-view-no-header": !x(n), "nice-view-flex-body": e.flexBody }])
      }, {
        default: c0(() => [
          x(n) || c.icon ? (h(), p("div", q9, [
            e.icon && !e.loading ? (h(), W(l, {
              key: 0,
              icon: e.icon,
            ...
            x(n) ? (h(), p("div", E9, [
              e.aboveTitle || x(t).aboveTitle ? (h(), p("div", I9, [
                X(s.$slots, "aboveTitle", {}, () => [
                  m0(C(e.aboveTitle), 1)
                ], !0)
              ])) : y("", !0),
              e.title || x(t).title ? (h(), p("div", A9, [
                X(s.$slots, "title", {}, () => [
                  m0(C(e.title), 1)
                ], !0)
              ])) : y("", !0),
              e.subTitle || x(t).subTitle ? (h(), p("div", W9, [
                X(s.$slots, "subTitle", {}, () => [
                  m0(C(e.subTitle), 1)
                ], !0)
              ])) : y("", !0)
...
}), R9 = /* @__PURE__ */ t0(H9, [["__scopeId", "data-v-0ca78f08"]]);
const U9 = (e) => (W0("data-v-82edbe78"), e = e(), j0(), e), Z9 = {
  key: 0,
...
}, J9 = /* @__PURE__ */ U9(() => /* @__PURE__ */ m("div", { class: "flex-grow" }, null, -1)), K9 = {
  key: 2,
  ...
  setup(e) {
    ...
    return (s, a) => (h(), p("div", {
      ...
      s.$slots.header || e.title || e.subtitle || e.collapsable ? (h(), p("div", Z9, [
        e.title || e.subtitle ? (h(), p("div", X9, [
          e.title ? (h(), p("div", Q9, C(e.title), 1)) : y("", !0),
          e.subtitle ? (h(), p("div", G9, C(e.subtitle), 1)) : y("", !0)
        ])) : y("", !0),
        X(s.$slots, "header", {}, void 0, !0),
        J9,
        e.collapsable ? (h(), W(p0, {
          key: 1,
      ...
      s.$slots.footer && t.value ? (h(), p("div", K9, [
        X(s.$slots, "footer", {}, void 0, !0)
      ])) : y("", !0)
    ], 2));
  }
}), ce = /* @__PURE__ */ t0(te, [["__scopeId", "data-v-82edbe78"]]);
const ne = { class: "nice-no-data" }, se = { class: "nice-no-data-message" }, ae = {
  name: "NiceNoData"
  ...
  setup(e) {
    const c = e, t = a0("$t"), n = Y(c.message || t("Nice", "No data"));
    return (s, a) => {
      const l = U("NiceIcon");
      return h(), p("div", ne, [
        L(l, {
        ...
        m("div", se, C(n.value), 1)
      ]);
    };
  }
}), le = /* @__PURE__ */ t0(oe, [["__scopeId", "data-v-63c3abc0"]]);
const ie = { class: "input-group" }, re = ["placeholder", "disabled", "required"], ue = { class: "nice-date-range-dropdown" }, de = { class: "nice-date-range-buttons" }, he = {
  name: "NiceDateRange"
  ...
  setup(e, { emit: c }) {
    const t = e, n = a0("$t"), s = Y(null), a = Y(""), l = Y("d.M.yyyy"), o = [
      {
        name: n("Nice", "Today"),
        from: _1(/* @__PURE__ */ new Date()),
        to: v7(/* @__PURE__ */ new Date())
      },
      {
        name: n("Nice", "Yesterday"),
        from: b5(/* @__PURE__ */ new Date()),
        to: g7(/* @__PURE__ */ new Date())
      },
      {
        name: n("Nice", "This week"),
        from: A0(/* @__PURE__ */ new Date()),
        to: y7(/* @__PURE__ */ new Date())
      },
      {
        name: n("Nice", "This month"),
        from: p7(/* @__PURE__ */ new Date()),
        to: f7(/* @__PURE__ */ new Date())
      }
    ], u = Y(null), r = Y(null);
    b0(() => {
      t.time && (l.value = "d.M.yyyy HH:mm"), t.from && (u.value = t.from), t.to && (r.value = t.to), u.value || v(o[0]);
    });
    function i() {
    }
    function d() {
      if (y5(r.value, u.value)) {
        const b = u.value;
        u.value = r.value, r.value = b;
      }
      f();
    }
    function v(b) {
      u.value = b.from, r.value = b.to, f();
    }
    function f() {
      c("update:to", r.value), c("update:from", u.value), c("change", { from: u.value, to: r.value }), M();
    }
    function M() {
      a.value = v2(u.value, l.value) + " - " + v2(r.value, l.value);
    }
    return (b, z) => {
      const S = U("NiceIcon"), D = U("NiceButton"), P = U("NiceDate");
      return h(), p("div", {
        ...
        L(s1, {
          ...
          trigger: c0(() => [
            m("div", ie, [
              k0(m("input", {
                "onUpdate:modelValue": z[0] || (z[0] = (g) => a.value = g),
                placeholder: e.placeholder || x(n)("Nice", "None"),
                disabled: e.disabled,
                required: e.required,
                onBlur: z[1] || (z[1] = (...g) => b.inputChanged && b.inputChanged(...g))
              }, null, 40, re), [
                [t1, a.value]
              ]),
              L(S, {
          ...
          content: c0(() => [
            m("div", ue, [
              ...
              L(P, {
                ...
                onChange: d,
                modelValue: u.value,
                "onUpdate:modelValue": z[2] || (z[2] = (g) => u.value = g),
                isInline: "",
                noMargin: ""
...
}), fe = /* @__PURE__ */ t0(ve, [["__scopeId", "data-v-f3fe5cee"]]);
const pe = { class: "nice-alert-data" }, me = {
  key: 0,
  ...
  setup(e) {
    return (c, t) => (h(), p("div", {
      class: I(["nice-alert", ["nice-alert-" + e.type, { "nice-alert-inline": e.inline, "nice-alert-align-center": e.alignCenter }]])
    }, [
      e.icon ? (h(), W(F1, {
        key: 0,
        icon: e.icon
      ...
      m("div", pe, [
        e.title ? (h(), p("div", me, C(e.title), 1)) : y("", !0),
        e.message ? (h(), p("div", ye, C(e.message), 1)) : y("", !0),
        X(c.$slots, "default")
      ])
    ], 2));
  }
  ...
  n.className = "nice-tooltip", n.textContent = c.value || e.getAttribute("nice-tooltip") || "", e.appendChild(n);
  const s = (l) => {
    n.style.display = "block";
  }, a = () => {
    n.style.display = "none";
  };
  e.addEventListener("mouseenter", s), e.addEventListener("mouseleave", a);
};
const xe = {
  install(e, c) {
    for (const l in f2) {
    ...
    e.directive("niceTooltip", Me);
    const t = Z2(), n = {
      debug: c ? c.debug : !1,
      emitter: t,
      // Notification
      onNotification: (l) => t.on("notification", l),
      notification: (l, o, u, r) => {
        t.emit("notification", { message: l, type: o, title: u, icon: r });
      },
      // Toast
      onToast: (l) => t.on("toast", l),
      toast: (l, o) => {
        t.emit("toast", { message: l, type: o });
      },
      // Panel
      onPanel: (l) => t.on("panel", l),
      panel: (l, o) => {
        t.emit("panel", { name: l, isOpen: o });
      },
      // Modal
      onModal: (l) => t.on("modal", l),
      modal: (l, o, u) => {
        t.emit("modal", { name: l, isOpen: o, event: u });
      }
    };
    e.config.globalProperties.$nice = n, e.provide("nice", n);
    async function s() {
      await c.router.isReady();
      const l = a(c.router.currentRoute.value.query);
      return delete l.id, l;
    }
    function a(l) {
      return Object.assign({}, l);
    }
    e.config.globalProperties.$query = s, e.provide("getQuery", s), e.config.globalProperties.$clone = a, e.provide("clone", a), e.config.globalProperties.$t = c.gettext.$pgettext, e.provide("$t", c.gettext.$pgettext);
  }
};
function Ce() {
  return a0("nice");
