...
const C4 = { class: "nice-checkbox-box" }, k4 = {
  ...
  setup(e, { emit: c }) {
    ...
    return (l, u) => (h(), f("div", {
      class: q(["nice-component nice-checkbox", {
      ...
      p("div", C4, [
        ...
        e.indeterminate && !a.value ? (h(), f("svg", B4, [...u[1] || (u[1] = [
      ...
      t.title ? (h(), f("div", {
        ...
        p("div", null, k(t.title), 1),
        t.description ? (h(), f("small", N4, k(t.description), 1)) : y("", !0)
      ], 8, _4)) : y("", !0),
      p("input", {
        type: "checkbox",
...
function P4(e, c, t, s, n, a) {
  return t.title || t.caption ? (h(), f("div", T4, [
    t.title ? (h(), f("div", L4, [
      y0(k(t.title) + " ", 1),
      t.required ? (h(), f("span", V4, " *")) : y("", !0)
    ])) : y("", !0),
    t.caption ? (h(), f("div", F4, k(t.caption), 1)) : y("", !0)
  ])) : y("", !0);
}
const N0 = /* @__PURE__ */ s0(D4, [["render", P4]]);
var r0 = "top", f0 = "bottom", p0 = "right", u0 = "left", k1 = "auto", K0 = [r0, f0, p0, u0], P0 = "start", Q0 = "end", q4 = "clippingParents", m2 = "viewport", Y0 = "popper", E4 = "reference", H1 = /* @__PURE__ */ K0.reduce(function(e, c) {
...
function s3(e) {
  ...
  if (!(!a || !r)) {
    var d = c3(n.padding, t), v = _1(a), m = u === "y" ? r0 : u0, _ = u === "y" ? f0 : p0, b = t.rects.reference[o] + t.rects.reference[u] - r[u] - t.rects.popper[o], M = r[u] - t.rects.reference[u], x = e1(a), L = x ? u === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, S = b / 2 - M / 2, T = d[m], g = L - v[o] - d[_], w = L / 2 - v[o] / 2 + S, P = U0(T, w, g), W = u;
...
function Z1(e, c, t) {
  return c === m2 ? M1(m3(e, t)) : T0(c) ? p3(c, t) : M1(f3($0(e)));
}
function y3(e) {
...
function G0(e, c) {
  c === void 0 && (c = {});
  var t = c, s = t.placement, n = s === void 0 ? e.placement : s, a = t.strategy, r = a === void 0 ? e.strategy : a, l = t.boundary, u = l === void 0 ? q4 : l, i = t.rootBoundary, o = i === void 0 ? m2 : i, d = t.elementContext, v = d === void 0 ? Y0 : d, m = t.altBoundary, _ = m === void 0 ? !1 : m, b = t.padding, M = b === void 0 ? 0 : b, x = b2(typeof M != "number" ? M : M2(M, K0)), L = v === Y0 ? E4 : Y0, S = e.rects.popper, T = e.elements[_ ? L : v], g = g3(T0(T) ? T : T.contextElement || $0(e.elements.popper), u, o, r), w = E0(e.elements.reference), P = w2({
    reference: w,
    element: S,
    strategy: "absolute",
    placement: n
...
function z3(e) {
  ...
  if (!c.modifiersData[s]._skip) {
    for (var n = t.mainAxis, a = n === void 0 ? !0 : n, r = t.altAxis, l = r === void 0 ? !0 : r, u = t.fallbackPlacements, i = t.padding, o = t.boundary, d = t.rootBoundary, v = t.altBoundary, m = t.flipVariations, _ = m === void 0 ? !0 : m, b = t.allowedAutoPlacements, M = c.options.placement, x = M0(M), L = x === M, S = u || (L || !_ ? [a1(M)] : M3(M)), T = [M].concat(S).reduce(function(Z, i0) {
...
function O3(e) {
  var c = e.state, t = e.options, s = e.name, n = t.mainAxis, a = n === void 0 ? !0 : n, r = t.altAxis, l = r === void 0 ? !1 : r, u = t.boundary, i = t.rootBoundary, o = t.altBoundary, d = t.padding, v = t.tether, m = v === void 0 ? !0 : v, _ = t.tetherOffset, b = _ === void 0 ? 0 : _, M = G0(c, {
    ...
    padding: d,
    altBoundary: o
  }), x = M0(c.placement), L = W0(c.placement), S = !L, T = N1(x), g = S3(T), w = c.modifiersData.popperOffsets, P = c.rects.reference, W = c.rects.popper, H = typeof b == "function" ? b(Object.assign({}, c.rects, {
    placement: c.placement
  })) : b, A = typeof H == "number" ? {
    mainAxis: H,
    altAxis: H
  ...
  if (w) {
    ...
    if (l) {
      var L1, O2 = T === "x" ? r0 : u0, D2 = T === "x" ? f0 : p0, S0 = w[g], s1 = g === "y" ? "height" : "width", V1 = S0 + M[O2], F1 = S0 - M[D2], v1 = [r0, u0].indexOf(x) !== -1, P1 = (L1 = Q == null ? void 0 : Q[g]) != null ? L1 : 0, q1 = v1 ? V1 : S0 - P[s1] - W[s1] - P1 + A.altAxis, E1 = v1 ? S0 + P[s1] + W[s1] - P1 - A.altAxis : F1, W1 = m && v1 ? t3(q1, S0, E1) : U0(m ? q1 : V1, S0, m ? E1 : F1);
      w[g] = W1, F[g] = W1 - S0;
    }
    c.modifiersData[s] = F;
  }
...
function F3(e, c, t) {
  t === void 0 && (t = !1);
  var s = m0(c), n = m0(c) && V3(c), a = $0(c), r = E0(e, n, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, u = {
    x: 0,
  ...
  O1(a)) && (l = L3(c)), m0(c) ? (u = E0(c, !0), u.x += c.clientLeft, u.y += c.clientTop) : a && (u.x = S1(a))), {
    ...
    var o = {
      ...
      forceUpdate: function() {
        if (!v) {
          ...
          if (J1(L, S)) {
            o.rects = {
              reference: F3(L, e1(S), o.options.strategy === "fixed"),
              popper: _1(S)
...
function a2(e, c, t) {
  var o, d, v, m, _, b, M, x;
  const s = c1(), n = (t == null ? void 0 : t.locale) ?? s.locale ?? P7, a = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((d = (o = t == null ? void 0 : t.locale) == null ? void 0 : o.options) == null ? void 0 : d.firstWeekContainsDate) ?? s.firstWeekContainsDate ?? ((m = (v = s.locale) == null ? void 0 : v.options) == null ? void 0 : m.firstWeekContainsDate) ?? 1, r = (t == null ? void 0 : t.weekStartsOn) ?? ((b = (_ = t == null ? void 0 : t.locale) == null ? void 0 : _.options) == null ? void 0 : b.weekStartsOn) ?? s.weekStartsOn ?? ((x = (M = s.locale) == null ? void 0 : M.options) == null ? void 0 : x.weekStartsOn) ?? 0, l = a0(e, t == null ? void 0 : t.in);
  if (!J3(l))
    throw new RangeError("Invalid time value");
  let u = c.match(J7).map((L) => {
    const S = L[0];
    if (S === "p" || S === "P") {
      const T = Y7[S];
...
const l5 = {
  key: 0,
  class: "nice-dropdown"
}, i5 = { class: "month-wrapper" }, o5 = { class: "value" }, r5 = { class: "year" }, u5 = { class: "month" }, d5 = { class: "calendar" }, h5 = { class: "header" }, v5 = { class: "month" }, m5 = ["onClick", "title"], f5 = {
  key: 0,
  class: "time"
      ...
      return h(), f("div", {
        ...
        e.isInline ? (h(), f("div", l5, [
          p("div", i5, [
            ...
            p("div", o5, [
              p("div", r5, k(l.value.getFullYear()), 1),
              p("div", u5, k(m[l.value.getMonth() + 1]), 1)
            ]),
            O(E, {
              class: "right",
          ...
          content: c0(() => [
            p("div", w5, [
              p("div", x5, [
                ...
                p("div", C5, [
                  p("div", k5, k(l.value.getFullYear()), 1),
                  p("div", B5, k(m[l.value.getMonth() + 1]), 1)
                ]),
                O(E, {
                  class: "right",
...
}), q5 = /* @__PURE__ */ s0(P5, [["__scopeId", "data-v-4c905654"]]);
          ...
          p("div", {
            ...
            p("select", {
              ...
              e.nullable ? (h(), f("option", {
                ...
                value: null,
                selected: !a.value
              }, k(e.nullText || K(s)("Nice", "None")), 9, I5)) : y("", !0),
              (h(!0), f(t0, null, n0(e.values, (m) => (h(), f("option", {
                value: m[e.keyName],
                key: m[e.keyName]
              }, k(m[e.valueName]), 9, A5))), 128))
            ], 40, W5),
            !e.nullable && !e.loading && (!e.values || e.values.length == 0) ? (h(), f("div", Y5, k(K(s)("Nice", "No options")), 1)) : y("", !0),
            e.loading ? (h(), I(d, {
              key: 1,
              class: "no-options"
            })) : y("", !0),
  ...
  setup(e) {
    ...
    return (t, s) => {
      ...
      return h(), f("div", {
        ...
        c.message ? (h(), f("div", X5, k(c.message), 1)) : y("", !0)
      ], 2);
    };
  }
      ...
      return h(), f("div", {
        ...
        p("div", K5, [
          O(t1, {
              ...
              p("div", e8, [
                p("div", t8, [
                  p("div", {
                    ...
                    !e.loading && e.modelValue && !t.multiple ? (h(), f("div", s8, [
                    ...
                    !e.loading && !e.modelValue || t.multiple && !x.value.length ? (h(), f("div", l8, k(e.nullText || K(s)("Nice", "None")), 1)) : y("", !0),
                    e.loading ? (h(), f("div", i8, k(K(s)("Nice", "Loading")), 1)) : y("", !0),
                    O(B, {
                      class: "arrow-down",
                      icon: "icon-chevron-down"
                    }),
            ...
            content: c0(() => [
              p("div", o8, [
                e.searchFunction && !e.noSearch ? (h(), f("div", r8, [
                  _0(p("input", {
                ...
                p("div", d8, [
                  ...
                  !v.value && (!m.value || m.value.length == 0) ? (h(), f("div", v8, k(K(s)("Nice", "No options")), 1)) : y("", !0)
                ])
              ])
            ]),
            _: 3
...
}), p8 = /* @__PURE__ */ s0(f8, [["__scopeId", "data-v-9b3d7ba4"]]);
  ...
  setup(e, { emit: c }) {
    ...
    return (g, w) => {
      ...
      return h(), f("div", y8, [
        ...
        e.showPills && v.value && v.value.length ? (h(), f("div", M8, [
...
}), C8 = /* @__PURE__ */ s0(x8, [["__scopeId", "data-v-b3e06448"]]);
  ...
  setup(e, { emit: c }) {
    ...
    return (d, v) => {
      ...
      return h(), f("div", {
        ...
        e.message ? (h(), f("div", D8, k(e.message), 1)) : y("", !0),
        i.value ? (h(), f("div", T8, k(i.value), 1)) : y("", !0)
      ], 2);
    };
  }
  ...
  setup(e, { emit: c }) {
    ...
    return g0(() => {
      ...
      return h(), f("div", {
        ...
        p("div", P8, [
          t.notification.title ? (h(), f("div", q8, k(t.notification.title), 1)) : y("", !0),
          t.notification.message ? (h(), f("div", E8, k(t.notification.message), 1)) : y("", !0)
        ])
      ], 34);
    };
  }
    ...
    return (t, s) => (h(), f("svg", Q8, [
      p("defs", null, [
        ...
        p("symbol", G8, [
          ...
          c.isDevelopment ? (h(), f("g", J8, [...s[0] || (s[0] = [
    ...
    return (l, u) => {
      ...
      return h(), f("div", {
        ...
        t.title ? (h(), f("div", {
          ...
          p("div", null, k(t.title), 1),
          t.description ? (h(), f("small", n6, k(t.description), 1)) : y("", !0)
        ], 8, s6)) : y("", !0),
        p("input", {
          type: "checkbox",
          tabindex: "-1",
...
const r6 = { class: "nice-table" }, u6 = { class: "nice-table-table-wrapper" }, d6 = { class: "nice-table-table" }, h6 = {
  key: 0,
  class: "w-0"
}, v6 = { key: 0 }, m6 = ["onClick"], f6 = { key: 1 }, p6 = ["placeholder", "onUpdate:modelValue"], y6 = ["onClick"], g6 = ["onClick"], b6 = { key: 0 }, M6 = { key: 0 }, z6 = { class: "list" }, w6 = ["onClick"], x6 = { key: 0 }, C6 = {
  key: 0,
  class: "w-0"
      ...
      return h(), f("div", r6, [
        p("div", u6, [
          p("table", d6, [
            p("thead", null, [
              p("tr", null, [
                ...
                a.actions.length ? (h(), f("th", {
                  ...
                  !a.showToggleColumns && !a.showFooter && S.value && S.value.length ? (h(), f("span", b6, [
                    p("span", null, k(S.value.length), 1),
                    S.value._metadata ? (h(), f("span", M6, " / " + k(S.value._metadata.count), 1)) : y("", !0)
                  ])) : y("", !0),
            ...
            S.value && S.value.length ? (h(), f("tbody", x6, [
              (h(!0), f(t0, null, n0(S.value, (C) => (h(), f("tr", {
                key: C.id
              }, [
                a.selectMultiple ? (h(), f("td", C6, [
                  O(R0, {
        ...
        a.showFooter ? (h(), f("div", _6, [
          e.loading ? (h(), I(d1, {
            key: 0,
            class: "nice-table-footer-loading"
          })) : y("", !0),
          p("div", N6, k(_.value) + " " + k($.$t("Nice", "total")), 1),
          Z[2] || (Z[2] = p("div", { class: "f-grow" }, null, -1)),
          a.paginated && b.value > 1 && b.value <= 5 ? (h(), f("div", $6, [
            O(v0, {
          ...
          a.paginated && b.value > 1 && b.value > 5 ? (h(), f("div", S6, [
            O(L0, {
    ...
    return (a, r) => {
      ...
      return h(), f("div", {
        ...
        p("div", L6, [
          ...
          a.$slots.append ? (h(), f("div", q6, [
            X(a.$slots, "append", {}, void 0, !0)
          ])) : y("", !0)
        ]),
        e.message ? (h(), f("div", E6, k(e.message), 1)) : y("", !0)
      ], 2);
    };
  }
...
function l9(e, c, t, s, n, a) {
  ...
  return h(), f("div", {
    ...
    p("div", {
      ...
      a.localValue ? y("", !0) : (h(), f("div", X6, [
        O(l, { icon: "icon-upload" }),
        p("div", Q6, k(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      a.localValue && a.localValueType == "FileList" ? (h(), f("div", G6, [
        O(l, { icon: "icon-file" }),
      ...
      a.localValue && a.localValueType == "string" ? (h(), f("div", J6, [
        O(l, { icon: "icon-file" }),
        p("div", K6, k(a.localValue), 1)
      ])) : y("", !0),
      a.localValue && a.localValueType == "image" ? (h(), f("div", e9, [
        p("img", {
          class: "nice-upload-overlay-image",
          src: a.localValue
        }, null, 8, t9)
      ])) : y("", !0),
      a.localValue && a.localValueType == "none" ? (h(), f("div", c9, [
        p("img", {
          class: "nice-upload-overlay-image",
          src: a.localValue
        }, null, 8, s9),
        p("div", n9, k(e.$t("Nice", "File selected")), 1)
      ])) : y("", !0),
      ...
      return h(), I(X0(e.isForm ? "form" : "div"), {
        ...
        default: c0(() => [
          s.value || t.icon ? (h(), f("div", o9, [
            ...
            s.value ? (h(), f("div", r9, [
              e.aboveTitle || K(c).aboveTitle ? (h(), f("div", u9, [
                X(n.$slots, "aboveTitle", {}, () => [
                  y0(k(e.aboveTitle), 1)
                ], !0)
              ])) : y("", !0),
              e.title || K(c).title ? (h(), f("div", d9, [
                X(n.$slots, "title", {}, () => [
                  y0(k(e.title), 1)
                ], !0)
              ])) : y("", !0),
              e.subTitle || K(c).subTitle ? (h(), f("div", h9, [
                X(n.$slots, "subTitle", {}, () => [
                  y0(k(e.subTitle), 1)
                ], !0)
              ])) : y("", !0)
...
}), p9 = /* @__PURE__ */ s0(f9, [["__scopeId", "data-v-0ca78f08"]]);
const y9 = {
  key: 0,
  ...
  setup(e) {
    ...
    return (n, a) => (h(), f("div", {
      ...
      n.$slots.header || e.title || e.subtitle || e.collapsable ? (h(), f("div", y9, [
        e.title || e.subtitle ? (h(), f("div", g9, [
          e.title ? (h(), f("div", b9, k(e.title), 1)) : y("", !0),
          e.subtitle ? (h(), f("div", M9, k(e.subtitle), 1)) : y("", !0)
        ])) : y("", !0),
      ...
      n.$slots.footer && t.value ? (h(), f("div", z9, [
        X(n.$slots, "footer", {}, void 0, !0)
      ])) : y("", !0)
    ], 2));
  }
...
const P9 = { class: "nice-alert-data" }, q9 = {
  ...
  setup(e) {
    return (c, t) => (h(), f("div", {
      ...
      p("div", P9, [
        e.title ? (h(), f("div", q9, k(e.title), 1)) : y("", !0),
        e.message ? (h(), f("div", E9, k(e.message), 1)) : y("", !0),
        X(c.$slots, "default")
      ])
    ], 2));
  }
