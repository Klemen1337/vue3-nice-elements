import { useSlots as N1, resolveComponent as Y, openBlock as h, createElementBlock as p, normalizeClass as E, unref as x, createBlock as I, createCommentVNode as y, renderSlot as X, toDisplayString as B, Teleport as W2, createVNode as D, Transition as d1, withCtx as e0, resolveDynamicComponent as J0, normalizeStyle as V1, withModifiers as j2, createElementVNode as f, createTextVNode as M0, inject as n0, Fragment as K, computed as J, pushScopeId as W0, popScopeId as j0, ref as j, onMounted as g0, onBeforeUnmount as Y2, withDirectives as N0, vShow as U1, watch as u1, renderList as a0, vModelText as t1, mergeProps as f2, isRef as $1, vModelDynamic as Z2, TransitionGroup as y2, onUnmounted as R2, createStaticVNode as S1, normalizeProps as U2 } from "vue";
import { useRoute as g2, useRouter as b2 } from "vue-router";
function X2(e) {
  return { all: e = e || /* @__PURE__ */ new Map(), on: function(c, t) {
    var a = e.get(c);
    a ? a.push(t) : e.set(c, [t]);
  }, off: function(c, t) {
    var a = e.get(c);
    a && (t ? a.splice(a.indexOf(t) >>> 0, 1) : e.set(c, []));
  }, emit: function(c, t) {
    var a = e.get(c);
...
const t0 = (e, c) => {
  ...
  for (const [a, s] of c)
    t[a] = s;
  return t;
}, Q2 = ["type", "disabled"], G2 = { key: 2 }, J2 = { key: 3 }, K2 = {
  name: "NiceButton"
}, e3 = /* @__PURE__ */ Object.assign(K2, {
  props: {
    addClass: {
      type: String,
      default: null
  ...
  setup(e) {
    const c = e, t = N1();
    return (a, s) => {
      const n = Y("NiceLoading"), o = Y("NiceIcon");
      return h(), p("button", {
        class: E(["nice-button btn", [
          c.addClass,
          "btn-" + c.type,
          c.size ? "btn-" + c.size : "",
          {
            ...
            "btn-icon": !x(t).default && !c.text && (c.icon || c.appendIcon)
          }
        ]]),
        type: c.nativeType,
        ...
        x(t).default ? (h(), p("span", G2, [
          X(a.$slots, "default", {}, void 0, !0)
        ])) : y("", !0),
        c.text ? (h(), p("span", J2, B(c.text), 1)) : y("", !0),
        c.appendIcon ? (h(), I(o, {
          key: 4,
          icon: c.appendIcon
        }, null, 8, ["icon"])) : y("", !0)
...
}), v0 = /* @__PURE__ */ t0(e3, [["__scopeId", "data-v-5bdcb792"]]);
const t3 = {
  name: "NiceModal",
  props: {
    name: {
...
}, a3 = { class: "nice-modal-title" }, s3 = { class: "nice-modal-subtitle" }, n3 = {
  key: 1,
  class: "nice-modal-footer"
};
function l3(e, c, t, a, s, n) {
  const o = Y("NiceButton");
  return h(), I(W2, { to: "body" }, [
    D(d1, { name: "fade" }, {
      default: e0(() => [
        s.isOpen ? (h(), p("div", {
          key: 0,
          class: "nice-modal-overlay",
          onClick: c[0] || (c[0] = (...l) => n.close && n.close(...l))
        })) : y("", !0)
      ]),
      _: 1
    }),
    D(d1, { name: "flyin" }, {
      default: e0(() => [
        s.isOpen ? (h(), I(J0(t.isForm ? "form" : "div"), {
          key: 0,
          class: E(["nice-modal", t.modalClass]),
          style: V1([{ width: t.width, height: t.height }, s.startingPosition]),
          onSubmit: c[1] || (c[1] = j2((l) => e.$emit("submit"), ["prevent"]))
        }, {
          default: e0(() => [
            e.$slots.title || t.title || e.$slots.subtitle || t.subtitle ? (h(), p("div", c3, [
              f("div", a3, [
            ...
            f("div", {
              class: E(["nice-modal-body", { "no-header": !(e.$slots.title || t.title || e.$slots.subtitle || t.subtitle), "no-footer": !e.$slots.footer }])
            }, [
              X(e.$slots, "default", {}, void 0, !0)
            ], 2),
            e.$slots.footer ? (h(), p("div", n3, [
...
const M2 = /* @__PURE__ */ t0(t3, [["render", l3], ["__scopeId", "data-v-45501a02"]]), o3 = { class: "p-0 m-0" }, i3 = {
  name: "NiceConfirmModal"
}, z2 = /* @__PURE__ */ Object.assign(i3, {
  props: {
    name: {
      type: String,
...
const r3 = { class: "nice-actions" }, d3 = /* @__PURE__ */ f("div", { class: "f-grow" }, null, -1), u3 = {
  name: "NiceActions"
}, h3 = /* @__PURE__ */ Object.assign(u3, {
  props: {
    form: String,
    loading: Boolean,
    showDelete: Boolean,
  ...
  setup(e, { emit: c }) {
    ...
    function n() {
      a.modal("delete-prompt", !0);
    }
    function o() {
      a.modal("delete-prompt", !1), c("delete");
    }
    function l() {
      c("cancel");
    }
    return (d, r) => {
      const i = Y("NiceButton");
      return h(), p(K, null, [
        f("div", r3, [
          t.showDelete ? (h(), I(i, {
            key: 0,
...
var f3 = p3;
const b1 = (e, c, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (c - e) * 6 * t : t < 1 / 2 ? c : t < 2 / 3 ? e + (c - e) * (2 / 3 - t) * 6 : e), y3 = (e, c, t) => {
  let a, s, n;
  if (e = e / 360, c == 0)
    a = s = n = t;
  else {
    const o = t < 0.5 ? t * (1 + c) : t + c - t * c, l = 2 * t - o;
    a = b1(l, o, e + 1 / 3), s = b1(l, o, e), n = b1(l, o, e - 1 / 3);
  }
  return [
...
var g3 = y3;
const b3 = m3, M3 = f3, X1 = g3, z3 = () => Math.floor(Math.random() * Date.now()), C3 = (e, c) => {
  const t = b3(e), a = M3(t % 360, 1, 0.5), s = X1(a[0][0], a[0][1], a[0][2]), n = X1(a[1][0], a[1][1], a[1][2]), o = `rgb(${s[0]}, ${s[1]}, ${s[2]})`, l = `rgb(${n[0]}, ${n[1]}, ${n[2]})`, d = z3();
...
(function() {
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = {
    ...
    bytesToWords: function(t) {
      for (var a = [], s = 0, n = 0; s < t.length; s++, n += 8)
        a[n >>> 5] |= t[s] << 24 - n % 32;
      return a;
    },
    // Convert big-endian 32-bit words to a byte array
    wordsToBytes: function(t) {
      for (var a = [], s = 0; s < t.length * 32; s += 8)
        a.push(t[s >>> 5] >>> 24 - s % 32 & 255);
      return a;
    },
    // Convert a byte array to a hex string
    bytesToHex: function(t) {
      for (var a = [], s = 0; s < t.length; s++)
        a.push((t[s] >>> 4).toString(16)), a.push((t[s] & 15).toString(16));
      return a.join("");
    },
    // Convert a hex string to a byte array
    hexToBytes: function(t) {
      for (var a = [], s = 0; s < t.length; s += 2)
        a.push(parseInt(t.substr(s, 2), 16));
      return a;
    },
    // Convert a byte array to a base-64 string
    bytesToBase64: function(t) {
      for (var a = [], s = 0; s < t.length; s += 3)
        for (var n = t[s] << 16 | t[s + 1] << 8 | t[s + 2], o = 0; o < 4; o++)
          s * 8 + o * 6 <= t.length * 8 ? a.push(e.charAt(n >>> 6 * (3 - o) & 63)) : a.push("=");
      return a.join("");
    },
    // Convert a base-64 string to a byte array
    base64ToBytes: function(t) {
      t = t.replace(/[^A-Z0-9+\/]/ig, "");
      for (var a = [], s = 0, n = 0; s < t.length; n = ++s % 4)
        n != 0 && a.push((e.indexOf(t.charAt(s - 1)) & Math.pow(2, -2 * n + 8) - 1) << n * 2 | e.indexOf(t.charAt(s)) >>> 6 - n * 2);
      return a;
    }
  };
  _3.exports = c;
...
var C1 = {
  ...
  utf8: {
    ...
    stringToBytes: function(e) {
      return C1.bin.stringToBytes(unescape(encodeURIComponent(e)));
    },
    // Convert a byte array to a string
    bytesToString: function(e) {
      return decodeURIComponent(escape(C1.bin.bytesToString(e)));
    }
  },
  // Binary encoding
  bin: {
 ...
 */
var k3 = function(e) {
  return e != null && (C2(e) || B3(e) || !!e._isBuffer);
};
function C2(e) {
  return !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
}
function B3(e) {
  return typeof e.readFloatLE == "function" && typeof e.slice == "function" && C2(e.slice(0, 0));
}
(function() {
  var e = z1, c = Q1.utf8, t = k3, a = Q1.bin, s = function(n, o) {
    n.constructor == String ? o && o.encoding === "binary" ? n = a.stringToBytes(n) : n = c.stringToBytes(n) : t(n) ? n = Array.prototype.slice.call(n, 0) : !Array.isArray(n) && n.constructor !== Uint8Array && (n = n.toString());
    for (var l = e.bytesToWords(n), d = n.length * 8, r = 1732584193, i = -271733879, u = -1732584194, v = 271733878, m = 0; m < l.length; m++)
      l[m] = (l[m] << 8 | l[m] >>> 24) & 16711935 | (l[m] << 24 | l[m] >>> 8) & 4278255360;
    l[d >>> 5] |= 128 << d % 32, l[(d + 64 >>> 9 << 4) + 14] = d;
    for (var b = s._ff, M = s._gg, z = s._hh, S = s._ii, m = 0; m < l.length; m += 16) {
      var L = r, H = i, g = u, w = v;
      r = b(r, i, u, v, l[m + 0], 7, -680876936), v = b(v, r, i, u, l[m + 1], 12, -389564586), u = b(u, v, r, i, l[m + 2], 17, 606105819), i = b(i, u, v, r, l[m + 3], 22, -1044525330), r = b(r, i, u, v, l[m + 4], 7, -176418897), v = b(v, r, i, u, l[m + 5], 12, 1200080426), u = b(u, v, r, i, l[m + 6], 17, -1473231341), i = b(i, u, v, r, l[m + 7], 22, -45705983), r = b(r, i, u, v, l[m + 8], 7, 1770035416), v = b(v, r, i, u, l[m + 9], 12, -1958414417), u = b(u, v, r, i, l[m + 10], 17, -42063), i = b(i, u, v, r, l[m + 11], 22, -1990404162), r = b(r, i, u, v, l[m + 12], 7, 1804603682), v = b(v, r, i, u, l[m + 13], 12, -40341101), u = b(u, v, r, i, l[m + 14], 17, -1502002290), i = b(i, u, v, r, l[m + 15], 22, 1236535329), r = M(r, i, u, v, l[m + 1], 5, -165796510), v = M(v, r, i, u, l[m + 6], 9, -1069501632), u = M(u, v, r, i, l[m + 11], 14, 643717713), i = M(i, u, v, r, l[m + 0], 20, -373897302), r = M(r, i, u, v, l[m + 5], 5, -701558691), v = M(v, r, i, u, l[m + 10], 9, 38016083), u = M(u, v, r, i, l[m + 15], 14, -660478335), i = M(i, u, v, r, l[m + 4], 20, -405537848), r = M(r, i, u, v, l[m + 9], 5, 568446438), v = M(v, r, i, u, l[m + 14], 9, -1019803690), u = M(u, v, r, i, l[m + 3], 14, -187363961), i = M(i, u, v, r, l[m + 8], 20, 1163531501), r = M(r, i, u, v, l[m + 13], 5, -1444681467), v = M(v, r, i, u, l[m + 2], 9, -51403784), u = M(u, v, r, i, l[m + 7], 14, 1735328473), i = M(i, u, v, r, l[m + 12], 20, -1926607734), r = z(r, i, u, v, l[m + 5], 4, -378558), v = z(v, r, i, u, l[m + 8], 11, -2022574463), u = z(u, v, r, i, l[m + 11], 16, 1839030562), i = z(i, u, v, r, l[m + 14], 23, -35309556), r = z(r, i, u, v, l[m + 1], 4, -1530992060), v = z(v, r, i, u, l[m + 4], 11, 1272893353), u = z(u, v, r, i, l[m + 7], 16, -155497632), i = z(i, u, v, r, l[m + 10], 23, -1094730640), r = z(r, i, u, v, l[m + 13], 4, 681279174), v = z(v, r, i, u, l[m + 0], 11, -358537222), u = z(u, v, r, i, l[m + 3], 16, -722521979), i = z(i, u, v, r, l[m + 6], 23, 76029189), r = z(r, i, u, v, l[m + 9], 4, -640364487), v = z(v, r, i, u, l[m + 12], 11, -421815835), u = z(u, v, r, i, l[m + 15], 16, 530742520), i = z(i, u, v, r, l[m + 2], 23, -995338651), r = S(r, i, u, v, l[m + 0], 6, -198630844), v = S(v, r, i, u, l[m + 7], 10, 1126891415), u = S(u, v, r, i, l[m + 14], 15, -1416354905), i = S(i, u, v, r, l[m + 5], 21, -57434055), r = S(r, i, u, v, l[m + 12], 6, 1700485571), v = S(v, r, i, u, l[m + 3], 10, -1894986606), u = S(u, v, r, i, l[m + 10], 15, -1051523), i = S(i, u, v, r, l[m + 1], 21, -2054922799), r = S(r, i, u, v, l[m + 8], 6, 1873313359), v = S(v, r, i, u, l[m + 15], 10, -30611744), u = S(u, v, r, i, l[m + 6], 15, -1560198380), i = S(i, u, v, r, l[m + 13], 21, 1309151649), r = S(r, i, u, v, l[m + 4], 6, -145523070), v = S(v, r, i, u, l[m + 11], 10, -1120210379), u = S(u, v, r, i, l[m + 2], 15, 718787259), i = S(i, u, v, r, l[m + 9], 21, -343485551), r = r + L >>> 0, i = i + H >>> 0, u = u + g >>> 0, v = v + w >>> 0;
    }
    return e.endian([r, i, u, v]);
  };
  s._ff = function(n, o, l, d, r, i, u) {
    var v = n + (o & l | ~o & d) + (r >>> 0) + u;
    return (v << i | v >>> 32 - i) + o;
  }, s._gg = function(n, o, l, d, r, i, u) {
    var v = n + (o & d | l & ~d) + (r >>> 0) + u;
    return (v << i | v >>> 32 - i) + o;
  }, s._hh = function(n, o, l, d, r, i, u) {
    var v = n + (o ^ l ^ d) + (r >>> 0) + u;
    return (v << i | v >>> 32 - i) + o;
  }, s._ii = function(n, o, l, d, r, i, u) {
    var v = n + (l ^ (o | ~d)) + (r >>> 0) + u;
    return (v << i | v >>> 32 - i) + o;
  }, s._blocksize = 16, s._digestsize = 16, x3.exports = function(n, o) {
    if (n == null)
      throw new Error("Illegal argument " + n);
    var l = e.wordsToBytes(s(n, o));
    return o && o.asBytes ? l : o && o.asString ? a.bytesToString(l) : e.bytesToHex(l);
  };
})();
const N3 = {
  key: 0,
  class: "status"
}, V3 = ["innerHTML"], $3 = ["src"], S3 = ["src"], O3 = {
  key: 4,
  class: "text"
}, L3 = {
  name: "NiceAvatar"
}, D3 = /* @__PURE__ */ Object.assign(L3, {
  props: {
    text: {
      type: String,
      required: !1
  ...
  setup(e) {
    const c = e, t = J(() => w3(h1(c.hash || c.text))), a = J(() => {
      const n = c.text.split(" ");
      return n.length > 1 ? n[0][0] + n[1][0] : c.text[0] + c.text[1];
    }), s = J(() => "https://www.gravatar.com/avatar/" + h1(c.gavatar.trim().toLowerCase()) + "?s=50");
    return (n, o) => (h(), p("div", {
      class: E(["nice-avatar", [
        c.size ? "size-" + c.size : "",
      ...
      c.text ? (h(), p("div", O3, B(x(a)), 1)) : y("", !0)
    ], 2));
  }
});
const w2 = (e) => (W0("data-v-f41f6bf4"), e = e(), j0(), e), T3 = { class: "nice-checkbox-box" }, H3 = {
  key: 0,
  viewBox: "0 0 20 20"
}, P3 = /* @__PURE__ */ w2(() => /* @__PURE__ */ f("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), F3 = [
  P3
], q3 = {
  key: 1,
  viewBox: "0 0 24 24"
}, E3 = /* @__PURE__ */ w2(() => /* @__PURE__ */ f("path", { d: "M5 13h14c0.552 0 1-0.448 1-1s-0.448-1-1-1h-14c-0.552 0-1 0.448-1 1s0.448 1 1 1z" }, null, -1)), I3 = [
  E3
], A3 = ["for"], W3 = { key: 0 }, j3 = ["id", "disabled"], Y3 = {
  name: "NiceCheckbox"
}, Z3 = /* @__PURE__ */ Object.assign(Y3, {
  props: {
    modelValue: {
      type: [Boolean, null],
      default: !1
  ...
  setup(e, { emit: c }) {
    const t = e, a = Math.random().toString(36).slice(2, 7), s = J({
      get() {
        return t.modelValue;
      },
      set(o) {
        c("update:modelValue", o), c("change", o);
      }
    });
    function n() {
    ...
    return (o, l) => (h(), p("div", {
      class: E(["nice-component nice-checkbox", {
      ...
      f("div", T3, [
        x(s) ? (h(), p("svg", H3, F3)) : y("", !0),
        e.indeterminate && !x(s) ? (h(), p("svg", q3, I3)) : y("", !0)
      ]),
      t.title ? (h(), p("div", {
        key: 0,
        class: "nice-checkbox-title",
        for: "nice-checkbox" + x(a)
      }, [
        f("div", null, B(t.title), 1),
        t.description ? (h(), p("small", W3, B(t.description), 1)) : y("", !0)
      ], 8, A3)) : y("", !0),
      f("input", {
        type: "checkbox",
        id: "nice-checkbox" + x(a),
        disabled: t.disabled
      }, null, 8, j3)
    ], 2));
  }
}), X0 = /* @__PURE__ */ t0(Z3, [["__scopeId", "data-v-f41f6bf4"]]);
const R3 = {
...
function J3(e, c, t, a, s, n) {
  return t.title || t.caption ? (h(), p("div", U3, [
    t.title ? (h(), p("div", X3, [
      M0(B(t.title) + " ", 1),
      t.required ? (h(), p("span", Q3, " *")) : y("", !0)
    ])) : y("", !0),
    t.caption ? (h(), p("div", G3, B(t.caption), 1)) : y("", !0)
  ])) : y("", !0);
}
const V0 = /* @__PURE__ */ t0(R3, [["render", J3]]);
var i0 = "top", m0 = "bottom", p0 = "right", r0 = "left", f1 = "auto", c1 = [i0, m0, p0, r0], F0 = "start", K0 = "end", K3 = "clippingParents", x2 = "viewport", Z0 = "popper", e4 = "reference", G1 = /* @__PURE__ */ c1.reduce(function(e, c) {
  return e.concat([c + "-" + F0, c + "-" + K0]);
}, []), _2 = /* @__PURE__ */ [].concat(c1, [f1]).reduce(function(e, c) {
  return e.concat([c, c + "-" + F0, c + "-" + K0]);
}, []), t4 = "beforeRead", c4 = "read", a4 = "afterRead", s4 = "beforeMain", n4 = "main", l4 = "afterMain", o4 = "beforeWrite", i4 = "write", r4 = "afterWrite", w1 = [t4, c4, a4, s4, n4, l4, o4, i4, r4];
function z0(e) {
...
function u0(e) {
  var c = h0(e).HTMLElement;
  return e instanceof c || e instanceof HTMLElement;
}
function O1(e) {
  if (typeof ShadowRoot > "u")
    return !1;
  var c = h0(e).ShadowRoot;
  return e instanceof c || e instanceof ShadowRoot;
}
function d4(e) {
  var c = e.state;
  Object.keys(c.elements).forEach(function(t) {
    var a = c.styles[t] || {}, s = c.attributes[t] || {}, n = c.elements[t];
    !u0(n) || !z0(n) || (Object.assign(n.style, a), Object.keys(s).forEach(function(o) {
      var l = s[o];
      l === !1 ? n.removeAttribute(o) : n.setAttribute(o, l === !0 ? "" : l);
    }));
  });
}
function u4(e) {
  ...
  return Object.assign(c.elements.popper.style, t.popper), c.styles = t, c.elements.arrow && Object.assign(c.elements.arrow.style, t.arrow), function() {
    Object.keys(c.elements).forEach(function(a) {
      var s = c.elements[a], n = c.attributes[a] || {}, o = Object.keys(c.styles.hasOwnProperty(a) ? c.styles[a] : t[a]), l = o.reduce(function(d, r) {
        return d[r] = "", d;
      }, {});
      !u0(s) || !z0(s) || (Object.assign(s.style, l), Object.keys(n).forEach(function(d) {
        s.removeAttribute(d);
      }));
    });
  };
...
var D0 = Math.max, v1 = Math.min, q0 = Math.round;
function x1() {
...
function E0(e, c, t) {
  ...
  c && u0(e) && (s = e.offsetWidth > 0 && q0(a.width) / e.offsetWidth || 1, n = e.offsetHeight > 0 && q0(a.height) / e.offsetHeight || 1);
  var o = T0(e) ? h0(e) : window, l = o.visualViewport, d = !k2() && t, r = (a.left + (d && l ? l.offsetLeft : 0)) / s, i = (a.top + (d && l ? l.offsetTop : 0)) / n, u = a.width / s, v = a.height / n;
  return {
    width: u,
    height: v,
    top: i,
...
function L1(e) {
  var c = E0(e), t = e.offsetWidth, a = e.offsetHeight;
  return Math.abs(c.width - t) <= 1 && (t = c.width), Math.abs(c.height - a) <= 1 && (a = c.height), {
    x: e.offsetLeft,
    y: e.offsetTop,
    width: t,
    height: a
...
function y0(e) {
  return h0(e).getComputedStyle(e);
}
function v4(e) {
...
function y1(e) {
  return z0(e) === "html" ? e : (
    ...
    (O1(e) ? e.host : null) || // ShadowRoot detected
    // $FlowFixMe[incompatible-call]: HTMLElement is a Node
    $0(e)
  );
}
function J1(e) {
  return !u0(e) || // https://github.com/popperjs/popper-core/issues/837
  y0(e).position === "fixed" ? null : e.offsetParent;
}
function m4(e) {
  var c = /firefox/i.test(x1()), t = /Trident/i.test(x1());
  if (t && u0(e)) {
    var a = y0(e);
    if (a.position === "fixed")
      return null;
  ...
  var s = y1(e);
  for (O1(s) && (s = s.host); u0(s) && ["html", "body"].indexOf(z0(s)) < 0; ) {
    var n = y0(s);
    if (n.transform !== "none" || n.perspective !== "none" || n.contain === "paint" || ["transform", "perspective"].indexOf(n.willChange) !== -1 || c && n.willChange === "filter" || c && n.filter && n.filter !== "none")
      return s;
    s = s.parentNode;
  }
  return null;
...
function a1(e) {
  for (var c = h0(e), t = J1(e); t && v4(t) && y0(t).position === "static"; )
    t = J1(t);
  return t && (z0(t) === "html" || z0(t) === "body" && y0(t).position === "static") ? c : t || m4(e) || c;
}
function D1(e) {
...
var f4 = function(c, t) {
  ...
  })) : c, V2(typeof c != "number" ? c : $2(c, c1));
};
function y4(e) {
  var c, t = e.state, a = e.name, s = e.options, n = t.elements.arrow, o = t.modifiersData.popperOffsets, l = f0(t.placement), d = D1(l), r = [r0, p0].indexOf(l) >= 0, i = r ? "height" : "width";
  if (!(!n || !o)) {
    var u = f4(s.padding, t), v = L1(n), m = d === "y" ? i0 : r0, b = d === "y" ? m0 : p0, M = t.rects.reference[i] + t.rects.reference[d] - o[d] - t.rects.popper[i], z = o[d] - t.rects.reference[d], S = a1(n), L = S ? d === "y" ? S.clientHeight || 0 : S.clientWidth || 0 : 0, H = M / 2 - z / 2, g = u[m], w = L - v[i] - u[b], T = L / 2 - v[i] / 2 + H, F = Q0(g, T, w), W = d;
    t.modifiersData[a] = (c = {}, c[W] = F, c.centerOffset = F - T, c);
  }
}
function g4(e) {
  var c = e.state, t = e.options, a = t.element, s = a === void 0 ? "[data-popper-arrow]" : a;
  if (s != null && !(typeof s == "string" && (s = c.elements.popper.querySelector(s), !s))) {
    if (process.env.NODE_ENV !== "production" && (u0(s) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !B2(c.elements.popper, s)) {
...
function z4(e, c) {
  var t = e.x, a = e.y, s = c.devicePixelRatio || 1;
  return {
    x: q0(t * s) / s || 0,
    y: q0(a * s) / s || 0
  };
...
function K1(e) {
  var c, t = e.popper, a = e.popperRect, s = e.placement, n = e.variation, o = e.offsets, l = e.position, d = e.gpuAcceleration, r = e.adaptive, i = e.roundOffsets, u = e.isFixed, v = o.x, m = v === void 0 ? 0 : v, b = o.y, M = b === void 0 ? 0 : b, z = typeof i == "function" ? i({
    x: m,
    y: M
  }) : {
    x: m,
  ...
  m = z.x, M = z.y;
  var S = o.hasOwnProperty("x"), L = o.hasOwnProperty("y"), H = r0, g = i0, w = window;
  if (r) {
    var T = a1(t), F = "clientHeight", W = "clientWidth";
    if (T === h0(t) && (T = $0(t), y0(T).position !== "static" && l === "absolute" && (F = "scrollHeight", W = "scrollWidth")), T = T, s === i0 || (s === r0 || s === p0) && n === K0) {
      g = m0;
      var A = u && T === w && w.visualViewport ? w.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        T[F]
      );
      M -= A - a.height, M *= d ? 1 : -1;
    }
    if (s === r0 || (s === i0 || s === m0) && n === K0) {
      H = p0;
      var Z = u && T === w && w.visualViewport ? w.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        T[W]
      );
      m -= Z - a.width, m *= d ? 1 : -1;
  ...
  if (m = R.x, M = R.y, d) {
    var O;
    return Object.assign({}, N, (O = {}, O[g] = L ? "0" : "", O[H] = S ? "0" : "", O.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + M + "px)" : "translate3d(" + m + "px, " + M + "px, 0)", O));
  }
  return Object.assign({}, N, (c = {}, c[g] = L ? M + "px" : "", c[H] = S ? m + "px" : "", c.transform = "", c));
}
function C4(e) {
  var c = e.state, t = e.options, a = t.gpuAcceleration, s = a === void 0 ? !0 : a, n = t.adaptive, o = n === void 0 ? !0 : n, l = t.roundOffsets, d = l === void 0 ? !0 : l;
  if (process.env.NODE_ENV !== "production") {
    var r = y0(c.elements.popper).transitionProperty || "";
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
  ...
  var i = {
    placement: f0(c.placement),
    variation: I0(c.placement),
    popper: c.elements.popper,
    popperRect: c.rects.popper,
    gpuAcceleration: s,
    isFixed: c.options.strategy === "fixed"
  };
  c.modifiersData.popperOffsets != null && (c.styles.popper = Object.assign({}, c.styles.popper, K1(Object.assign({}, i, {
    offsets: c.modifiersData.popperOffsets,
    position: c.options.strategy,
    adaptive: o,
    roundOffsets: d
  })))), c.modifiersData.arrow != null && (c.styles.arrow = Object.assign({}, c.styles.arrow, K1(Object.assign({}, i, {
...
function x4(e) {
  var c = e.state, t = e.instance, a = e.options, s = a.scroll, n = s === void 0 ? !0 : s, o = a.resize, l = o === void 0 ? !0 : o, d = h0(c.elements.popper), r = [].concat(c.scrollParents.reference, c.scrollParents.popper);
  return n && r.forEach(function(i) {
    i.addEventListener("scroll", t.update, i1);
  }), l && d.addEventListener("resize", t.update, i1), function() {
    n && r.forEach(function(i) {
      i.removeEventListener("scroll", t.update, i1);
    }), l && d.removeEventListener("resize", t.update, i1);
  };
}
const _4 = {
  name: "eventListeners",
...
function T1(e) {
  var c = h0(e), t = c.pageXOffset, a = c.pageYOffset;
  return {
    scrollLeft: t,
    scrollTop: a
  };
...
function H1(e) {
  return E0($0(e)).left + T1(e).scrollLeft;
}
function N4(e, c) {
  var t = h0(e), a = $0(e), s = t.visualViewport, n = a.clientWidth, o = a.clientHeight, l = 0, d = 0;
  if (s) {
    n = s.width, o = s.height;
    var r = k2();
    (r || !r && c === "fixed") && (l = s.offsetLeft, d = s.offsetTop);
  }
  return {
    width: n,
    height: o,
...
function V4(e) {
  var c, t = $0(e), a = T1(e), s = (c = e.ownerDocument) == null ? void 0 : c.body, n = D0(t.scrollWidth, t.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), o = D0(t.scrollHeight, t.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), l = -a.scrollLeft + H1(e), d = -a.scrollTop;
  return y0(s || t).direction === "rtl" && (l += D0(t.clientWidth, s ? s.clientWidth : 0) - n), {
    width: n,
    height: o,
    x: l,
    y: d
...
function P1(e) {
  var c = y0(e), t = c.overflow, a = c.overflowX, s = c.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + s + a);
}
function S2(e) {
  return ["html", "body", "#document"].indexOf(z0(e)) >= 0 ? e.ownerDocument.body : u0(e) && P1(e) ? e : S2(y1(e));
}
function G0(e, c) {
  var t;
  c === void 0 && (c = []);
  var a = S2(e), s = a === ((t = e.ownerDocument) == null ? void 0 : t.body), n = h0(a), o = s ? [n].concat(n.visualViewport || [], P1(a) ? a : []) : a, l = c.concat(o);
  return s ? l : (
...
function t2(e, c, t) {
  return c === x2 ? _1(N4(e, t)) : T0(c) ? $4(c, t) : _1(V4($0(e)));
}
function S4(e) {
  var c = G0(y1(e)), t = ["absolute", "fixed"].indexOf(y0(e).position) >= 0, a = t && u0(e) ? a1(e) : e;
  return T0(a) ? c.filter(function(s) {
    return T0(s) && B2(s, a) && z0(s) !== "body";
  }) : [];
}
function O4(e, c, t, a) {
  var s = c === "clippingParents" ? S4(e) : [].concat(c), n = [].concat(s, [t]), o = n[0], l = n.reduce(function(d, r) {
    var i = t2(e, r, a);
    return d.top = D0(i.top, d.top), d.right = v1(i.right, d.right), d.bottom = v1(i.bottom, d.bottom), d.left = D0(i.left, d.left), d;
  }, t2(e, o, a));
  return l.width = l.right - l.left, l.height = l.bottom - l.top, l.x = l.left, l.y = l.top, l;
}
function O2(e) {
  var c = e.reference, t = e.element, a = e.placement, s = a ? f0(a) : null, n = a ? I0(a) : null, o = c.x + c.width / 2 - t.width / 2, l = c.y + c.height / 2 - t.height / 2, d;
  switch (s) {
    case i0:
      d = {
        x: o,
...
function e1(e, c) {
  c === void 0 && (c = {});
  var t = c, a = t.placement, s = a === void 0 ? e.placement : a, n = t.strategy, o = n === void 0 ? e.strategy : n, l = t.boundary, d = l === void 0 ? K3 : l, r = t.rootBoundary, i = r === void 0 ? x2 : r, u = t.elementContext, v = u === void 0 ? Z0 : u, m = t.altBoundary, b = m === void 0 ? !1 : m, M = t.padding, z = M === void 0 ? 0 : M, S = V2(typeof z != "number" ? z : $2(z, c1)), L = v === Z0 ? e4 : Z0, H = e.rects.popper, g = e.elements[b ? L : v], w = O4(T0(g) ? g : g.contextElement || $0(e.elements.popper), d, i, o), T = E0(e.elements.reference), F = O2({
    reference: T,
    element: H,
    strategy: "absolute",
    placement: s
  }), W = _1(Object.assign({}, H, F)), A = v === Z0 ? W : T, Z = {
    top: w.top - A.top + S.top,
    bottom: A.bottom - w.bottom + S.bottom,
    left: w.left - A.left + S.left,
    right: A.right - w.right + S.right
  }, N = e.modifiersData.offset;
  if (v === Z0 && N) {
    var R = N[s];
    Object.keys(Z).forEach(function(O) {
      var U = [p0, m0].indexOf(O) >= 0 ? 1 : -1, q = [i0, m0].indexOf(O) >= 0 ? "y" : "x";
      Z[O] += R[q] * U;
    });
  }
  return Z;
...
function L4(e, c) {
  c === void 0 && (c = {});
  var t = c, a = t.placement, s = t.boundary, n = t.rootBoundary, o = t.padding, l = t.flipVariations, d = t.allowedAutoPlacements, r = d === void 0 ? _2 : d, i = I0(a), u = i ? l ? G1 : G1.filter(function(b) {
    return I0(b) === i;
  }) : c1, v = u.filter(function(b) {
    return r.indexOf(b) >= 0;
  });
  ...
  return Object.keys(m).sort(function(b, M) {
    return m[b] - m[M];
  });
}
function D4(e) {
...
function T4(e) {
  var c = e.state, t = e.options, a = e.name;
  if (!c.modifiersData[a]._skip) {
    for (var s = t.mainAxis, n = s === void 0 ? !0 : s, o = t.altAxis, l = o === void 0 ? !0 : o, d = t.fallbackPlacements, r = t.padding, i = t.boundary, u = t.rootBoundary, v = t.altBoundary, m = t.flipVariations, b = m === void 0 ? !0 : m, M = t.allowedAutoPlacements, z = c.options.placement, S = f0(z), L = S === z, H = d || (L || !b ? [r1(z)] : D4(z)), g = [z].concat(H).reduce(function(o0, l0) {
      return o0.concat(f0(l0) === f1 ? L4(c, {
        placement: l0,
        boundary: i,
        rootBoundary: u,
        padding: r,
    ...
    }, []), w = c.rects.reference, T = c.rects.popper, F = /* @__PURE__ */ new Map(), W = !0, A = g[0], Z = 0; Z < g.length; Z++) {
      var N = g[Z], R = f0(N), O = I0(N) === F0, U = [i0, m0].indexOf(R) >= 0, q = U ? "width" : "height", V = e1(c, {
        placement: N,
        boundary: i,
        rootBoundary: u,
        altBoundary: v,
      ...
      w[q] > T[q] && (P = r1(P));
      var c0 = r1(P), k = [];
      if (n && k.push(V[R] <= 0), l && k.push(V[P] <= 0, V[c0] <= 0), k.every(function(o0) {
        return o0;
      })) {
        A = N, W = !1;
        break;
    ...
    if (W)
      for (var d0 = b ? 3 : 1, x0 = function(l0) {
        var w0 = g.find(function(H0) {
          var b0 = F.get(H0);
          if (b0)
            return b0.slice(0, l0).every(function(_) {
              return _;
            });
        });
        if (w0)
    ...
    c.placement !== A && (c.modifiersData[a]._skip = !0, c.placement = A, c.reset = !0);
  }
}
const H4 = {
  name: "flip",
...
function a2(e) {
  return [i0, p0, m0, r0].some(function(c) {
    return e[c] >= 0;
  });
}
function P4(e) {
  var c = e.state, t = e.name, a = c.rects.reference, s = c.rects.popper, n = c.modifiersData.preventOverflow, o = e1(c, {
    elementContext: "reference"
  }), l = e1(c, {
    altBoundary: !0
  }), d = c2(o, a), r = c2(l, s, n), i = a2(d), u = a2(r);
  c.modifiersData[t] = {
...
function q4(e, c, t) {
  var a = f0(e), s = [r0, i0].indexOf(a) >= 0 ? -1 : 1, n = typeof t == "function" ? t(Object.assign({}, c, {
    placement: e
  })) : t, o = n[0], l = n[1];
  return o = o || 0, l = (l || 0) * s, [r0, p0].indexOf(a) >= 0 ? {
    x: l,
    y: o
  } : {
    x: o,
...
function E4(e) {
  var c = e.state, t = e.options, a = e.name, s = t.offset, n = s === void 0 ? [0, 0] : s, o = _2.reduce(function(i, u) {
    return i[u] = q4(u, c.rects, n), i;
  }, {}), l = o[c.placement], d = l.x, r = l.y;
  c.modifiersData.popperOffsets != null && (c.modifiersData.popperOffsets.x += d, c.modifiersData.popperOffsets.y += r), c.modifiersData[a] = o;
}
const I4 = {
  name: "offset",
  enabled: !0,
...
function Y4(e) {
  var c = e.state, t = e.options, a = e.name, s = t.mainAxis, n = s === void 0 ? !0 : s, o = t.altAxis, l = o === void 0 ? !1 : o, d = t.boundary, r = t.rootBoundary, i = t.altBoundary, u = t.padding, v = t.tether, m = v === void 0 ? !0 : v, b = t.tetherOffset, M = b === void 0 ? 0 : b, z = e1(c, {
    boundary: d,
    rootBoundary: r,
    padding: u,
    altBoundary: i
  }), S = f0(c.placement), L = I0(c.placement), H = !L, g = D1(S), w = j4(g), T = c.modifiersData.popperOffsets, F = c.rects.reference, W = c.rects.popper, A = typeof M == "function" ? M(Object.assign({}, c.rects, {
    placement: c.placement
  })) : M, Z = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
    ...
    mainAxis: 0,
    altAxis: 0
  }, A), N = c.modifiersData.offset ? c.modifiersData.offset[c.placement] : null, R = {
    x: 0,
    y: 0
  };
  if (T) {
    if (n) {
      var O, U = g === "y" ? i0 : r0, q = g === "y" ? m0 : p0, V = g === "y" ? "height" : "width", P = T[g], c0 = P + z[U], k = P - z[q], d0 = m ? -W[V] / 2 : 0, x0 = L === F0 ? F[V] : W[V], $ = L === F0 ? -W[V] : -F[V], G = c.elements.arrow, o0 = m && G ? L1(G) : {
        width: 0,
        height: 0
      }, l0 = c.modifiersData["arrow#persistent"] ? c.modifiersData["arrow#persistent"].padding : N2(), w0 = l0[U], H0 = l0[q], b0 = Q0(0, F[V], o0[V]), _ = H ? F[V] / 2 - d0 - b0 - w0 - Z.mainAxis : x0 - b0 - w0 - Z.mainAxis, C = H ? -F[V] / 2 + d0 + b0 + H0 + Z.mainAxis : $ + b0 + H0 + Z.mainAxis, _0 = c.elements.arrow && a1(c.elements.arrow), l1 = _0 ? g === "y" ? _0.clientTop || 0 : _0.clientLeft || 0 : 0, q1 = (O = N == null ? void 0 : N[g]) != null ? O : 0, q2 = P + _ - q1 - l1, E2 = P + C - q1, E1 = Q0(m ? v1(c0, q2) : c0, P, m ? D0(k, E2) : k);
      T[g] = E1, R[g] = E1 - P;
    }
    if (l) {
      var I1, I2 = g === "x" ? i0 : r0, A2 = g === "x" ? m0 : p0, S0 = T[w], o1 = w === "y" ? "height" : "width", A1 = S0 + z[I2], W1 = S0 - z[A2], g1 = [i0, r0].indexOf(S) !== -1, j1 = (I1 = N == null ? void 0 : N[w]) != null ? I1 : 0, Y1 = g1 ? A1 : S0 - F[o1] - W[o1] - j1 + Z.altAxis, Z1 = g1 ? S0 + F[o1] + W[o1] - j1 - Z.altAxis : W1, R1 = m && g1 ? p4(Y1, S0, Z1) : Q0(m ? Y1 : A1, S0, m ? Z1 : W1);
      T[w] = R1, R[w] = R1 - S0;
    }
    c.modifiersData[a] = R;
  }
...
function U4(e) {
  return e === h0(e) || !u0(e) ? T1(e) : R4(e);
}
function X4(e) {
  var c = e.getBoundingClientRect(), t = q0(c.width) / e.offsetWidth || 1, a = q0(c.height) / e.offsetHeight || 1;
  return t !== 1 || a !== 1;
}
function Q4(e, c, t) {
  t === void 0 && (t = !1);
  var a = u0(c), s = u0(c) && X4(c), n = $0(c), o = E0(e, s, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, d = {
    x: 0,
  ...
  return (a || !a && !t) && ((z0(c) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  P1(n)) && (l = U4(c)), u0(c) ? (d = E0(c, !0), d.x += c.clientLeft, d.y += c.clientTop) : n && (d.x = H1(n))), {
...
function G4(e) {
  var c = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Set(), a = [];
  e.forEach(function(n) {
    c.set(n.name, n);
  });
  function s(n) {
    t.add(n.name);
    var o = [].concat(n.requires || [], n.requiresIfExists || []);
...
function k0(e) {
  for (var c = arguments.length, t = new Array(c > 1 ? c - 1 : 0), a = 1; a < c; a++)
    t[a - 1] = arguments[a];
  return [].concat(t).reduce(function(s, n) {
    return s.replace(/%s/, n);
  }, e);
}
var O0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', e5 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', s2 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function t5(e) {
  e.forEach(function(c) {
    [].concat(Object.keys(c), s2).filter(function(t, a, s) {
      return s.indexOf(t) === a;
    }).forEach(function(t) {
      switch (t) {
        case "name":
          typeof c.name != "string" && console.error(k0(O0, String(c.name), '"name"', '"string"', '"' + String(c.name) + '"'));
          break;
        case "enabled":
          typeof c.enabled != "boolean" && console.error(k0(O0, c.name, '"enabled"', '"boolean"', '"' + String(c.enabled) + '"'));
          break;
        case "phase":
          w1.indexOf(c.phase) < 0 && console.error(k0(O0, c.name, '"phase"', "either " + w1.join(", "), '"' + String(c.phase) + '"'));
          break;
        case "fn":
          typeof c.fn != "function" && console.error(k0(O0, c.name, '"fn"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "effect":
          c.effect != null && typeof c.effect != "function" && console.error(k0(O0, c.name, '"effect"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "requires":
          c.requires != null && !Array.isArray(c.requires) && console.error(k0(O0, c.name, '"requires"', '"array"', '"' + String(c.requires) + '"'));
          break;
        case "requiresIfExists":
          Array.isArray(c.requiresIfExists) || console.error(k0(O0, c.name, '"requiresIfExists"', '"array"', '"' + String(c.requiresIfExists) + '"'));
          break;
        case "options":
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + c.name + '" modifier, valid properties are ' + s2.map(function(a) {
            return '"' + a + '"';
          }).join(", ") + '; but "' + t + '" was provided.');
      }
      c.requires && c.requires.forEach(function(a) {
        e.find(function(s) {
          return s.name === a;
        }) == null && console.error(k0(e5, String(c.name), a, a));
      });
    });
  });
}
...
function a5(e) {
  var c = e.reduce(function(t, a) {
    var s = t[a.name];
    return t[a.name] = s ? Object.assign({}, s, a, {
...
var n2 = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.", s5 = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.", l2 = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
};
...
function n5(e) {
  e === void 0 && (e = {});
  var c = e, t = c.defaultModifiers, a = t === void 0 ? [] : t, s = c.defaultOptions, n = s === void 0 ? l2 : s;
  return function(l, d, r) {
    r === void 0 && (r = n);
    var i = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, l2, n),
      modifiersData: {},
      elements: {
        reference: l,
        popper: d
      ...
      setOptions: function(S) {
        var L = typeof S == "function" ? S(i.options) : S;
        M(), i.options = Object.assign({}, n, i.options, L), i.scrollParents = {
          reference: T0(l) ? G0(l) : l.contextElement ? G0(l.contextElement) : [],
          popper: G0(d)
        };
        var H = J4(a5([].concat(a, i.options.modifiers)));
        if (i.orderedModifiers = H.filter(function(N) {
          return N.enabled;
        }), process.env.NODE_ENV !== "production") {
          var g = c5([].concat(H, i.options.modifiers), function(N) {
            var R = N.name;
            return R;
          });
          if (t5(g), f0(i.options.placement) === f1) {
            var w = i.orderedModifiers.find(function(N) {
              var R = N.name;
              return R === "flip";
            });
            w || console.error(['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
          }
          var T = y0(d), F = T.marginTop, W = T.marginRight, A = T.marginBottom, Z = T.marginLeft;
          [F, W, A, Z].some(function(N) {
            return parseFloat(N);
      ...
      forceUpdate: function() {
        if (!v) {
          var S = i.elements, L = S.reference, H = S.popper;
          if (!o2(L, H)) {
            process.env.NODE_ENV !== "production" && console.error(n2);
            return;
          }
          i.rects = {
            reference: Q4(L, a1(H), i.options.strategy === "fixed"),
            popper: L1(H)
          ...
          for (var g = 0, w = 0; w < i.orderedModifiers.length; w++) {
            ...
            var T = i.orderedModifiers[w], F = T.fn, W = T.options, A = W === void 0 ? {} : W, Z = T.name;
            typeof F == "function" && (i = F({
              state: i,
              options: A,
              name: Z,
              instance: m
    ...
    if (!o2(l, d))
      return process.env.NODE_ENV !== "production" && console.error(n2), m;
    m.setOptions(r).then(function(z) {
      !v && r.onFirstUpdate && r.onFirstUpdate(z);
    });
    function b() {
      i.orderedModifiers.forEach(function(z) {
        var S = z.name, L = z.options, H = L === void 0 ? {} : L, g = z.effect;
...
var l5 = [_4, W4, w4, h4, I4, H4, Z4, b4, F4], o5 = /* @__PURE__ */ n5({
  defaultModifiers: l5
});
const i5 = {
  name: "NicePopup"
}, r5 = /* @__PURE__ */ Object.assign(i5, {
  props: {
    noPadding: {
      type: Boolean,
      default: !1
  ...
  setup(e, { expose: c, emit: t }) {
    const a = e, s = j(!1), n = j(!1);
    let o = null;
    const l = j(null), d = j(null), r = j(null), i = j(null);
    g0(() => {
      const z = [
        {
          name: "preventOverflow",
    ...
    function u() {
      a.disabled || (s.value = !s.value, o.update(), t("change", s));
    }
    function v() {
      s.value = !1, t("change", s);
    }
    function m() {
      !a.openOnHover || a.disabled || (n.value = !0, s.value = !0, o.update());
    }
    function b() {
      !a.openOnHover || a.disabled || (n.value = !1, s.value = !1);
    }
    function M(z) {
      a.openOnHover || a.disabled || s.value && !z.composedPath().includes(i.value) && !z.composedPath().includes(d.value) && v();
    }
    return c({ close: v, toggle: u }), (z, S) => (h(), p("div", {
      class: E(["nice-popup", { "nice-popup-open": s.value, "nice-popup-focused": n.value, disabled: a.disabled }]),
      ref_key: "$el",
      ref: i
    }, [
      f("div", {
      ...
      N0(f("div", {
        ...
        f("div", {
          class: E(["nice-popup-content", { "no-padding": a.noPadding }])
        }, [
...
}), s1 = /* @__PURE__ */ t0(r5, [["__scopeId", "data-v-67f29891"]]), L2 = 6048e5, d5 = 864e5, i2 = Symbol.for("constructDateFrom");
function C0(e, c) {
  return typeof e == "function" ? e(c) : e && typeof e == "object" && i2 in e ? e[i2](c) : e instanceof Date ? new e.constructor(c) : new Date(c);
}
function s0(e, c) {
  return C0(c || e, e);
}
...
function A0(e, c) {
  var l, d, r, i;
  const t = n1(), a = (c == null ? void 0 : c.weekStartsOn) ?? ((d = (l = c == null ? void 0 : c.locale) == null ? void 0 : l.options) == null ? void 0 : d.weekStartsOn) ?? t.weekStartsOn ?? ((i = (r = t.locale) == null ? void 0 : r.options) == null ? void 0 : i.weekStartsOn) ?? 0, s = s0(e, c == null ? void 0 : c.in), n = s.getDay(), o = (n < a ? 7 : 0) + n - a;
  return s.setDate(s.getDate() - o), s.setHours(0, 0, 0, 0), s;
}
function m1(e, c) {
  return A0(e, { ...c, weekStartsOn: 1 });
}
function D2(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), a = t.getFullYear(), s = C0(t, 0);
  s.setFullYear(a + 1, 0, 4), s.setHours(0, 0, 0, 0);
  const n = m1(s), o = C0(t, 0);
  o.setFullYear(a, 0, 4), o.setHours(0, 0, 0, 0);
  const l = m1(o);
  return t.getTime() >= n.getTime() ? a + 1 : t.getTime() >= l.getTime() ? a : a - 1;
}
function r2(e) {
  const c = s0(e), t = new Date(
    Date.UTC(
      c.getFullYear(),
      c.getMonth(),
      c.getDate(),
...
function h5(e, ...c) {
  const t = C0.bind(
    null,
    e || c.find((a) => typeof a == "object")
  );
  return c.map(t);
}
function k1(e, c) {
  const t = s0(e, c == null ? void 0 : c.in);
...
function v5(e, c, t) {
  const [a, s] = h5(
    ...
    e,
    c
  ), n = k1(a), o = k1(s), l = +n - r2(n), d = +o - r2(o);
  return Math.round((l - d) / d5);
}
function m5(e, c) {
  const t = D2(e, c), a = C0((c == null ? void 0 : c.in) || e, 0);
  return a.setFullYear(t, 0, 4), a.setHours(0, 0, 0, 0), m1(a);
}
function B1(e) {
  return C0(e, Date.now());
}
function p5(e) {
  return e instanceof Date || typeof e == "object" && Object.prototype.toString.call(e) === "[object Date]";
}
function f5(e) {
  return !(!p5(e) && typeof e != "number" || isNaN(+s0(e)));
}
function y5(e, c) {
  const t = s0(e, c == null ? void 0 : c.in);
...
function g5(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), a = t.getMonth();
...
function z5(e, c) {
  var l, d, r, i;
  const t = n1(), a = (c == null ? void 0 : c.weekStartsOn) ?? ((d = (l = c == null ? void 0 : c.locale) == null ? void 0 : l.options) == null ? void 0 : d.weekStartsOn) ?? t.weekStartsOn ?? ((i = (r = t.locale) == null ? void 0 : r.options) == null ? void 0 : i.weekStartsOn) ?? 0, s = s0(e, c == null ? void 0 : c.in), n = s.getDay(), o = (n < a ? -7 : 0) + 6 - (n - a);
  return s.setDate(s.getDate() + o), s.setHours(23, 59, 59, 999), s;
}
function C5(e) {
  const c = B1(e == null ? void 0 : e.in), t = C0(e == null ? void 0 : e.in, 0);
...
const w5 = {
  ...
  let a;
  const s = w5[e];
  return typeof s == "string" ? a = s : c === 1 ? a = s.one : a = s.other.replace("{{count}}", c.toString()), t != null && t.addSuffix ? t.comparison && t.comparison > 0 ? "in " + a : a + " ago" : a;
};
function M1(e) {
  return (c = {}) => {
...
function R0(e) {
  return (c, t) => {
    ...
    const n = e.argumentCallback ? e.argumentCallback(c) : c;
    return s[n];
  };
}
const S5 = {
...
function U0(e) {
  return (c, t = {}) => {
    const a = t.width, s = a && e.matchPatterns[a] || e.matchPatterns[e.defaultMatchWidth], n = c.match(s);
    if (!n)
      return null;
    const o = n[0], l = a && e.parsePatterns[a] || e.parsePatterns[e.defaultParseWidth], d = Array.isArray(l) ? E5(l, (u) => u.test(o)) : (
...
function I5(e) {
  return (c, t = {}) => {
    const a = c.match(e.matchPattern);
    if (!a)
      return null;
    const s = a[0], n = c.match(e.parsePattern);
    if (!n)
      return null;
    let o = e.valueCallback ? e.valueCallback(n[0]) : n[0];
    o = t.valueCallback ? t.valueCallback(o) : o;
    const l = c.slice(s.length);
    return { value: o, rest: l };
  };
}
const A5 = /^(\d+)(th|st|nd|rd)?/i, W5 = /\d+/i, j5 = {
  narrow: /^(b|a)/i,
...
function a7(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), a = +m1(t) - +m5(t);
  return Math.round(a / L2) + 1;
}
function T2(e, c) {
  var i, u, v, m;
  const t = s0(e, c == null ? void 0 : c.in), a = t.getFullYear(), s = n1(), n = (c == null ? void 0 : c.firstWeekContainsDate) ?? ((u = (i = c == null ? void 0 : c.locale) == null ? void 0 : i.options) == null ? void 0 : u.firstWeekContainsDate) ?? s.firstWeekContainsDate ?? ((m = (v = s.locale) == null ? void 0 : v.options) == null ? void 0 : m.firstWeekContainsDate) ?? 1, o = C0((c == null ? void 0 : c.in) || e, 0);
  o.setFullYear(a + 1, 0, n), o.setHours(0, 0, 0, 0);
  const l = A0(o, c), d = C0((c == null ? void 0 : c.in) || e, 0);
  d.setFullYear(a, 0, n), d.setHours(0, 0, 0, 0);
  const r = A0(d, c);
  return +t >= +l ? a + 1 : +t >= +r ? a : a - 1;
}
function s7(e, c) {
  var l, d, r, i;
  const t = n1(), a = (c == null ? void 0 : c.firstWeekContainsDate) ?? ((d = (l = c == null ? void 0 : c.locale) == null ? void 0 : l.options) == null ? void 0 : d.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((i = (r = t.locale) == null ? void 0 : r.options) == null ? void 0 : i.firstWeekContainsDate) ?? 1, s = T2(e, c), n = C0((c == null ? void 0 : c.in) || e, 0);
  return n.setFullYear(s, 0, a), n.setHours(0, 0, 0, 0), A0(n, c);
}
function n7(e, c) {
  const t = s0(e, c == null ? void 0 : c.in), a = +A0(t, c) - +s7(t, c);
  return Math.round(a / L2) + 1;
}
function Q(e, c) {
  const t = e < 0 ? "-" : "", a = Math.abs(e).toString().padStart(c, "0");
  return t + a;
}
const B0 = {
  // Year
  y(e, c) {
    ...
    return Q(c === "yy" ? a % 100 : a, c.length);
  },
  // Month
  M(e, c) {
    const t = e.getMonth();
    return c === "M" ? String(t + 1) : Q(t + 1, 2);
  },
  // Day of the month
  d(e, c) {
    return Q(e.getDate(), c.length);
  },
  // AM or PM
  a(e, c) {
  ...
  // Hour [1-12]
  h(e, c) {
    return Q(e.getHours() % 12 || 12, c.length);
  },
  // Hour [0-23]
  H(e, c) {
    return Q(e.getHours(), c.length);
  },
  // Minute
  m(e, c) {
    return Q(e.getMinutes(), c.length);
  },
  // Second
  s(e, c) {
    return Q(e.getSeconds(), c.length);
  },
  // Fraction of second
  S(e, c) {
    const t = c.length, a = e.getMilliseconds(), s = Math.trunc(
      a * Math.pow(10, t - 3)
    );
    return Q(s, c.length);
  }
  ...
  y: function(e, c, t) {
    if (c === "yo") {
      const a = e.getFullYear(), s = a > 0 ? a : 1 - a;
  ...
  Y: function(e, c, t, a) {
    const s = T2(e, a), n = s > 0 ? s : 1 - s;
    if (c === "YY") {
      const o = n % 100;
      return Q(o, 2);
    }
    return c === "Yo" ? t.ordinalNumber(n, { unit: "year" }) : Q(n, c.length);
  },
  ...
  w: function(e, c, t, a) {
    const s = n7(e, a);
    return c === "wo" ? t.ordinalNumber(s, { unit: "week" }) : Q(s, c.length);
  },
  // ISO week of year
  I: function(e, c, t) {
    const a = a7(e);
    return c === "Io" ? t.ordinalNumber(a, { unit: "week" }) : Q(a, c.length);
  },
  // Day of the month
  d: function(e, c, t) {
  ...
  D: function(e, c, t) {
    const a = c7(e);
    return c === "Do" ? t.ordinalNumber(a, { unit: "dayOfYear" }) : Q(a, c.length);
  },
  // Day of week
  E: function(e, c, t) {
    const a = e.getDay();
  ...
  // Local day of week
  e: function(e, c, t, a) {
    const s = e.getDay(), n = (s - a.weekStartsOn + 8) % 7 || 7;
    switch (c) {
      case "e":
        return String(n);
      case "ee":
  ...
  b: function(e, c, t) {
    const a = e.getHours();
    let s;
    switch (a === 12 ? s = P0.noon : a === 0 ? s = P0.midnight : s = a / 12 >= 1 ? "pm" : "am", c) {
      case "b":
      case "bb":
        return t.dayPeriod(s, {
          width: "abbreviated",
  ...
  B: function(e, c, t) {
    const a = e.getHours();
    let s;
    switch (a >= 17 ? s = P0.evening : a >= 12 ? s = P0.afternoon : a >= 4 ? s = P0.morning : s = P0.night, c) {
      case "B":
      case "BB":
      case "BBB":
        return t.dayPeriod(s, {
  ...
  K: function(e, c, t) {
    ...
    return c === "Ko" ? t.ordinalNumber(a, { unit: "hour" }) : Q(a, c.length);
  },
  // Hour [1-24]
  k: function(e, c, t) {
    let a = e.getHours();
    return a === 0 && (a = 24), c === "ko" ? t.ordinalNumber(a, { unit: "hour" }) : Q(a, c.length);
  },
  // Minute
  m: function(e, c, t) {
...
function u2(e, c = "") {
  const t = e > 0 ? "-" : "+", a = Math.abs(e), s = Math.trunc(a / 60), n = a % 60;
  return n === 0 ? t + String(s) : t + String(s) + c + Q(n, 2);
}
function h2(e, c) {
  return e % 60 === 0 ? (e > 0 ? "-" : "+") + Q(Math.abs(e) / 60, 2) : L0(e, c);
}
function L0(e, c = "") {
  const t = e > 0 ? "-" : "+", a = Math.abs(e), s = Q(Math.trunc(a / 60), 2), n = Q(a % 60, 2);
  return t + s + c + n;
}
const v2 = (e, c) => {
  switch (e) {
  ...
  const t = e.match(/(P+)(p+)?/) || [], a = t[1], s = t[2];
  if (!s)
    return v2(e, c);
  let n;
  switch (a) {
    case "P":
      n = c.dateTime({ width: "short" });
      break;
    case "PP":
      n = c.dateTime({ width: "medium" });
      break;
    case "PPP":
      n = c.dateTime({ width: "long" });
      break;
    case "PPPP":
    default:
      n = c.dateTime({ width: "full" });
      break;
  }
  return n.replace("{{date}}", v2(a, c)).replace("{{time}}", H2(s, c));
}, o7 = {
  p: H2,
  P: l7
}, i7 = /^D+$/, r7 = /^Y+$/, d7 = ["D", "DD", "YY", "YYYY"];
function u7(e) {
  return i7.test(e);
}
function h7(e) {
...
function v7(e, c, t) {
  const a = m7(e, c, t);
  if (console.warn(a), d7.includes(e))
    throw new RangeError(a);
}
function m7(e, c, t) {
  const a = e[0] === "Y" ? "years" : "days of the month";
  return `Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${c}\`) for formatting ${a} to the input \`${t}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`;
}
const p7 = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, f7 = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, y7 = /^'([^]*?)'?$/, g7 = /''/g, b7 = /[a-zA-Z]/;
function m2(e, c, t) {
  var i, u, v, m, b, M, z, S;
  const a = n1(), s = (t == null ? void 0 : t.locale) ?? a.locale ?? t7, n = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((u = (i = t == null ? void 0 : t.locale) == null ? void 0 : i.options) == null ? void 0 : u.firstWeekContainsDate) ?? a.firstWeekContainsDate ?? ((m = (v = a.locale) == null ? void 0 : v.options) == null ? void 0 : m.firstWeekContainsDate) ?? 1, o = (t == null ? void 0 : t.weekStartsOn) ?? ((M = (b = t == null ? void 0 : t.locale) == null ? void 0 : b.options) == null ? void 0 : M.weekStartsOn) ?? a.weekStartsOn ?? ((S = (z = a.locale) == null ? void 0 : z.options) == null ? void 0 : S.weekStartsOn) ?? 0, l = s0(e, t == null ? void 0 : t.in);
  if (!f5(l))
    throw new RangeError("Invalid time value");
  let d = c.match(f7).map((L) => {
    const H = L[0];
    if (H === "p" || H === "P") {
      const g = o7[H];
      return g(L, s.formatLong);
    }
    return L;
  }).join("").match(p7).map((L) => {
    if (L === "''")
  ...
  return d.map((L) => {
    if (!L.isToken)
      return L.value;
    const H = L.value;
    (!(t != null && t.useAdditionalWeekYearTokens) && h7(H) || !(t != null && t.useAdditionalDayOfYearTokens) && u7(H)) && v7(H, c, String(e));
    const g = d2[H[0]];
    return g(l, H, s.localize, r);
  }).join("");
}
function M7(e) {
  const c = e.match(y7);
  return c ? c[1].replace(g7, "'") : e;
}
function z7(e, c) {
  return +s0(e) < +s0(c);
}
function C7(e, c, t) {
  const a = +s0(e, t == null ? void 0 : t.in), [s, n] = [
    +s0(c.start, t == null ? void 0 : t.in),
    +s0(c.end, t == null ? void 0 : t.in)
  ].sort((o, l) => o - l);
  return a >= s && a <= n;
}
function w7(e) {
  const c = B1(e == null ? void 0 : e.in), t = c.getFullYear(), a = c.getMonth(), s = c.getDate(), n = B1(e == null ? void 0 : e.in);
  return n.setFullYear(t, a, s - 1), n.setHours(0, 0, 0, 0), n;
}
const Y0 = (e) => (W0("data-v-5c959de9"), e = e(), j0(), e), x7 = {
  key: 0,
  class: "nice-dropdown"
}, _7 = { class: "month-wrapper" }, k7 = { class: "value" }, B7 = { class: "year" }, N7 = { class: "month" }, V7 = { class: "calendar" }, $7 = { class: "header" }, S7 = { class: "month" }, O7 = ["onClick", "title"], L7 = {
  key: 0,
  class: "time"
}, D7 = { class: "select-wrapper" }, T7 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ f("div", { class: "arrow-down" }, null, -1)), H7 = ["value", "selected"], P7 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ f("div", null, ":", -1)), F7 = { class: "select-wrapper" }, q7 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ f("div", { class: "arrow-down" }, null, -1)), E7 = ["value", "selected"], I7 = { class: "input-group" }, A7 = ["placeholder", "disabled", "required"], W7 = { class: "nice-dropdown" }, j7 = { class: "month-wrapper" }, Y7 = { class: "value" }, Z7 = { class: "year" }, R7 = { class: "month" }, U7 = { class: "calendar" }, X7 = { class: "header" }, Q7 = { class: "month" }, G7 = ["onClick", "title"], J7 = {
  key: 0,
  class: "time"
}, K7 = { class: "select-wrapper" }, e8 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ f("div", { class: "arrow-down" }, null, -1)), t8 = ["value", "selected"], c8 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ f("div", null, ":", -1)), a8 = { class: "select-wrapper" }, s8 = /* @__PURE__ */ Y0(() => /* @__PURE__ */ f("div", { class: "arrow-down" }, null, -1)), n8 = ["value", "selected"], l8 = {
  name: "NiceDate"
}, o8 = /* @__PURE__ */ Object.assign(l8, {
  props: {
    modelValue: {
  ...
  emits: ["change", "update:modelValue"],
  setup(e, { emit: c }) {
    const t = e, a = n0("$t"), s = j(null), n = j(""), o = j(/* @__PURE__ */ new Date()), l = j([]), d = j(null), r = [
      0,
      1,
      2,
      3,
    ...
    u1(() => t.modelValue, () => {
      t.modelValue && b(t.modelValue) && (s.value = new Date(t.modelValue), o.value = new Date(t.modelValue), U());
    }), u1(() => t.highlightTo, () => {
      A();
    }), g0(() => {
      F();
    ...
    function b(q) {
      return !isNaN(new Date(q));
    }
    function M() {
      d.value && d.value.close();
    }
    function z() {
      n.value = "", c("update:modelValue", null), c("change", null), setTimeout(() => {
        M();
      });
    }
    function S(q) {
    ...
    function L() {
      U(), c("update:modelValue", s.value), c("change", s.value);
    }
    function H() {
      if (n.value && n.value != "") {
        let q = n.value.split(" • "), V = /* @__PURE__ */ new Date(), P = q[0].split(".");
        if (V.setDate(P[0]), V.setMonth(P[1] - 1), V.setFullYear(P[2]), t.time) {
          let c0 = q[1].split(":");
          V.setHours(c0[0]), V.setMinutes(c0[1]), V.setSeconds(0, 0);
        } else
          V.setHours(12), V.setMinutes(0), V.setSeconds(0, 0);
        s.value = V, L();
      }
    }
    function g(q) {
      let V = q.target.value;
      o.value.setHours(V), s.value.setHours(V), L();
    }
    function w(q) {
      let V = q.target.value;
      o.value.setMinutes(V), s.value.setMinutes(V), L();
    }
    function T(q) {
      s.value.setYear(q.year), s.value.setMonth(q.month), s.value.setDate(q.day), L();
    }
    function F() {
      t.modelValue || (s.value = /* @__PURE__ */ new Date(), s.value.setSeconds(0, 0)), t.modelValue && b(t.modelValue) && (s.value = new Date(t.modelValue), s.value.setSeconds(0, 0), n.value = O(s.value)), t.isInline && A();
    }
    function W(q) {
      let V = o.value.getMonth();
      q ? V += 1 : V -= 1, o.value.setMonth(V), A();
    }
    function A() {
      l.value = [];
      let V = new Date(
    ...
    function Z(q, V, P) {
      const c0 = /* @__PURE__ */ new Date(), k = new Date(q, V, P);
      return {
        id: k.toString(),
        date: k,
        year: k.getFullYear(),
        ...
        day: k.getDate(),
        dayInWeek: k.getDay(),
        currentMonth: k.getMonth() == o.value.getMonth(),
        selected: R(s.value, k),
        today: R(c0, k),
        highlighted: N(k),
        text: O(k)
      };
    ...
    function N(q) {
      return !!(t.highlightTo && C7(q, { end: t.highlightTo, start: o.value }));
    }
    function R(q, V) {
      return q.getDate() == V.getDate() && q.getMonth() == V.getMonth() && q.getFullYear() == V.getFullYear();
    }
    function O(q) {
      let V = q.getDate(), P = q.getMonth() + 1, c0 = q.getFullYear(), k = q.getHours(), d0 = q.getMinutes();
      return d0 < 10 && (d0 = "0" + d0), t.time ? `${V}.${P}.${c0} • ${k}:${d0}` : `${V}.${P}.${c0}`;
    }
    function U() {
      s.value || (s.value = /* @__PURE__ */ new Date()), m.day = s.value.getDate(), m.month = s.value.getMonth(), m.year = s.value.getFullYear(), m.hour = s.value.getHours(), m.minute = s.value.getMinutes(), n.value = O(s.value), o.value.year = m.year, o.value.month = m.month, A();
    }
    return (q, V) => {
      const P = Y("NiceButton"), c0 = Y("NiceIcon");
      return h(), p("div", {
        class: E(["nice-component nice-date", {
          disabled: e.disabled,
        ...
        e.isInline ? (h(), p("div", x7, [
          f("div", _7, [
            D(P, {
              class: "left",
              onClick: V[0] || (V[0] = (k) => W(!1)),
              icon: "icon-chevron-left",
              naked: ""
            }),
            f("div", k7, [
              f("div", B7, B(o.value.getFullYear()), 1),
              f("div", N7, B(v[o.value.getMonth() + 1]), 1)
            ]),
            D(P, {
              class: "right",
              onClick: V[1] || (V[1] = (k) => W(!0)),
          ...
          f("div", V7, [
            ...
            f("div", S7, [
              (h(!0), p(K, null, a0(l.value, (k) => (h(), p("div", {
                class: E(["day", {
                  "previous-month": !k.currentMonth,
                  "day-highlighted": k.highlighted,
                  today: k.today,
                  selected: k.selected
                }]),
                onClick: (d0) => T(k),
          ...
          e.time ? (h(), p("div", L7, [
            f("div", D7, [
              T7,
              f("select", { onChange: g }, [
                (h(), p(K, null, a0(r, (k) => f("option", {
                  value: k,
                  key: k,
                  selected: k == o.value.getHours()
                }, B(k), 9, H7)), 64))
              ], 32)
            ]),
            P7,
            f("div", F7, [
              q7,
              f("select", { onChange: w }, [
                (h(), p(K, null, a0(i, (k) => f("option", {
                  value: k,
                  key: k,
                  selected: k == o.value.getMinutes()
                }, B(k), 9, E7)), 64))
              ], 32)
            ]),
            D(c0, {
        ...
        e.isInline ? y("", !0) : (h(), I(s1, {
          ...
          trigger: e0(() => [
            f("div", I7, [
              N0(f("input", {
                "onUpdate:modelValue": V[2] || (V[2] = (k) => n.value = k),
                placeholder: e.placeholder || x(a)("Nice", "None"),
                disabled: e.disabled,
                required: e.required,
                onBlur: H
              }, null, 40, A7), [
          ...
          content: e0(() => [
            f("div", W7, [
              f("div", j7, [
                D(P, {
                  class: "left",
                  onClick: V[3] || (V[3] = (k) => W(!1)),
                  icon: "icon-chevron-left",
                  naked: ""
                }),
                f("div", Y7, [
                  f("div", Z7, B(o.value.getFullYear()), 1),
                  f("div", R7, B(v[o.value.getMonth() + 1]), 1)
                ]),
                D(P, {
                  class: "right",
                  onClick: V[4] || (V[4] = (k) => W(!0)),
                  icon: "icon-chevron-right",
                  naked: ""
                })
              ]),
...
}), i8 = /* @__PURE__ */ t0(o8, [["__scopeId", "data-v-5c959de9"]]);
const r8 = { class: "input-group" }, d8 = ["required", "disabled", "modelValue"], u8 = ["selected"], h8 = ["value"], v8 = {
  key: 0,
  class: "no-options"
}, m8 = ["disabled"], p8 = {
  name: "NiceDropdownSimple"
}, f8 = /* @__PURE__ */ Object.assign(p8, {
  props: {
    modelValue: {
  ...
  setup(e, { emit: c }) {
    ...
    function n(d) {
      const r = t.values.find((i) => i[t.keyName] == d.target.value);
      l(r || void 0);
    }
    function o() {
      setTimeout(() => {
        !s.value && t.values.length > 0 && !t.nullable && l(t.values[0]);
      });
    }
    function l(d) {
    ...
    return (d, r) => {
      const i = Y("NiceLoading"), u = Y("NiceIcon");
      return h(), p("div", {
        class: E(["nice-component nice-dropdown-simple", { disabled: e.disabled, "no-margin": e.noMargin }])
      }, [
        D(V0, {
          title: e.title,
          required: e.required,
        ...
        f("div", r8, [
          f("div", {
            class: E(["select-wrapper", { "no-value": x(s) == null }])
          }, [
            f("select", {
              required: e.required,
              disabled: e.disabled,
              ...
              e.nullable ? (h(), p("option", {
                key: 0,
                value: null,
                selected: !x(s)
              }, B(e.nullText || x(a)("Nice", "None")), 9, u8)) : y("", !0),
              (h(!0), p(K, null, a0(e.values, (v) => (h(), p("option", {
                value: v[e.keyName],
                key: v[e.keyName]
              }, B(v[e.valueName]), 9, h8))), 128))
            ], 40, d8),
            !e.nullable && !e.loading && (!e.values || e.values.length == 0) ? (h(), p("div", v8, B(x(a)("Nice", "No options")), 1)) : y("", !0),
            e.loading ? (h(), I(i, {
              key: 1,
              class: "no-options"
            })) : y("", !0),
          ...
          e.addFunction ? (h(), p("button", {
            key: 0,
            class: "btn",
            type: "button",
            disabled: e.disabled,
            onClick: r[0] || (r[0] = (...v) => e.addFunction && e.addFunction(...v))
          }, [
            D(u, { icon: "icon-plus" })
          ], 8, m8)) : y("", !0)
        ])
...
}), y8 = /* @__PURE__ */ t0(f8, [["__scopeId", "data-v-d2fc0d46"]]);
const g8 = { class: "nice-loading-wrapper" }, b8 = {
  key: 0,
  class: "nice-loading-message"
}, M8 = {
  name: "NiceLoading"
}, z8 = /* @__PURE__ */ Object.assign(M8, {
  props: {
    message: {
      type: String,
      default: null
  ...
  setup(e) {
    ...
    return (t, a) => {
      const s = Y("NiceIcon");
      return h(), p("div", {
        class: E(["nice-loading", [c.size ? "nice-loading-" + c.size : "", { "full-div": c.fullDiv }]])
      }, [
        f("div", g8, [
          D(s, { icon: "icon-half-loading" }),
          D(s, { icon: "icon-half-loading" })
        ]),
        c.message ? (h(), p("div", b8, B(c.message), 1)) : y("", !0)
      ], 2);
    };
  }
}), p1 = /* @__PURE__ */ t0(z8, [["__scopeId", "data-v-3d00153a"]]);
const C8 = ["title"], w8 = { class: "nice-dropdown-wrapper" }, x8 = { class: "input-group" }, _8 = { class: "select-wrapper" }, k8 = ["required", "value", "disabled"], B8 = {
  key: 0,
  class: "option"
}, N8 = ["innerHTML"], V8 = {
  key: 1,
  class: "options"
}, $8 = ["innerHTML"], S8 = ["onClick"], O8 = {
  key: 2,
  class: "no-options"
}, L8 = {
  key: 3,
  class: "no-options"
}, D8 = { class: "nice-dropdown-popup" }, T8 = {
  key: 0,
  class: "input-group"
}, H8 = ["placeholder", "name", "disabled"], P8 = { class: "list" }, F8 = ["onClick"], q8 = ["innerHTML"], E8 = {
  key: 1,
  class: "element no-options"
}, I8 = {
  name: "NiceDropdown"
}, A8 = /* @__PURE__ */ Object.assign(I8, {
  props: {
    modelValue: {
  ...
  setup(e, { emit: c }) {
    const t = e, a = n0("$t");
    let s = null;
    const n = 500, o = j(!1), l = j(null), d = j(null), r = j(null), i = j(null), u = j(!1), v = j(null), m = j(null), b = J(() => t.keyOnly && !t.multiple ? v.value ? v.value.find((O) => O[t.keyName] == t.modelValue) : {} : (t.multiple && S(), t.modelValue)), M = J(() => t.disabled ? !1 : !!t.modelValue && !!t.nullable), z = J(() => v.value != null ? v.value.filter((O) => O._selected) : []), S = function() {
      v.value && t.modelValue != null && t.multiple && v.value.forEach((O) => {
        O._selected = !!t.modelValue.find((U) => U[t.keyName] == O[t.keyName]);
      });
    };
    g0(async () => {
      await N(), W();
    ...
    function L(O) {
      (O.code == "Enter" || O.code == "Space") && (O.preventDefault(), r.value && r.value.toggle());
    }
    function H() {
    ...
    async function T(O) {
      O ? (v.value || await N(), m.value != null ? i.value = v.value.findIndex(
        (U) => U[t.keyName] == m.value[t.keyName]
      ) : i.value = -1, setTimeout(() => {
        d.value && d.value.focus();
      }, 100), document.addEventListener("keydown", R)) : (l.value = null, u.value = !1, document.removeEventListener("keydown", R));
    }
    function F(O) {
      if (O) {
        const U = O[t.keyName], q = v.value.find((V) => V[t.keyName] == U);
        A(q || null);
      } else
        A(null);
      t.multiple || H();
    ...
    function W() {
      v.value && v.value.length > 0 && !t.nullable && !t.modelValue ? A(v.value[0]) : S();
    }
    function A(O) {
      O ? t.multiple ? (O._selected = !O._selected, t.keyOnly ? (c("update:modelValue", z.value.filter.map((U) => U[t.keyName])), c("change", z.value.map((U) => U[t.keyName]))) : (c("update:modelValue", z.value), c("change", z.value))) : t.keyOnly ? (c("update:modelValue", O[t.keyName]), c("change", O[t.keyName])) : (c("update:modelValue", O), c("change", O)) : (c("update:modelValue", null), c("change", null));
    }
    function Z() {
    ...
    async function N() {
      if (t.values && (v.value = t.values), t.searchFunction) {
        u.value = !0;
        const O = await t.searchFunction(l.value);
        return i.value = 0, u.value = !1, v.value = O, O;
      } else
        return null;
    }
    function R(O) {
      O.key == "ArrowDown" ? (i.value < v.value.length - 1 && (i.value += 1), O.preventDefault()) : O.key == "ArrowUp" ? (i.value > 0 && (i.value -= 1), O.preventDefault()) : O.key == "Escape" ? (H(), O.preventDefault()) : O.key == "Enter" && (A(v.value[i.value]), H(), O.preventDefault());
    }
    return (O, U) => {
      const q = Y("nice-icon"), V = Y("NiceIcon");
      return h(), p("div", {
        title: e.nativeTitle,
        class: E(["nice-component nice-dropdown", {
          disabled: e.disabled,
          "no-margin": e.noMargin,
          "can-clear": x(M),
          "has-value": e.modelValue
          ...
          D(s1, {
            ...
            trigger: e0(() => [
              f("div", x8, [
                f("div", _8, [
                  f("div", {
                    class: E(["selected-value", { focus: o.value }])
                  }, [
                    f("input", {
                      required: e.required,
                      value: e.modelValue,
                      class: "hidden-input",
                      onFocus: U[0] || (U[0] = (P) => o.value = !0),
                      onBlur: U[1] || (U[1] = (P) => o.value = !1),
                      onKeypress: L,
                      disabled: e.disabled
                    }, null, 40, k8),
                    !e.loading && e.modelValue && !t.multiple ? (h(), p("div", B8, [
                      X(O.$slots, "selected-option", { item: x(b) }, () => [
                        f("span", {
                          innerHTML: e.formatFunction ? e.formatFunction(e.modelValue) : x(b) ? x(b)[t.valueName] || x(b) : e.modelValue
                        }, null, 8, N8)
                      ], !0)
                    ])) : y("", !0),
                    t.multiple ? (h(), p("div", V8, [
                      (h(!0), p(K, null, a0(x(z), (P) => (h(), p("div", {
                        class: "option",
                        key: P
                      }, [
                        X(O.$slots, "selected-option", f2({ item: P }, P), () => [
                          f("span", {
                            innerHTML: e.formatFunction ? e.formatFunction(P) : P && P[t.valueName]
                          }, null, 8, $8)
                        ], !0),
                        f("button", {
                          type: "button",
                    ...
                    !e.loading && !e.modelValue || t.multiple && !x(z).length ? (h(), p("div", O8, B(e.nullText || x(a)("Nice", "None")), 1)) : y("", !0),
                    e.loading ? (h(), p("div", L8, B(x(a)("Nice", "Loading")), 1)) : y("", !0),
                    D(V, {
                      class: "arrow-down",
                      icon: "icon-chevron-down"
                    }),
            ...
            content: e0(() => [
              f("div", D8, [
                e.searchFunction && !e.noSearch ? (h(), p("div", T8, [
                  N0(f("input", {
                    "onUpdate:modelValue": U[2] || (U[2] = (P) => l.value = P),
                    type: "text",
                    placeholder: x(a)("Nice", "Search..."),
                    name: x(a)("Nice", "Search"),
                    onInput: Z,
                ...
                f("div", P8, [
                  e.nullable ? (h(), p("div", {
                    ...
                    onClick: U[3] || (U[3] = (P) => F(void 0))
                  }, B(e.nullText || x(a)("Nice", "None")), 3)) : y("", !0),
                  (h(!0), p(K, null, a0(v.value, (P, c0) => (h(), p("div", {
                    class: E(["element", {
                      hover: i.value == c0,
                      selected: e.modelValue && (!t.multiple && P[e.keyName] == x(b)[e.keyName] || P._selected)
                    }]),
                    key: P[e.keyName],
                    onClick: (k) => F(P)
                  }, [
                    ...
                    X(O.$slots, "option", { item: P }, () => [
                      f("span", {
                        innerHTML: e.formatFunction ? e.formatFunction(P) : P[e.valueName] || P
                      }, null, 8, q8)
                    ], !0)
                  ], 10, F8))), 128)),
                  !u.value && (!v.value || v.value.length == 0) ? (h(), p("div", E8, B(x(a)("Nice", "No options")), 1)) : y("", !0)
                ])
              ])
            ]),
            _: 3
...
}), W8 = /* @__PURE__ */ t0(A8, [["__scopeId", "data-v-a28a1f36"]]);
const j8 = (e) => (W0("data-v-a8a2e225"), e = e(), j0(), e), Y8 = { class: "nice-filters-wrapper" }, Z8 = { class: "nice-component nice-filters" }, R8 = {
  key: 0,
  class: "nice-filters-options"
}, U8 = /* @__PURE__ */ j8(() => /* @__PURE__ */ f("div", { class: "f-grow" }, null, -1)), X8 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, Q8 = ["title"], G8 = {
  name: "NiceFilters"
}, J8 = /* @__PURE__ */ Object.assign(G8, {
  props: {
    // filters: {
    //   type: Object,
    //   required: false,
  ...
  setup(e, { emit: c }) {
    const t = e, a = n0("clone"), s = n0("$t"), n = g2(), o = b2(), l = j(""), d = j(t.modelValue), r = [
      { id: "true", name: s("Nice", "Yes") },
      { id: "false", name: s("Nice", "No") }
    ], i = (g) => g ? r.filter(
      (w) => w.name.toLowerCase().includes(g.toLowerCase())
    ) : r, u = J(() => d.value ? d.value.filter((g) => g.value != null) : []), v = J(() => {
      if (!d.value)
        return {};
      const g = {};
    ...
    function m(g) {
      const w = new Date(g.value), T = w.getDate(), F = w.getMonth() + 1, W = w.getFullYear(), A = w.getHours(), Z = w.getMinutes();
      return `${T}.${F}.${W} ${A}:${Z < 10 ? "0" : ""}${Z}`;
    }
    function b(g) {
      return g.formatter ? g.formatter(g.value) : g.type == "date" ? m(g) : g.type == "boolean" ? g.value ? s("Nice", "Yes") : s("Nice", "No") : g.valueName ? g.value[g.valueName] : g.value && g.value.name ? g.value.name : g.value && g.value.value ? g.value.value : g.value;
    }
    function M(g) {
      var w;
    ...
    async function z() {
      await o.isReady();
      const g = a(n.query);
      g.search && (l.value = g.search), d.value.forEach(async (w) => {
        const T = g[w.key];
        if (w.type == "yesno") {
          let F = r.find(
            (W) => W.id == g[w.key]
          );
          g[w.key] || (F = null), w.value = F;
        } else if (w.type == "date")
          w.value = new Date(T);
        else if (w.type == "boolean")
          w.value = T == "true";
        else if (w.type == "select" && w.fetch) {
          const F = await w.fetch(T);
          w.value = F;
        } else if (w.type == "select" && w.searchFunction) {
          const F = await w.searchFunction();
          w.value = F.find((W) => W[w.keyName || "id"] == T);
        } else
          console.log("[NiceFilters] Query not handled: ", w.key, T);
      }), setTimeout(() => {
        c("update:modelValue", d), c("change", d);
      });
    }
    async function S() {
      setTimeout(async () => {
        ...
        const w = Object.keys(g).filter((T) => g[T] != null && g[T] != "").reduce((T, F) => ({ ...T, [F]: g[F] }), {});
        o.push({ query: w }), await o.isReady(), setTimeout(() => {
          c("update:modelValue", d.value), c("change", d.value);
        });
      });
    }
    async function L() {
      const g = { ...n.query, id: "new" };
      o.push({ query: g }), await o.isReady(), c("create");
    }
    function H(g) {
      g.value = null, S();
    }
    return (g, w) => {
      const T = Y("NiceInput"), F = Y("NiceSwitch"), W = Y("NiceDate"), A = Y("NiceDropdown"), Z = Y("NiceButton");
      return h(), p("div", Y8, [
        f("div", Z8, [
          D(T, {
            title: x(s)("Nice", "Search"),
            placeholder: x(s)("Nice", "Search..."),
            icon: "icon-search",
            modelValue: l.value,
          ...
          d.value ? (h(), p("div", R8, [
            (h(!0), p(K, null, a0(d.value, (N) => (h(), p("div", {
              class: "nice-filters-filter",
              key: N.key
            }, [
              N.type == "boolean" ? (h(), I(F, {
                key: 0,
                modelValue: N.value,
              ...
              N.type == "select" ? (h(), I(A, {
                ...
                "onUpdate:modelValue": (R) => N.value = R,
                title: N.name,
                "search-function": N.searchFunction,
                valueName: N.valueName,
                keyName: N.keyName,
                formatFunction: N.formatter,
                onChange: S,
                nullable: "",
                noMargin: ""
          ...
          e.showCreateButton ? (h(), I(Z, {
            key: 1,
            disabled: e.disableCreateButton,
            text: x(s)("Nice", "Create"),
            onClick: L,
            icon: "icon-plus"
          }, null, 8, ["disabled", "text"])) : y("", !0)
        ]),
        e.showPills && x(u) && x(u).length ? (h(), p("div", X8, [
          (h(!0), p(K, null, a0(x(u), (N) => (h(), p("div", {
            class: "nice-filters-pill badge badge-primary",
            key: N.key,
            title: N.description
          }, [
            f("div", null, [
              f("small", null, B(N.name), 1),
              f("div", null, B(b(N)), 1)
            ]),
            D(Z, {
              icon: "icon-x",
...
}), K8 = /* @__PURE__ */ t0(J8, [["__scopeId", "data-v-a8a2e225"]]);
const e6 = ["xlink:href"], t6 = {
  name: "NiceIcon"
}, c6 = /* @__PURE__ */ Object.assign(t6, {
  props: {
    icon: {
      type: String,
      required: !0
  ...
  setup(e) {
    ...
    return (t, a) => (h(), p("svg", {
      class: "nice-icon",
      style: V1({ height: e.size + "px", width: e.size + "px" })
    }, [
      f("use", {
        "xlink:href": "#" + c.icon
      }, null, 8, e6)
...
}), F1 = /* @__PURE__ */ t0(c6, [["__scopeId", "data-v-17798a9f"]]);
var P2 = a6;
function a6(e, c, t) {
  if (!e)
    return t;
  var a, s;
  if (Array.isArray(c) && (a = c.slice(0)), typeof c == "string" && (a = c.split(".")), typeof c == "symbol" && (a = [c]), !Array.isArray(a))
    throw new Error("props arg must be an array, a string or a symbol");
  for (; a.length; )
    if (s = a.shift(), !e || (e = e[s], e === void 0))
      return t;
  return e;
}
const s6 = { class: "input-group" }, n6 = ["placeholder", "autocomplete", "type", "required", "disabled", "min", "max", "min-length", "max-length", "regex-pattern"], l6 = {
  key: 1,
  ...
  setup(e, { emit: c }) {
    ...
    const n = J({
      get() {
        return !o.value || !t.formatter ? t.modelValue : t.formatter(t.modelValue);
      },
      set(i) {
        c("update:modelValue", i), c("change", i), clearTimeout(s), s = setTimeout(() => {
          c("debounce", i);
        }, 500);
      }
    }), o = j(!0);
    ...
    const d = J(() => {
      if (typeof t.error == "string")
        return t.error;
      const i = P2(t.error, ["response", "data", t.prop]);
      return typeof i == "object" ? i.join("-") : i;
    });
    function r() {
      n.value = "";
    }
    return (i, u) => {
      const v = Y("NiceIcon");
      return h(), p("div", {
        class: E(["nice-component nice-input", { "no-margin": e.noMargin, active: x(n), disabled: e.disabled }])
      }, [
        D(V0, {
          title: e.title,
          required: e.required,
        ...
        f("div", s6, [
          x(a).suffix || t.suffixText ? (h(), p("div", {
            key: 0,
            class: E(["input-group-suffix", { "input-group-suffix-text": t.suffixText }])
          }, [
            X(i.$slots, "suffix", {}, () => [
              M0(B(t.suffixText), 1)
            ], !0)
          ...
          N0(f("input", {
            onBlur: u[0] || (u[0] = (m) => l(!0)),
            onFocus: u[1] || (u[1] = (m) => l(!1)),
            "onUpdate:modelValue": u[2] || (u[2] = (m) => $1(n) ? n.value = m : null),
            class: E({ "text-right": e.textRight }),
          ...
          x(a).append || t.appendText ? (h(), p("div", {
            key: 2,
            class: E(["input-group-append", { "input-group-append-text": t.appendText }])
          }, [
            X(i.$slots, "append", {}, () => [
              M0(B(t.appendText), 1)
            ], !0)
        ...
        e.message ? (h(), p("div", o6, B(e.message), 1)) : y("", !0),
        x(d) ? (h(), p("div", i6, B(x(d)), 1)) : y("", !0)
      ], 2);
    };
  }
}), u6 = /* @__PURE__ */ t0(d6, [["__scopeId", "data-v-bc7cd04e"]]);
const h6 = { class: "notification-info" }, v6 = {
  key: 0,
  ...
  setup(e, { emit: c }) {
    ...
    return g0(() => {
      ...
      const d = Y("NiceIcon");
      return h(), p("div", {
        class: E(["nice-notification", ["nice-notification-" + t.notification.type]]),
        onMouseover: n,
        onMouseleave: s
      }, [
        t.notification.icon ? (h(), I(d, {
          key: 0,
          class: "notification-icon",
          icon: t.notification.icon
        }, null, 8, ["icon"])) : y("", !0),
        f("div", h6, [
          t.notification.title ? (h(), p("div", v6, B(t.notification.title), 1)) : y("", !0),
          t.notification.message ? (h(), p("div", m6, B(t.notification.message), 1)) : y("", !0)
        ])
      ], 34);
    };
  }
}), F2 = /* @__PURE__ */ t0(f6, [["__scopeId", "data-v-b366cb5b"]]);
const y6 = { class: "nice-notifications" }, g6 = {
  name: "NiceNotifications"
}, b6 = /* @__PURE__ */ Object.assign(g6, {
  setup(e) {
    const c = n0("$t"), t = n0("nice"), a = 3e3, s = j([]);
    function n({ message: l, type: d, title: r, icon: i }) {
      var u = {
    ...
    function o(l) {
      let d = s.value.findIndex((r) => r.id == l.id);
      d >= 0 && s.value.splice(d, 1);
    }
    return g0(() => {
      t.onNotification((l, d, r) => {
        n(l);
      });
    }), (l, d) => (h(), p("div", y6, [
      D(y2, {
        ...
        default: e0(() => [
          (h(!0), p(K, null, a0(s.value, (r) => (h(), I(F2, {
            key: r.id,
            notification: r,
            timeoutTime: a,
            onRemove: (i) => o(r)
...
}), M6 = /* @__PURE__ */ t0(b6, [["__scopeId", "data-v-69de8d3e"]]);
const z6 = {
  name: "NicePanel"
}, C6 = /* @__PURE__ */ Object.assign(z6, {
  props: {
    name: {
      type: String,
      required: !0
  ...
  emits: ["close"],
  setup(e, { expose: c, emit: t }) {
    const a = e, s = n0("nice"), n = j(!1), o = j(!1), l = j(500), d = j(null);
    g0(() => {
      document.addEventListener("keyup", m), s.onPanel((b) => {
        a.name == b.name && (n.value = b.isOpen), b.isOpen && i();
      });
    }), R2(() => {
    ...
    function i() {
      setTimeout(() => {
        if (!d.value)
          return;
        const b = d.value.querySelectorAll("input");
        b && b[0] && b[0].focus && b[0].focus();
      });
    }
    function u() {
      t("close"), s.panel(a.name, !1);
    }
    function v(b) {
      if (o.value) {
        let M = 300;
        a.position == "right" ? M = document.body.clientWidth - b.clientX : a.position == "left" ? M = b.clientX : a.position == "top" ? M = b.clientY : a.position == "bottom" && (M = document.body.clientHeight - b.clientY), M >= 300 && r(M);
      }
    }
    function m(b) {
      b.key == "Escape" && u();
    }
    return c({ close: u }), (b, M) => (h(), I(J0(e.isForm ? "form" : "div"), {
      class: E(["nice-side-view", [e.position, { "no-select": o.value }]]),
      onMousemove: v,
      onMouseup: M[1] || (M[1] = (z) => o.value = !1),
      ...
      default: e0(() => [
        D(d1, { name: "side-view" }, {
          default: e0(() => [
            n.value ? (h(), p("div", {
              key: 0,
              class: E(["side-view-body", { "no-padding": e.noPadding }]),
              style: V1({ "--side-view-width": l.value + "px" })
            }, [
              f("div", {
                class: E(["handle", { active: o.value }]),
                ref: "handle",
                onMousedown: M[0] || (M[0] = (z) => o.value = !0)
              }, null, 34),
              X(b.$slots, "default")
            ], 6)) : y("", !0)
          ]),
  ...
  setup(e) {
    const c = e;
    return (t, a) => (h(), p("div", {
      class: E(["nice-component nice-slot", { "no-margin": c.noMargin }])
    }, [
      D(V0, {
        title: c.title,
        caption: c.caption
  ...
  setup(e) {
    const c = e;
    return (t, a) => (h(), p("svg", _6, [
      f("defs", null, [
        k6,
        f("symbol", B6, [
          N6,
          c.isDevelopment ? (h(), p("g", V6, S6)) : y("", !0)
        ]),
        X(t.$slots, "default")
      ])
    ]));
...
const D6 = (e) => (W0("data-v-afe1c71d"), e = e(), j0(), e), T6 = { class: "nice-switch-box-wrapper" }, H6 = ["disabled"], P6 = /* @__PURE__ */ D6(() => /* @__PURE__ */ f("div", { class: "nice-switch-handle" }, null, -1)), F6 = [
  P6
], q6 = ["for"], E6 = { key: 0 }, I6 = ["id", "disabled"], A6 = {
  name: "NiceSwitch"
}, W6 = /* @__PURE__ */ Object.assign(A6, {
  props: {
    modelValue: {
      type: [Boolean, null],
      required: !0
  ...
  setup(e, { emit: c }) {
    ...
    return (o, l) => {
      const d = Y("NiceComponentHeader");
      return h(), p("div", {
        class: E(["nice-component nice-switch", [
          "nice-switch-" + t.type,
          t.size ? "nice-switch-" + t.size : "",
          { "no-margin": t.noMargin, active: x(s), disabled: t.disabled, "nice-is-inline": t.isInline, "nice-is-block": t.isBlock, "nice-is-title-left": e.titleLeft }
        ]])
      }, [
        t.isInline ? (h(), I(d, {
          key: 0,
        ...
        t.title ? (h(), p("div", {
          ...
          f("div", null, B(t.title), 1),
          t.description ? (h(), p("small", E6, B(t.description), 1)) : y("", !0)
        ], 8, q6)) : y("", !0),
        f("input", {
          type: "checkbox",
          tabindex: "-1",
...
}), j6 = /* @__PURE__ */ t0(W6, [["__scopeId", "data-v-afe1c71d"]]);
const Y6 = (e) => (W0("data-v-d91e8725"), e = e(), j0(), e), Z6 = { class: "nice-table" }, R6 = { class: "nice-table-table-wrapper" }, U6 = { class: "nice-table-table" }, X6 = {
  key: 0,
  class: "w-0"
}, Q6 = { key: 0 }, G6 = ["onClick"], J6 = { key: 1 }, K6 = ["placeholder", "onUpdate:modelValue"], e9 = ["onClick"], t9 = ["onClick"], c9 = { key: 0 }, a9 = { key: 0 }, s9 = { class: "list" }, n9 = ["onClick"], l9 = { key: 0 }, o9 = {
  key: 0,
  class: "w-0"
}, i9 = ["innerHTML"], r9 = { class: "actions-td-inner" }, d9 = {
  key: 2,
  class: "nice-table-footer"
}, u9 = { class: "pagination-info" }, h9 = /* @__PURE__ */ Y6(() => /* @__PURE__ */ f("div", { class: "f-grow" }, null, -1)), v9 = {
  key: 1,
  class: "pagination"
}, m9 = {
  key: 2,
  ...
  setup(e, { emit: c }) {
    const t = e, a = g2(), s = b2(), n = n0("getQuery"), o = j(void 0), l = j(50), d = [
      { id: 10, value: 10 },
      { id: 20, value: 20 },
      { id: 50, value: 50 },
      { id: 100, value: 100 }
    ...
    let u = null;
    const v = J(() => (r.value - 1) * l.value), m = J(() => {
      var $, G;
      return ((G = ($ = t.data) == null ? void 0 : $._metadata) == null ? void 0 : G.count) || 0;
    }), b = J(() => Math.ceil(m.value / l.value) || 1), M = J(() => Array.from({ length: b.value }, ($, G) => ({ id: String(G + 1), value: String(G + 1) }))), z = J(() => t.columns), S = J(() => z.value.filter(($) => !$.disabled)), L = J(() => {
      let $ = t.data;
      if ($.forEach((G) => {
        G._selected === void 0 && (G._selected = !1);
      }), t.orderLocally && o.value !== void 0) {
        const G = o.value.replace("-", "");
        $.sort((o0, l0) => {
          if (o.value[0] != "-") {
            const w0 = o0;
            o0 = l0, l0 = w0;
          }
          return String(o0[G]).localeCompare(String(l0[G]));
        });
      }
      return $;
    }), H = J(() => L.value.filter(($) => $._selected)), g = J(() => H.value.length == L.value.length);
    function w($) {
      return $.to != null ? "router-link" : $.href != null ? "a" : "div";
    }
    function T() {
      let $ = !0;
      g.value && ($ = !1), L.value.forEach((G) => G._selected = $), W();
    }
    function F($) {
      $._selected = !$._selected, W();
    }
    function W() {
      c("selected", H.value);
    }
    ...
    function Z() {
      clearTimeout(A), A = setTimeout(() => {
        s.push({
          query: { ...a.query, ...i.value }
        }), x0();
      }, 500);
    }
    function N($) {
      i.value[$.key] = void 0, Z();
    }
    function R($) {
      $.disabled = !$.disabled;
    }
    function O($) {
      $.key == o.value ? o.value = "-" + $.key : o.value && o.value[0] === "-" && o.value === "-" + $.key ? o.value = void 0 : o.value = $.key, s.push({
        query: { ...a.query, ordering: o.value }
      }), setTimeout(() => {
        c("orderChange", o.value);
      }), x0();
    }
    function U() {
      k(1);
    ...
    async function k($) {
      a.query.page != $ && (r.value = $, s.replace({
        path: a.path,
        query: { ...a.query, page: r.value, offset: v.value, limit: l.value }
      }), setTimeout(() => {
        c("pageChange", $), x0();
      }));
    }
    function d0($) {
      a.query.limit != $ && (l.value = $, s.push({
        path: a.path,
        query: { ...a.query, limit: l.value }
      }), setTimeout(() => {
        c("limitChange", l);
      }), x0());
    }
    function x0() {
      setTimeout(() => {
        c("filterChange", { ordering: o.value, page: r.value, offset: v.value, limit: l.value, ...i.value });
      });
    }
    return g0(async () => {
      const $ = await n();
      ...
      t.paginated && (l.value = Number($.limit) || 50, r.value = Number($.page) || 1, u = M[String($.page) || "1"] || { id: "1", value: "1" }, k(r.value));
    }), ($, G) => {
      const o0 = Y("NiceIcon"), l0 = Y("nice-icon"), w0 = Y("router-link"), H0 = Y("NiceNoData"), b0 = Y("NiceDropdown");
      return h(), p("div", Z6, [
        f("div", R6, [
          f("table", U6, [
            f("thead", null, [
              f("tr", null, [
                t.selectMultiple ? (h(), p("th", X6, [
                  D(X0, {
                    modelValue: x(g),
                    "no-margin": "",
                    onClick: T
                ...
                (h(!0), p(K, null, a0(x(S), (_) => (h(), p("th", {
                  key: _.key,
                  class: E([_.class, "nice-table-th-wrapper"])
                }, [
                  _.hasOrder ? (h(), p("div", Q6, [
                    f("div", {
                      class: E(["nice-table-th", {
                        "active asc": o.value == _.key,
                        "active desc": o.value == "-" + _.key
                      }]),
                      onClick: (C) => O(_)
                    }, [
                      f("span", null, B(_.name), 1),
                      D(o0, {
                        icon: "icon-bar-chart",
                        class: "table-order"
                      })
                    ], 10, G6)
                  ])) : (h(), p("span", J6, B(_.name), 1)),
                  _.hasSearch ? (h(), p("div", {
                    key: 2,
                    class: E(["nice-table-th-search", { visible: i.value[_.key] }])
                  }, [
                    N0(f("input", {
                      placeholder: _.name,
                      "onUpdate:modelValue": (C) => i.value[_.key] = C,
                      onInput: Z
                    }, null, 40, K6), [
                      [t1, i.value[_.key]]
                    ]),
                    i.value[_.key] ? (h(), p("button", {
                      key: 0,
                      title: "Clear",
                      type: "button",
                    ...
                    _.hasOrder ? (h(), p("button", {
                      ...
                      o.value != _.key && o.value != "-" + _.key ? (h(), I(l0, {
                        key: 0,
                        icon: "icon-filter"
                      })) : y("", !0),
                      o.value == _.key ? (h(), I(l0, {
                        key: 1,
                        class: "asc",
                        icon: "icon-bar-chart"
                      })) : y("", !0),
                ...
                t.actions.length ? (h(), p("th", {
                  key: 1,
                  class: E(["actions-td w-0", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  !t.showToggleColumns && !t.showFooter && x(L) && x(L).length ? (h(), p("span", c9, [
                    f("span", null, B(x(L).length), 1),
                    x(L)._metadata ? (h(), p("span", a9, " / " + B(x(L)._metadata.count), 1)) : y("", !0)
                  ])) : y("", !0),
                  t.showToggleColumns ? (h(), I(s1, {
                    key: 1,
                    ...
                    trigger: e0(() => [
                      D(o0, { icon: "icon-plus-circle" })
                    ]),
                    content: e0(() => [
                      f("div", s9, [
                        (h(!0), p(K, null, a0(x(z), (_) => (h(), p("div", {
                          class: "element",
                          key: _.key,
                          onClick: (C) => R(_)
                        }, [
                          D(X0, {
                            modelValue: !_.disabled,
                            title: _.name,
                            "no-margin": ""
            ...
            x(L) && x(L).length ? (h(), p("tbody", l9, [
              (h(!0), p(K, null, a0(x(L), (_) => (h(), p("tr", {
                key: _.id
              }, [
                t.selectMultiple ? (h(), p("td", o9, [
                  D(X0, {
                    modelValue: _._selected,
                    onClick: (C) => F(_),
                    "no-margin": ""
                  }, null, 8, ["modelValue", "onClick"])
                ])) : y("", !0),
                (h(!0), p(K, null, a0(x(S), (C) => {
                  var _0, l1;
                  return h(), p("td", {
                    key: C.key,
                    class: E(C.class)
                  }, [
                    C.component ? (h(), I(J0((_0 = C.component()) == null ? void 0 : _0.instance), U2(f2({ key: 0 }, (l1 = C.component(_[C.key], _)) == null ? void 0 : l1.props)), null, 16)) : y("", !0),
                    !C.component && C.html ? (h(), p("span", {
                      key: 1,
                      innerHTML: C.html(_[C.key], _)
                    }, null, 8, i9)) : y("", !0),
                    !C.component && !C.html ? (h(), p("span", {
                      key: 2,
                      class: E(C.fieldClass ? C.fieldClass(_[C.key], _) : "")
                    }, B(C.formatter ? C.formatter(_[C.key], _) : _[C.key]), 3)) : y("", !0)
                  ], 2);
                }), 128)),
                t.actions.length ? (h(), p("td", {
                  key: 1,
                  class: E(["actions-td", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  f("div", r9, [
                    (h(!0), p(K, null, a0(t.actions, (C) => (h(), p(K, { key: C }, [
                      w(C) == "router-link" && !(C.hidden && C.hidden(_)) ? (h(), I(w0, {
                        key: 0,
                        disabled: C.disabled && C.disabled(_),
                        to: C.to && C.to(_)
                      }, {
                        default: e0(() => [
                          C.hidden && C.hidden(_) ? y("", !0) : (h(), I(v0, {
                            key: 0,
                            icon: C.icon && C.icon(_),
                            type: C.type && C.type(_),
                            text: C.text && C.text(_).toString(),
                            plain: C.plain && C.plain(_),
                            loading: C.loading && C.loading(_),
                            disabled: C.disabled && C.disabled(_),
                            title: C.title && C.title(_),
                            onClick: (_0) => C.function && C.function(_),
                            size: "small"
                          }, null, 8, ["icon", "type", "text", "plain", "loading", "disabled", "title", "onClick"]))
                        ]),
                        _: 2
                      }, 1032, ["disabled", "to"])) : y("", !0),
                      C.hidden && C.hidden(_) ? y("", !0) : (h(), I(J0(w(C) != "router-link" && w(C)), {
                        key: 1,
                        disabled: C.disabled && C.disabled(_),
                        href: C.href && C.href(_),
                        target: C.href ? "blank" : null
                      }, {
                        default: e0(() => [
                          C.hidden && C.hidden(_) ? y("", !0) : (h(), I(v0, {
                            key: 0,
        ...
        x(L) && !x(L).length && e.loading ? (h(), I(p1, {
          key: 0,
          class: "nice-table-loading"
        })) : y("", !0),
        !e.loading && t.data.length == 0 ? (h(), I(H0, { key: 1 })) : y("", !0),
        t.showFooter ? (h(), p("div", d9, [
          e.loading ? (h(), I(p1, {
            key: 0,
            class: "nice-table-footer-loading"
          })) : y("", !0),
          f("div", u9, B(x(m)) + " " + B($.$t("Nice", "total")), 1),
          h9,
          t.paginated && x(b) > 1 && x(b) <= 5 ? (h(), p("div", v9, [
            D(v0, {
            ...
            (h(!0), p(K, null, a0(x(b), (_) => (h(), I(v0, {
              size: "small",
              plain: r.value !== _,
              key: _,
              class: E(r.value === _ ? "active" : ""),
              onClick: (C) => k(_)
            }, {
              default: e0(() => [
                M0(B(_), 1)
          ...
          t.paginated && x(b) > 1 && x(b) > 5 ? (h(), p("div", m9, [
            D(b0, {
              nativeTitle: $.$t("Nice", "Page"),
              modelValue: x(u),
              "onUpdate:modelValue": G[0] || (G[0] = (_) => $1(u) ? u.value = _ : u = _),
              values: x(M),
              noMargin: "",
              onChange: c0
...
}), y9 = /* @__PURE__ */ t0(f9, [["__scopeId", "data-v-d91e8725"]]);
const g9 = { class: "input-group" }, b9 = {
  key: 0,
  class: "input-group-suffix"
}, M9 = ["placeholder", "autocomplete", "type", "rows", "disabled"], z9 = {
  key: 1,
  class: "input-group-append input-group-icon"
}, C9 = {
  key: 2,
  ...
  setup(e, { emit: c }) {
    ...
    return (s, n) => {
      const o = Y("NiceComponentHeader");
      return h(), p("div", {
        class: E(["nice-component nice-textarea", { "no-margin": e.noMargin, active: x(a), disabled: e.disabled }])
      }, [
        D(o, {
          title: e.title,
          required: e.required,
        ...
        f("div", g9, [
          s.$slots.suffix ? (h(), p("div", b9, [
            X(s.$slots, "suffix", {}, void 0, !0)
          ])) : y("", !0),
          N0(f("textarea", {
            "onUpdate:modelValue": n[0] || (n[0] = (l) => $1(a) ? a.value = l : null),
            placeholder: e.placeholder,
            autocomplete: e.autocomplete,
            type: e.type,
            rows: e.rows,
          ...
          e.icon ? (h(), p("div", z9, [
            D(F1, { icon: e.icon }, null, 8, ["icon"])
          ])) : y("", !0),
          s.$slots.append ? (h(), p("div", C9, [
            X(s.$slots, "append", {}, void 0, !0)
          ])) : y("", !0)
        ]),
        e.message ? (h(), p("div", w9, B(e.message), 1)) : y("", !0)
      ], 2);
    };
  }
}), k9 = /* @__PURE__ */ t0(_9, [["__scopeId", "data-v-483407b0"]]);
const B9 = { class: "nice-toasts" }, N9 = {
  name: "NiceToast"
}, V9 = /* @__PURE__ */ Object.assign(N9, {
  setup(e) {
    const t = j([]), a = n0("nice");
    g0(() => {
      a.onToast(({ message: o, type: l }) => {
        s(o, l);
      });
    });
    function s(o, l) {
    ...
    function n(o) {
      const l = t.value.findIndex((d) => d.id == o.id);
      l >= 0 && t.value.splice(l, 1);
    }
    return (o, l) => (h(), p("div", B9, [
      D(y2, {
        name: "toast",
        key: "div"
      }, {
        default: e0(() => [
          (h(!0), p(K, null, a0(t.value, (d) => (h(), p("div", {
            class: E(["nice-toast", ["nice-toast-" + d.type]]),
            key: d.id
          }, B(d.message), 3))), 128))
        ]),
        _: 1
...
}), $9 = /* @__PURE__ */ t0(V9, [["__scopeId", "data-v-95aff90a"]]);
const S9 = {
  name: "NiceUpload",
  components: {
  ...
  computed: {
    ...
    errorMessage() {
      if (typeof this.error == "string")
        return this.error;
      const e = P2(this.error, ["response", "data", this.prop]);
  ...
  // },
}, O9 = ["modelValue", "placeholder", "required", "accept", "disabled"], L9 = {
  key: 0,
  class: "nice-upload-overlay"
}, D9 = { class: "nice-upload-overlay-message" }, T9 = {
  key: 1,
  class: "nice-upload-overlay"
}, H9 = {
  key: 2,
  class: "nice-upload-overlay"
}, P9 = { class: "nice-upload-overlay-message" }, F9 = {
  key: 3,
  class: "nice-upload-overlay"
}, q9 = ["src"], E9 = {
  key: 4,
  class: "nice-upload-overlay"
}, I9 = ["src"], A9 = { class: "nice-upload-overlay-message" }, W9 = ["disabled"];
function j9(e, c, t, a, s, n) {
  const o = Y("NiceComponentHeader"), l = Y("NiceIcon"), d = Y("NiceLoading");
  return h(), p("div", {
    class: E(["nice-component nice-upload", { "no-margin": t.noMargin, active: n.localValue, disabled: t.disabled }])
  }, [
    D(o, {
      title: t.title,
      required: t.required,
    ...
    f("div", {
      class: E(["input-group", { dragging: s.isDragging, "on-target": s.isOnTarget }]),
      onDragenter: c[2] || (c[2] = (...r) => n.dragChanged && n.dragChanged(...r)),
      onDragleave: c[3] || (c[3] = (...r) => n.dragChanged && n.dragChanged(...r)),
      onDragover: c[4] || (c[4] = (...r) => n.dragChanged && n.dragChanged(...r)),
      onDragend: c[5] || (c[5] = (...r) => n.dragChanged && n.dragChanged(...r)),
      onDrop: c[6] || (c[6] = (...r) => n.dragChanged && n.dragChanged(...r))
    }, [
      f("input", {
        ref: "inputFile",
        modelValue: s.file,
        placeholder: t.placeholder,
        required: t.required && !n.localValue,
        accept: t.accept,
        type: "file",
        onChange: c[0] || (c[0] = (...r) => n.fileChanged && n.fileChanged(...r)),
        disabled: t.disabled
      }, null, 40, O9),
      n.localValue ? y("", !0) : (h(), p("div", L9, [
        D(l, { icon: "icon-upload" }),
        f("div", D9, B(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      n.localValue && n.localValueType == "FileList" ? (h(), p("div", T9, [
        D(l, { icon: "icon-file" }),
        (h(!0), p(K, null, a0(n.localValue, (r) => (h(), p("div", {
          class: "nice-upload-overlay-message",
          key: r.name
        }, B(r.name), 1))), 128))
      ])) : y("", !0),
      n.localValue && n.localValueType == "string" ? (h(), p("div", H9, [
        D(l, { icon: "icon-file" }),
        f("div", P9, B(n.localValue), 1)
      ])) : y("", !0),
      n.localValue && n.localValueType == "image" ? (h(), p("div", F9, [
        f("img", {
          class: "nice-upload-overlay-image",
          src: n.localValue
        }, null, 8, q9)
      ])) : y("", !0),
      n.localValue && n.localValueType == "none" ? (h(), p("div", E9, [
        f("img", {
          class: "nice-upload-overlay-image",
          src: n.localValue
        }, null, 8, I9),
        f("div", A9, B(e.$t("Nice", "File selected")), 1)
      ])) : y("", !0),
      n.localValue ? (h(), p("button", {
        key: 5,
        type: "button",
        class: "nice-upload-button btn btn-white btn-plain",
        onClick: c[1] || (c[1] = (...r) => n.clear && n.clear(...r)),
        disabled: t.disabled
      }, [
        D(l, { icon: "icon-x" })
      ], 8, W9)) : y("", !0),
...
const Y9 = /* @__PURE__ */ t0(S9, [["render", j9], ["__scopeId", "data-v-dab4b1f3"]]);
const Z9 = {
  key: 0,
  ...
  setup(e) {
    const c = e, t = N1(), a = J(() => t.title || c.title || t.subTitle || c.subTitle || t.aboveTitle || c.aboveTitle);
    return (s, n) => {
      const o = Y("NiceIcon"), l = Y("NiceLoading");
      return h(), I(J0(e.isForm ? "form" : "div"), {
        class: E(["nice-view", { "nice-view-no-header": !x(a), "nice-view-flex-body": e.flexBody }])
      }, {
        default: e0(() => [
          x(a) || c.icon ? (h(), p("div", Z9, [
            e.icon && !e.loading ? (h(), I(o, {
              key: 0,
              icon: e.icon,
            ...
            x(a) ? (h(), p("div", R9, [
              e.aboveTitle || x(t).aboveTitle ? (h(), p("div", U9, [
                X(s.$slots, "aboveTitle", {}, () => [
                  M0(B(e.aboveTitle), 1)
                ], !0)
              ])) : y("", !0),
              e.title || x(t).title ? (h(), p("div", X9, [
                X(s.$slots, "title", {}, () => [
                  M0(B(e.title), 1)
                ], !0)
              ])) : y("", !0),
              e.subTitle || x(t).subTitle ? (h(), p("div", Q9, [
                X(s.$slots, "subTitle", {}, () => [
                  M0(B(e.subTitle), 1)
                ], !0)
              ])) : y("", !0)
          ...
          f("div", {
            class: E(["nice-view-body", { "nice-view-body-flex": e.flexBody }])
          }, [
            X(s.$slots, "default", {}, void 0, !0)
          ], 2),
          x(t).footer ? (h(), p("div", G9, [
...
}), ee = /* @__PURE__ */ t0(K9, [["__scopeId", "data-v-85282661"]]);
const te = (e) => (W0("data-v-bdde4e0c"), e = e(), j0(), e), ce = {
  key: 0,
...
}, le = /* @__PURE__ */ te(() => /* @__PURE__ */ f("div", { class: "flex-grow" }, null, -1)), oe = {
  key: 2,
  ...
  setup(e) {
    const t = j(!e.collapsed);
    function a() {
      t.value = !t.value;
    }
    return (s, n) => (h(), p("div", {
      class: E(["nice-wrapper", { "no-margin": e.noMargin }])
    }, [
      s.$slots.header || e.title || e.subtitle || e.collapsable ? (h(), p("div", ce, [
        e.title || e.subtitle ? (h(), p("div", ae, [
          e.title ? (h(), p("div", se, B(e.title), 1)) : y("", !0),
          e.subtitle ? (h(), p("div", ne, B(e.subtitle), 1)) : y("", !0)
        ])) : y("", !0),
        X(s.$slots, "header", {}, void 0, !0),
        le,
        e.collapsable ? (h(), I(v0, {
          key: 1,
          class: E(["wrapper-header-chevron", { "rotate-180": !t.value }]),
          icon: "icon-chevron-down",
          naked: "",
          onClick: a
        }, null, 8, ["class"])) : y("", !0),
        e.collapsable ? (h(), p("div", {
          key: 2,
      ...
      t.value ? (h(), p("div", {
        key: 1,
        class: E(["wrapper-body", { "no-top-padding": s.$slots.header || e.title || e.subtitle, "no-padding": e.noBodyPadding }])
      }, [
        X(s.$slots, "default", {}, void 0, !0)
      ], 2)) : y("", !0),
      s.$slots.footer && t.value ? (h(), p("div", oe, [
        X(s.$slots, "footer", {}, void 0, !0)
      ])) : y("", !0)
    ], 2));
  }
}), de = /* @__PURE__ */ t0(re, [["__scopeId", "data-v-bdde4e0c"]]);
const ue = { class: "nice-no-data" }, he = { class: "nice-no-data-message" }, ve = {
  name: "NiceNoData"
  ...
  setup(e) {
    const c = e, t = n0("$t"), a = j(c.message || t("Nice", "No data"));
    return (s, n) => {
      const o = Y("NiceIcon");
      return h(), p("div", ue, [
        D(o, {
        ...
        f("div", he, B(a.value), 1)
      ]);
    };
  }
}), pe = /* @__PURE__ */ t0(me, [["__scopeId", "data-v-a5c7ad13"]]);
const fe = { class: "input-group" }, ye = ["placeholder", "disabled", "required"], ge = { class: "nice-date-range-dropdown" }, be = { class: "nice-date-range-buttons" }, Me = {
  name: "NiceDateRange"
}, ze = /* @__PURE__ */ Object.assign(Me, {
  props: {
    from: {
      type: [String, Date, null],
      required: !1
  ...
  setup(e, { emit: c }) {
    const t = e, a = n0("$t"), s = j(null), n = j(""), o = j("d.M.yyyy"), l = [
      {
        name: a("Nice", "Today"),
        from: k1(/* @__PURE__ */ new Date()),
        to: y5(/* @__PURE__ */ new Date())
      },
      {
        name: a("Nice", "Yesterday"),
        from: w7(/* @__PURE__ */ new Date()),
        to: C5(/* @__PURE__ */ new Date())
      },
      {
        name: a("Nice", "This week"),
        from: A0(/* @__PURE__ */ new Date()),
        to: z5(/* @__PURE__ */ new Date())
      },
      {
        name: a("Nice", "This month"),
        from: b5(/* @__PURE__ */ new Date()),
        to: g5(/* @__PURE__ */ new Date())
      }
    ], d = j(null), r = j(null);
    g0(() => {
      t.time && (o.value = "d.M.yyyy HH:mm"), t.from && (d.value = t.from), t.to && (r.value = t.to), d.value || v(l[0]);
    });
    function i() {
    }
    function u() {
      if (z7(r.value, d.value)) {
        const M = d.value;
        d.value = r.value, r.value = M;
      }
      m();
    }
    function v(M) {
      d.value = M.from, r.value = M.to, m();
    }
    function m() {
      c("update:to", r.value), c("update:from", d.value), c("change", { from: d.value, to: r.value }), b();
    }
    function b() {
      n.value = m2(d.value, o.value) + " - " + m2(r.value, o.value);
    }
    return (M, z) => {
      const S = Y("NiceIcon"), L = Y("NiceButton"), H = Y("NiceDate");
      return h(), p("div", {
        class: E(["nice-component nice-date-range", {
          disabled: e.disabled,
          "no-margin": e.noMargin
        }])
      }, [
        ...
        D(s1, {
          ...
          trigger: e0(() => [
            f("div", fe, [
              N0(f("input", {
                "onUpdate:modelValue": z[0] || (z[0] = (g) => n.value = g),
                placeholder: e.placeholder || x(a)("Nice", "None"),
                disabled: e.disabled,
                required: e.required,
                onBlur: z[1] || (z[1] = (...g) => M.inputChanged && M.inputChanged(...g))
              }, null, 40, ye), [
                [t1, n.value]
              ]),
              D(S, {
          ...
          content: e0(() => [
            f("div", ge, [
              ...
              D(H, {
                ...
                onChange: u,
                modelValue: d.value,
                "onUpdate:modelValue": z[2] || (z[2] = (g) => d.value = g),
                isInline: "",
                noMargin: ""
              ...
              D(H, {
                ...
                onChange: u,
                modelValue: r.value,
                "onUpdate:modelValue": z[3] || (z[3] = (g) => r.value = g),
                isInline: "",
                noMargin: ""
              }, null, 8, ["time", "highlightTo", "modelValue"])
            ])
...
}), Ce = /* @__PURE__ */ t0(ze, [["__scopeId", "data-v-ab30638c"]]);
const we = { class: "nice-alert-data" }, xe = {
  key: 0,
  ...
  setup(e) {
    return (c, t) => (h(), p("div", {
      class: E(["nice-alert", ["nice-alert-" + e.type, { "nice-alert-inline": e.inline, "nice-alert-align-center": e.alignCenter }]])
    }, [
      e.icon ? (h(), I(F1, {
        key: 0,
        icon: e.icon
      ...
      f("div", we, [
        e.title ? (h(), p("div", xe, B(e.title), 1)) : y("", !0),
        e.message ? (h(), p("div", _e, B(e.message), 1)) : y("", !0),
        X(c.$slots, "default")
      ])
    ], 2));
  }
  ...
  a.className = "nice-tooltip", a.textContent = c.value || e.getAttribute("nice-tooltip") || "", e.appendChild(a);
  const s = (o) => {
...
const Se = {
  install(e, c) {
    ...
    e.directive("niceTooltip", Ne);
    const t = X2(), a = {
      debug: c ? c.debug : !1,
      emitter: t,
      // Notification
      onNotification: (o) => t.on("notification", o),
      notification: (o, l, d, r) => {
        t.emit("notification", { message: o, type: l, title: d, icon: r });
      },
      // Toast
      onToast: (o) => t.on("toast", o),
      toast: (o, l) => {
        t.emit("toast", { message: o, type: l });
      },
      // Panel
      onPanel: (o) => t.on("panel", o),
      panel: (o, l) => {
        t.emit("panel", { name: o, isOpen: l });
      },
      // Modal
      onModal: (o) => t.on("modal", o),
      modal: (o, l, d) => {
        t.emit("modal", { name: o, isOpen: l, event: d });
      }
    };
    e.config.globalProperties.$nice = a, e.provide("nice", a);
    async function s() {
      await c.router.isReady();
      const o = n(c.router.currentRoute.value.query);
      return delete o.id, o;
    }
    function n(o) {
      return Object.assign({}, o);
    }
    e.config.globalProperties.$query = s, e.provide("getQuery", s), e.config.globalProperties.$clone = n, e.provide("clone", n), e.config.globalProperties.$t = c.gettext.$pgettext, e.provide("$t", c.gettext.$pgettext);
  }
};
function Oe() {
  return n0("nice");
