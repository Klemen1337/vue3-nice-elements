import { resolveComponent as w, openBlock as d, createElementBlock as m, normalizeClass as B, createBlock as V, createCommentVNode as f, renderSlot as E, toDisplayString as z, Teleport as o2, createVNode as _, Transition as F0, withCtx as H, normalizeStyle as I1, createElementVNode as b, createTextVNode as d0, Fragment as F, pushScopeId as k0, popScopeId as N0, withDirectives as p0, vShow as z1, vModelText as s1, renderList as R, vModelDynamic as i2, TransitionGroup as $1, createStaticVNode as n2, resolveDynamicComponent as l2, normalizeProps as a2, mergeProps as r2 } from "vue";
import { createGettext as h2 } from "vue3-gettext";
function d2(e) {
...
}, v2 = ["type", "disabled"], p2 = { key: 2 }, m2 = { key: 3 };
function f2(e, s, t, i, c, o) {
  const a = w("NiceLoading"), n = w("NiceIcon");
  return d(), m("button", {
    ...
    e.$slots.default ? (d(), m("span", p2, [
      E(e.$slots, "default", {}, void 0, !0)
    ])) : f("", !0),
    t.text ? (d(), m("span", m2, z(t.text), 1)) : f("", !0),
    t.appendIcon ? (d(), V(n, {
      key: 4,
      icon: t.appendIcon
    }, null, 8, ["icon"])) : f("", !0)
...
const S0 = /* @__PURE__ */ O(u2, [["render", f2], ["__scopeId", "data-v-45b5043d"]]);
const y2 = {
  name: "NiceModal",
  props: {
    name: {
...
}, b2 = { class: "nice-modal-title" }, g2 = { class: "nice-modal-subtitle" }, z2 = { class: "nice-modal-body" }, w2 = {
  key: 1,
  class: "nice-modal-footer"
};
function _2(e, s, t, i, c, o) {
  const a = w("NiceButton");
  return d(), V(o2, { to: "body" }, [
    _(F0, { name: "fade" }, {
      default: H(() => [
        c.isOpen ? (d(), m("div", {
          key: 0,
    ...
    _(F0, { name: "flyin" }, {
      default: H(() => [
        c.isOpen ? (d(), m("div", {
          ...
          e.$slots.title || t.title || e.$slots.subtitle || t.subtitle ? (d(), m("div", M2, [
            b("div", b2, [
...
const q1 = /* @__PURE__ */ O(y2, [["render", _2], ["__scopeId", "data-v-72f12cd9"]]), x2 = {
...
function B2(e, s, t, i, c, o) {
  const a = w("NiceButton"), n = w("NiceModal");
  return d(), V(n, {
    name: t.name,
...
const F1 = /* @__PURE__ */ O(x2, [["render", B2]]);
const k2 = {
  name: "NiceActions",
  components: {
    NiceConfirmModal: F1
...
}, N2 = { class: "nice-actions" }, S2 = /* @__PURE__ */ b("div", { class: "flex-grow" }, null, -1);
function V2(e, s, t, i, c, o) {
  const a = w("NiceButton"), n = w("NiceConfirmModal");
  return d(), m(F, null, [
    b("div", N2, [
      t.showDelete ? (d(), V(a, {
        key: 0,
...
const O2 = /* @__PURE__ */ O(k2, [["render", V2]]);
function D2(e) {
...
var E2 = P2;
const K0 = (e, s, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (s - e) * 6 * t : t < 1 / 2 ? s : t < 2 / 3 ? e + (s - e) * (2 / 3 - t) * 6 : e), I2 = (e, s, t) => {
  let i, c, o;
  if (e = e / 360, s == 0)
    i = c = o = t;
  else {
    const a = t < 0.5 ? t * (1 + s) : t + s - t * s, n = 2 * t - a;
    i = K0(n, a, e + 1 / 3), c = K0(n, a, e), o = K0(n, a, e - 1 / 3);
  }
  return [
...
var $2 = I2;
const q2 = T2, F2 = E2, w1 = $2, A2 = () => Math.floor(Math.random() * Date.now()), L2 = (e, s) => {
  const t = q2(e), i = F2(t % 360, 1, 0.5), c = w1(i[0][0], i[0][1], i[0][2]), o = w1(i[1][0], i[1][1], i[1][2]), a = `rgb(${c[0]}, ${c[1]}, ${c[2]})`, n = `rgb(${o[0]}, ${o[1]}, ${o[2]})`, v = A2();
  ...
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = {
    ...
    bytesToBase64: function(t) {
      for (var i = [], c = 0; c < t.length; c += 3)
        for (var o = t[c] << 16 | t[c + 1] << 8 | t[c + 2], a = 0; a < 4; a++)
          c * 8 + a * 6 <= t.length * 8 ? i.push(e.charAt(o >>> 6 * (3 - a) & 63)) : i.push("=");
      return i.join("");
    },
 ...
 */
var W2 = function(e) {
  return e != null && (A1(e) || U2(e) || !!e._isBuffer);
};
function A1(e) {
  return !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
}
function U2(e) {
  return typeof e.readFloatLE == "function" && typeof e.slice == "function" && A1(e.slice(0, 0));
}
(function() {
  var e = G0, s = _1.utf8, t = W2, i = _1.bin, c = function(o, a) {
    o.constructor == String ? a && a.encoding === "binary" ? o = i.stringToBytes(o) : o = s.stringToBytes(o) : t(o) ? o = Array.prototype.slice.call(o, 0) : !Array.isArray(o) && o.constructor !== Uint8Array && (o = o.toString());
    for (var n = e.bytesToWords(o), v = o.length * 8, h = 1732584193, l = -271733879, r = -1732584194, u = 271733878, p = 0; p < n.length; p++)
      n[p] = (n[p] << 8 | n[p] >>> 24) & 16711935 | (n[p] << 24 | n[p] >>> 8) & 4278255360;
    n[v >>> 5] |= 128 << v % 32, n[(v + 64 >>> 9 << 4) + 14] = v;
    for (var M = c._ff, y = c._gg, g = c._hh, x = c._ii, p = 0; p < n.length; p += 16) {
      var P = h, D = l, C = r, N = u;
      h = M(h, l, r, u, n[p + 0], 7, -680876936), u = M(u, h, l, r, n[p + 1], 12, -389564586), r = M(r, u, h, l, n[p + 2], 17, 606105819), l = M(l, r, u, h, n[p + 3], 22, -1044525330), h = M(h, l, r, u, n[p + 4], 7, -176418897), u = M(u, h, l, r, n[p + 5], 12, 1200080426), r = M(r, u, h, l, n[p + 6], 17, -1473231341), l = M(l, r, u, h, n[p + 7], 22, -45705983), h = M(h, l, r, u, n[p + 8], 7, 1770035416), u = M(u, h, l, r, n[p + 9], 12, -1958414417), r = M(r, u, h, l, n[p + 10], 17, -42063), l = M(l, r, u, h, n[p + 11], 22, -1990404162), h = M(h, l, r, u, n[p + 12], 7, 1804603682), u = M(u, h, l, r, n[p + 13], 12, -40341101), r = M(r, u, h, l, n[p + 14], 17, -1502002290), l = M(l, r, u, h, n[p + 15], 22, 1236535329), h = y(h, l, r, u, n[p + 1], 5, -165796510), u = y(u, h, l, r, n[p + 6], 9, -1069501632), r = y(r, u, h, l, n[p + 11], 14, 643717713), l = y(l, r, u, h, n[p + 0], 20, -373897302), h = y(h, l, r, u, n[p + 5], 5, -701558691), u = y(u, h, l, r, n[p + 10], 9, 38016083), r = y(r, u, h, l, n[p + 15], 14, -660478335), l = y(l, r, u, h, n[p + 4], 20, -405537848), h = y(h, l, r, u, n[p + 9], 5, 568446438), u = y(u, h, l, r, n[p + 14], 9, -1019803690), r = y(r, u, h, l, n[p + 3], 14, -187363961), l = y(l, r, u, h, n[p + 8], 20, 1163531501), h = y(h, l, r, u, n[p + 13], 5, -1444681467), u = y(u, h, l, r, n[p + 2], 9, -51403784), r = y(r, u, h, l, n[p + 7], 14, 1735328473), l = y(l, r, u, h, n[p + 12], 20, -1926607734), h = g(h, l, r, u, n[p + 5], 4, -378558), u = g(u, h, l, r, n[p + 8], 11, -2022574463), r = g(r, u, h, l, n[p + 11], 16, 1839030562), l = g(l, r, u, h, n[p + 14], 23, -35309556), h = g(h, l, r, u, n[p + 1], 4, -1530992060), u = g(u, h, l, r, n[p + 4], 11, 1272893353), r = g(r, u, h, l, n[p + 7], 16, -155497632), l = g(l, r, u, h, n[p + 10], 23, -1094730640), h = g(h, l, r, u, n[p + 13], 4, 681279174), u = g(u, h, l, r, n[p + 0], 11, -358537222), r = g(r, u, h, l, n[p + 3], 16, -722521979), l = g(l, r, u, h, n[p + 6], 23, 76029189), h = g(h, l, r, u, n[p + 9], 4, -640364487), u = g(u, h, l, r, n[p + 12], 11, -421815835), r = g(r, u, h, l, n[p + 15], 16, 530742520), l = g(l, r, u, h, n[p + 2], 23, -995338651), h = x(h, l, r, u, n[p + 0], 6, -198630844), u = x(u, h, l, r, n[p + 7], 10, 1126891415), r = x(r, u, h, l, n[p + 14], 15, -1416354905), l = x(l, r, u, h, n[p + 5], 21, -57434055), h = x(h, l, r, u, n[p + 12], 6, 1700485571), u = x(u, h, l, r, n[p + 3], 10, -1894986606), r = x(r, u, h, l, n[p + 10], 15, -1051523), l = x(l, r, u, h, n[p + 1], 21, -2054922799), h = x(h, l, r, u, n[p + 8], 6, 1873313359), u = x(u, h, l, r, n[p + 15], 10, -30611744), r = x(r, u, h, l, n[p + 6], 15, -1560198380), l = x(l, r, u, h, n[p + 13], 21, 1309151649), h = x(h, l, r, u, n[p + 4], 6, -145523070), u = x(u, h, l, r, n[p + 11], 10, -1120210379), r = x(r, u, h, l, n[p + 2], 15, 718787259), l = x(l, r, u, h, n[p + 9], 21, -343485551), h = h + P >>> 0, l = l + D >>> 0, r = r + C >>> 0, u = u + N >>> 0;
    }
    return e.endian([h, l, r, u]);
  };
  c._ff = function(o, a, n, v, h, l, r) {
    var u = o + (a & n | ~a & v) + (h >>> 0) + r;
    return (u << l | u >>> 32 - l) + a;
  }, c._gg = function(o, a, n, v, h, l, r) {
    var u = o + (a & v | n & ~v) + (h >>> 0) + r;
    return (u << l | u >>> 32 - l) + a;
  }, c._hh = function(o, a, n, v, h, l, r) {
    var u = o + (a ^ n ^ v) + (h >>> 0) + r;
    return (u << l | u >>> 32 - l) + a;
  }, c._ii = function(o, a, n, v, h, l, r) {
    var u = o + (n ^ (a | ~v)) + (h >>> 0) + r;
    return (u << l | u >>> 32 - l) + a;
  }, c._blocksize = 16, c._digestsize = 16, H2.exports = function(o, a) {
    if (o == null)
      throw new Error("Illegal argument " + o);
    var n = e.wordsToBytes(c(o, a));
    return a && a.asBytes ? n : a && a.asString ? i.bytesToString(n) : e.bytesToHex(n);
  };
})();
const Y2 = {
  name: "NiceAvatar",
  ...
  computed: {
    gradientSvg() {
      return R2(A0(this.hash || this.text));
    },
    safeString() {
  ...
  key: 0,
  class: "status"
}, Q2 = ["innerHTML"], K2 = ["src"], G2 = ["src"], X2 = {
  key: 4,
  class: "text"
};
function J2(e, s, t, i, c, o) {
  return d(), m("div", {
    class: B(["nice-avatar", [
      t.size ? "size-" + t.size : "",
    ...
    t.text ? (d(), m("div", X2, z(o.safeString), 1)) : f("", !0)
  ], 2);
}
const e4 = /* @__PURE__ */ O(Y2, [["render", J2]]);
const t4 = {
  name: "NiceCheckbox",
  props: {
    modelValue: {
...
}, s4 = (e) => (k0("data-v-fa1b17bc"), e = e(), N0(), e), c4 = { class: "nice-checkbox-box" }, o4 = {
  key: 0,
  viewBox: "0 0 20 20"
}, i4 = /* @__PURE__ */ s4(() => /* @__PURE__ */ b("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), n4 = [
  i4
], l4 = ["for"], a4 = ["id"];
function r4(e, s, t, i, c, o) {
  return d(), m("div", {
    class: B(["nice-component nice-checkbox", { "no-margin": t.noMargin, active: o.localValue }]),
    onClick: s[0] || (s[0] = (...a) => o.toggleValue && o.toggleValue(...a))
  }, [
    b("div", c4, [
      o.localValue ? (d(), m("svg", o4, n4)) : f("", !0)
    ]),
    t.title ? (d(), m("div", {
      key: 0,
...
const L1 = /* @__PURE__ */ O(t4, [["render", r4], ["__scopeId", "data-v-fa1b17bc"]]);
const h4 = {
...
function m4(e, s, t, i, c, o) {
  return t.title || t.caption ? (d(), m("div", d4, [
    t.title ? (d(), m("div", u4, [
      d0(z(t.title) + " ", 1),
      t.required ? (d(), m("span", v4, " *")) : f("", !0)
    ])) : f("", !0),
    t.caption ? (d(), m("div", p4, z(t.caption), 1)) : f("", !0)
  ])) : f("", !0);
}
const b0 = /* @__PURE__ */ O(h4, [["render", m4], ["__scopeId", "data-v-b2f23a24"]]);
var j = "top", Q = "bottom", K = "right", W = "left", R0 = "auto", V0 = [j, Q, K, W], m0 = "start", C0 = "end", f4 = "clippingParents", R1 = "viewport", w0 = "popper", y4 = "reference", x1 = /* @__PURE__ */ V0.reduce(function(e, s) {
  return e.concat([s + "-" + m0, s + "-" + C0]);
}, []), H1 = /* @__PURE__ */ [].concat(V0, [R0]).reduce(function(e, s) {
  return e.concat([s, s + "-" + m0, s + "-" + C0]);
}, []), M4 = "beforeRead", b4 = "read", g4 = "afterRead", z4 = "beforeMain", w4 = "main", _4 = "afterMain", x4 = "beforeWrite", C4 = "write", B4 = "afterWrite", J0 = [M4, b4, g4, z4, w4, _4, x4, C4, B4];
function e0(e) {
...
function k4(e) {
  ...
  Object.keys(s.elements).forEach(function(t) {
    ...
    !Y(o) || !e0(o) || (Object.assign(o.style, i), Object.keys(c).forEach(function(a) {
      var n = c[a];
      n === !1 ? o.removeAttribute(a) : o.setAttribute(a, n === !0 ? "" : n);
    }));
  });
}
function N4(e) {
  ...
  return Object.assign(s.elements.popper.style, t.popper), s.styles = t, s.elements.arrow && Object.assign(s.elements.arrow.style, t.arrow), function() {
    Object.keys(s.elements).forEach(function(i) {
      var c = s.elements[i], o = s.attributes[i] || {}, a = Object.keys(s.styles.hasOwnProperty(i) ? s.styles[i] : t[i]), n = a.reduce(function(v, h) {
        return v[h] = "", v;
      }, {});
      !Y(c) || !e0(c) || (Object.assign(c.style, n), Object.keys(o).forEach(function(v) {
        c.removeAttribute(v);
      }));
    });
  };
...
function y0(e, s, t) {
  ...
  var a = u0(e) ? Z(e) : window, n = a.visualViewport, v = !j1() && t, h = (i.left + (v && n ? n.offsetLeft : 0)) / c, l = (i.top + (v && n ? n.offsetTop : 0)) / o, r = i.width / c, u = i.height / o;
  return {
    width: r,
    height: u,
    top: l,
...
function O0(e) {
  for (var s = Z(e), t = C1(e); t && V4(t) && J(t).position === "static"; )
    t = C1(t);
  return t && (e0(t) === "html" || e0(t) === "body" && J(t).position === "static") ? s : t || O4(e) || s;
}
function i1(e) {
...
var T4 = function(s, t) {
  ...
  })) : s, Y1(typeof s != "number" ? s : Z1(s, V0));
};
function P4(e) {
  var s, t = e.state, i = e.name, c = e.options, o = t.elements.arrow, a = t.modifiersData.popperOffsets, n = X(t.placement), v = i1(n), h = [W, K].indexOf(n) >= 0, l = h ? "height" : "width";
  if (!(!o || !a)) {
    var r = T4(c.padding, t), u = o1(o), p = v === "y" ? j : W, M = v === "y" ? Q : K, y = t.rects.reference[l] + t.rects.reference[v] - a[v] - t.rects.popper[l], g = a[v] - t.rects.reference[v], x = O0(o), P = x ? v === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, D = y / 2 - g / 2, C = r[p], N = P - u[l] - r[M], k = P / 2 - u[l] / 2 + D, T = _0(C, k, N), I = v;
    t.modifiersData[i] = (s = {}, s[I] = T, s.centerOffset = T - k, s);
  }
}
function E4(e) {
  ...
  if (c != null && !(typeof c == "string" && (c = s.elements.popper.querySelector(c), !c))) {
    if (process.env.NODE_ENV !== "production" && (Y(c) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !W1(s.elements.popper, c)) {
...
function B1(e) {
  var s, t = e.popper, i = e.popperRect, c = e.placement, o = e.variation, a = e.offsets, n = e.position, v = e.gpuAcceleration, h = e.adaptive, l = e.roundOffsets, r = e.isFixed, u = a.x, p = u === void 0 ? 0 : u, M = a.y, y = M === void 0 ? 0 : M, g = typeof l == "function" ? l({
    x: p,
    y
  }) : {
    x: p,
  ...
  p = g.x, y = g.y;
  var x = a.hasOwnProperty("x"), P = a.hasOwnProperty("y"), D = W, C = j, N = window;
  if (h) {
    var k = O0(t), T = "clientHeight", I = "clientWidth";
    if (k === Z(t) && (k = c0(t), J(k).position !== "static" && n === "absolute" && (T = "scrollHeight", I = "scrollWidth")), k = k, c === j || (c === W || c === K) && o === C0) {
      C = Q;
  ...
  if (p = A.x, y = A.y, v) {
    var L;
    return Object.assign({}, S, (L = {}, L[C] = P ? "0" : "", L[D] = x ? "0" : "", L.transform = (N.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + y + "px)" : "translate3d(" + p + "px, " + y + "px, 0)", L));
  }
  return Object.assign({}, S, (s = {}, s[C] = P ? y + "px" : "", s[D] = x ? p + "px" : "", s.transform = "", s));
}
function F4(e) {
  var s = e.state, t = e.options, i = t.gpuAcceleration, c = i === void 0 ? !0 : i, o = t.adaptive, a = o === void 0 ? !0 : o, n = t.roundOffsets, v = n === void 0 ? !0 : n;
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
  ...
  s.modifiersData.popperOffsets != null && (s.styles.popper = Object.assign({}, s.styles.popper, B1(Object.assign({}, l, {
    offsets: s.modifiersData.popperOffsets,
    position: s.options.strategy,
    adaptive: a,
    roundOffsets: v
  })))), s.modifiersData.arrow != null && (s.styles.arrow = Object.assign({}, s.styles.arrow, B1(Object.assign({}, l, {
...
function L4(e) {
  var s = e.state, t = e.instance, i = e.options, c = i.scroll, o = c === void 0 ? !0 : c, a = i.resize, n = a === void 0 ? !0 : a, v = Z(s.elements.popper), h = [].concat(s.scrollParents.reference, s.scrollParents.popper);
  return o && h.forEach(function(l) {
    l.addEventListener("scroll", t.update, $0);
  }), n && v.addEventListener("resize", t.update, $0), function() {
    o && h.forEach(function(l) {
      l.removeEventListener("scroll", t.update, $0);
    }), n && v.removeEventListener("resize", t.update, $0);
  };
}
const R4 = {
  name: "eventListeners",
...
function W4(e, s) {
  var t = Z(e), i = c0(e), c = t.visualViewport, o = i.clientWidth, a = i.clientHeight, n = 0, v = 0;
  if (c) {
    o = c.width, a = c.height;
    var h = j1();
    (h || !h && s === "fixed") && (n = c.offsetLeft, v = c.offsetTop);
  }
  return {
    width: o,
    height: a,
...
function U4(e) {
  var s, t = c0(e), i = n1(e), c = (s = e.ownerDocument) == null ? void 0 : s.body, o = h0(t.scrollWidth, t.clientWidth, c ? c.scrollWidth : 0, c ? c.clientWidth : 0), a = h0(t.scrollHeight, t.clientHeight, c ? c.scrollHeight : 0, c ? c.clientHeight : 0), n = -i.scrollLeft + l1(e), v = -i.scrollTop;
  return J(c || t).direction === "rtl" && (n += h0(t.clientWidth, c ? c.clientWidth : 0) - o), {
    width: o,
    height: a,
    x: n,
    y: v
...
function Q1(e) {
  return ["html", "body", "#document"].indexOf(e0(e)) >= 0 ? e.ownerDocument.body : Y(e) && a1(e) ? e : Q1(H0(e));
}
function x0(e, s) {
  var t;
  s === void 0 && (s = []);
  var i = Q1(e), c = i === ((t = e.ownerDocument) == null ? void 0 : t.body), o = Z(i), a = c ? [o].concat(o.visualViewport || [], a1(i) ? i : []) : i, n = s.concat(a);
  return c ? n : (
...
function N1(e, s, t) {
  return s === R1 ? t1(W4(e, t)) : u0(s) ? Y4(s, t) : t1(U4(c0(e)));
}
function Z4(e) {
  var s = x0(H0(e)), t = ["absolute", "fixed"].indexOf(J(e).position) >= 0, i = t && Y(e) ? O0(e) : e;
  return u0(i) ? s.filter(function(c) {
    return u0(c) && W1(c, i) && e0(c) !== "body";
  }) : [];
}
function Q4(e, s, t, i) {
  var c = s === "clippingParents" ? Z4(e) : [].concat(s), o = [].concat(c, [t]), a = o[0], n = o.reduce(function(v, h) {
    var l = N1(e, h, i);
    return v.top = h0(l.top, v.top), v.right = L0(l.right, v.right), v.bottom = L0(l.bottom, v.bottom), v.left = h0(l.left, v.left), v;
  }, N1(e, a, i));
  return n.width = n.right - n.left, n.height = n.bottom - n.top, n.x = n.left, n.y = n.top, n;
}
function K1(e) {
  var s = e.reference, t = e.element, i = e.placement, c = i ? X(i) : null, o = i ? M0(i) : null, a = s.x + s.width / 2 - t.width / 2, n = s.y + s.height / 2 - t.height / 2, v;
  switch (c) {
    case j:
      v = {
        x: a,
...
function B0(e, s) {
  s === void 0 && (s = {});
  var t = s, i = t.placement, c = i === void 0 ? e.placement : i, o = t.strategy, a = o === void 0 ? e.strategy : o, n = t.boundary, v = n === void 0 ? f4 : n, h = t.rootBoundary, l = h === void 0 ? R1 : h, r = t.elementContext, u = r === void 0 ? w0 : r, p = t.altBoundary, M = p === void 0 ? !1 : p, y = t.padding, g = y === void 0 ? 0 : y, x = Y1(typeof g != "number" ? g : Z1(g, V0)), P = u === w0 ? y4 : w0, D = e.rects.popper, C = e.elements[M ? P : u], N = Q4(u0(C) ? C : C.contextElement || c0(e.elements.popper), v, l, a), k = y0(e.elements.reference), T = K1({
    reference: k,
    element: D,
    strategy: "absolute",
    placement: c
  }), I = t1(Object.assign({}, D, T)), $ = u === w0 ? I : k, q = {
    top: N.top - $.top + x.top,
    bottom: $.bottom - N.bottom + x.bottom,
    left: N.left - $.left + x.left,
    right: $.right - N.right + x.right
  }, S = e.modifiersData.offset;
  if (u === w0 && S) {
    var A = S[c];
    Object.keys(q).forEach(function(L) {
      var o0 = [K, Q].indexOf(L) >= 0 ? 1 : -1, i0 = [j, Q].indexOf(L) >= 0 ? "y" : "x";
      q[L] += A[i0] * o0;
    });
  }
  return q;
...
function K4(e, s) {
  s === void 0 && (s = {});
  var t = s, i = t.placement, c = t.boundary, o = t.rootBoundary, a = t.padding, n = t.flipVariations, v = t.allowedAutoPlacements, h = v === void 0 ? H1 : v, l = M0(i), r = l ? n ? x1 : x1.filter(function(M) {
    return M0(M) === l;
  }) : V0, u = r.filter(function(M) {
    return h.indexOf(M) >= 0;
  });
  u.length === 0 && (u = r, process.env.NODE_ENV !== "production" && console.error(["Popper: The `allowedAutoPlacements` option did not allow any", "placements. Ensure the `placement` option matches the variation", "of the allowed placements.", 'For example, "auto" cannot be used to allow "bottom-start".', 'Use "auto-start" instead.'].join(" ")));
  var p = u.reduce(function(M, y) {
    return M[y] = B0(e, {
      placement: y,
      boundary: c,
      rootBoundary: o,
...
function X4(e) {
  ...
  if (!s.modifiersData[i]._skip) {
    for (var c = t.mainAxis, o = c === void 0 ? !0 : c, a = t.altAxis, n = a === void 0 ? !0 : a, v = t.fallbackPlacements, h = t.padding, l = t.boundary, r = t.rootBoundary, u = t.altBoundary, p = t.flipVariations, M = p === void 0 ? !0 : p, y = t.allowedAutoPlacements, g = s.options.placement, x = X(g), P = x === g, D = v || (P || !M ? [q0(g)] : G4(g)), C = [g].concat(D).reduce(function(v0, t0) {
      return v0.concat(X(t0) === R0 ? K4(s, {
        placement: t0,
        boundary: l,
        rootBoundary: r,
        padding: h,
      ...
      var S = C[q], A = X(S), L = M0(S) === m0, o0 = [j, Q].indexOf(A) >= 0, i0 = o0 ? "width" : "height", U = B0(s, {
        placement: S,
        boundary: l,
        rootBoundary: r,
        altBoundary: u,
      ...
      N[i0] > k[i0] && (G = q0(G));
      var D0 = q0(G), n0 = [];
      if (o && n0.push(U[A] <= 0), n && n0.push(U[G] <= 0, U[D0] <= 0), n0.every(function(v0) {
        return v0;
      })) {
        $ = S, I = !1;
        break;
    ...
    if (I)
      for (var T0 = M ? 3 : 1, U0 = function(t0) {
...
function e3(e) {
  var s = e.state, t = e.name, i = s.rects.reference, c = s.rects.popper, o = s.modifiersData.preventOverflow, a = B0(s, {
    elementContext: "reference"
  }), n = B0(s, {
    altBoundary: !0
  }), v = S1(a, i), h = S1(n, c, o), l = V1(v), r = V1(h);
  s.modifiersData[t] = {
...
function s3(e, s, t) {
  var i = X(e), c = [W, j].indexOf(i) >= 0 ? -1 : 1, o = typeof t == "function" ? t(Object.assign({}, s, {
    placement: e
  })) : t, a = o[0], n = o[1];
  return a = a || 0, n = (n || 0) * c, [W, K].indexOf(i) >= 0 ? {
    x: n,
    y: a
  } : {
    x: a,
...
function c3(e) {
  var s = e.state, t = e.options, i = e.name, c = t.offset, o = c === void 0 ? [0, 0] : c, a = H1.reduce(function(l, r) {
    return l[r] = s3(r, s.rects, o), l;
  }, {}), n = a[s.placement], v = n.x, h = n.y;
  s.modifiersData.popperOffsets != null && (s.modifiersData.popperOffsets.x += v, s.modifiersData.popperOffsets.y += h), s.modifiersData[i] = a;
}
const o3 = {
  name: "offset",
  enabled: !0,
...
function a3(e) {
  var s = e.state, t = e.options, i = e.name, c = t.mainAxis, o = c === void 0 ? !0 : c, a = t.altAxis, n = a === void 0 ? !1 : a, v = t.boundary, h = t.rootBoundary, l = t.altBoundary, r = t.padding, u = t.tether, p = u === void 0 ? !0 : u, M = t.tetherOffset, y = M === void 0 ? 0 : M, g = B0(s, {
    boundary: v,
    rootBoundary: h,
    padding: r,
    altBoundary: l
  }), x = X(s.placement), P = M0(s.placement), D = !P, C = i1(x), N = l3(C), k = s.modifiersData.popperOffsets, T = s.rects.reference, I = s.rects.popper, $ = typeof y == "function" ? y(Object.assign({}, s.rects, {
    placement: s.placement
  })) : y, q = typeof $ == "number" ? {
    mainAxis: $,
    altAxis: $
    ...
    mainAxis: 0,
    altAxis: 0
  }, $), S = s.modifiersData.offset ? s.modifiersData.offset[s.placement] : null, A = {
    x: 0,
    y: 0
  };
  if (k) {
    if (o) {
      var L, o0 = C === "y" ? j : W, i0 = C === "y" ? Q : K, U = C === "y" ? "height" : "width", G = k[C], D0 = G + g[o0], n0 = G - g[i0], T0 = p ? -I[U] / 2 : 0, U0 = P === m0 ? T[U] : I[U], g0 = P === m0 ? -I[U] : -T[U], P0 = s.elements.arrow, v0 = p && P0 ? o1(P0) : {
        width: 0,
        height: 0
      }, t0 = s.modifiersData["arrow#persistent"] ? s.modifiersData["arrow#persistent"].padding : U1(), z0 = t0[o0], E0 = t0[i0], l0 = _0(0, T[U], v0[U]), Y0 = D ? T[U] / 2 - T0 - l0 - z0 - q.mainAxis : U0 - l0 - z0 - q.mainAxis, X1 = D ? -T[U] / 2 + T0 + l0 + E0 + q.mainAxis : g0 + l0 + E0 + q.mainAxis, Z0 = s.elements.arrow && O0(s.elements.arrow), J1 = Z0 ? C === "y" ? Z0.clientTop || 0 : Z0.clientLeft || 0 : 0, u1 = (L = S == null ? void 0 : S[C]) != null ? L : 0, e2 = G + Y0 - u1 - J1, t2 = G + X1 - u1, v1 = _0(p ? L0(D0, e2) : D0, G, p ? h0(n0, t2) : n0);
      k[C] = v1, A[C] = v1 - G;
    }
    if (n) {
      var p1, s2 = C === "x" ? j : W, c2 = C === "x" ? Q : K, a0 = k[N], I0 = N === "y" ? "height" : "width", m1 = a0 + g[s2], f1 = a0 - g[c2], Q0 = [j, W].indexOf(x) !== -1, y1 = (p1 = S == null ? void 0 : S[N]) != null ? p1 : 0, M1 = Q0 ? m1 : a0 - T[I0] - I[I0] - y1 + q.altAxis, b1 = Q0 ? a0 + T[I0] + I[I0] - y1 - q.altAxis : f1, g1 = p && Q0 ? D4(M1, a0, b1) : _0(p ? M1 : m1, a0, p ? b1 : f1);
      k[N] = g1, A[N] = g1 - a0;
    }
    s.modifiersData[i] = A;
  }
...
function v3(e, s, t) {
  t === void 0 && (t = !1);
  var i = Y(s), c = Y(s) && u3(s), o = c0(s), a = y0(e, c, t), n = {
    scrollLeft: 0,
    scrollTop: 0
  }, v = {
    x: 0,
  ...
  a1(o)) && (n = d3(s)), Y(s) ? (v = y0(s, !0), v.x += s.clientLeft, v.y += s.clientTop) : o && (v.x = l1(o))), {
    x: a.left + n.scrollLeft - v.x,
    y: a.top + n.scrollTop - v.y,
    width: a.width,
    height: a.height
  };
}
...
var r0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', y3 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', O1 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function M3(e) {
  e.forEach(function(s) {
    [].concat(Object.keys(s), O1).filter(function(t, i, c) {
      ...
      switch (t) {
        ...
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + s.name + '" modifier, valid properties are ' + O1.map(function(i) {
            return '"' + i + '"';
      ...
      s.requires && s.requires.forEach(function(i) {
        e.find(function(c) {
          return c.name === i;
        }) == null && console.error(s0(y3, String(s.name), i, i));
      });
    });
  });
}
...
var D1 = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.", z3 = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.", T1 = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
};
...
function w3(e) {
  e === void 0 && (e = {});
  var s = e, t = s.defaultModifiers, i = t === void 0 ? [] : t, c = s.defaultOptions, o = c === void 0 ? T1 : c;
  return function(n, v, h) {
    h === void 0 && (h = o);
    var l = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, T1, o),
      modifiersData: {},
      elements: {
        reference: n,
        popper: v
      ...
      setOptions: function(x) {
        var P = typeof x == "function" ? x(l.options) : x;
        y(), l.options = Object.assign({}, o, l.options, P), l.scrollParents = {
          reference: u0(n) ? x0(n) : n.contextElement ? x0(n.contextElement) : [],
          popper: x0(v)
        };
        var D = m3(g3([].concat(i, l.options.modifiers)));
        if (l.orderedModifiers = D.filter(function(S) {
          return S.enabled;
        }), process.env.NODE_ENV !== "production") {
          var C = b3([].concat(D, l.options.modifiers), function(S) {
            var A = S.name;
            return A;
          });
          if (M3(C), X(l.options.placement) === R0) {
          ...
          var k = J(v), T = k.marginTop, I = k.marginRight, $ = k.marginBottom, q = k.marginLeft;
          [T, I, $, q].some(function(S) {
            return parseFloat(S);
      ...
      forceUpdate: function() {
        if (!u) {
          var x = l.elements, P = x.reference, D = x.popper;
          if (!P1(P, D)) {
            process.env.NODE_ENV !== "production" && console.error(D1);
            return;
          }
          l.rects = {
            reference: v3(P, O0(D), l.options.strategy === "fixed"),
            popper: o1(D)
    ...
    if (!P1(n, v))
      return process.env.NODE_ENV !== "production" && console.error(D1), p;
    p.setOptions(h).then(function(g) {
      !u && h.onFirstUpdate && h.onFirstUpdate(g);
    });
    function M() {
      l.orderedModifiers.forEach(function(g) {
        var x = g.name, P = g.options, D = P === void 0 ? {} : P, C = g.effect;
...
var _3 = [R4, n3, A4, S4, o3, J4, r3, I4, t3], x3 = /* @__PURE__ */ w3({
  defaultModifiers: _3
});
const C3 = {
  name: "NicePopup",
  ...
  mounted() {
    ...
    }), this.popper = x3(this.$refs.trigger, this.$refs.content, {
      strategy: "fixed",
...
function N3(e, s, t, i, c, o) {
  return d(), m("div", {
    ...
    b("div", {
      ...
      ref: "trigger",
      onClick: s[0] || (s[0] = (...a) => o.toggle && o.toggle(...a)),
      onMouseover: s[1] || (s[1] = (...a) => o.handleFocus && o.handleFocus(...a)),
      onMouseleave: s[2] || (s[2] = (...a) => o.handleBlur && o.handleBlur(...a))
    }, [
      E(e.$slots, "trigger", {}, void 0, !0)
    ], 544),
    p0(b("div", B3, [
      p0(b("div", k3, null, 512), [
        [z1, t.showArrow]
      ]),
      b("div", {
...
const j0 = /* @__PURE__ */ O(C3, [["render", N3], ["__scopeId", "data-v-80b46807"]]), r1 = h2({
  defaultLanguage: "en",
  mutedLanguages: ["en"]
});
const { $gettext: S3 } = r1, V3 = {
  name: "NiceDate",
  components: {
    NicePopup: j0,
...
}, h1 = (e) => (k0("data-v-71d63255"), e = e(), N0(), e), O3 = { class: "input-group" }, D3 = ["placeholder", "disabled", "required"], T3 = { class: "nice-dropdown" }, P3 = { class: "month-wrapper" }, E3 = { class: "value" }, I3 = { class: "year" }, $3 = { class: "month" }, q3 = { class: "calendar" }, F3 = { class: "header" }, A3 = { class: "month" }, L3 = ["onClick", "title"], R3 = {
  key: 0,
  class: "time"
}, H3 = { class: "select-wrapper" }, j3 = /* @__PURE__ */ h1(() => /* @__PURE__ */ b("div", { class: "arrow-down" }, null, -1)), W3 = ["value", "selected"], U3 = /* @__PURE__ */ h1(() => /* @__PURE__ */ b("div", null, ":", -1)), Y3 = { class: "select-wrapper" }, Z3 = /* @__PURE__ */ h1(() => /* @__PURE__ */ b("div", { class: "arrow-down" }, null, -1)), Q3 = ["value", "selected"];
function K3(e, s, t, i, c, o) {
  const a = w("NiceComponentHeader"), n = w("NiceIcon"), v = w("NiceButton"), h = w("NicePopup");
  return d(), m("div", {
      ...
      content: H(() => [
        b("div", T3, [
          b("div", P3, [
            ...
            b("div", E3, [
              b("div", I3, z(c.selected.getFullYear()), 1),
              b("div", $3, z(c.monthNames[c.selected.getMonth() + 1]), 1)
            ]),
            _(v, {
              class: "right",
          ...
          b("div", q3, [
            b("div", F3, [
              b("div", null, z(c.dayNames[1]), 1),
              b("div", null, z(c.dayNames[2]), 1),
              b("div", null, z(c.dayNames[3]), 1),
              b("div", null, z(c.dayNames[4]), 1),
              b("div", null, z(c.dayNames[5]), 1),
              b("div", null, z(c.dayNames[6]), 1),
              b("div", null, z(c.dayNames[7]), 1)
            ]),
            b("div", A3, [
              (d(!0), m(F, null, R(c.days, (l) => (d(), m("div", {
                class: B(["day", {
                  "previous-month": !l.currentMonth,
                  today: l.today,
                  selected: l.selected
                }]),
                onClick: (r) => o.dayChanged(l),
                title: l.text,
                key: l.id
              }, z(l.day), 11, L3))), 128))
            ])
          ...
          t.time ? (d(), m("div", R3, [
            b("div", H3, [
              ...
              b("select", {
                ...
                (d(!0), m(F, null, R(c.hours, (l) => (d(), m("option", {
                  value: l,
                  key: l,
            ...
            b("div", Y3, [
              ...
              b("select", {
                ...
                (d(!0), m(F, null, R(c.minutes, (l) => (d(), m("option", {
                  value: l,
                  key: l,
...
const G3 = /* @__PURE__ */ O(V3, [["render", K3], ["__scopeId", "data-v-71d63255"]]);
const X3 = {
  name: "NiceIcon",
  props: {
    icon: {
...
}, J3 = { class: "nice-icon" }, e7 = ["xlink:href"];
function t7(e, s, t, i, c, o) {
  return d(), m("svg", J3, [
    b("use", {
      "xlink:href": "#" + t.icon
    }, null, 8, e7)
...
const W0 = /* @__PURE__ */ O(X3, [["render", t7], ["__scopeId", "data-v-40da5ac0"]]);
const { $gettext: s7 } = r1, c7 = {
...
}, o7 = { class: "input-group" }, i7 = ["required", "disabled", "modelValue"], n7 = ["selected"], l7 = ["value"], a7 = {
  key: 0,
  class: "no-options"
}, r7 = ["disabled"];
function h7(e, s, t, i, c, o) {
  const a = w("NiceComponentHeader"), n = w("NiceLoading"), v = w("NiceIcon");
  return d(), m("div", {
    ...
    b("div", o7, [
      b("div", {
        class: B(["select-wrapper", { "no-value": o.localValue == null }])
      }, [
        b("select", {
          required: t.required,
          disabled: t.disabled,
          modelValue: o.localValue,
          onChange: s[0] || (s[0] = (...h) => o.handleChange && o.handleChange(...h))
        }, [
          t.nullable ? (d(), m("option", {
            key: 0,
            value: null,
            selected: !o.localValue
          }, z(t.nullText), 9, n7)) : f("", !0),
          (d(!0), m(F, null, R(t.values, (h) => (d(), m("option", {
            value: h[t.keyName],
            key: h[t.keyName]
          }, z(h[t.valueName]), 9, l7))), 128))
        ], 40, i7),
        !t.nullable && !t.loading && (!t.values || t.values.length == 0) ? (d(), m("div", a7, z(e.$gettext("No options")), 1)) : f("", !0),
        t.loading ? (d(), V(n, {
          key: 1,
          class: "no-options"
        })) : f("", !0),
...
const d7 = /* @__PURE__ */ O(c7, [["render", h7], ["__scopeId", "data-v-1ddb5f1a"]]);
const u7 = {
  name: "NiceLoading",
  props: {
    message: {
...
}, v7 = { class: "nice-loading-wrapper" }, p7 = {
  key: 0,
  class: "nice-loading-message"
};
function m7(e, s, t, i, c, o) {
  const a = w("NiceIcon");
  return d(), m("div", {
    class: B(["nice-loading", [t.size ? "nice-loading-" + t.size : "", { "full-div": t.fullDiv }]])
  }, [
    b("div", v7, [
      _(a, { icon: "icon-half-loading" }),
      _(a, { icon: "icon-half-loading" })
    ]),
    t.message ? (d(), m("div", p7, z(t.message), 1)) : f("", !0)
  ], 2);
}
const d1 = /* @__PURE__ */ O(u7, [["render", m7], ["__scopeId", "data-v-7c7a02c1"]]);
const { $gettext: f7 } = r1, y7 = {
  name: "NiceDropdown",
  components: {
    NicePopup: j0,
    NiceLoading: d1,
...
}, M7 = { class: "nice-dropdown-wrapper" }, b7 = { class: "input-group" }, g7 = { class: "select-wrapper" }, z7 = ["required", "value"], w7 = {
  key: 0,
  class: "option"
}, _7 = {
  key: 1,
  ...
  key: 2,
  class: "no-options"
}, C7 = { class: "nice-dropdown-popup" }, B7 = {
  key: 0,
  class: "input-group"
}, k7 = ["placeholder", "name"], N7 = { class: "list" }, S7 = ["onClick"], V7 = {
  key: 1,
  class: "element no-options"
};
function O7(e, s, t, i, c, o) {
  const a = w("NiceComponentHeader"), n = w("NiceIcon"), v = w("NiceLoading"), h = w("NicePopup"), l = w("NiceButton");
  return d(), m("div", {
    class: B(["nice-component nice-dropdown", {
      disabled: t.disabled,
      "no-margin": t.noMargin,
      "can-clear": o.canClear,
      "has-value": t.modelValue
    }])
  }, [
    _(a, {
    ...
    b("div", M7, [
      _(h, {
            ...
            b("div", g7, [
              b("div", {
                ...
                b("input", {
                  ...
                  onKeypress: s[2] || (s[2] = (...r) => o.onKeypress && o.onKeypress(...r))
                }, null, 40, z7),
                !t.loading && t.modelValue ? (d(), m("div", w7, [
                  E(e.$slots, "selected-option", { item: t.modelValue }, () => [
                    d0(z(t.formatFunction ? t.formatFunction(t.modelValue) : o.localValue[t.valueName]), 1)
                  ], !0)
                ])) : f("", !0),
                !t.loading && !t.modelValue ? (d(), m("div", _7, z(t.nullText), 1)) : f("", !0),
                t.loading ? (d(), m("div", x7, z(e.$gettext("Loading")), 1)) : f("", !0),
                _(n, {
                  class: "arrow-down",
                  icon: "icon-chevron-down"
                }),
        ...
        content: H(() => [
          b("div", C7, [
            t.searchFunction && !t.noSearch ? (d(), m("div", B7, [
              p0(b("input", {
                "onUpdate:modelValue": s[3] || (s[3] = (r) => c.search = r),
                type: "text",
                placeholder: e.$gettext("Search..."),
                name: e.$gettext("Search"),
                onInput: s[4] || (s[4] = (...r) => o.handleSearch && o.handleSearch(...r)),
                ref: "search"
              }, null, 40, k7), [
                [s1, c.search]
              ]),
              c.innerLoading ? (d(), V(v, {
                key: 0,
                class: "loading"
              })) : f("", !0)
            ])) : f("", !0),
            b("div", N7, [
              t.nullable ? (d(), m("div", {
                ...
                onClick: s[5] || (s[5] = (r) => o.handleChange(void 0))
              }, z(t.nullText), 3)) : f("", !0),
              (d(!0), m(F, null, R(c.innerValues, (r, u) => (d(), m("div", {
                class: B(["element", {
                  hover: c.innerIndex == u,
                  selected: t.modelValue && r[t.keyName] == o.localValue[t.keyName]
                }]),
                key: r[t.keyName],
                onClick: (p) => o.handleChange(r)
              }, [
                E(e.$slots, "option", { item: r }, () => [
                  d0(z(t.formatFunction ? t.formatFunction(r) : r[t.valueName]), 1)
                ], !0)
              ], 10, S7))), 128)),
              !c.innerLoading && (!c.innerValues || c.innerValues.length == 0) ? (d(), m("div", V7, z(e.$gettext("No options")), 1)) : f("", !0)
            ])
          ])
        ]),
        _: 3
...
const D7 = /* @__PURE__ */ O(y7, [["render", O7], ["__scopeId", "data-v-eb9b75f3"]]);
const T7 = {
  name: "NiceFilters",
  props: {
    // filters: {
  ...
  methods: {
    getFormattedValue(e) {
      var s, t;
      return e.formatter ? e.formatter(e.value) : e.type == "date" ? this.$formatDateWithTime(e.value) : e.type == "boolean" ? e.value ? this.$gettext("Yes") : this.$gettext("No") : e.valueName ? e.value[e.valueName] : (s = e.value) != null && s.name ? e.value.name : (t = e.value) != null && t.value ? e.value.value : e.value;
    },
    getFilterValue(e) {
      var s;
    ...
    async getQuery() {
      ...
      this.filters.forEach(async (s) => {
        const t = e[s.key];
        if (s.type == "yesno") {
          let i = this.yesNo.find(
            (c) => c.id == e[s.key]
          );
          e[s.key] || (i = null), s.value = i;
        } else if (s.type == "date")
          s.value = new Date(t);
        else if (s.type == "boolean")
          s.value = t == "true";
        else if (s.type == "select" && s.fetch) {
          const i = await s.fetch(t);
          s.value = i;
        } else
...
}, P7 = (e) => (k0("data-v-638892c3"), e = e(), N0(), e), E7 = { class: "nice-filters-wrapper" }, I7 = { class: "nice-component nice-filters" }, $7 = {
  key: 0,
  class: "nice-filters-options"
}, q7 = /* @__PURE__ */ P7(() => /* @__PURE__ */ b("div", { class: "f-grow" }, null, -1)), F7 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, A7 = ["title"];
function L7(e, s, t, i, c, o) {
  const a = w("NiceInput"), n = w("NiceSwitch"), v = w("NiceDate"), h = w("NiceDropdown"), l = w("NiceButton");
  return d(), m("div", E7, [
    b("div", I7, [
      _(a, {
        title: e.$gettext("Search"),
        placeholder: e.$gettext("Search..."),
        icon: "icon-search",
        modelValue: c.search,
      ...
      c.filters ? (d(), m("div", $7, [
        (d(!0), m(F, null, R(c.filters, (r) => (d(), m("div", {
          class: "nice-filters-filter",
          key: r.key
        }, [
          r.type == "boolean" ? (d(), V(n, {
            key: 0,
            modelValue: r.value,
    ...
    t.showPills && o.pills && o.pills.length ? (d(), m("div", F7, [
      (d(!0), m(F, null, R(o.pills, (r) => (d(), m("div", {
        class: "nice-filters-pill badge badge-primary",
        key: r.key,
        title: r.description
      }, [
        b("div", null, [
          b("small", null, z(r.name), 1),
          b("div", null, z(o.getFormattedValue(r)), 1)
        ]),
        _(l, {
          icon: "icon-x",
          onClick: (u) => o.clearFilter(r)
        }, null, 8, ["onClick"])
      ], 8, A7))), 128))
    ])) : f("", !0)
  ]);
}
const R7 = /* @__PURE__ */ O(T7, [["render", L7], ["__scopeId", "data-v-638892c3"]]);
var H7 = j7;
function j7(e, s, t) {
  if (!e)
    return t;
...
const W7 = {
  ...
  computed: {
    ...
    errorMessage() {
      const e = H7(this.error, ["response", "data", this.prop]);
...
}, U7 = { class: "input-group" }, Y7 = {
  key: 0,
  class: "input-group-suffix"
}, Z7 = ["placeholder", "autocomplete", "type", "required"], Q7 = {
  key: 1,
...
function J7(e, s, t, i, c, o) {
  const a = w("NiceComponentHeader"), n = w("NiceIcon");
  return d(), m("div", {
    class: B(["nice-component nice-input", { "no-margin": t.noMargin, active: o.localValue }])
  }, [
    _(a, {
      title: t.title,
      required: t.required,
    ...
    b("div", U7, [
      e.$slots.suffix ? (d(), m("div", Y7, [
        E(e.$slots, "suffix", {}, void 0, !0)
      ])) : f("", !0),
      p0(b("input", {
        "onUpdate:modelValue": s[0] || (s[0] = (v) => o.localValue = v),
        placeholder: t.placeholder,
      ...
      e.$slots.append ? (d(), m("div", K7, [
        E(e.$slots, "append", {}, void 0, !0)
      ])) : f("", !0)
    ]),
    t.message ? (d(), m("div", G7, z(t.message), 1)) : f("", !0),
    o.errorMessage ? (d(), m("div", X7, z(o.errorMessage), 1)) : f("", !0)
  ], 2);
}
const e8 = /* @__PURE__ */ O(W7, [["render", J7], ["__scopeId", "data-v-6d70cec3"]]);
const t8 = {
...
function i8(e, s, t, i, c, o) {
  ...
  return d(), m("div", {
    ...
    t.notification.icon ? (d(), V(a, {
      key: 0,
      class: "notification-icon",
      icon: t.notification.icon
    }, null, 8, ["icon"])) : f("", !0),
    b("div", s8, [
      t.notification.title ? (d(), m("div", c8, z(t.notification.title), 1)) : f("", !0),
      t.notification.message ? (d(), m("div", o8, z(t.notification.message), 1)) : f("", !0)
    ])
  ], 34);
}
const G1 = /* @__PURE__ */ O(t8, [["render", i8], ["__scopeId", "data-v-b3cdc099"]]);
const n8 = {
...
}, l8 = { class: "nice-notifications" };
function a8(e, s, t, i, c, o) {
  const a = w("NiceNotification");
  return d(), m("div", l8, [
    _($1, {
      name: "notification",
      tag: "div"
      ...
      default: H(() => [
        (d(!0), m(F, null, R(c.notifications, (n) => (d(), V(a, {
          key: n.id,
          notification: n,
          timeoutTime: c.timeoutTime,
          onRemove: (v) => o.removeNotification(n)
...
const r8 = /* @__PURE__ */ O(n8, [["render", a8], ["__scopeId", "data-v-2fbd20be"]]);
const h8 = {
  name: "NicePanel",
  props: {
    name: {
...
function d8(e, s, t, i, c, o) {
  return d(), m("div", {
    class: B(["nice-side-view", { "no-select": c.dragging }]),
    onMousemove: s[2] || (s[2] = (...a) => o.mouseMove && o.mouseMove(...a)),
    ...
    _(F0, { name: "side-overlay" }, {
      default: H(() => [
        c.isOpen ? (d(), m("div", {
          key: 0,
          class: "overlay",
          onClick: s[1] || (s[1] = (...a) => o.close && o.close(...a))
        })) : f("", !0)
      ]),
      _: 1
    })
...
const u8 = /* @__PURE__ */ O(h8, [["render", d8]]), v8 = {
  name: "NiceSlot",
...
function p8(e, s, t, i, c, o) {
  const a = w("NiceComponentHeader");
  return d(), m("div", {
...
const m8 = /* @__PURE__ */ O(v8, [["render", p8]]), f8 = {
  name: "NiceSvgs"
}, y8 = {
  "aria-hidden": "true",
  style: { display: "none" },
...
}, _8 = (e) => (k0("data-v-e53b927f"), e = e(), N0(), e), x8 = /* @__PURE__ */ _8(() => /* @__PURE__ */ b("div", { class: "nice-switch-box" }, [
  /* @__PURE__ */ b("div", { class: "nice-switch-handle" })
], -1)), C8 = ["for"], B8 = ["id"];
function k8(e, s, t, i, c, o) {
  return d(), m("div", {
...
const N8 = /* @__PURE__ */ O(w8, [["render", k8], ["__scopeId", "data-v-e53b927f"]]);
const S8 = {
  name: "NiceTable",
  components: {
    NiceCheckbox: L1,
...
}, V8 = { class: "nice-table" }, O8 = { class: "nice-table-table-wrapper" }, D8 = { class: "nice-table-table" }, T8 = {
  key: 0,
  class: "w-0"
}, P8 = ["onClick"], E8 = { key: 1 }, I8 = { class: "list" }, $8 = ["onClick"], q8 = {
  key: 0,
  class: "w-0"
}, F8 = ["innerHTML"], A8 = {
  key: 1,
...
function W8(e, s, t, i, c, o) {
  const a = w("NiceCheckbox"), n = w("NiceIcon"), v = w("NicePopup"), h = w("NiceButton"), l = w("router-link"), r = w("NiceLoading"), u = w("NiceDropdownSimple"), p = w("NiceDropdown");
  return d(), m("div", V8, [
    b("div", O8, [
      b("table", D8, [
        b("thead", null, [
          b("tr", null, [
            t.selectMultiple ? (d(), m("th", T8, [
              _(a, {
            ...
            (d(!0), m(F, null, R(o.enabledColumns, (M) => (d(), m("th", {
              key: M.key,
              class: B(M.class)
            }, [
              t.showOrder ? (d(), m("div", {
                key: 0,
                class: B(["table-th", {
                  "active asc": c.order == M.key,
                  "active desc": c.order == "-" + M.key
                }]),
                onClick: (y) => o.setOrder(M)
              }, [
                b("span", null, z(M.name), 1),
                t.showOrder ? (d(), V(n, {
                  key: 0,
                  icon: "icon-bar-chart",
                  class: "table-order"
                })) : f("", !0)
              ], 10, P8)) : (d(), m("span", E8, z(M.name), 1))
            ], 2))), 128)),
            t.actions.length ? (d(), m("th", {
              key: 1,
              ...
              _(v, {
                ...
                trigger: H(() => [
                  _(n, { icon: "icon-plus-circle" })
                ]),
                content: H(() => [
                  b("div", I8, [
                    (d(!0), m(F, null, R(t.columns, (M) => (d(), m("div", {
                      class: "element",
                      key: M.key,
                      onClick: (y) => o.toggleColumn(M)
                    }, [
                      _(a, {
        ...
        b("tbody", null, [
          (d(!0), m(F, null, R(o.innerData, (M) => (d(), m("tr", {
            key: M.id
          }, [
            t.selectMultiple ? (d(), m("td", q8, [
              _(a, {
                modelValue: M._selected,
                onClick: (y) => o.toggleSelect(M),
                "no-margin": ""
              }, null, 8, ["modelValue", "onClick"])
            ])) : f("", !0),
            (d(!0), m(F, null, R(o.enabledColumns, (y) => (d(), m("td", {
              key: y.key,
              class: B(y.class)
            }, [
              y.component ? (d(), V(l2(y.component().instance), a2(r2({ key: 0 }, y.component(M[y.key], M).props)), null, 16)) : f("", !0),
              !y.component && y.html ? (d(), m("span", {
                key: 1,
                innerHTML: y.html(M[y.key], M)
              }, null, 8, F8)) : f("", !0),
              !y.component && !y.html ? (d(), m("span", {
                key: 2,
                class: B(y.fieldClass ? y.fieldClass(M[y.key], M) : "")
              }, z(y.formatter ? y.formatter(M[y.key], M) : M[y.key]), 3)) : f("", !0)
            ], 2))), 128)),
            t.actions.length ? (d(), m("td", {
              key: 1,
              class: B(["actions-td", { "freeze-column-right": t.freezeLastColumn }])
            }, [
              (d(!0), m(F, null, R(t.actions, (y) => (d(), m("div", { key: y }, [
                y.to ? (d(), V(l, {
                  key: 0,
                  to: y.to(M)
                }, {
    ...
    t.loading ? (d(), V(r, { key: 0 })) : f("", !0),
    !t.loading && t.data.length == 0 ? (d(), m("div", A8, z(e.$gettext("No data.")), 1)) : f("", !0),
    t.showFooter ? (d(), m("div", L8, [
      b("div", R8, z(o.count) + " " + z(e.$gettext("total")), 1),
      t.paginated && o.pages > 1 && o.pages < 5 ? (d(), m("div", H8, [
        (d(!0), m(F, null, R(o.pages, (M) => (d(), V(h, {
          size: "small",
          plain: c.currentPage !== M,
          key: M,
          class: B(c.currentPage === M ? "btn-primary" : "btn-default"),
          onClick: (y) => o.setPage(M)
        }, {
          default: H(() => [
            d0(z(M), 1)
          ]),
      ...
      t.paginated && o.pages > 1 && o.pages > 5 ? (d(), m("div", j8, [
        _(u, {
          modelValue: c.currentPageDropdown,
          "onUpdate:modelValue": s[0] || (s[0] = (M) => c.currentPageDropdown = M),
          values: o.pagesList,
          keyOnly: "",
          noMargin: "",
          onChange: o.setPage
      ...
      t.showLimit ? (d(), V(p, {
        key: 2,
        modelValue: c.limit,
        "onUpdate:modelValue": s[1] || (s[1] = (M) => c.limit = M),
        class: B({ "dropdown-small": o.pages > 1 && o.pages < 5 }),
        values: c.limits,
        keyOnly: "",
        noMargin: "",
        onChange: o.setLimit
...
const U8 = /* @__PURE__ */ O(S8, [["render", W8], ["__scopeId", "data-v-edac1101"]]);
const Y8 = {
  name: "NiceTextarea",
  components: {
    NiceIcon: W0
  ...
  key: 0,
  class: "input-group-suffix"
}, K8 = ["placeholder", "autocomplete", "type", "rows"], G8 = {
  key: 1,
  class: "input-group-append input-group-icon"
}, X8 = {
  key: 2,
...
function e5(e, s, t, i, c, o) {
  const a = w("NiceComponentHeader"), n = w("NiceIcon");
  return d(), m("div", {
    class: B(["nice-component nice-textarea", { "no-margin": t.noMargin, active: o.localValue }])
  }, [
    _(a, {
      title: t.title,
      required: t.required,
    ...
    b("div", Z8, [
      ...
      e.$slots.append ? (d(), m("div", X8, [
        E(e.$slots, "append", {}, void 0, !0)
      ])) : f("", !0)
    ]),
    t.message ? (d(), m("div", J8, z(t.message), 1)) : f("", !0)
  ], 2);
}
const t5 = /* @__PURE__ */ O(Y8, [["render", e5], ["__scopeId", "data-v-4893643b"]]);
const s5 = {
  name: "NiceToast",
  data() {
    return {
...
function o5(e, s, t, i, c, o) {
  return d(), m("div", c5, [
    _($1, {
      ...
      default: H(() => [
        (d(!0), m(F, null, R(c.toasts, (a) => (d(), m("div", {
...
const i5 = /* @__PURE__ */ O(s5, [["render", o5], ["__scopeId", "data-v-d538dc55"]]);
const n5 = {
  name: "NiceView",
  props: {
    title: {
...
function h5(e, s, t, i, c, o) {
  const a = w("NiceIcon"), n = w("NiceLoading");
  return d(), m("div", {
    class: B(["nice-view", { "nice-view-no-header": !o.showHeader }])
  }, [
    o.showHeader ? (d(), m("div", l5, [
      t.icon && !t.loading ? (d(), V(a, {
        key: 0,
        icon: t.icon,
      ...
      e.$slots.title || t.title ? (d(), m("div", a5, [
        E(e.$slots, "title", {}, () => [
          d0(z(t.title), 1)
        ], !0)
      ])) : f("", !0)
    ...
    e.$slots.footer ? (d(), m("div", r5, [
      E(e.$slots, "footer", {}, void 0, !0)
    ])) : f("", !0)
  ], 2);
}
const d5 = /* @__PURE__ */ O(n5, [["render", h5], ["__scopeId", "data-v-a49db2bc"]]);
const u5 = {
  name: "NiceWrapper",
  components: { NiceButton: S0 },
  props: {
    title: {
      type: String,
      required: !1
...
}, v5 = (e) => (k0("data-v-dc1e67ab"), e = e(), N0(), e), p5 = {
  key: 0,
...
}, M5 = /* @__PURE__ */ v5(() => /* @__PURE__ */ b("div", { class: "flex-grow" }, null, -1)), b5 = {
  key: 2,
  class: "wrapper-footer"
};
function g5(e, s, t, i, c, o) {
  const a = w("NiceButton");
  return d(), m("div", {
    class: B(["nice-wrapper", { "no-margin": t.noMargin }])
  }, [
    e.$slots.header || t.title || t.subtitle ? (d(), m("div", p5, [
      t.title || t.subtitle ? (d(), m("div", m5, [
        t.title ? (d(), m("div", f5, z(t.title), 1)) : f("", !0),
        t.subtitle ? (d(), m("div", y5, z(t.subtitle), 1)) : f("", !0)
      ])) : f("", !0),
    ...
    e.$slots.footer && c.isOpen ? (d(), m("div", b5, [
      E(e.$slots, "footer", {}, void 0, !0)
    ])) : f("", !0)
  ], 2);
}
const z5 = /* @__PURE__ */ O(u5, [["render", g5], ["__scopeId", "data-v-dc1e67ab"]]), E1 = {
  NiceActions: O2,
  NiceAvatar: e4,
  NiceButton: S0,
  NiceCheckbox: L1,
...
const x5 = {
  install(e, s) {
    ...
    const t = d2(), i = {
      ...
      notification: (a, n, v, h) => {
        t.emit("notification", { message: a, type: n, title: v, icon: h });
      },
      // Toast
    ...
    async function c() {
      ...
      const a = o(s.router.currentRoute.value.query);
      return delete a.id, a;
    }
    function o(a) {
      return Object.assign({}, a);
    }
    e.config.globalProperties.$query = c, e.provide("getQuery", c), e.config.globalProperties.$clone = o, e.provide("clone", o);
  }
};
export {
  x5 as default
