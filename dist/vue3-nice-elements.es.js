import { resolveComponent as V, openBlock as h, createElementBlock as p, normalizeClass as k, createBlock as T, createCommentVNode as f, renderSlot as F, toDisplayString as w, Teleport as d2, createVNode as B, Transition as H0, withCtx as U, normalizeStyle as L1, createElementVNode as y, createTextVNode as m0, inject as j0, Fragment as j, computed as K, unref as D, pushScopeId as D0, popScopeId as $0, ref as u0, onMounted as Y0, onBeforeUnmount as h2, withDirectives as b0, vShow as C1, vModelText as l1, renderList as W, vModelDynamic as u2, TransitionGroup as R1, createStaticVNode as v2, resolveDynamicComponent as p2, normalizeProps as m2, mergeProps as f2, isRef as B1 } from "vue";
import { useRoute as y2, useRouter as M2 } from "vue-router";
function b2(e) {
...
const P = (e, s) => {
  ...
  for (const [o, c] of s)
    t[o] = c;
  return t;
}, g2 = ["type", "disabled"], z2 = { key: 2 }, w2 = { key: 3 }, _2 = {
  name: "NiceButton"
}, x2 = /* @__PURE__ */ Object.assign(_2, {
  props: {
    addClass: {
      type: String,
      default: null
  ...
  setup(e) {
    ...
    return (t, o) => {
      ...
      return h(), p("button", {
        ...
        t.$slots.default ? (h(), p("span", z2, [
          F(t.$slots, "default", {}, void 0, !0)
        ])) : f("", !0),
        s.text ? (h(), p("span", w2, w(s.text), 1)) : f("", !0),
        s.appendIcon ? (h(), T(n, {
          key: 4,
          icon: s.appendIcon
        }, null, 8, ["icon"])) : f("", !0)
...
}), v0 = /* @__PURE__ */ P(x2, [["__scopeId", "data-v-c4cf40bd"]]);
const C2 = {
  name: "NiceModal",
  props: {
    name: {
...
}, k2 = { class: "nice-modal-title" }, N2 = { class: "nice-modal-subtitle" }, V2 = {
  key: 1,
  class: "nice-modal-footer"
};
function S2(e, s, t, o, c, n) {
  const r = V("NiceButton");
  return h(), T(d2, { to: "body" }, [
    B(H0, { name: "fade" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          key: 0,
    ...
    B(H0, { name: "flyin" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          key: 0,
          class: "nice-modal",
          style: L1({ width: t.width, height: t.height })
        }, [
          e.$slots.title || t.title || e.$slots.subtitle || t.subtitle ? (h(), p("div", B2, [
            y("div", k2, [
...
const H1 = /* @__PURE__ */ P(C2, [["render", S2], ["__scopeId", "data-v-46a2523a"]]), O2 = {
...
}, D2 = { class: "nice-actions" };
function $2(e, s, t, o, c, n) {
...
const j1 = /* @__PURE__ */ P(O2, [["render", $2]]);
const T2 = { class: "nice-actions" }, E2 = /* @__PURE__ */ y("div", { class: "f-grow" }, null, -1), I2 = {
  name: "NiceActions"
}, q2 = /* @__PURE__ */ Object.assign(I2, {
  props: {
    form: String,
    loading: Boolean,
    showDelete: Boolean,
...
var L2 = P2;
const t1 = (e, s, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (s - e) * 6 * t : t < 1 / 2 ? s : t < 2 / 3 ? e + (s - e) * (2 / 3 - t) * 6 : e), R2 = (e, s, t) => {
  let o, c, n;
  if (e = e / 360, s == 0)
    o = c = n = t;
  else {
...
var H2 = R2;
const j2 = F2, W2 = L2, k1 = H2, U2 = () => Math.floor(Math.random() * Date.now()), Y2 = (e, s) => {
  const t = j2(e), o = W2(t % 360, 1, 0.5), c = k1(o[0][0], o[0][1], o[0][2]), n = k1(o[1][0], o[1][1], o[1][2]), r = `rgb(${c[0]}, ${c[1]}, ${c[2]})`, i = `rgb(${n[0]}, ${n[1]}, ${n[2]})`, v = U2();
 ...
 */
var X2 = function(e) {
  return e != null && (W1(e) || G2(e) || !!e._isBuffer);
};
function W1(e) {
  return !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
}
function G2(e) {
  return typeof e.readFloatLE == "function" && typeof e.slice == "function" && W1(e.slice(0, 0));
}
(function() {
  var e = s1, s = N1.utf8, t = X2, o = N1.bin, c = function(n, r) {
  ...
  c._ff = function(n, r, i, v, a, l, d) {
    ...
    var u = n + (i ^ (r | ~v)) + (a >>> 0) + d;
    return (u << l | u >>> 32 - l) + r;
  }, c._blocksize = 16, c._digestsize = 16, Q2.exports = function(n, r) {
    if (n == null)
...
const J2 = {
  key: 0,
  class: "status"
}, e4 = ["innerHTML"], t4 = ["src"], s4 = ["src"], c4 = {
  key: 4,
  class: "text"
}, o4 = {
  name: "NiceAvatar"
}, n4 = /* @__PURE__ */ Object.assign(o4, {
  props: {
    text: {
      type: String,
      required: !1
  ...
  setup(e) {
    const s = e, t = K(() => Z2(W0(s.hash || s.text))), o = K(() => {
      const n = s.text.split(" ");
      return n.length > 1 ? n[0][0] + n[1][0] : s.text[0] + s.text[1];
    }), c = K(() => "https://www.gravatar.com/avatar/" + W0(s.gavatar.trim().toLowerCase()) + "?s=50");
    return (n, r) => (h(), p("div", {
      class: k(["nice-avatar", [
        s.size ? "size-" + s.size : "",
      ...
      s.text ? (h(), p("div", c4, w(D(o)), 1)) : f("", !0)
    ], 2));
  }
});
const i4 = (e) => (D0("data-v-59577e66"), e = e(), $0(), e), l4 = { class: "nice-checkbox-box" }, a4 = {
  key: 0,
  viewBox: "0 0 20 20"
}, r4 = /* @__PURE__ */ i4(() => /* @__PURE__ */ y("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), d4 = [
  r4
], h4 = ["for"], u4 = ["id", "disabled"], v4 = {
  name: "NiceCheckbox"
}, p4 = /* @__PURE__ */ Object.assign(v4, {
  props: {
    modelValue: {
      type: [Boolean, null],
      default: !1
  ...
  setup(e, { emit: s }) {
    const t = e, o = Math.random().toString(36).slice(2, 7), c = K({
      get() {
        return t.modelValue;
      },
      set(r) {
...
}), L0 = /* @__PURE__ */ P(p4, [["__scopeId", "data-v-59577e66"]]);
const m4 = {
...
function g4(e, s, t, o, c, n) {
  return t.title || t.caption ? (h(), p("div", f4, [
    t.title ? (h(), p("div", y4, [
      m0(w(t.title) + " ", 1),
      t.required ? (h(), p("span", M4, " *")) : f("", !0)
    ])) : f("", !0),
    t.caption ? (h(), p("div", b4, w(t.caption), 1)) : f("", !0)
  ])) : f("", !0);
}
const y0 = /* @__PURE__ */ P(m4, [["render", g4], ["__scopeId", "data-v-b2f23a24"]]);
var Y = "top", e0 = "bottom", t0 = "right", Z = "left", Z0 = "auto", T0 = [Y, e0, t0, Z], g0 = "start", S0 = "end", z4 = "clippingParents", U1 = "viewport", k0 = "popper", w4 = "reference", V1 = /* @__PURE__ */ T0.reduce(function(e, s) {
  return e.concat([s + "-" + g0, s + "-" + S0]);
}, []), Y1 = /* @__PURE__ */ [].concat(T0, [Z0]).reduce(function(e, s) {
  return e.concat([s, s + "-" + g0, s + "-" + S0]);
}, []), _4 = "beforeRead", x4 = "read", C4 = "afterRead", B4 = "beforeMain", k4 = "main", N4 = "afterMain", V4 = "beforeWrite", S4 = "write", O4 = "afterWrite", o1 = [_4, x4, C4, B4, k4, N4, V4, S4, O4];
function o0(e) {
...
function D4(e) {
  ...
  Object.keys(s.elements).forEach(function(t) {
    ...
    !X(n) || !o0(n) || (Object.assign(n.style, o), Object.keys(c).forEach(function(r) {
      var i = c[r];
...
function $4(e) {
  ...
  return Object.assign(s.elements.popper.style, t.popper), s.styles = t, s.elements.arrow && Object.assign(s.elements.arrow.style, t.arrow), function() {
    Object.keys(s.elements).forEach(function(o) {
      ...
      !X(c) || !o0(c) || (Object.assign(c.style, i), Object.keys(n).forEach(function(v) {
        c.removeAttribute(v);
      }));
    });
  };
...
function w0(e, s, t) {
  ...
  s && X(e) && (c = e.offsetWidth > 0 && z0(o.width) / e.offsetWidth || 1, n = e.offsetHeight > 0 && z0(o.height) / e.offsetHeight || 1);
  var r = f0(e) ? G(e) : window, i = r.visualViewport, v = !Z1() && t, a = (o.left + (v && i ? i.offsetLeft : 0)) / c, l = (o.top + (v && i ? i.offsetTop : 0)) / n, d = o.width / c, u = o.height / n;
  return {
    width: d,
    height: u,
    top: l,
...
function I4(e) {
  ...
  var c = Q0(e);
  for (a1(c) && (c = c.host); X(c) && ["html", "body"].indexOf(o0(c)) < 0; ) {
    var n = c0(c);
...
function E0(e) {
  for (var s = G(e), t = S1(e); t && E4(t) && c0(t).position === "static"; )
    t = S1(t);
  return t && (o0(t) === "html" || o0(t) === "body" && c0(t).position === "static") ? s : t || I4(e) || s;
}
function d1(e) {
...
var A4 = function(s, t) {
  ...
  })) : s, X1(typeof s != "number" ? s : G1(s, T0));
};
function F4(e) {
  ...
  if (!(!n || !r)) {
    var d = A4(c.padding, t), u = r1(n), m = v === "y" ? Y : Z, _ = v === "y" ? e0 : t0, b = t.rects.reference[l] + t.rects.reference[v] - r[v] - t.rects.popper[l], g = r[v] - t.rects.reference[v], C = E0(n), E = C ? v === "y" ? C.clientHeight || 0 : C.clientWidth || 0 : 0, I = b / 2 - g / 2, N = d[m], S = E - u[l] - d[_], O = E / 2 - u[l] / 2 + I, q = N0(N, O, S), A = v;
...
function P4(e) {
  ...
  if (c != null && !(typeof c == "string" && (c = s.elements.popper.querySelector(c), !c))) {
    if (process.env.NODE_ENV !== "production" && (X(c) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !Q1(s.elements.popper, c)) {
...
function O1(e) {
  var s, t = e.popper, o = e.popperRect, c = e.placement, n = e.variation, r = e.offsets, i = e.position, v = e.gpuAcceleration, a = e.adaptive, l = e.roundOffsets, d = e.isFixed, u = r.x, m = u === void 0 ? 0 : u, _ = r.y, b = _ === void 0 ? 0 : _, g = typeof l == "function" ? l({
    x: m,
    y: b
  }) : {
    x: m,
  ...
  if (a) {
    var O = E0(t), q = "clientHeight", A = "clientWidth";
    if (O === G(t) && (O = l0(t), c0(O).position !== "static" && i === "absolute" && (q = "scrollHeight", A = "scrollWidth")), O = O, c === Y || (c === Z || c === t0) && n === S0) {
      N = e0;
      var R = d && O === S && S.visualViewport ? S.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        O[q]
      );
      b -= R - o.height, b *= v ? 1 : -1;
    }
  ...
  if (m = $.x, b = $.y, v) {
    var H;
    return Object.assign({}, M, (H = {}, H[N] = E ? "0" : "", H[I] = C ? "0" : "", H.transform = (S.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + b + "px)" : "translate3d(" + m + "px, " + b + "px, 0)", H));
  }
  return Object.assign({}, M, (s = {}, s[N] = E ? b + "px" : "", s[I] = C ? m + "px" : "", s.transform = "", s));
}
function j4(e) {
...
function U4(e) {
  var s = e.state, t = e.instance, o = e.options, c = o.scroll, n = c === void 0 ? !0 : c, r = o.resize, i = r === void 0 ? !0 : r, v = G(s.elements.popper), a = [].concat(s.scrollParents.reference, s.scrollParents.popper);
  return n && a.forEach(function(l) {
    l.addEventListener("scroll", t.update, P0);
  }), i && v.addEventListener("resize", t.update, P0), function() {
    n && a.forEach(function(l) {
      l.removeEventListener("scroll", t.update, P0);
    }), i && v.removeEventListener("resize", t.update, P0);
  };
}
const Y4 = {
  name: "eventListeners",
...
function h1(e) {
  var s = G(e), t = s.pageXOffset, o = s.pageYOffset;
  return {
    scrollLeft: t,
    scrollTop: o
  };
...
function K4(e, s) {
  var t = G(e), o = l0(e), c = t.visualViewport, n = o.clientWidth, r = o.clientHeight, i = 0, v = 0;
  if (c) {
...
function J1(e) {
  return ["html", "body", "#document"].indexOf(o0(e)) >= 0 ? e.ownerDocument.body : X(e) && v1(e) ? e : J1(Q0(e));
}
function V0(e, s) {
  var t;
  s === void 0 && (s = []);
  var o = J1(e), c = o === ((t = e.ownerDocument) == null ? void 0 : t.body), n = G(o), r = c ? [n].concat(n.visualViewport || [], v1(o) ? o : []) : o, i = s.concat(r);
  return c ? i : (
...
function $1(e, s, t) {
  return s === U1 ? i1(K4(e, t)) : f0(s) ? G4(s, t) : i1(X4(l0(e)));
}
function J4(e) {
  var s = V0(Q0(e)), t = ["absolute", "fixed"].indexOf(c0(e).position) >= 0, o = t && X(e) ? E0(e) : e;
  return f0(o) ? s.filter(function(c) {
    return f0(c) && Q1(c, o) && o0(c) !== "body";
  }) : [];
}
function e3(e, s, t, o) {
  var c = s === "clippingParents" ? J4(e) : [].concat(s), n = [].concat(c, [t]), r = n[0], i = n.reduce(function(v, a) {
    var l = $1(e, a, o);
...
function O0(e, s) {
  s === void 0 && (s = {});
  var t = s, o = t.placement, c = o === void 0 ? e.placement : o, n = t.strategy, r = n === void 0 ? e.strategy : n, i = t.boundary, v = i === void 0 ? z4 : i, a = t.rootBoundary, l = a === void 0 ? U1 : a, d = t.elementContext, u = d === void 0 ? k0 : d, m = t.altBoundary, _ = m === void 0 ? !1 : m, b = t.padding, g = b === void 0 ? 0 : b, C = X1(typeof g != "number" ? g : G1(g, T0)), E = u === k0 ? w4 : k0, I = e.rects.popper, N = e.elements[_ ? E : u], S = e3(f0(N) ? N : N.contextElement || l0(e.elements.popper), v, l, r), O = w0(e.elements.reference), q = e2({
    reference: O,
    element: I,
    strategy: "absolute",
    placement: c
  ...
  if (u === k0 && M) {
    ...
    Object.keys(L).forEach(function(H) {
      var Q = [t0, e0].indexOf(H) >= 0 ? 1 : -1, J = [Y, e0].indexOf(H) >= 0 ? "y" : "x";
      L[H] += $[J] * Q;
    });
  }
  return L;
...
function t3(e, s) {
  s === void 0 && (s = {});
  var t = s, o = t.placement, c = t.boundary, n = t.rootBoundary, r = t.padding, i = t.flipVariations, v = t.allowedAutoPlacements, a = v === void 0 ? Y1 : v, l = _0(o), d = l ? i ? V1 : V1.filter(function(_) {
    return _0(_) === l;
  }) : T0, u = d.filter(function(_) {
...
function c3(e) {
  ...
  if (!s.modifiersData[o]._skip) {
    for (var c = t.mainAxis, n = c === void 0 ? !0 : c, r = t.altAxis, i = r === void 0 ? !0 : r, v = t.fallbackPlacements, a = t.padding, l = t.boundary, d = t.rootBoundary, u = t.altBoundary, m = t.flipVariations, _ = m === void 0 ? !0 : m, b = t.allowedAutoPlacements, g = s.options.placement, C = s0(g), E = C === g, I = v || (E || !_ ? [R0(g)] : s3(g)), N = [g].concat(I).reduce(function(M0, n0) {
      return M0.concat(s0(n0) === Z0 ? t3(s, {
        placement: n0,
        boundary: l,
        rootBoundary: d,
        padding: a,
      ...
      var M = N[L], $ = s0(M), H = _0(M) === g0, Q = [Y, e0].indexOf($) >= 0, J = Q ? "width" : "height", z = O0(s, {
        placement: M,
        boundary: l,
        rootBoundary: d,
        altBoundary: u,
      ...
      S[J] > O[J] && (x = R0(x));
      var x0 = R0(x), a0 = [];
      if (n && a0.push(z[$] <= 0), i && a0.push(z[x] <= 0, z[x0] <= 0), a0.every(function(M0) {
        return M0;
      })) {
        R = M, A = !1;
        break;
    ...
    if (A)
      for (var I0 = _ ? 3 : 1, X0 = function(n0) {
        var B0 = N.find(function(A0) {
          var r0 = q.get(A0);
          if (r0)
            return r0.slice(0, n0).every(function(G0) {
              return G0;
            });
        });
        if (B0)
...
function a3(e) {
  var s = e.state, t = e.options, o = e.name, c = t.offset, n = c === void 0 ? [0, 0] : c, r = Y1.reduce(function(l, d) {
    return l[d] = l3(d, s.rects, n), l;
...
function v3(e) {
  var s = e.state, t = e.options, o = e.name, c = t.mainAxis, n = c === void 0 ? !0 : c, r = t.altAxis, i = r === void 0 ? !1 : r, v = t.boundary, a = t.rootBoundary, l = t.altBoundary, d = t.padding, u = t.tether, m = u === void 0 ? !0 : u, _ = t.tetherOffset, b = _ === void 0 ? 0 : _, g = O0(s, {
    boundary: v,
    rootBoundary: a,
    padding: d,
    altBoundary: l
  }), C = s0(s.placement), E = _0(s.placement), I = !E, N = d1(C), S = u3(N), O = s.modifiersData.popperOffsets, q = s.rects.reference, A = s.rects.popper, R = typeof b == "function" ? b(Object.assign({}, s.rects, {
    placement: s.placement
  })) : b, L = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
    ...
    mainAxis: 0,
    altAxis: 0
  }, R), M = s.modifiersData.offset ? s.modifiersData.offset[s.placement] : null, $ = {
    x: 0,
    y: 0
  };
  if (O) {
    if (n) {
      var H, Q = N === "y" ? Y : Z, J = N === "y" ? e0 : t0, z = N === "y" ? "height" : "width", x = O[N], x0 = x + g[Q], a0 = x - g[J], I0 = m ? -A[z] / 2 : 0, X0 = E === g0 ? q[z] : A[z], C0 = E === g0 ? -A[z] : -q[z], q0 = s.elements.arrow, M0 = m && q0 ? r1(q0) : {
        width: 0,
        height: 0
      }, n0 = s.modifiersData["arrow#persistent"] ? s.modifiersData["arrow#persistent"].padding : K1(), B0 = n0[Q], A0 = n0[J], r0 = N0(0, q[z], M0[z]), G0 = I ? q[z] / 2 - I0 - r0 - B0 - L.mainAxis : X0 - r0 - B0 - L.mainAxis, o2 = I ? -q[z] / 2 + I0 + r0 + A0 + L.mainAxis : C0 + r0 + A0 + L.mainAxis, J0 = s.elements.arrow && E0(s.elements.arrow), n2 = J0 ? N === "y" ? J0.clientTop || 0 : J0.clientLeft || 0 : 0, f1 = (H = M == null ? void 0 : M[N]) != null ? H : 0, i2 = x + G0 - f1 - n2, l2 = x + o2 - f1, y1 = N0(m ? U0(x0, i2) : x0, x, m ? p0(a0, l2) : a0);
      O[N] = y1, $[N] = y1 - x;
    }
    if (i) {
      var M1, a2 = N === "x" ? Y : Z, r2 = N === "x" ? e0 : t0, d0 = O[S], F0 = S === "y" ? "height" : "width", b1 = d0 + g[a2], g1 = d0 - g[r2], e1 = [Y, Z].indexOf(C) !== -1, z1 = (M1 = M == null ? void 0 : M[S]) != null ? M1 : 0, w1 = e1 ? b1 : d0 - q[F0] - A[F0] - z1 + L.altAxis, _1 = e1 ? d0 + q[F0] + A[F0] - z1 - L.altAxis : g1, x1 = m && e1 ? q4(w1, d0, _1) : N0(m ? w1 : b1, d0, m ? _1 : g1);
      O[S] = x1, $[S] = x1 - d0;
    }
    s.modifiersData[o] = $;
  }
...
function M3(e, s, t) {
  t === void 0 && (t = !1);
  var o = X(s), c = X(s) && y3(s), n = l0(s), r = w0(e, c, t), i = {
    scrollLeft: 0,
    scrollTop: 0
  }, v = {
    x: 0,
  ...
  v1(n)) && (i = f3(s)), X(s) ? (v = w0(s, !0), v.x += s.clientLeft, v.y += s.clientTop) : n && (v.x = u1(n))), {
...
var h0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', w3 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', I1 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function _3(e) {
  e.forEach(function(s) {
    [].concat(Object.keys(s), I1).filter(function(t, o, c) {
      ...
      s.requires && s.requires.forEach(function(o) {
        e.find(function(c) {
          return c.name === o;
        }) == null && console.error(i0(w3, String(s.name), o, o));
      });
    });
  });
}
...
var q1 = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.", B3 = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.", A1 = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
};
  ...
  return function(i, v, a) {
    ...
    var l = {
      ...
      setOptions: function(C) {
        ...
        b(), l.options = Object.assign({}, n, l.options, E), l.scrollParents = {
          reference: f0(i) ? V0(i) : i.contextElement ? V0(i.contextElement) : [],
          popper: V0(v)
        };
        var I = g3(C3([].concat(o, l.options.modifiers)));
        if (l.orderedModifiers = I.filter(function(M) {
          return M.enabled;
        }), process.env.NODE_ENV !== "production") {
          var N = x3([].concat(I, l.options.modifiers), function(M) {
            var $ = M.name;
            return $;
          });
          if (_3(N), s0(l.options.placement) === Z0) {
            var S = l.orderedModifiers.find(function(M) {
              var $ = M.name;
              return $ === "flip";
            });
      ...
      forceUpdate: function() {
        if (!u) {
          ...
          l.rects = {
            reference: M3(E, E0(I), l.options.strategy === "fixed"),
            popper: r1(I)
...
var N3 = [Y4, h3, W4, T4, r3, o3, p3, L4, i3], V3 = /* @__PURE__ */ k3({
  defaultModifiers: N3
});
const S3 = {
  name: "NicePopup"
}, O3 = /* @__PURE__ */ Object.assign(S3, {
  props: {
    noPadding: {
      type: Boolean,
      default: !1
  ...
  setup(e, { emit: s }) {
    ...
    function _(b) {
      t.openOnHover || t.disabled || o.value && !b.composedPath().includes(a.value) && !b.composedPath().includes(i.value) && d();
    }
    return (b, g) => (h(), p("div", {
...
}), K0 = /* @__PURE__ */ P(O3, [["__scopeId", "data-v-746fc631"]]);
const D3 = {
  name: "NiceDate",
  components: {
    NicePopup: K0,
...
}, p1 = (e) => (D0("data-v-e810dc14"), e = e(), $0(), e), $3 = { class: "input-group" }, T3 = ["placeholder", "disabled", "required"], E3 = { class: "nice-dropdown" }, I3 = { class: "month-wrapper" }, q3 = { class: "value" }, A3 = { class: "year" }, F3 = { class: "month" }, P3 = { class: "calendar" }, L3 = { class: "header" }, R3 = { class: "month" }, H3 = ["onClick", "title"], j3 = {
  key: 0,
  class: "time"
}, W3 = { class: "select-wrapper" }, U3 = /* @__PURE__ */ p1(() => /* @__PURE__ */ y("div", { class: "arrow-down" }, null, -1)), Y3 = ["value", "selected"], Z3 = /* @__PURE__ */ p1(() => /* @__PURE__ */ y("div", null, ":", -1)), Q3 = { class: "select-wrapper" }, K3 = /* @__PURE__ */ p1(() => /* @__PURE__ */ y("div", { class: "arrow-down" }, null, -1)), X3 = ["value", "selected"];
function G3(e, s, t, o, c, n) {
      ...
      content: U(() => [
        y("div", E3, [
          y("div", I3, [
            ...
            y("div", q3, [
              y("div", A3, w(c.selected.getFullYear()), 1),
              y("div", F3, w(c.monthNames[c.selected.getMonth() + 1]), 1)
            ]),
            B(v, {
              class: "right",
...
const J3 = /* @__PURE__ */ P(D3, [["render", G3], ["__scopeId", "data-v-e810dc14"]]);
const e7 = {
...
}, t7 = { class: "input-group" }, s7 = ["required", "disabled", "modelValue"], c7 = ["selected"], o7 = ["value"], n7 = {
  key: 0,
  class: "no-options"
}, i7 = ["disabled"];
function l7(e, s, t, o, c, n) {
    ...
    y("div", t7, [
      y("div", {
        ...
        y("select", {
          ...
          }, w(t.nullText || e.$t("Nice", "None")), 9, c7)) : f("", !0),
          (h(!0), p(j, null, W(t.values, (a) => (h(), p("option", {
            value: a[t.keyName],
            key: a[t.keyName]
          }, w(a[t.valueName]), 9, o7))), 128))
        ], 40, s7),
        !t.nullable && !t.loading && (!t.values || t.values.length == 0) ? (h(), p("div", n7, w(e.$t("Nice", "No options")), 1)) : f("", !0),
        t.loading ? (h(), T(i, {
          key: 1,
          class: "no-options"
        })) : f("", !0),
...
const a7 = /* @__PURE__ */ P(e7, [["render", l7], ["__scopeId", "data-v-42a60a1f"]]);
const r7 = { class: "nice-loading-wrapper" }, d7 = {
  key: 0,
  class: "nice-loading-message"
}, h7 = {
  name: "NiceLoading"
}, u7 = /* @__PURE__ */ Object.assign(h7, {
  props: {
    message: {
      type: String,
      default: null
  ...
  setup(e) {
    ...
    return (t, o) => {
      ...
      return h(), p("div", {
        ...
        s.message ? (h(), p("div", d7, w(s.message), 1)) : f("", !0)
      ], 2);
    };
  }
}), m1 = /* @__PURE__ */ P(u7, [["__scopeId", "data-v-79dfb1c4"]]);
const v7 = {
  name: "NiceDropdown",
  components: {
    NicePopup: K0,
...
}, p7 = { class: "nice-dropdown-wrapper" }, m7 = { class: "input-group" }, f7 = { class: "select-wrapper" }, y7 = ["required", "value", "disabled"], M7 = {
  key: 0,
  class: "option"
}, b7 = {
  key: 1,
  ...
  key: 2,
  class: "no-options"
}, z7 = { class: "nice-dropdown-popup" }, w7 = {
  key: 0,
  class: "input-group"
}, _7 = ["placeholder", "name", "disabled"], x7 = { class: "list" }, C7 = ["onClick"], B7 = {
  key: 1,
  class: "element no-options"
};
function k7(e, s, t, o, c, n) {
  ...
  return h(), p("div", {
    ...
    y("div", p7, [
      B(a, {
          ...
          y("div", m7, [
            y("div", f7, [
              y("div", {
                ...
                !t.loading && t.modelValue ? (h(), p("div", M7, [
                ...
                !t.loading && !t.modelValue ? (h(), p("div", b7, w(t.nullText || e.$t("Nice", "None")), 1)) : f("", !0),
                t.loading ? (h(), p("div", g7, w(e.$t("Nice", "Loading")), 1)) : f("", !0),
                B(i, {
                  class: "arrow-down",
                  icon: "icon-chevron-down"
                }),
        ...
        content: U(() => [
          y("div", z7, [
            t.searchFunction && !t.noSearch ? (h(), p("div", w7, [
              b0(y("input", {
            ...
            y("div", x7, [
              ...
              !c.innerLoading && (!c.innerValues || c.innerValues.length == 0) ? (h(), p("div", B7, w(e.$t("Nice", "No options")), 1)) : f("", !0)
            ])
          ])
        ]),
        _: 3
...
const N7 = /* @__PURE__ */ P(v7, [["render", k7], ["__scopeId", "data-v-4dd52871"]]);
const V7 = {
  name: "NiceFilters",
  props: {
    // filters: {
...
}, S7 = (e) => (D0("data-v-fad220d1"), e = e(), $0(), e), O7 = { class: "nice-filters-wrapper" }, D7 = { class: "nice-component nice-filters" }, $7 = {
  key: 0,
  class: "nice-filters-options"
}, T7 = /* @__PURE__ */ S7(() => /* @__PURE__ */ y("div", { class: "f-grow" }, null, -1)), E7 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, I7 = ["title"];
function q7(e, s, t, o, c, n) {
  ...
  return h(), p("div", O7, [
    ...
    t.showPills && n.pills && n.pills.length ? (h(), p("div", E7, [
...
const A7 = /* @__PURE__ */ P(V7, [["render", q7], ["__scopeId", "data-v-fad220d1"]]);
const F7 = { class: "nice-icon" }, P7 = ["xlink:href"], L7 = {
  name: "NiceIcon"
}, R7 = /* @__PURE__ */ Object.assign(L7, {
  props: {
    icon: {
      type: String,
      required: !0
  ...
  setup(e) {
    const s = e;
    return (t, o) => (h(), p("svg", F7, [
      y("use", {
        "xlink:href": "#" + s.icon
      }, null, 8, P7)
    ]));
  }
}), t2 = /* @__PURE__ */ P(R7, [["__scopeId", "data-v-11b82ed8"]]);
var s2 = H7;
function H7(e, s, t) {
  if (!e)
    return t;
  ...
  computed: {
    ...
    errorMessage() {
      if (typeof this.error == "string")
        return this.error;
      const e = s2(this.error, ["response", "data", this.prop]);
...
}, W7 = { class: "input-group" }, U7 = {
  key: 0,
  class: "input-group-suffix"
}, Y7 = ["placeholder", "autocomplete", "type", "required", "disabled"], Z7 = {
  key: 1,
...
function G7(e, s, t, o, c, n) {
  ...
  return h(), p("div", {
    ...
    y("div", W7, [
      ...
      e.$slots.append ? (h(), p("div", Q7, [
        F(e.$slots, "append", {}, void 0, !0)
      ])) : f("", !0)
    ]),
    t.message ? (h(), p("div", K7, w(t.message), 1)) : f("", !0),
    n.errorMessage ? (h(), p("div", X7, w(n.errorMessage), 1)) : f("", !0)
  ], 2);
}
const J7 = /* @__PURE__ */ P(j7, [["render", G7], ["__scopeId", "data-v-77517aa1"]]);
const e8 = { class: "notification-info" }, t8 = {
  key: 0,
  ...
  setup(e, { emit: s }) {
    ...
    return Y0(() => {
      ...
      return h(), p("div", {
        ...
        y("div", e8, [
          t.notification.title ? (h(), p("div", t8, w(t.notification.title), 1)) : f("", !0),
          t.notification.message ? (h(), p("div", s8, w(t.notification.message), 1)) : f("", !0)
        ])
      ], 34);
    };
  }
}), c2 = /* @__PURE__ */ P(o8, [["__scopeId", "data-v-e97b3468"]]);
const n8 = { class: "nice-notifications" }, i8 = {
  name: "NiceNotifications"
}, l8 = /* @__PURE__ */ Object.assign(i8, {
  setup(e) {
    const s = j0("$t"), t = j0("nice"), o = 3e3, c = u0([]);
    ...
    return Y0(() => {
      ...
      B(R1, {
        ...
        default: U(() => [
          (h(!0), p(j, null, W(c.value, (a) => (h(), T(c2, {
            key: a.id,
            notification: a,
            timeoutTime: o,
            onRemove: (l) => r(a)
...
}), a8 = /* @__PURE__ */ P(l8, [["__scopeId", "data-v-a3b90f70"]]);
const r8 = {
  name: "NicePanel",
  props: {
    name: {
    ...
    B(H0, { name: "side-view" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          ...
          style: L1({ "--side-view-width": c.sideViewWidth + "px" })
        }, [
          y("div", {
...
const h8 = /* @__PURE__ */ P(r8, [["render", d8]]), u8 = {
  name: "NiceSlot"
}, v8 = /* @__PURE__ */ Object.assign(u8, {
  props: {
    title: {
      type: String,
      default: null
...
}), B8 = /* @__PURE__ */ P(C8, [["__scopeId", "data-v-d6fa25f8"]]);
const k8 = { class: "nice-table" }, N8 = { class: "nice-table-table-wrapper" }, V8 = { class: "nice-table-table" }, S8 = {
  key: 0,
  class: "w-0"
}, O8 = ["onClick"], D8 = { key: 1 }, $8 = { key: 0 }, T8 = { key: 0 }, E8 = { class: "list" }, I8 = ["onClick"], q8 = {
  key: 0,
  class: "w-0"
}, A8 = ["innerHTML"], F8 = {
  key: 1,
  ...
  setup(e, { emit: s }) {
    const t = e, o = y2(), c = M2(), n = j0("getQuery");
    let r, i = 50;
    const v = [
      { id: 10, value: 10 },
      { id: 20, value: 20 },
    ...
    const d = K(() => {
      var M, $;
      return (($ = (M = t.data) == null ? void 0 : M._metadata) == null ? void 0 : $.count) || 0;
    }), u = K(() => Math.ceil(d.value / i) || 1), m = K(() => Array.from({ length: u.value }, (M, $) => ({ id: $ + 1, value: $ + 1 }))), _ = K(() => t.columns), b = K(() => _.value.filter((M) => !M.disabled)), g = K(() => {
      let M = t.data;
      if (M.forEach(($) => {
        ...
        M.sort((H, Q) => {
          ...
          return String(H[$]).localeCompare(String(Q[$]));
        });
      }
      return M;
    }), C = K(() => g.value.filter((M) => M._selected)), E = K(() => C.value.length == g.value.length);
    function I() {
      let M = !0;
      E.value && (M = !1), g.value.forEach(($) => $._selected = M), S();
    }
    function N(M) {
      M._selected = !M._selected, S();
    }
    function S() {
      s("selected", C.value);
    }
    ...
    function q(M) {
      M.key == r ? r = "-" + M.key : r && r[0] === "-" && r === "-" + M.key ? r = void 0 : r = M.key, c.push({
    ...
    async function A(M) {
      a = M, c.replace({
        path: o.path,
        query: { ...o.query, page: M, offset: (M - 1) * i, limit: i }
      }), s("pageChange", M), L();
    }
    function R(M) {
      i = M, c.push({
    ...
    return Y0(async () => {
      const M = await n();
      r = M.ordering, t.paginated && (i = Number(M.limit) || 50, a = Number(M.page) || 1, l = Number(M.page) || 1, A(a));
    }), (M, $) => {
      const H = V("NiceIcon"), Q = V("router-link"), J = V("NiceDropdown");
      return h(), p("div", k8, [
        y("div", N8, [
          y("table", V8, [
            y("thead", null, [
              y("tr", null, [
                t.selectMultiple ? (h(), p("th", S8, [
                  B(L0, {
                    modelValue: D(E),
                    "no-margin": "",
                    onClick: I
                ...
                (h(!0), p(j, null, W(D(b), (z) => (h(), p("th", {
                  ...
                  ], 10, O8)) : (h(), p("span", D8, w(z.name), 1))
                ], 2))), 128)),
                t.actions.length ? (h(), p("th", {
                  key: 1,
                  class: k(["actions-td w-0", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  !t.showToggleColumns && !t.showFooter && D(g) && D(g).length ? (h(), p("span", $8, [
                    y("span", null, w(D(g).length), 1),
                    D(g)._metadata ? (h(), p("span", T8, " / " + w(D(g)._metadata.count), 1)) : f("", !0)
                  ])) : f("", !0),
                  t.showToggleColumns ? (h(), T(K0, {
                    key: 1,
            ...
            y("tbody", null, [
              (h(!0), p(j, null, W(D(g), (z) => (h(), p("tr", {
                ...
                (h(!0), p(j, null, W(D(b), (x) => (h(), p("td", {
                  key: x.key,
                  class: k(x.class)
                }, [
                  x.component ? (h(), T(p2(x.component().instance), m2(f2({ key: 0 }, x.component(z[x.key], z).props)), null, 16)) : f("", !0),
        ...
        !e.loading && t.data.length == 0 ? (h(), p("div", F8, w(M.$t("Nice", "No data.")), 1)) : f("", !0),
        t.showFooter ? (h(), p("div", P8, [
          y("div", L8, w(D(d)) + " " + w(M.$t("Nice", "total")), 1),
          t.paginated && D(u) > 1 && D(u) < 5 ? (h(), p("div", R8, [
          ...
          t.paginated && D(u) > 1 && D(u) > 5 ? (h(), p("div", H8, [
            B(J, {
              modelValue: D(l),
...
}), U8 = /* @__PURE__ */ P(W8, [["__scopeId", "data-v-8bd1b207"]]);
const Y8 = {
  name: "NiceTextarea",
  components: {
    NiceIcon: t2
...
}, Z8 = { class: "input-group" }, Q8 = {
  key: 0,
  class: "input-group-suffix"
}, K8 = ["placeholder", "autocomplete", "type", "rows", "disabled"], X8 = {
  key: 1,
  class: "input-group-append input-group-icon"
}, G8 = {
  key: 2,
...
function e5(e, s, t, o, c, n) {
  ...
  return h(), p("div", {
    ...
    y("div", Z8, [
      ...
      e.$slots.append ? (h(), p("div", G8, [
        F(e.$slots, "append", {}, void 0, !0)
      ])) : f("", !0)
    ]),
    t.message ? (h(), p("div", J8, w(t.message), 1)) : f("", !0)
  ], 2);
}
const t5 = /* @__PURE__ */ P(Y8, [["render", e5], ["__scopeId", "data-v-cf411692"]]);
const s5 = {
  name: "NiceToast",
  data() {
    return {
...
}, c5 = { class: "nice-toasts" };
function o5(e, s, t, o, c, n) {
  return h(), p("div", c5, [
    B(R1, {
      name: "toast",
      key: "div"
...
const n5 = /* @__PURE__ */ P(s5, [["render", o5], ["__scopeId", "data-v-d538dc55"]]);
const i5 = {
  name: "NiceUpload",
  components: {
    NiceComponentHeader: y0
  ...
  // },
}, l5 = ["modelValue", "placeholder", "required", "accept", "disabled"], a5 = {
  key: 0,
  class: "nice-upload-overlay"
}, r5 = { class: "nice-upload-overlay-message" }, d5 = {
  key: 1,
  class: "nice-upload-overlay"
};
function h5(e, s, t, o, c, n) {
  ...
  return h(), p("div", {
    ...
    y("div", {
      ...
      n.localValue ? (h(), p("div", d5, [
        ...
        y("div", r5, w(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      c.loading ? (h(), T(v, {
        key: 2,
        "full-div": ""
...
const u5 = /* @__PURE__ */ P(i5, [["render", h5], ["__scopeId", "data-v-08563ae3"]]);
const v5 = {
  name: "NiceView",
  props: {
    title: {
...
function y5(e, s, t, o, c, n) {
  ...
  return h(), p("div", {
    ...
    n.showHeader ? (h(), p("div", p5, [
      ...
      e.$slots.title || t.title ? (h(), p("div", m5, [
        F(e.$slots, "title", {}, () => [
          m0(w(t.title), 1)
        ], !0)
      ])) : f("", !0)
    ...
    e.$slots.footer ? (h(), p("div", f5, [
      F(e.$slots, "footer", {}, void 0, !0)
    ])) : f("", !0)
  ], 2);
}
const M5 = /* @__PURE__ */ P(v5, [["render", y5], ["__scopeId", "data-v-3644b288"]]);
const b5 = {
  name: "NiceWrapper",
...
}, g5 = (e) => (D0("data-v-e0a79396"), e = e(), $0(), e), z5 = {
  key: 0,
...
}, C5 = /* @__PURE__ */ g5(() => /* @__PURE__ */ y("div", { class: "flex-grow" }, null, -1)), B5 = {
  key: 2,
  class: "wrapper-footer"
};
function k5(e, s, t, o, c, n) {
  const r = V("NiceButton");
  return h(), p("div", {
    class: k(["nice-wrapper", { "no-margin": t.noMargin }])
  }, [
    e.$slots.header || t.title || t.subtitle ? (h(), p("div", z5, [
      t.title || t.subtitle ? (h(), p("div", w5, [
        t.title ? (h(), p("div", _5, w(t.title), 1)) : f("", !0),
        t.subtitle ? (h(), p("div", x5, w(t.subtitle), 1)) : f("", !0)
      ])) : f("", !0),
    ...
    e.$slots.footer && c.isOpen ? (h(), p("div", B5, [
      F(e.$slots, "footer", {}, void 0, !0)
    ])) : f("", !0)
  ], 2);
}
const N5 = /* @__PURE__ */ P(b5, [["render", k5], ["__scopeId", "data-v-e0a79396"]]), P1 = {
  NiceActions: q2,
  NiceAvatar: n4,
  NiceButton: v0,
  NiceCheckbox: L0,
