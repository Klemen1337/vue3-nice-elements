import { resolveComponent as V, openBlock as h, createElementBlock as p, normalizeClass as k, createBlock as T, createCommentVNode as f, renderSlot as F, toDisplayString as w, Teleport as v2, createVNode as B, Transition as j0, withCtx as U, normalizeStyle as j1, createElementVNode as y, createTextVNode as m0, inject as D0, Fragment as j, computed as Q, unref as D, pushScopeId as $0, popScopeId as T0, ref as u0, onMounted as Y0, onBeforeUnmount as p2, withDirectives as M0, vShow as C1, vModelText as l1, renderList as W, vModelDynamic as m2, TransitionGroup as W1, createStaticVNode as f2, resolveDynamicComponent as y2, normalizeProps as b2, mergeProps as M2, isRef as B1 } from "vue";
import { useGettext as g2 } from "vue3-gettext";
function z2(e) {
...
const P = (e, s) => {
  ...
  for (const [o, c] of s)
    t[o] = c;
  return t;
}, w2 = ["type", "disabled"], _2 = { key: 2 }, x2 = { key: 3 }, C2 = {
  name: "NiceButton"
}, B2 = /* @__PURE__ */ Object.assign(C2, {
  props: {
    addClass: {
      type: String,
      default: null
  ...
  setup(e) {
    const s = e;
    return (t, o) => {
      const c = V("NiceLoading"), n = V("NiceIcon");
      return h(), p("button", {
        class: k(["nice-button btn", [
          ...
          {
            "btn-naked": s.naked,
            "btn-rounded": s.rounded,
            "btn-plain": s.plain,
            "btn-outline": s.outline,
            "btn-icon": !t.$slots.default && !s.text && (s.icon || s.appendIcon)
          }
        ]]),
        type: s.nativeType,
        ...
        t.$slots.default ? (h(), p("span", _2, [
          F(t.$slots, "default", {}, void 0, !0)
        ])) : f("", !0),
        s.text ? (h(), p("span", x2, w(s.text), 1)) : f("", !0),
        s.appendIcon ? (h(), T(n, {
          key: 4,
          icon: s.appendIcon
        }, null, 8, ["icon"])) : f("", !0)
...
}), v0 = /* @__PURE__ */ P(B2, [["__scopeId", "data-v-c4cf40bd"]]);
const k2 = {
  name: "NiceModal",
  props: {
    name: {
...
}, V2 = { class: "nice-modal-title" }, S2 = { class: "nice-modal-subtitle" }, O2 = {
  key: 1,
  class: "nice-modal-footer"
};
function D2(e, s, t, o, c, n) {
  const r = V("NiceButton");
  return h(), T(v2, { to: "body" }, [
    B(j0, { name: "fade" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          key: 0,
          class: "nice-modal-overlay",
          onClick: s[0] || (s[0] = (...i) => n.close && n.close(...i))
        })) : f("", !0)
      ]),
      _: 1
    }),
    B(j0, { name: "flyin" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          key: 0,
          class: "nice-modal",
          style: j1({ width: t.width, height: t.height })
        }, [
          e.$slots.title || t.title || e.$slots.subtitle || t.subtitle ? (h(), p("div", N2, [
            y("div", V2, [
              e.$slots.title || t.title ? F(e.$slots, "title", { key: 0 }, () => [
                m0(w(t.title), 1)
              ], !0) : f("", !0)
            ]),
            y("div", S2, [
              e.$slots.subtitle || t.subtitle ? F(e.$slots, "subtitle", { key: 0 }, () => [
                m0(w(t.subtitle), 1)
              ], !0) : f("", !0)
            ]),
            B(r, {
          ...
          y("div", {
            class: k(["nice-modal-body", { "no-header": !(e.$slots.title || t.title || e.$slots.subtitle || t.subtitle), "no-footer": !e.$slots.footer }])
          }, [
            F(e.$slots, "default", {}, void 0, !0)
          ], 2),
          e.$slots.footer ? (h(), p("div", O2, [
...
const U1 = /* @__PURE__ */ P(k2, [["render", D2], ["__scopeId", "data-v-46a2523a"]]), $2 = {
...
}, T2 = { class: "nice-actions" };
function E2(e, s, t, o, c, n) {
  const r = V("NiceButton"), i = V("NiceModal");
  return h(), T(i, {
    name: t.name,
...
const Y1 = /* @__PURE__ */ P($2, [["render", E2]]);
const I2 = { class: "nice-actions" }, q2 = /* @__PURE__ */ y("div", { class: "f-grow" }, null, -1), A2 = {
  name: "NiceActions"
  ...
  setup(e, { emit: s }) {
    ...
    function r() {
      o.modal("delete-prompt", !1), s("delete");
    }
    function i() {
      s("cancel");
    }
    return (v, a) => {
      const l = V("NiceButton");
      return h(), p(j, null, [
        y("div", I2, [
          t.showDelete ? (h(), T(l, {
            key: 0,
            ...
            type: "danger",
            onClick: n,
            text: v.$t("Nice", "Delete"),
            form: t.form,
            disabled: t.loading,
            icon: "icon-trash-2"
          }, null, 8, ["text", "form", "disabled"])) : f("", !0),
          F(v.$slots, "left"),
          q2,
          F(v.$slots, "default"),
          B(l, {
          ...
          B(l, {
            "native-type": "submit",
            onClick: c,
            text: t.submitText ? t.submitText : v.$t("Nice", "Submit"),
            form: t.form,
            disabled: t.loading,
            icon: "icon-save"
          }, null, 8, ["text", "form", "disabled"])
        ...
        B(Y1, {
          name: "delete-prompt",
          onConfirm: r,
          title: v.$t("Nice", "Delete"),
          subtitle: t.deleteText ? t.deleteText : v.$t("Nice", "Are you sure you want to delete?")
...
var H2 = R2;
const t1 = (e, s, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (s - e) * 6 * t : t < 1 / 2 ? s : t < 2 / 3 ? e + (s - e) * (2 / 3 - t) * 6 : e), j2 = (e, s, t) => {
  let o, c, n;
  if (e = e / 360, s == 0)
    o = c = n = t;
  else {
    const r = t < 0.5 ? t * (1 + s) : t + s - t * s, i = 2 * t - r;
    o = t1(i, r, e + 1 / 3), c = t1(i, r, e), n = t1(i, r, e - 1 / 3);
  }
  return [
...
var W2 = j2;
const U2 = L2, Y2 = H2, k1 = W2, Z2 = () => Math.floor(Math.random() * Date.now()), K2 = (e, s) => {
  const t = U2(e), o = Y2(t % 360, 1, 0.5), c = k1(o[0][0], o[0][1], o[0][2]), n = k1(o[1][0], o[1][1], o[1][2]), r = `rgb(${c[0]}, ${c[1]}, ${c[2]})`, i = `rgb(${n[0]}, ${n[1]}, ${n[2]})`, v = Z2();
...
<svg ${s != null ? `width="${s}px" height="${s}px"` : ""} viewBox="0 0 80 80" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
    <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="${v}">
      <stop stop-color="${r}" offset="0%"></stop>
      <stop stop-color="${i}" offset="100%"></stop>
    </linearGradient>
  </defs>
  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <rect id="Rectangle" fill="url(#${v})" x="0" y="0" width="80" height="80"></rect>
  </g>
</svg>`;
};
var Q2 = K2, W0 = {}, G2 = {
...
(function() {
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = {
    ...
    bytesToWords: function(t) {
      for (var o = [], c = 0, n = 0; c < t.length; c++, n += 8)
        o[n >>> 5] |= t[c] << 24 - n % 32;
      return o;
    },
    ...
    bytesToBase64: function(t) {
      for (var o = [], c = 0; c < t.length; c += 3)
        for (var n = t[c] << 16 | t[c + 1] << 8 | t[c + 2], r = 0; r < 4; r++)
          c * 8 + r * 6 <= t.length * 8 ? o.push(e.charAt(n >>> 6 * (3 - r) & 63)) : o.push("=");
      return o.join("");
    },
    // Convert a base-64 string to a byte array
    base64ToBytes: function(t) {
      t = t.replace(/[^A-Z0-9+\/]/ig, "");
      for (var o = [], c = 0, n = 0; c < t.length; n = ++c % 4)
        n != 0 && o.push((e.indexOf(t.charAt(c - 1)) & Math.pow(2, -2 * n + 8) - 1) << n * 2 | e.indexOf(t.charAt(c)) >>> 6 - n * 2);
      return o;
    }
  };
  X2.exports = s;
 ...
 */
var J2 = function(e) {
  return e != null && (Z1(e) || e4(e) || !!e._isBuffer);
};
function Z1(e) {
  return !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
}
function e4(e) {
  return typeof e.readFloatLE == "function" && typeof e.slice == "function" && Z1(e.slice(0, 0));
}
(function() {
  var e = s1, s = N1.utf8, t = J2, o = N1.bin, c = function(n, r) {
    n.constructor == String ? r && r.encoding === "binary" ? n = o.stringToBytes(n) : n = s.stringToBytes(n) : t(n) ? n = Array.prototype.slice.call(n, 0) : !Array.isArray(n) && n.constructor !== Uint8Array && (n = n.toString());
    for (var i = e.bytesToWords(n), v = n.length * 8, a = 1732584193, l = -271733879, d = -1732584194, u = 271733878, m = 0; m < i.length; m++)
      i[m] = (i[m] << 8 | i[m] >>> 24) & 16711935 | (i[m] << 24 | i[m] >>> 8) & 4278255360;
    i[v >>> 5] |= 128 << v % 32, i[(v + 64 >>> 9 << 4) + 14] = v;
    for (var _ = c._ff, M = c._gg, g = c._hh, C = c._ii, m = 0; m < i.length; m += 16) {
      var E = a, I = l, N = d, S = u;
      a = _(a, l, d, u, i[m + 0], 7, -680876936), u = _(u, a, l, d, i[m + 1], 12, -389564586), d = _(d, u, a, l, i[m + 2], 17, 606105819), l = _(l, d, u, a, i[m + 3], 22, -1044525330), a = _(a, l, d, u, i[m + 4], 7, -176418897), u = _(u, a, l, d, i[m + 5], 12, 1200080426), d = _(d, u, a, l, i[m + 6], 17, -1473231341), l = _(l, d, u, a, i[m + 7], 22, -45705983), a = _(a, l, d, u, i[m + 8], 7, 1770035416), u = _(u, a, l, d, i[m + 9], 12, -1958414417), d = _(d, u, a, l, i[m + 10], 17, -42063), l = _(l, d, u, a, i[m + 11], 22, -1990404162), a = _(a, l, d, u, i[m + 12], 7, 1804603682), u = _(u, a, l, d, i[m + 13], 12, -40341101), d = _(d, u, a, l, i[m + 14], 17, -1502002290), l = _(l, d, u, a, i[m + 15], 22, 1236535329), a = M(a, l, d, u, i[m + 1], 5, -165796510), u = M(u, a, l, d, i[m + 6], 9, -1069501632), d = M(d, u, a, l, i[m + 11], 14, 643717713), l = M(l, d, u, a, i[m + 0], 20, -373897302), a = M(a, l, d, u, i[m + 5], 5, -701558691), u = M(u, a, l, d, i[m + 10], 9, 38016083), d = M(d, u, a, l, i[m + 15], 14, -660478335), l = M(l, d, u, a, i[m + 4], 20, -405537848), a = M(a, l, d, u, i[m + 9], 5, 568446438), u = M(u, a, l, d, i[m + 14], 9, -1019803690), d = M(d, u, a, l, i[m + 3], 14, -187363961), l = M(l, d, u, a, i[m + 8], 20, 1163531501), a = M(a, l, d, u, i[m + 13], 5, -1444681467), u = M(u, a, l, d, i[m + 2], 9, -51403784), d = M(d, u, a, l, i[m + 7], 14, 1735328473), l = M(l, d, u, a, i[m + 12], 20, -1926607734), a = g(a, l, d, u, i[m + 5], 4, -378558), u = g(u, a, l, d, i[m + 8], 11, -2022574463), d = g(d, u, a, l, i[m + 11], 16, 1839030562), l = g(l, d, u, a, i[m + 14], 23, -35309556), a = g(a, l, d, u, i[m + 1], 4, -1530992060), u = g(u, a, l, d, i[m + 4], 11, 1272893353), d = g(d, u, a, l, i[m + 7], 16, -155497632), l = g(l, d, u, a, i[m + 10], 23, -1094730640), a = g(a, l, d, u, i[m + 13], 4, 681279174), u = g(u, a, l, d, i[m + 0], 11, -358537222), d = g(d, u, a, l, i[m + 3], 16, -722521979), l = g(l, d, u, a, i[m + 6], 23, 76029189), a = g(a, l, d, u, i[m + 9], 4, -640364487), u = g(u, a, l, d, i[m + 12], 11, -421815835), d = g(d, u, a, l, i[m + 15], 16, 530742520), l = g(l, d, u, a, i[m + 2], 23, -995338651), a = C(a, l, d, u, i[m + 0], 6, -198630844), u = C(u, a, l, d, i[m + 7], 10, 1126891415), d = C(d, u, a, l, i[m + 14], 15, -1416354905), l = C(l, d, u, a, i[m + 5], 21, -57434055), a = C(a, l, d, u, i[m + 12], 6, 1700485571), u = C(u, a, l, d, i[m + 3], 10, -1894986606), d = C(d, u, a, l, i[m + 10], 15, -1051523), l = C(l, d, u, a, i[m + 1], 21, -2054922799), a = C(a, l, d, u, i[m + 8], 6, 1873313359), u = C(u, a, l, d, i[m + 15], 10, -30611744), d = C(d, u, a, l, i[m + 6], 15, -1560198380), l = C(l, d, u, a, i[m + 13], 21, 1309151649), a = C(a, l, d, u, i[m + 4], 6, -145523070), u = C(u, a, l, d, i[m + 11], 10, -1120210379), d = C(d, u, a, l, i[m + 2], 15, 718787259), l = C(l, d, u, a, i[m + 9], 21, -343485551), a = a + E >>> 0, l = l + I >>> 0, d = d + N >>> 0, u = u + S >>> 0;
    }
    return e.endian([a, l, d, u]);
  };
  c._ff = function(n, r, i, v, a, l, d) {
    var u = n + (r & i | ~r & v) + (a >>> 0) + d;
    return (u << l | u >>> 32 - l) + r;
  }, c._gg = function(n, r, i, v, a, l, d) {
    var u = n + (r & v | i & ~v) + (a >>> 0) + d;
    return (u << l | u >>> 32 - l) + r;
  }, c._hh = function(n, r, i, v, a, l, d) {
    var u = n + (r ^ i ^ v) + (a >>> 0) + d;
    return (u << l | u >>> 32 - l) + r;
  }, c._ii = function(n, r, i, v, a, l, d) {
    var u = n + (i ^ (r | ~v)) + (a >>> 0) + d;
    return (u << l | u >>> 32 - l) + r;
  }, c._blocksize = 16, c._digestsize = 16, G2.exports = function(n, r) {
    if (n == null)
      throw new Error("Illegal argument " + n);
    var i = e.wordsToBytes(c(n, r));
    return r && r.asBytes ? i : r && r.asString ? o.bytesToString(i) : e.bytesToHex(i);
  };
})();
const t4 = {
  key: 0,
  class: "status"
}, s4 = ["innerHTML"], c4 = ["src"], o4 = ["src"], n4 = {
  key: 4,
  class: "text"
}, i4 = {
  name: "NiceAvatar"
}, l4 = /* @__PURE__ */ Object.assign(i4, {
  props: {
    text: {
      type: String,
      required: !1
  ...
  setup(e) {
    const s = e, t = Q(() => Q2(W0(s.hash || s.text))), o = Q(() => {
      const n = s.text.split(" ");
      return n.length > 1 ? n[0][0] + n[1][0] : s.text[0] + s.text[1];
    }), c = Q(() => "https://www.gravatar.com/avatar/" + W0(s.gavatar.trim().toLowerCase()) + "?s=50");
    return (n, r) => (h(), p("div", {
      class: k(["nice-avatar", [
        s.size ? "size-" + s.size : "",
      ...
      s.text ? (h(), p("div", n4, w(D(o)), 1)) : f("", !0)
    ], 2));
  }
});
const a4 = (e) => ($0("data-v-59577e66"), e = e(), T0(), e), r4 = { class: "nice-checkbox-box" }, d4 = {
  key: 0,
  viewBox: "0 0 20 20"
}, h4 = /* @__PURE__ */ a4(() => /* @__PURE__ */ y("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), u4 = [
  h4
], v4 = ["for"], p4 = ["id", "disabled"], m4 = {
  name: "NiceCheckbox"
}, f4 = /* @__PURE__ */ Object.assign(m4, {
  props: {
    modelValue: {
      type: [Boolean, null],
      default: !1
  ...
  setup(e, { emit: s }) {
    const t = e, o = Math.random().toString(36).slice(2, 7), c = Q({
      get() {
        return t.modelValue;
      },
      set(r) {
    ...
    return (r, i) => (h(), p("div", {
      class: k(["nice-component nice-checkbox", { "no-margin": t.noMargin, active: D(c), disabled: t.disabled }]),
      onClick: n
    }, [
      y("div", r4, [
        D(c) ? (h(), p("svg", d4, u4)) : f("", !0)
      ]),
      t.title ? (h(), p("div", {
        key: 0,
        class: "nice-checkbox-title",
        for: "nice-checkbox" + D(o)
      }, w(t.title), 9, v4)) : f("", !0),
      y("input", {
        type: "checkbox",
        id: "nice-checkbox" + D(o),
        disabled: t.disabled
      }, null, 8, p4)
    ], 2));
  }
}), R0 = /* @__PURE__ */ P(f4, [["__scopeId", "data-v-59577e66"]]);
const y4 = {
...
function w4(e, s, t, o, c, n) {
  return t.title || t.caption ? (h(), p("div", b4, [
    t.title ? (h(), p("div", M4, [
      m0(w(t.title) + " ", 1),
      t.required ? (h(), p("span", g4, " *")) : f("", !0)
    ])) : f("", !0),
    t.caption ? (h(), p("div", z4, w(t.caption), 1)) : f("", !0)
  ])) : f("", !0);
}
const y0 = /* @__PURE__ */ P(y4, [["render", w4], ["__scopeId", "data-v-b2f23a24"]]);
var Y = "top", e0 = "bottom", t0 = "right", Z = "left", Z0 = "auto", E0 = [Y, e0, t0, Z], g0 = "start", S0 = "end", _4 = "clippingParents", K1 = "viewport", k0 = "popper", x4 = "reference", V1 = /* @__PURE__ */ E0.reduce(function(e, s) {
  return e.concat([s + "-" + g0, s + "-" + S0]);
}, []), Q1 = /* @__PURE__ */ [].concat(E0, [Z0]).reduce(function(e, s) {
  return e.concat([s, s + "-" + g0, s + "-" + S0]);
}, []), C4 = "beforeRead", B4 = "read", k4 = "afterRead", N4 = "beforeMain", V4 = "main", S4 = "afterMain", O4 = "beforeWrite", D4 = "write", $4 = "afterWrite", o1 = [C4, B4, k4, N4, V4, S4, O4, D4, $4];
function o0(e) {
...
function G(e) {
  var s = X(e).HTMLElement;
  return e instanceof s || e instanceof HTMLElement;
}
function a1(e) {
  if (typeof ShadowRoot > "u")
    return !1;
  var s = X(e).ShadowRoot;
  return e instanceof s || e instanceof ShadowRoot;
}
function T4(e) {
  var s = e.state;
  Object.keys(s.elements).forEach(function(t) {
    var o = s.styles[t] || {}, c = s.attributes[t] || {}, n = s.elements[t];
    !G(n) || !o0(n) || (Object.assign(n.style, o), Object.keys(c).forEach(function(r) {
      var i = c[r];
      i === !1 ? n.removeAttribute(r) : n.setAttribute(r, i === !0 ? "" : i);
    }));
  });
}
function E4(e) {
  ...
  return Object.assign(s.elements.popper.style, t.popper), s.styles = t, s.elements.arrow && Object.assign(s.elements.arrow.style, t.arrow), function() {
    Object.keys(s.elements).forEach(function(o) {
      var c = s.elements[o], n = s.attributes[o] || {}, r = Object.keys(s.styles.hasOwnProperty(o) ? s.styles[o] : t[o]), i = r.reduce(function(v, a) {
        return v[a] = "", v;
      }, {});
      !G(c) || !o0(c) || (Object.assign(c.style, i), Object.keys(n).forEach(function(v) {
        c.removeAttribute(v);
      }));
    });
  };
...
var p0 = Math.max, U0 = Math.min, z0 = Math.round;
function n1() {
...
function w0(e, s, t) {
  ...
  var o = e.getBoundingClientRect(), c = 1, n = 1;
  s && G(e) && (c = e.offsetWidth > 0 && z0(o.width) / e.offsetWidth || 1, n = e.offsetHeight > 0 && z0(o.height) / e.offsetHeight || 1);
  var r = f0(e) ? X(e) : window, i = r.visualViewport, v = !G1() && t, a = (o.left + (v && i ? i.offsetLeft : 0)) / c, l = (o.top + (v && i ? i.offsetTop : 0)) / n, d = o.width / c, u = o.height / n;
  return {
    width: d,
    height: u,
    top: l,
...
function r1(e) {
  var s = w0(e), t = e.offsetWidth, o = e.offsetHeight;
...
function q4(e) {
  return ["table", "td", "th"].indexOf(o0(e)) >= 0;
}
function l0(e) {
  return ((f0(e) ? e.ownerDocument : (
...
function K0(e) {
  return o0(e) === "html" ? e : (
    ...
    (a1(e) ? e.host : null) || // ShadowRoot detected
...
function A4(e) {
  var s = /firefox/i.test(n1()), t = /Trident/i.test(n1());
  if (t && G(e)) {
    var o = c0(e);
    if (o.position === "fixed")
      return null;
  ...
  var c = K0(e);
  for (a1(c) && (c = c.host); G(c) && ["html", "body"].indexOf(o0(c)) < 0; ) {
    var n = c0(c);
    if (n.transform !== "none" || n.perspective !== "none" || n.contain === "paint" || ["transform", "perspective"].indexOf(n.willChange) !== -1 || s && n.willChange === "filter" || s && n.filter && n.filter !== "none")
      return c;
    c = c.parentNode;
  }
  return null;
...
function I0(e) {
  for (var s = X(e), t = S1(e); t && q4(t) && c0(t).position === "static"; )
    t = S1(t);
  return t && (o0(t) === "html" || o0(t) === "body" && c0(t).position === "static") ? s : t || A4(e) || s;
}
function d1(e) {
...
var P4 = function(s, t) {
  ...
  })) : s, e2(typeof s != "number" ? s : t2(s, E0));
};
function L4(e) {
  var s, t = e.state, o = e.name, c = e.options, n = t.elements.arrow, r = t.modifiersData.popperOffsets, i = s0(t.placement), v = d1(i), a = [Z, t0].indexOf(i) >= 0, l = a ? "height" : "width";
  if (!(!n || !r)) {
    var d = P4(c.padding, t), u = r1(n), m = v === "y" ? Y : Z, _ = v === "y" ? e0 : t0, M = t.rects.reference[l] + t.rects.reference[v] - r[v] - t.rects.popper[l], g = r[v] - t.rects.reference[v], C = I0(n), E = C ? v === "y" ? C.clientHeight || 0 : C.clientWidth || 0 : 0, I = M / 2 - g / 2, N = d[m], S = E - u[l] - d[_], O = E / 2 - u[l] / 2 + I, q = N0(N, O, S), A = v;
    t.modifiersData[o] = (s = {}, s[A] = q, s.centerOffset = q - O, s);
  }
}
function R4(e) {
  ...
  if (c != null && !(typeof c == "string" && (c = s.elements.popper.querySelector(c), !c))) {
    if (process.env.NODE_ENV !== "production" && (G(c) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !X1(s.elements.popper, c)) {
...
function O1(e) {
  var s, t = e.popper, o = e.popperRect, c = e.placement, n = e.variation, r = e.offsets, i = e.position, v = e.gpuAcceleration, a = e.adaptive, l = e.roundOffsets, d = e.isFixed, u = r.x, m = u === void 0 ? 0 : u, _ = r.y, M = _ === void 0 ? 0 : _, g = typeof l == "function" ? l({
    x: m,
    y: M
  }) : {
    x: m,
  ...
  m = g.x, M = g.y;
  var C = r.hasOwnProperty("x"), E = r.hasOwnProperty("y"), I = Z, N = Y, S = window;
  if (a) {
    var O = I0(t), q = "clientHeight", A = "clientWidth";
    if (O === X(t) && (O = l0(t), c0(O).position !== "static" && i === "absolute" && (q = "scrollHeight", A = "scrollWidth")), O = O, c === Y || (c === Z || c === t0) && n === S0) {
      N = e0;
      var R = d && O === S && S.visualViewport ? S.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        O[q]
      );
      M -= R - o.height, M *= v ? 1 : -1;
    }
    if (c === Z || (c === Y || c === e0) && n === S0) {
      I = t0;
      var L = d && O === S && S.visualViewport ? S.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        O[A]
      );
      m -= L - o.width, m *= v ? 1 : -1;
  ...
  if (m = $.x, M = $.y, v) {
    var H;
    return Object.assign({}, b, (H = {}, H[N] = E ? "0" : "", H[I] = C ? "0" : "", H.transform = (S.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + M + "px)" : "translate3d(" + m + "px, " + M + "px, 0)", H));
  }
  return Object.assign({}, b, (s = {}, s[N] = E ? M + "px" : "", s[I] = C ? m + "px" : "", s.transform = "", s));
}
function U4(e) {
  var s = e.state, t = e.options, o = t.gpuAcceleration, c = o === void 0 ? !0 : o, n = t.adaptive, r = n === void 0 ? !0 : n, i = t.roundOffsets, v = i === void 0 ? !0 : i;
  if (process.env.NODE_ENV !== "production") {
    var a = c0(s.elements.popper).transitionProperty || "";
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
  ...
  var l = {
    placement: s0(s.placement),
    variation: _0(s.placement),
    popper: s.elements.popper,
    popperRect: s.rects.popper,
    gpuAcceleration: c,
    isFixed: s.options.strategy === "fixed"
  };
  s.modifiersData.popperOffsets != null && (s.styles.popper = Object.assign({}, s.styles.popper, O1(Object.assign({}, l, {
    offsets: s.modifiersData.popperOffsets,
    position: s.options.strategy,
    adaptive: r,
    roundOffsets: v
  })))), s.modifiersData.arrow != null && (s.styles.arrow = Object.assign({}, s.styles.arrow, O1(Object.assign({}, l, {
...
function Z4(e) {
  var s = e.state, t = e.instance, o = e.options, c = o.scroll, n = c === void 0 ? !0 : c, r = o.resize, i = r === void 0 ? !0 : r, v = X(s.elements.popper), a = [].concat(s.scrollParents.reference, s.scrollParents.popper);
  return n && a.forEach(function(l) {
    l.addEventListener("scroll", t.update, L0);
  }), i && v.addEventListener("resize", t.update, L0), function() {
    n && a.forEach(function(l) {
      l.removeEventListener("scroll", t.update, L0);
    }), i && v.removeEventListener("resize", t.update, L0);
  };
}
const K4 = {
  name: "eventListeners",
...
function h1(e) {
  var s = X(e), t = s.pageXOffset, o = s.pageYOffset;
  return {
    scrollLeft: t,
    scrollTop: o
  };
...
function u1(e) {
  return w0(l0(e)).left + h1(e).scrollLeft;
}
function X4(e, s) {
  var t = X(e), o = l0(e), c = t.visualViewport, n = o.clientWidth, r = o.clientHeight, i = 0, v = 0;
  if (c) {
    n = c.width, r = c.height;
    var a = G1();
    (a || !a && s === "fixed") && (i = c.offsetLeft, v = c.offsetTop);
  }
  return {
    width: n,
    height: r,
...
function J4(e) {
  var s, t = l0(e), o = h1(e), c = (s = e.ownerDocument) == null ? void 0 : s.body, n = p0(t.scrollWidth, t.clientWidth, c ? c.scrollWidth : 0, c ? c.clientWidth : 0), r = p0(t.scrollHeight, t.clientHeight, c ? c.scrollHeight : 0, c ? c.clientHeight : 0), i = -o.scrollLeft + u1(e), v = -o.scrollTop;
  return c0(c || t).direction === "rtl" && (i += p0(t.clientWidth, c ? c.clientWidth : 0) - n), {
    width: n,
    height: r,
    x: i,
    y: v
...
function v1(e) {
  var s = c0(e), t = s.overflow, o = s.overflowX, c = s.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + c + o);
}
function s2(e) {
  return ["html", "body", "#document"].indexOf(o0(e)) >= 0 ? e.ownerDocument.body : G(e) && v1(e) ? e : s2(K0(e));
}
function V0(e, s) {
  var t;
  s === void 0 && (s = []);
  var o = s2(e), c = o === ((t = e.ownerDocument) == null ? void 0 : t.body), n = X(o), r = c ? [n].concat(n.visualViewport || [], v1(o) ? o : []) : o, i = s.concat(r);
  return c ? i : (
...
function e3(e, s) {
  var t = w0(e, !1, s === "fixed");
  return t.top = t.top + e.clientTop, t.left = t.left + e.clientLeft, t.bottom = t.top + e.clientHeight, t.right = t.left + e.clientWidth, t.width = e.clientWidth, t.height = e.clientHeight, t.x = t.left, t.y = t.top, t;
}
function $1(e, s, t) {
  return s === K1 ? i1(X4(e, t)) : f0(s) ? e3(s, t) : i1(J4(l0(e)));
}
function t3(e) {
  var s = V0(K0(e)), t = ["absolute", "fixed"].indexOf(c0(e).position) >= 0, o = t && G(e) ? I0(e) : e;
  return f0(o) ? s.filter(function(c) {
    return f0(c) && X1(c, o) && o0(c) !== "body";
  }) : [];
}
function s3(e, s, t, o) {
  var c = s === "clippingParents" ? t3(e) : [].concat(s), n = [].concat(c, [t]), r = n[0], i = n.reduce(function(v, a) {
    var l = $1(e, a, o);
    return v.top = p0(l.top, v.top), v.right = U0(l.right, v.right), v.bottom = U0(l.bottom, v.bottom), v.left = p0(l.left, v.left), v;
  }, $1(e, r, o));
  return i.width = i.right - i.left, i.height = i.bottom - i.top, i.x = i.left, i.y = i.top, i;
}
function c2(e) {
  var s = e.reference, t = e.element, o = e.placement, c = o ? s0(o) : null, n = o ? _0(o) : null, r = s.x + s.width / 2 - t.width / 2, i = s.y + s.height / 2 - t.height / 2, v;
  switch (c) {
    case Y:
      v = {
        x: r,
...
function O0(e, s) {
  s === void 0 && (s = {});
  var t = s, o = t.placement, c = o === void 0 ? e.placement : o, n = t.strategy, r = n === void 0 ? e.strategy : n, i = t.boundary, v = i === void 0 ? _4 : i, a = t.rootBoundary, l = a === void 0 ? K1 : a, d = t.elementContext, u = d === void 0 ? k0 : d, m = t.altBoundary, _ = m === void 0 ? !1 : m, M = t.padding, g = M === void 0 ? 0 : M, C = e2(typeof g != "number" ? g : t2(g, E0)), E = u === k0 ? x4 : k0, I = e.rects.popper, N = e.elements[_ ? E : u], S = s3(f0(N) ? N : N.contextElement || l0(e.elements.popper), v, l, r), O = w0(e.elements.reference), q = c2({
    reference: O,
    element: I,
    strategy: "absolute",
    placement: c
  }), A = i1(Object.assign({}, I, q)), R = u === k0 ? A : O, L = {
    top: S.top - R.top + C.top,
    bottom: R.bottom - S.bottom + C.bottom,
    left: S.left - R.left + C.left,
    right: R.right - S.right + C.right
  }, b = e.modifiersData.offset;
  if (u === k0 && b) {
    var $ = b[c];
    Object.keys(L).forEach(function(H) {
      var K = [t0, e0].indexOf(H) >= 0 ? 1 : -1, J = [Y, e0].indexOf(H) >= 0 ? "y" : "x";
      L[H] += $[J] * K;
    });
  }
  return L;
...
function c3(e, s) {
  s === void 0 && (s = {});
  var t = s, o = t.placement, c = t.boundary, n = t.rootBoundary, r = t.padding, i = t.flipVariations, v = t.allowedAutoPlacements, a = v === void 0 ? Q1 : v, l = _0(o), d = l ? i ? V1 : V1.filter(function(_) {
    return _0(_) === l;
  }) : E0, u = d.filter(function(_) {
  ...
  return Object.keys(m).sort(function(_, M) {
    return m[_] - m[M];
  });
}
function o3(e) {
...
function n3(e) {
  ...
  if (!s.modifiersData[o]._skip) {
    for (var c = t.mainAxis, n = c === void 0 ? !0 : c, r = t.altAxis, i = r === void 0 ? !0 : r, v = t.fallbackPlacements, a = t.padding, l = t.boundary, d = t.rootBoundary, u = t.altBoundary, m = t.flipVariations, _ = m === void 0 ? !0 : m, M = t.allowedAutoPlacements, g = s.options.placement, C = s0(g), E = C === g, I = v || (E || !_ ? [H0(g)] : o3(g)), N = [g].concat(I).reduce(function(b0, n0) {
      return b0.concat(s0(n0) === Z0 ? c3(s, {
        placement: n0,
        boundary: l,
        rootBoundary: d,
        padding: a,
    ...
    }, []), S = s.rects.reference, O = s.rects.popper, q = /* @__PURE__ */ new Map(), A = !0, R = N[0], L = 0; L < N.length; L++) {
      var b = N[L], $ = s0(b), H = _0(b) === g0, K = [Y, e0].indexOf($) >= 0, J = K ? "width" : "height", z = O0(s, {
        placement: b,
        boundary: l,
        rootBoundary: d,
        altBoundary: u,
      ...
      S[J] > O[J] && (x = H0(x));
      var x0 = H0(x), a0 = [];
      if (n && a0.push(z[$] <= 0), i && a0.push(z[x] <= 0, z[x0] <= 0), a0.every(function(b0) {
        return b0;
      })) {
        R = b, A = !1;
        break;
    ...
    if (A)
      for (var q0 = _ ? 3 : 1, G0 = function(n0) {
        var B0 = N.find(function(F0) {
          var r0 = q.get(F0);
          if (r0)
            return r0.slice(0, n0).every(function(X0) {
              return X0;
            });
        });
        if (B0)
    ...
    s.placement !== R && (s.modifiersData[o]._skip = !0, s.placement = R, s.reset = !0);
  }
}
const i3 = {
  name: "flip",
...
function E1(e) {
  return [Y, t0, e0, Z].some(function(s) {
    return e[s] >= 0;
  });
}
function l3(e) {
  var s = e.state, t = e.name, o = s.rects.reference, c = s.rects.popper, n = s.modifiersData.preventOverflow, r = O0(s, {
    elementContext: "reference"
  }), i = O0(s, {
    altBoundary: !0
  }), v = T1(r, o), a = T1(i, c, n), l = E1(v), d = E1(a);
  s.modifiersData[t] = {
...
function r3(e, s, t) {
  var o = s0(e), c = [Z, Y].indexOf(o) >= 0 ? -1 : 1, n = typeof t == "function" ? t(Object.assign({}, s, {
    placement: e
  })) : t, r = n[0], i = n[1];
  return r = r || 0, i = (i || 0) * c, [Z, t0].indexOf(o) >= 0 ? {
    x: i,
    y: r
  } : {
    x: r,
...
function d3(e) {
  var s = e.state, t = e.options, o = e.name, c = t.offset, n = c === void 0 ? [0, 0] : c, r = Q1.reduce(function(l, d) {
    return l[d] = r3(d, s.rects, n), l;
  }, {}), i = r[s.placement], v = i.x, a = i.y;
  s.modifiersData.popperOffsets != null && (s.modifiersData.popperOffsets.x += v, s.modifiersData.popperOffsets.y += a), s.modifiersData[o] = r;
}
const h3 = {
  name: "offset",
  enabled: !0,
...
function m3(e) {
  var s = e.state, t = e.options, o = e.name, c = t.mainAxis, n = c === void 0 ? !0 : c, r = t.altAxis, i = r === void 0 ? !1 : r, v = t.boundary, a = t.rootBoundary, l = t.altBoundary, d = t.padding, u = t.tether, m = u === void 0 ? !0 : u, _ = t.tetherOffset, M = _ === void 0 ? 0 : _, g = O0(s, {
    boundary: v,
    rootBoundary: a,
    padding: d,
    altBoundary: l
  }), C = s0(s.placement), E = _0(s.placement), I = !E, N = d1(C), S = p3(N), O = s.modifiersData.popperOffsets, q = s.rects.reference, A = s.rects.popper, R = typeof M == "function" ? M(Object.assign({}, s.rects, {
    placement: s.placement
  })) : M, L = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
    ...
    mainAxis: 0,
    altAxis: 0
  }, R), b = s.modifiersData.offset ? s.modifiersData.offset[s.placement] : null, $ = {
    x: 0,
    y: 0
  };
  if (O) {
    if (n) {
      var H, K = N === "y" ? Y : Z, J = N === "y" ? e0 : t0, z = N === "y" ? "height" : "width", x = O[N], x0 = x + g[K], a0 = x - g[J], q0 = m ? -A[z] / 2 : 0, G0 = E === g0 ? q[z] : A[z], C0 = E === g0 ? -A[z] : -q[z], A0 = s.elements.arrow, b0 = m && A0 ? r1(A0) : {
        width: 0,
        height: 0
      }, n0 = s.modifiersData["arrow#persistent"] ? s.modifiersData["arrow#persistent"].padding : J1(), B0 = n0[K], F0 = n0[J], r0 = N0(0, q[z], b0[z]), X0 = I ? q[z] / 2 - q0 - r0 - B0 - L.mainAxis : G0 - r0 - B0 - L.mainAxis, l2 = I ? -q[z] / 2 + q0 + r0 + F0 + L.mainAxis : C0 + r0 + F0 + L.mainAxis, J0 = s.elements.arrow && I0(s.elements.arrow), a2 = J0 ? N === "y" ? J0.clientTop || 0 : J0.clientLeft || 0 : 0, f1 = (H = b == null ? void 0 : b[N]) != null ? H : 0, r2 = x + X0 - f1 - a2, d2 = x + l2 - f1, y1 = N0(m ? U0(x0, r2) : x0, x, m ? p0(a0, d2) : a0);
      O[N] = y1, $[N] = y1 - x;
    }
    if (i) {
      var b1, h2 = N === "x" ? Y : Z, u2 = N === "x" ? e0 : t0, d0 = O[S], P0 = S === "y" ? "height" : "width", M1 = d0 + g[h2], g1 = d0 - g[u2], e1 = [Y, Z].indexOf(C) !== -1, z1 = (b1 = b == null ? void 0 : b[S]) != null ? b1 : 0, w1 = e1 ? M1 : d0 - q[P0] - A[P0] - z1 + L.altAxis, _1 = e1 ? d0 + q[P0] + A[P0] - z1 - L.altAxis : g1, x1 = m && e1 ? F4(w1, d0, _1) : N0(m ? w1 : M1, d0, m ? _1 : g1);
      O[S] = x1, $[S] = x1 - d0;
    }
    s.modifiersData[o] = $;
  }
...
function b3(e) {
  return e === X(e) || !G(e) ? h1(e) : y3(e);
}
function M3(e) {
  var s = e.getBoundingClientRect(), t = z0(s.width) / e.offsetWidth || 1, o = z0(s.height) / e.offsetHeight || 1;
  return t !== 1 || o !== 1;
}
function g3(e, s, t) {
  t === void 0 && (t = !1);
  var o = G(s), c = G(s) && M3(s), n = l0(s), r = w0(e, c, t), i = {
    scrollLeft: 0,
    scrollTop: 0
  }, v = {
    x: 0,
  ...
  return (o || !o && !t) && ((o0(s) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  v1(n)) && (i = b3(s)), G(s) ? (v = w0(s, !0), v.x += s.clientLeft, v.y += s.clientTop) : n && (v.x = u1(n))), {
    x: r.left + i.scrollLeft - v.x,
    y: r.top + i.scrollTop - v.y,
    width: r.width,
    height: r.height
  };
}
...
function i0(e) {
  for (var s = arguments.length, t = new Array(s > 1 ? s - 1 : 0), o = 1; o < s; o++)
    t[o - 1] = arguments[o];
  return [].concat(t).reduce(function(c, n) {
    return c.replace(/%s/, n);
  }, e);
}
var h0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', x3 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', I1 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function C3(e) {
  e.forEach(function(s) {
    [].concat(Object.keys(s), I1).filter(function(t, o, c) {
      return c.indexOf(t) === o;
    }).forEach(function(t) {
      switch (t) {
        case "name":
          typeof s.name != "string" && console.error(i0(h0, String(s.name), '"name"', '"string"', '"' + String(s.name) + '"'));
          break;
        case "enabled":
          typeof s.enabled != "boolean" && console.error(i0(h0, s.name, '"enabled"', '"boolean"', '"' + String(s.enabled) + '"'));
          break;
        case "phase":
          o1.indexOf(s.phase) < 0 && console.error(i0(h0, s.name, '"phase"', "either " + o1.join(", "), '"' + String(s.phase) + '"'));
          break;
        case "fn":
          typeof s.fn != "function" && console.error(i0(h0, s.name, '"fn"', '"function"', '"' + String(s.fn) + '"'));
          break;
        case "effect":
          s.effect != null && typeof s.effect != "function" && console.error(i0(h0, s.name, '"effect"', '"function"', '"' + String(s.fn) + '"'));
          break;
        case "requires":
          s.requires != null && !Array.isArray(s.requires) && console.error(i0(h0, s.name, '"requires"', '"array"', '"' + String(s.requires) + '"'));
          break;
        case "requiresIfExists":
          Array.isArray(s.requiresIfExists) || console.error(i0(h0, s.name, '"requiresIfExists"', '"array"', '"' + String(s.requiresIfExists) + '"'));
          break;
        case "options":
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + s.name + '" modifier, valid properties are ' + I1.map(function(o) {
            return '"' + o + '"';
      ...
      s.requires && s.requires.forEach(function(o) {
        e.find(function(c) {
          return c.name === o;
        }) == null && console.error(i0(x3, String(s.name), o, o));
      });
    });
  });
}
...
var q1 = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.", N3 = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.", A1 = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
};
...
function V3(e) {
  e === void 0 && (e = {});
  var s = e, t = s.defaultModifiers, o = t === void 0 ? [] : t, c = s.defaultOptions, n = c === void 0 ? A1 : c;
  return function(i, v, a) {
    a === void 0 && (a = n);
    var l = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, A1, n),
      modifiersData: {},
      elements: {
        reference: i,
        popper: v
      ...
      setOptions: function(C) {
        ...
        M(), l.options = Object.assign({}, n, l.options, E), l.scrollParents = {
          reference: f0(i) ? V0(i) : i.contextElement ? V0(i.contextElement) : [],
          popper: V0(v)
        };
        var I = w3(k3([].concat(o, l.options.modifiers)));
        if (l.orderedModifiers = I.filter(function(b) {
          return b.enabled;
        }), process.env.NODE_ENV !== "production") {
          var N = B3([].concat(I, l.options.modifiers), function(b) {
            var $ = b.name;
            return $;
          });
          if (C3(N), s0(l.options.placement) === Z0) {
            var S = l.orderedModifiers.find(function(b) {
              var $ = b.name;
              return $ === "flip";
            });
            S || console.error(['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
          }
          var O = c0(v), q = O.marginTop, A = O.marginRight, R = O.marginBottom, L = O.marginLeft;
          [q, A, R, L].some(function(b) {
            return parseFloat(b);
      ...
      forceUpdate: function() {
        if (!u) {
          var C = l.elements, E = C.reference, I = C.popper;
          if (!F1(E, I)) {
            process.env.NODE_ENV !== "production" && console.error(q1);
            return;
          }
          l.rects = {
            reference: g3(E, I0(I), l.options.strategy === "fixed"),
            popper: r1(I)
          ...
          for (var N = 0, S = 0; S < l.orderedModifiers.length; S++) {
            ...
            var O = l.orderedModifiers[S], q = O.fn, A = O.options, R = A === void 0 ? {} : A, L = O.name;
            typeof q == "function" && (l = q({
              state: l,
              options: R,
              name: L,
              instance: m
    ...
    if (!F1(i, v))
      return process.env.NODE_ENV !== "production" && console.error(q1), m;
    m.setOptions(a).then(function(g) {
      !u && a.onFirstUpdate && a.onFirstUpdate(g);
    });
    function _() {
      l.orderedModifiers.forEach(function(g) {
        var C = g.name, E = g.options, I = E === void 0 ? {} : E, N = g.effect;
...
var S3 = [K4, v3, Y4, I4, h3, i3, f3, H4, a3], O3 = /* @__PURE__ */ V3({
  defaultModifiers: S3
});
const D3 = {
  name: "NicePopup"
}, $3 = /* @__PURE__ */ Object.assign(D3, {
  props: {
    noPadding: {
      type: Boolean,
      default: !1
  ...
  emits: ["change"],
  setup(e, { emit: s }) {
    const t = e, o = u0(!1), c = u0(!1);
    let n = null;
    const r = u0(null), i = u0(null), v = u0(null), a = u0(null);
    Y0(() => {
      const M = [
        {
          name: "preventOverflow",
      ...
      }), n = O3(i.value, v.value, {
        strategy: "fixed",
        placement: t.placement,
        modifiers: M
      }), document.addEventListener("click", _), document.addEventListener("touchend", _);
    }), p2(() => {
      document.removeEventListener("click", _), document.removeEventListener("touchend", _);
    });
    function l() {
      t.disabled || (o.value = !o.value, n.update(), s("change", o));
    }
    function d() {
      o.value = !1, s("change", o);
    }
    function u() {
      !t.openOnHover || t.disabled || (c.value = !0, o.value = !0, n.update());
    }
    function m() {
      !t.openOnHover || t.disabled || (c.value = !1, o.value = !1);
    }
    function _(M) {
      t.openOnHover || t.disabled || o.value && !M.composedPath().includes(a.value) && !M.composedPath().includes(i.value) && d();
    }
    return (M, g) => (h(), p("div", {
      class: k(["nice-popup", { "nice-popup-open": o.value, "nice-popup-focused": c.value, disabled: t.disabled }]),
      ref_key: "$el",
      ref: a
    }, [
      y("div", {
...
}), Q0 = /* @__PURE__ */ P($3, [["__scopeId", "data-v-746fc631"]]);
const T3 = {
  name: "NiceDate",
  components: {
    NicePopup: Q0,
    NiceComponentHeader: y0
  },
  props: {
  ...
  methods: {
    ...
    _formatDate(e) {
      let s = e.getDate(), t = e.getMonth() + 1, o = e.getFullYear(), c = e.getHours(), n = e.getMinutes();
      return n < 10 && (n = "0" + n), this.time ? `${s}.${t}.${o} • ${c}:${n}` : `${s}.${t}.${o}`;
    },
    _extractData() {
...
}, p1 = (e) => ($0("data-v-e810dc14"), e = e(), T0(), e), E3 = { class: "input-group" }, I3 = ["placeholder", "disabled", "required"], q3 = { class: "nice-dropdown" }, A3 = { class: "month-wrapper" }, F3 = { class: "value" }, P3 = { class: "year" }, L3 = { class: "month" }, R3 = { class: "calendar" }, H3 = { class: "header" }, j3 = { class: "month" }, W3 = ["onClick", "title"], U3 = {
  key: 0,
  class: "time"
}, Y3 = { class: "select-wrapper" }, Z3 = /* @__PURE__ */ p1(() => /* @__PURE__ */ y("div", { class: "arrow-down" }, null, -1)), K3 = ["value", "selected"], Q3 = /* @__PURE__ */ p1(() => /* @__PURE__ */ y("div", null, ":", -1)), G3 = { class: "select-wrapper" }, X3 = /* @__PURE__ */ p1(() => /* @__PURE__ */ y("div", { class: "arrow-down" }, null, -1)), J3 = ["value", "selected"];
function e7(e, s, t, o, c, n) {
  const r = V("NiceComponentHeader"), i = V("NiceIcon"), v = V("NiceButton"), a = V("NicePopup");
  return h(), p("div", {
      ...
      trigger: U(() => [
        y("div", E3, [
          M0(y("input", {
            ...
            disabled: t.disabled,
            required: t.required,
            onBlur: s[1] || (s[1] = (...l) => n.inputChanged && n.inputChanged(...l))
          }, null, 40, I3), [
            [l1, c.inputVal]
          ]),
          B(i, {
      ...
      content: U(() => [
        y("div", q3, [
          y("div", A3, [
            B(v, {
              class: "left",
              onClick: s[2] || (s[2] = (l) => n.changeMonth(!1)),
              icon: "icon-chevron-left",
              naked: ""
            }),
            y("div", F3, [
              y("div", P3, w(c.selected.getFullYear()), 1),
              y("div", L3, w(c.monthNames[c.selected.getMonth() + 1]), 1)
            ]),
            B(v, {
              class: "right",
              onClick: s[3] || (s[3] = (l) => n.changeMonth(!0)),
          ...
          y("div", R3, [
            y("div", H3, [
              y("div", null, w(c.dayNames[1]), 1),
              y("div", null, w(c.dayNames[2]), 1),
              y("div", null, w(c.dayNames[3]), 1),
              y("div", null, w(c.dayNames[4]), 1),
              y("div", null, w(c.dayNames[5]), 1),
              y("div", null, w(c.dayNames[6]), 1),
              y("div", null, w(c.dayNames[7]), 1)
            ]),
            y("div", j3, [
              (h(!0), p(j, null, W(c.days, (l) => (h(), p("div", {
                class: k(["day", {
                  "previous-month": !l.currentMonth,
                  today: l.today,
                  selected: l.selected
                }]),
                onClick: (d) => n.dayChanged(l),
                title: l.text,
                key: l.id
              }, w(l.day), 11, W3))), 128))
            ])
          ...
          t.time ? (h(), p("div", U3, [
            y("div", Y3, [
              Z3,
              y("select", {
                onChange: s[4] || (s[4] = (...l) => n.hourChanged && n.hourChanged(...l))
              }, [
                (h(!0), p(j, null, W(c.hours, (l) => (h(), p("option", {
                  value: l,
                  key: l,
            ...
            y("div", G3, [
              X3,
              y("select", {
                onChange: s[5] || (s[5] = (...l) => n.minuteChanged && n.minuteChanged(...l))
              }, [
                (h(!0), p(j, null, W(c.minutes, (l) => (h(), p("option", {
                  value: l,
                  key: l,
...
const t7 = /* @__PURE__ */ P(T3, [["render", e7], ["__scopeId", "data-v-e810dc14"]]);
const s7 = {
...
}, c7 = { class: "input-group" }, o7 = ["required", "disabled", "modelValue"], n7 = ["selected"], i7 = ["value"], l7 = {
  key: 0,
  class: "no-options"
}, a7 = ["disabled"];
function r7(e, s, t, o, c, n) {
  const r = V("NiceComponentHeader"), i = V("NiceLoading"), v = V("NiceIcon");
  return h(), p("div", {
    ...
    y("div", c7, [
      y("div", {
        class: k(["select-wrapper", { "no-value": n.localValue == null }])
      }, [
        y("select", {
          required: t.required,
          disabled: t.disabled,
          modelValue: n.localValue,
          onChange: s[0] || (s[0] = (...a) => n.handleChange && n.handleChange(...a))
        }, [
          t.nullable ? (h(), p("option", {
            key: 0,
            value: null,
            selected: !n.localValue
          }, w(t.nullText || e.$t("Nice", "None")), 9, n7)) : f("", !0),
          (h(!0), p(j, null, W(t.values, (a) => (h(), p("option", {
            value: a[t.keyName],
            key: a[t.keyName]
          }, w(a[t.valueName]), 9, i7))), 128))
        ], 40, o7),
        !t.nullable && !t.loading && (!t.values || t.values.length == 0) ? (h(), p("div", l7, w(e.$t("Nice", "No options")), 1)) : f("", !0),
        t.loading ? (h(), T(i, {
          key: 1,
          class: "no-options"
        })) : f("", !0),
      ...
      t.addFunction ? (h(), p("button", {
        key: 0,
        class: "btn",
        type: "button",
        disabled: t.disabled,
        onClick: s[1] || (s[1] = (...a) => t.addFunction && t.addFunction(...a))
      }, [
        B(v, { icon: "icon-plus" })
      ], 8, a7)) : f("", !0)
    ])
...
const d7 = /* @__PURE__ */ P(s7, [["render", r7], ["__scopeId", "data-v-42a60a1f"]]);
const h7 = { class: "nice-loading-wrapper" }, u7 = {
  key: 0,
  ...
  setup(e) {
    ...
    return (t, o) => {
      const c = V("NiceIcon");
      return h(), p("div", {
        class: k(["nice-loading", [s.size ? "nice-loading-" + s.size : "", { "full-div": s.fullDiv }]])
      }, [
        y("div", h7, [
          B(c, { icon: "icon-half-loading" }),
          B(c, { icon: "icon-half-loading" })
        ]),
        s.message ? (h(), p("div", u7, w(s.message), 1)) : f("", !0)
      ], 2);
    };
  }
}), m1 = /* @__PURE__ */ P(p7, [["__scopeId", "data-v-79dfb1c4"]]);
const m7 = {
  name: "NiceDropdown",
  components: {
    NicePopup: Q0,
  ...
  computed: {
    ...
    canClear() {
      return this.disabled ? !1 : !!this.modelValue && !!this.nullable;
    }
  },
  async mounted() {
...
}, f7 = { class: "nice-dropdown-wrapper" }, y7 = { class: "input-group" }, b7 = { class: "select-wrapper" }, M7 = ["required", "value", "disabled"], g7 = {
  key: 0,
  class: "option"
}, z7 = {
  key: 1,
  ...
  key: 2,
  class: "no-options"
}, _7 = { class: "nice-dropdown-popup" }, x7 = {
  key: 0,
  class: "input-group"
}, C7 = ["placeholder", "name", "disabled"], B7 = { class: "list" }, k7 = ["onClick"], N7 = {
  key: 1,
  class: "element no-options"
};
function V7(e, s, t, o, c, n) {
  const r = V("NiceComponentHeader"), i = V("NiceIcon"), v = V("NiceLoading"), a = V("NicePopup"), l = V("NiceButton");
  return h(), p("div", {
    class: k(["nice-component nice-dropdown", {
      disabled: t.disabled,
      "no-margin": t.noMargin,
      "can-clear": n.canClear,
      "has-value": t.modelValue
    }])
  }, [
    B(r, {
    ...
    y("div", f7, [
      B(a, {
            ...
            y("div", b7, [
              y("div", {
                ...
                y("input", {
                  ...
                  value: t.modelValue,
                  class: "hidden-input",
                  onFocus: s[0] || (s[0] = (d) => c.focus = !0),
                  onBlur: s[1] || (s[1] = (d) => c.focus = !1),
                  onKeypress: s[2] || (s[2] = (...d) => n.onKeypress && n.onKeypress(...d)),
                  disabled: t.disabled
                }, null, 40, M7),
                !t.loading && t.modelValue ? (h(), p("div", g7, [
                  F(e.$slots, "selected-option", { item: t.modelValue }, () => [
                    m0(w(t.formatFunction ? t.formatFunction(t.modelValue) : n.localValue[t.valueName]), 1)
                  ], !0)
                ])) : f("", !0),
                !t.loading && !t.modelValue ? (h(), p("div", z7, w(t.nullText || e.$t("Nice", "None")), 1)) : f("", !0),
                t.loading ? (h(), p("div", w7, w(e.$t("Nice", "Loading")), 1)) : f("", !0),
                B(i, {
                  class: "arrow-down",
                  icon: "icon-chevron-down"
                }),
        ...
        content: U(() => [
          y("div", _7, [
            t.searchFunction && !t.noSearch ? (h(), p("div", x7, [
              M0(y("input", {
                "onUpdate:modelValue": s[3] || (s[3] = (d) => c.search = d),
                type: "text",
                placeholder: e.$t("Nice", "Search..."),
                name: e.$t("Nice", "Search"),
                onInput: s[4] || (s[4] = (...d) => n.handleSearch && n.handleSearch(...d)),
                ref: "search",
                disabled: t.disabled
              }, null, 40, C7), [
                [l1, c.search]
              ]),
              c.innerLoading ? (h(), T(v, {
                key: 0,
                class: "loading"
              })) : f("", !0)
            ])) : f("", !0),
            y("div", B7, [
              t.nullable ? (h(), p("div", {
                ...
                onClick: s[5] || (s[5] = (d) => n.handleChange(void 0))
              }, w(t.nullText || e.$t("Nice", "None")), 3)) : f("", !0),
              (h(!0), p(j, null, W(c.innerValues, (d, u) => (h(), p("div", {
                class: k(["element", {
                  hover: c.innerIndex == u,
                  selected: t.modelValue && d[t.keyName] == n.localValue[t.keyName]
                }]),
                key: d[t.keyName],
                onClick: (m) => n.handleChange(d)
              }, [
                F(e.$slots, "option", { item: d }, () => [
                  m0(w(t.formatFunction ? t.formatFunction(d) : d[t.valueName]), 1)
                ], !0)
              ], 10, k7))), 128)),
              !c.innerLoading && (!c.innerValues || c.innerValues.length == 0) ? (h(), p("div", N7, w(e.$t("Nice", "No options")), 1)) : f("", !0)
            ])
          ])
        ]),
        _: 3
...
const S7 = /* @__PURE__ */ P(m7, [["render", V7], ["__scopeId", "data-v-4dd52871"]]);
const O7 = {
  name: "NiceFilters",
  props: {
    // filters: {
...
}, D7 = (e) => ($0("data-v-fad220d1"), e = e(), T0(), e), $7 = { class: "nice-filters-wrapper" }, T7 = { class: "nice-component nice-filters" }, E7 = {
  key: 0,
  class: "nice-filters-options"
}, I7 = /* @__PURE__ */ D7(() => /* @__PURE__ */ y("div", { class: "f-grow" }, null, -1)), q7 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, A7 = ["title"];
function F7(e, s, t, o, c, n) {
  const r = V("NiceInput"), i = V("NiceSwitch"), v = V("NiceDate"), a = V("NiceDropdown"), l = V("NiceButton");
  return h(), p("div", $7, [
    y("div", T7, [
      B(r, {
        ...
        icon: "icon-search",
        modelValue: c.search,
        "onUpdate:modelValue": s[0] || (s[0] = (d) => c.search = d),
        class: "w-300",
        "no-margin": "",
        onDebounce: n.updateQuery
      }, null, 8, ["title", "placeholder", "modelValue", "onDebounce"]),
      c.filters ? (h(), p("div", E7, [
        (h(!0), p(j, null, W(c.filters, (d) => (h(), p("div", {
          class: "nice-filters-filter",
          key: d.key
        }, [
          d.type == "boolean" ? (h(), T(i, {
            key: 0,
            modelValue: d.value,
            "onUpdate:modelValue": (u) => d.value = u,
            title: d.name,
            onChange: n.updateQuery,
            noMargin: ""
          ...
          d.type == "select" ? (h(), T(a, {
            ...
            "onUpdate:modelValue": (u) => d.value = u,
            title: d.name,
            "search-function": d.searchFunction,
            valueName: d.valueName,
            keyName: d.keyName,
            formatFunction: d.formatter,
            onChange: n.updateQuery,
            nullable: "",
            noMargin: ""
    ...
    t.showPills && n.pills && n.pills.length ? (h(), p("div", q7, [
      (h(!0), p(j, null, W(n.pills, (d) => (h(), p("div", {
        class: "nice-filters-pill badge badge-primary",
        key: d.key,
        title: d.description
      }, [
        y("div", null, [
          y("small", null, w(d.name), 1),
          y("div", null, w(n.getFormattedValue(d)), 1)
        ]),
        B(l, {
          icon: "icon-x",
          onClick: (u) => n.clearFilter(d)
        }, null, 8, ["onClick"])
      ], 8, A7))), 128))
    ])) : f("", !0)
  ]);
}
const P7 = /* @__PURE__ */ P(O7, [["render", F7], ["__scopeId", "data-v-fad220d1"]]);
const L7 = { class: "nice-icon" }, R7 = ["xlink:href"], H7 = {
  name: "NiceIcon"
}, j7 = /* @__PURE__ */ Object.assign(H7, {
  props: {
    icon: {
      type: String,
      required: !0
  ...
  setup(e) {
    const s = e;
    return (t, o) => (h(), p("svg", L7, [
      y("use", {
        "xlink:href": "#" + s.icon
      }, null, 8, R7)
    ]));
  }
}), o2 = /* @__PURE__ */ P(j7, [["__scopeId", "data-v-11b82ed8"]]);
var n2 = W7;
function W7(e, s, t) {
  if (!e)
    return t;
  ...
  computed: {
    ...
    errorMessage() {
      if (typeof this.error == "string")
        return this.error;
      const e = n2(this.error, ["response", "data", this.prop]);
...
}, Y7 = { class: "input-group" }, Z7 = {
  key: 0,
  class: "input-group-suffix"
}, K7 = ["placeholder", "autocomplete", "type", "required", "disabled"], Q7 = {
  key: 1,
...
function e8(e, s, t, o, c, n) {
  const r = V("NiceComponentHeader"), i = V("NiceIcon");
  return h(), p("div", {
    class: k(["nice-component nice-input", { "no-margin": t.noMargin, active: n.localValue, disabled: t.disabled }])
  }, [
    B(r, {
      title: t.title,
      required: t.required,
    ...
    y("div", Y7, [
      e.$slots.suffix ? (h(), p("div", Z7, [
        F(e.$slots, "suffix", {}, void 0, !0)
      ])) : f("", !0),
      M0(y("input", {
        "onUpdate:modelValue": s[0] || (s[0] = (v) => n.localValue = v),
      ...
      e.$slots.append ? (h(), p("div", G7, [
        F(e.$slots, "append", {}, void 0, !0)
      ])) : f("", !0)
    ]),
    t.message ? (h(), p("div", X7, w(t.message), 1)) : f("", !0),
    n.errorMessage ? (h(), p("div", J7, w(n.errorMessage), 1)) : f("", !0)
  ], 2);
}
const t8 = /* @__PURE__ */ P(U7, [["render", e8], ["__scopeId", "data-v-77517aa1"]]);
const s8 = { class: "notification-info" }, c8 = {
  key: 0,
  ...
  setup(e, { emit: s }) {
    ...
    return Y0(() => {
      ...
      return h(), p("div", {
        ...
        t.notification.icon ? (h(), T(v, {
          key: 0,
          class: "notification-icon",
          icon: t.notification.icon
        }, null, 8, ["icon"])) : f("", !0),
        y("div", s8, [
          t.notification.title ? (h(), p("div", c8, w(t.notification.title), 1)) : f("", !0),
          t.notification.message ? (h(), p("div", o8, w(t.notification.message), 1)) : f("", !0)
        ])
      ], 34);
    };
  }
}), i2 = /* @__PURE__ */ P(i8, [["__scopeId", "data-v-e97b3468"]]);
const l8 = { class: "nice-notifications" }, a8 = {
  name: "NiceNotifications"
}, r8 = /* @__PURE__ */ Object.assign(a8, {
  setup(e) {
    const { $gettext: s } = g2(), t = D0("nice"), o = 3e3, c = u0([]);
    function n({ message: i, type: v, title: a, icon: l }) {
      var d = {
      ...
      a || (v == "danger" ? (d.title = s("Nice", "Error"), d.icon = "icon-alert-triangle") : v == "success" ? (d.title = s("Nice", "Success"), d.icon = "icon-smile") : v == "warning" && (d.title = s("Nice", "Warning"), d.icon = "icon-alert-circle")), c.value.unshift(d);
    }
    function r(i) {
      let v = c.value.findIndex((a) => a.id == i.id);
      v >= 0 && c.value.splice(v, 1);
    }
    return Y0(() => {
      t.onNotification((i, v, a) => {
        n(i);
      });
    }), (i, v) => (h(), p("div", l8, [
      B(W1, {
        ...
        default: U(() => [
          (h(!0), p(j, null, W(c.value, (a) => (h(), T(i2, {
            key: a.id,
            notification: a,
            timeoutTime: o,
            onRemove: (l) => r(a)
...
}), d8 = /* @__PURE__ */ P(r8, [["__scopeId", "data-v-1db1bd0f"]]);
const h8 = {
  name: "NicePanel",
  props: {
    name: {
...
function u8(e, s, t, o, c, n) {
  return h(), p("div", {
    class: k(["nice-side-view", { "no-select": c.dragging }]),
    onMousemove: s[2] || (s[2] = (...r) => n.mouseMove && n.mouseMove(...r)),
    onMouseup: s[3] || (s[3] = (r) => c.dragging = !1)
  }, [
    B(j0, { name: "side-view" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          ...
          style: j1({ "--side-view-width": c.sideViewWidth + "px" })
        }, [
          y("div", {
            class: k(["handle", { active: c.dragging }]),
            ref: "handle",
            onMousedown: s[0] || (s[0] = (r) => c.dragging = !0)
          }, null, 34),
          F(e.$slots, "default")
        ], 6)) : f("", !0)
      ]),
    ...
    B(j0, { name: "side-overlay" }, {
      default: U(() => [
        c.isOpen ? (h(), p("div", {
          key: 0,
          class: "overlay",
          onClick: s[1] || (s[1] = (...r) => n.close && n.close(...r))
        })) : f("", !0)
      ]),
      _: 1
    })
...
const v8 = /* @__PURE__ */ P(h8, [["render", u8]]), p8 = {
  name: "NiceSlot"
  ...
  setup(e) {
    const s = e;
    return (t, o) => (h(), p("div", {
      class: k(["nice-component nice-slot", { "no-margin": s.noMargin }])
    }, [
      B(y0, {
        title: s.title,
        caption: s.caption
...
function g8(e, s, t, o, c, n) {
  return h(), p("svg", y8, M8);
}
const z8 = /* @__PURE__ */ P(f8, [["render", g8]]);
const w8 = (e) => ($0("data-v-d6fa25f8"), e = e(), T0(), e), _8 = /* @__PURE__ */ w8(() => /* @__PURE__ */ y("div", { class: "nice-switch-box" }, [
  /* @__PURE__ */ y("div", { class: "nice-switch-handle" })
], -1)), x8 = ["for"], C8 = ["id", "disabled"], B8 = {
  name: "NiceSwitch"
}, k8 = /* @__PURE__ */ Object.assign(B8, {
  props: {
    modelValue: {
      type: [Boolean, null],
      required: !0
  ...
  setup(e, { emit: s }) {
    ...
    return (r, i) => (h(), p("div", {
      class: k(["nice-component nice-switch", [
        ...
        { "no-margin": t.noMargin, active: D(c), disabled: t.disabled }
      ]]),
      onClick: n
    }, [
      _8,
...
}), N8 = /* @__PURE__ */ P(k8, [["__scopeId", "data-v-d6fa25f8"]]);
/*!
  * vue-router v4.2.4
...
const V8 = Symbol(process.env.NODE_ENV !== "production" ? "router" : ""), S8 = Symbol(process.env.NODE_ENV !== "production" ? "route location" : "");
...
const $8 = { class: "nice-table" }, T8 = { class: "nice-table-table-wrapper" }, E8 = { class: "nice-table-table" }, I8 = {
  key: 0,
  class: "w-0"
}, q8 = ["onClick"], A8 = { key: 1 }, F8 = { key: 0 }, P8 = { key: 0 }, L8 = { class: "list" }, R8 = ["onClick"], H8 = {
  key: 0,
  class: "w-0"
}, j8 = ["innerHTML"], W8 = {
  key: 1,
  ...
  setup(e, { emit: s }) {
    const t = e, o = D8(), c = O8(), n = D0("getQuery");
    let r, i = 50;
    const v = [
      { id: 10, value: 10 },
      { id: 20, value: 20 },
    ...
    const d = Q(() => {
      var b, $;
      return (($ = (b = t.data) == null ? void 0 : b._metadata) == null ? void 0 : $.count) || 0;
    }), u = Q(() => Math.ceil(d.value / i) || 1), m = Q(() => Array.from({ length: u.value }, (b, $) => ({ id: $ + 1, value: $ + 1 }))), _ = Q(() => t.columns), M = Q(() => _.value.filter((b) => !b.disabled)), g = Q(() => {
      let b = t.data;
      if (b.forEach(($) => {
        $._selected === void 0 && ($._selected = !1);
      }), r !== void 0) {
        const $ = r.replace("-", "");
        b.sort((H, K) => {
          if (r[0] != "-") {
          ...
          return String(H[$]).localeCompare(String(K[$]));
        });
      }
      return b;
    }), C = Q(() => g.value.filter((b) => b._selected)), E = Q(() => C.value.length == g.value.length);
    function I() {
      let b = !0;
      E.value && (b = !1), g.value.forEach(($) => $._selected = b), S();
    }
    function N(b) {
    ...
    function q(b) {
      b.key == r ? r = "-" + b.key : r && r[0] === "-" && r === "-" + b.key ? r = void 0 : r = b.key, c.push({
        query: { ...o.query, ordering: r }
      }), s("orderChange", r), s("filtersChange");
    }
    async function A(b) {
      a = b, c.replace({
        path: o.path,
        query: { ...o.query, page: b, offset: (b - 1) * i, limit: i }
      }), s("pageChange", b), L();
    }
    function R(b) {
      i = b, c.push({
        path: o.path,
        query: { ...o.query, limit: i }
      }), s("pageChange", a), L();
    }
    function L() {
      s("filterChange", { ordering: r, page: a, offset: (a - 1) * i, limit: i });
    }
    return Y0(async () => {
      const b = await n();
      r = b.ordering, t.paginated && (i = Number(b.limit) || 50, a = Number(b.page) || 1, l = Number(b.page) || 1, A(a));
    }), (b, $) => {
      const H = V("NiceIcon"), K = V("router-link"), J = V("NiceDropdown");
      return h(), p("div", $8, [
        y("div", T8, [
          y("table", E8, [
            y("thead", null, [
              y("tr", null, [
                t.selectMultiple ? (h(), p("th", I8, [
                  B(R0, {
                    modelValue: D(E),
                    "no-margin": "",
                    onClick: I
                ...
                (h(!0), p(j, null, W(D(M), (z) => (h(), p("th", {
                  ...
                  t.showOrder ? (h(), p("div", {
                    key: 0,
                    class: k(["table-th", {
                      "active asc": D(r) == z.key,
                      "active desc": D(r) == "-" + z.key
                    }]),
                    onClick: (x) => q(z)
                  }, [
                    y("span", null, w(z.name), 1),
                    t.showOrder ? (h(), T(H, {
                      key: 0,
                      icon: "icon-bar-chart",
                      class: "table-order"
                    })) : f("", !0)
                  ], 10, q8)) : (h(), p("span", A8, w(z.name), 1))
                ], 2))), 128)),
                t.actions.length ? (h(), p("th", {
                  key: 1,
                  class: k(["actions-td w-0", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  !t.showToggleColumns && !t.showFooter && D(g) && D(g).length ? (h(), p("span", F8, [
                    y("span", null, w(D(g).length), 1),
                    D(g)._metadata ? (h(), p("span", P8, " / " + w(D(g)._metadata.count), 1)) : f("", !0)
                  ])) : f("", !0),
                  t.showToggleColumns ? (h(), T(Q0, {
                    key: 1,
                    ...
                    trigger: U(() => [
                      B(H, { icon: "icon-plus-circle" })
                    ]),
                    content: U(() => [
                      y("div", L8, [
                        (h(!0), p(j, null, W(D(_), (z) => (h(), p("div", {
                          class: "element",
                          key: z.key,
                          onClick: (x) => O(z)
                        }, [
                          B(R0, {
                            modelValue: !z.disabled,
                            title: z.name,
                            "no-margin": ""
            ...
            y("tbody", null, [
              (h(!0), p(j, null, W(D(g), (z) => (h(), p("tr", {
                key: z.id
              }, [
                t.selectMultiple ? (h(), p("td", H8, [
                  B(R0, {
                    modelValue: z._selected,
                    onClick: (x) => N(z),
                    "no-margin": ""
                  }, null, 8, ["modelValue", "onClick"])
                ])) : f("", !0),
                (h(!0), p(j, null, W(D(M), (x) => (h(), p("td", {
                  key: x.key,
                  class: k(x.class)
                }, [
                  x.component ? (h(), T(y2(x.component().instance), b2(M2({ key: 0 }, x.component(z[x.key], z).props)), null, 16)) : f("", !0),
                  !x.component && x.html ? (h(), p("span", {
                    key: 1,
                    innerHTML: x.html(z[x.key], z)
                  }, null, 8, j8)) : f("", !0),
                  !x.component && !x.html ? (h(), p("span", {
                    key: 2,
                    class: k(x.fieldClass ? x.fieldClass(z[x.key], z) : "")
                  }, w(x.formatter ? x.formatter(z[x.key], z) : z[x.key]), 3)) : f("", !0)
                ], 2))), 128)),
                t.actions.length ? (h(), p("td", {
                  key: 1,
                  class: k(["actions-td", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  (h(!0), p(j, null, W(t.actions, (x) => (h(), p("div", { key: x }, [
                    x.to ? (h(), T(K, {
                      key: 0,
                      to: x.to(z)
                    }, {
        ...
        e.loading ? (h(), T(m1, { key: 0 })) : f("", !0),
        !e.loading && t.data.length == 0 ? (h(), p("div", W8, w(b.$t("Nice", "No data.")), 1)) : f("", !0),
        t.showFooter ? (h(), p("div", U8, [
          y("div", Y8, w(D(d)) + " " + w(b.$t("Nice", "total")), 1),
          t.paginated && D(u) > 1 && D(u) < 5 ? (h(), p("div", Z8, [
            (h(!0), p(j, null, W(D(u), (z) => (h(), T(v0, {
              size: "small",
              plain: D(a) !== z,
              key: z,
              class: k(D(a) === z ? "btn-primary" : "btn-default"),
              onClick: (x) => A(z)
            }, {
              default: U(() => [
                m0(w(z), 1)
          ...
          t.paginated && D(u) > 1 && D(u) > 5 ? (h(), p("div", K8, [
            B(J, {
              modelValue: D(l),
              "onUpdate:modelValue": $[0] || ($[0] = (z) => B1(l) ? l.value = z : l = z),
              values: D(m),
              keyOnly: "",
              noMargin: "",
              onChange: A
          ...
          t.showLimit ? (h(), T(J, {
            key: 2,
            modelValue: D(i),
            "onUpdate:modelValue": $[1] || ($[1] = (z) => B1(i) ? i.value = z : i = z),
            class: k({ "dropdown-small": D(u) > 1 && D(u) < 5 }),
            values: v,
            keyOnly: "",
            noMargin: "",
            onChange: R
...
}), X8 = /* @__PURE__ */ P(G8, [["__scopeId", "data-v-8bd1b207"]]);
const J8 = {
  name: "NiceTextarea",
  components: {
    NiceIcon: o2
...
}, e5 = { class: "input-group" }, t5 = {
  key: 0,
  class: "input-group-suffix"
}, s5 = ["placeholder", "autocomplete", "type", "rows", "disabled"], c5 = {
  key: 1,
  class: "input-group-append input-group-icon"
}, o5 = {
  key: 2,
...
function i5(e, s, t, o, c, n) {
  const r = V("NiceComponentHeader"), i = V("NiceIcon");
  return h(), p("div", {
    class: k(["nice-component nice-textarea", { "no-margin": t.noMargin, active: n.localValue, disabled: t.disabled }])
  }, [
    B(r, {
      title: t.title,
      required: t.required,
    ...
    y("div", e5, [
      ...
      e.$slots.append ? (h(), p("div", o5, [
        F(e.$slots, "append", {}, void 0, !0)
      ])) : f("", !0)
    ]),
    t.message ? (h(), p("div", n5, w(t.message), 1)) : f("", !0)
  ], 2);
}
const l5 = /* @__PURE__ */ P(J8, [["render", i5], ["__scopeId", "data-v-cf411692"]]);
const a5 = {
  name: "NiceToast",
  data() {
    return {
...
}, r5 = { class: "nice-toasts" };
function d5(e, s, t, o, c, n) {
  return h(), p("div", r5, [
    B(W1, {
      name: "toast",
      key: "div"
      ...
      default: U(() => [
        (h(!0), p(j, null, W(c.toasts, (r) => (h(), p("div", {
          class: k(["nice-toast", ["nice-toast-" + r.type]]),
          key: r.id
        }, w(r.message), 3))), 128))
      ]),
      _: 1
...
const h5 = /* @__PURE__ */ P(a5, [["render", d5], ["__scopeId", "data-v-d538dc55"]]);
const u5 = {
  name: "NiceUpload",
  components: {
    NiceComponentHeader: y0
  ...
  methods: {
    fileChanged(e) {
      console.log(e.target.files), this.isDragging = !1, this.isOnTarget = !1, this.localValue = e.target.files, this.file = null;
    },
    dragChanged(e) {
  ...
  // },
}, v5 = ["modelValue", "placeholder", "required", "accept", "disabled"], p5 = {
  key: 0,
  class: "nice-upload-overlay"
}, m5 = { class: "nice-upload-overlay-message" }, f5 = {
  key: 1,
  class: "nice-upload-overlay"
};
function y5(e, s, t, o, c, n) {
  const r = V("NiceComponentHeader"), i = V("NiceIcon"), v = V("NiceLoading");
  return h(), p("div", {
    class: k(["nice-component nice-upload", { "no-margin": t.noMargin, active: n.localValue, disabled: t.disabled }])
  }, [
    B(r, {
      title: t.title,
      required: t.required,
    ...
    y("div", {
      class: k(["input-group", { dragging: c.isDragging, "on-target": c.isOnTarget }]),
      onDragenter: s[1] || (s[1] = (...a) => n.dragChanged && n.dragChanged(...a)),
      onDragleave: s[2] || (s[2] = (...a) => n.dragChanged && n.dragChanged(...a)),
      onDragover: s[3] || (s[3] = (...a) => n.dragChanged && n.dragChanged(...a)),
      onDragend: s[4] || (s[4] = (...a) => n.dragChanged && n.dragChanged(...a)),
      onDrop: s[5] || (s[5] = (...a) => n.dragChanged && n.dragChanged(...a))
    }, [
      y("input", {
        modelValue: c.file,
        placeholder: t.placeholder,
        ...
        accept: t.accept,
        type: "file",
        onChange: s[0] || (s[0] = (...a) => n.fileChanged && n.fileChanged(...a)),
        disabled: t.disabled
      }, null, 40, v5),
      n.localValue ? (h(), p("div", f5, [
        B(i, { icon: "icon-file" }),
        (h(!0), p(j, null, W(n.localValue, (a) => (h(), p("div", {
          class: "nice-upload-overlay-message",
          key: a.name
        }, w(a.name), 1))), 128))
      ])) : (h(), p("div", p5, [
        B(i, { icon: "icon-upload" }),
        y("div", m5, w(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      c.loading ? (h(), T(v, {
        key: 2,
        "full-div": ""
...
const b5 = /* @__PURE__ */ P(u5, [["render", y5], ["__scopeId", "data-v-08563ae3"]]);
const M5 = {
  name: "NiceView",
  props: {
    title: {
...
function _5(e, s, t, o, c, n) {
  const r = V("NiceIcon"), i = V("NiceLoading");
  return h(), p("div", {
    class: k(["nice-view", { "nice-view-no-header": !n.showHeader, "nice-view-flex-body": t.flexBody }])
  }, [
    n.showHeader ? (h(), p("div", g5, [
      t.icon && !t.loading ? (h(), T(r, {
        key: 0,
        icon: t.icon,
      ...
      e.$slots.title || t.title ? (h(), p("div", z5, [
        F(e.$slots, "title", {}, () => [
          m0(w(t.title), 1)
        ], !0)
      ])) : f("", !0)
    ...
    e.$slots.footer ? (h(), p("div", w5, [
      F(e.$slots, "footer", {}, void 0, !0)
    ])) : f("", !0)
  ], 2);
}
const x5 = /* @__PURE__ */ P(M5, [["render", _5], ["__scopeId", "data-v-3644b288"]]);
const C5 = {
  name: "NiceWrapper",
...
}, B5 = (e) => ($0("data-v-e0a79396"), e = e(), T0(), e), k5 = {
  key: 0,
...
}, O5 = /* @__PURE__ */ B5(() => /* @__PURE__ */ y("div", { class: "flex-grow" }, null, -1)), D5 = {
  key: 2,
  class: "wrapper-footer"
};
function $5(e, s, t, o, c, n) {
  const r = V("NiceButton");
  return h(), p("div", {
    class: k(["nice-wrapper", { "no-margin": t.noMargin }])
  }, [
    e.$slots.header || t.title || t.subtitle ? (h(), p("div", k5, [
      t.title || t.subtitle ? (h(), p("div", N5, [
        t.title ? (h(), p("div", V5, w(t.title), 1)) : f("", !0),
        t.subtitle ? (h(), p("div", S5, w(t.subtitle), 1)) : f("", !0)
      ])) : f("", !0),
      ...
      t.collapsable ? (h(), p("div", {
        key: 2,
        class: "wrapper-header-toggler",
        onClick: s[0] || (s[0] = (...i) => n.toggleOpen && n.toggleOpen(...i))
      })) : f("", !0)
    ])) : f("", !0),
    c.isOpen ? (h(), p("div", {
      key: 1,
      class: k(["wrapper-body", { "no-top-padding": e.$slots.header || t.title || t.subtitle, "no-padding": t.noBodyPadding }])
    }, [
      F(e.$slots, "default", {}, void 0, !0)
    ], 2)) : f("", !0),
    e.$slots.footer && c.isOpen ? (h(), p("div", D5, [
      F(e.$slots, "footer", {}, void 0, !0)
    ])) : f("", !0)
  ], 2);
}
const T5 = /* @__PURE__ */ P(C5, [["render", $5], ["__scopeId", "data-v-e0a79396"]]), H1 = {
  NiceActions: F2,
  NiceAvatar: l4,
  NiceButton: v0,
  NiceCheckbox: R0,
...
const q5 = {
  install(e, s) {
    ...
    const t = z2(), o = {
      ...
      notification: (r, i, v, a) => {
        t.emit("notification", { message: r, type: i, title: v, icon: a });
      },
      // Toast
      onToast: (r) => t.on("toast", r),
      toast: (r, i) => {
        t.emit("toast", { message: r, type: i });
      },
      // Panel
      onPanel: (r) => t.on("panel", r),
      panel: (r, i) => {
        t.emit("panel", { name: r, isOpen: i });
      },
      // Modal
      onModal: (r) => t.on("modal", r),
      modal: (r, i) => {
        t.emit("modal", { name: r, isOpen: i });
      }
    };
    e.config.globalProperties.$nice = o, e.provide("nice", o);
    async function c() {
      await s.router.isReady();
      const r = n(s.router.currentRoute.value.query);
      return delete r.id, r;
    }
    function n(r) {
      return Object.assign({}, r);
    }
    e.config.globalProperties.$query = c, e.provide("getQuery", c), e.config.globalProperties.$clone = n, e.provide("clone", n), e.config.globalProperties.$t = s.gettext.$pgettext, e.provide("$t", s.gettext.$pgettext);
  }
};
export {
  q5 as default
