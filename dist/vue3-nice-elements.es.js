import { useSlots as a1, resolveComponent as U, openBlock as v, createElementBlock as f, normalizeClass as I, unref as _, createBlock as H, createCommentVNode as y, renderSlot as Y, toDisplayString as V, Teleport as f2, createVNode as q, Transition as U0, withCtx as J, normalizeStyle as L1, createElementVNode as b, createTextVNode as p0, inject as Q, Fragment as G, computed as Z, pushScopeId as I0, popScopeId as A0, ref as W, onMounted as r0, onBeforeUnmount as m2, withDirectives as _0, vShow as k1, watch as R1, vModelText as r1, renderList as K, mergeProps as H1, isRef as Y0, vModelDynamic as y2, TransitionGroup as W1, onUnmounted as b2, createStaticVNode as M2, resolveDynamicComponent as g2, normalizeProps as z2 } from "vue";
import { useRoute as U1, useRouter as Y1 } from "vue-router";
function w2(e) {
...
const X = (e, c) => {
  ...
  setup(e) {
    const c = e, t = a1();
    return (o, s) => {
      const a = U("NiceLoading"), i = U("NiceIcon");
      return v(), f("button", {
        ...
        _(t).default ? (v(), f("span", _2, [
          Y(o.$slots, "default", {}, void 0, !0)
        ])) : y("", !0),
        c.text ? (v(), f("span", C2, V(c.text), 1)) : y("", !0),
        c.appendIcon ? (v(), H(i, {
          key: 4,
          icon: c.appendIcon
        }, null, 8, ["icon"])) : y("", !0)
...
}), v0 = /* @__PURE__ */ X(k2, [["__scopeId", "data-v-5bdcb792"]]);
const N2 = {
  name: "NiceModal",
  props: {
    name: {
...
function D2(e, c, t, o, s, a) {
  const i = U("NiceButton");
  return v(), H(f2, { to: "body" }, [
    q(U0, { name: "fade" }, {
      default: J(() => [
        s.isOpen ? (v(), f("div", {
          key: 0,
      ...
      default: J(() => [
        s.isOpen ? (v(), f("div", {
          ...
          e.$slots.title || t.title || e.$slots.subtitle || t.subtitle ? (v(), f("div", $2, [
            b("div", S2, [
              e.$slots.title || t.title ? Y(e.$slots, "title", { key: 0 }, () => [
                p0(V(t.title), 1)
              ], !0) : y("", !0)
            ]),
            b("div", O2, [
              e.$slots.subtitle || t.subtitle ? Y(e.$slots, "subtitle", { key: 0 }, () => [
                p0(V(t.subtitle), 1)
              ], !0) : y("", !0)
            ]),
            q(i, {
...
const Z1 = /* @__PURE__ */ X(N2, [["render", D2], ["__scopeId", "data-v-0bffddaa"]]), T2 = { class: "nice-actions" }, E2 = {
  name: "NiceConfirmModal"
}, X1 = /* @__PURE__ */ Object.assign(E2, {
  props: {
    name: {
      type: String,
  ...
  setup(e, { emit: c }) {
    ...
    return (n, d) => (v(), H(Z1, {
      name: e.name,
      title: _(o)("Nice", "Delete"),
      subtitle: _(o)("Nice", "Are you sure you want to delete?"),
      onClose: a
    }, {
      default: J(() => [
        b("div", T2, [
          q(v0, {
            text: _(o)("Nice", "Cancel"),
            onClick: a,
            type: "default",
            plain: "",
            icon: "icon-x"
...
const q2 = { class: "nice-actions" }, I2 = /* @__PURE__ */ b("div", { class: "f-grow" }, null, -1), A2 = {
  name: "NiceActions"
...
const c1 = (e, c, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (c - e) * 6 * t : t < 1 / 2 ? c : t < 2 / 3 ? e + (c - e) * (2 / 3 - t) * 6 : e), H2 = (e, c, t) => {
  ...
  if (e = e / 360, c == 0)
    ...
    o = c1(n, i, e + 1 / 3), s = c1(n, i, e), a = c1(n, i, e - 1 / 3);
  }
  return [
...
var W2 = H2;
const U2 = j2, Y2 = R2, N1 = W2, Z2 = () => Math.floor(Math.random() * Date.now()), X2 = (e, c) => {
  const t = U2(e), o = Y2(t % 360, 1, 0.5), s = N1(o[0][0], o[0][1], o[0][2]), a = N1(o[1][0], o[1][1], o[1][2]), i = `rgb(${s[0]}, ${s[1]}, ${s[2]})`, n = `rgb(${a[0]}, ${a[1]}, ${a[2]})`, d = Z2();
...
(function() {
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = {
    ...
    bytesToWords: function(t) {
      for (var o = [], s = 0, a = 0; s < t.length; s++, a += 8)
        o[a >>> 5] |= t[s] << 24 - a % 32;
      return o;
    },
    ...
    bytesToBase64: function(t) {
      for (var o = [], s = 0; s < t.length; s += 3)
        for (var a = t[s] << 16 | t[s + 1] << 8 | t[s + 2], i = 0; i < 4; i++)
          s * 8 + i * 6 <= t.length * 8 ? o.push(e.charAt(a >>> 6 * (3 - i) & 63)) : o.push("=");
      return o.join("");
    },
    // Convert a base-64 string to a byte array
    base64ToBytes: function(t) {
      t = t.replace(/[^A-Z0-9+\/]/ig, "");
      for (var o = [], s = 0, a = 0; s < t.length; a = ++s % 4)
        a != 0 && o.push((e.indexOf(t.charAt(s - 1)) & Math.pow(2, -2 * a + 8) - 1) << a * 2 | e.indexOf(t.charAt(s)) >>> 6 - a * 2);
      return o;
    }
  };
  K2.exports = c;
 ...
 */
var J2 = function(e) {
  return e != null && (G1(e) || e4(e) || !!e._isBuffer);
};
function G1(e) {
  return !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
}
function e4(e) {
  return typeof e.readFloatLE == "function" && typeof e.slice == "function" && G1(e.slice(0, 0));
}
(function() {
  var e = s1, c = $1.utf8, t = J2, o = $1.bin, s = function(a, i) {
    a.constructor == String ? i && i.encoding === "binary" ? a = o.stringToBytes(a) : a = c.stringToBytes(a) : t(a) ? a = Array.prototype.slice.call(a, 0) : !Array.isArray(a) && a.constructor !== Uint8Array && (a = a.toString());
    ...
    for (var C = s._ff, w = s._gg, z = s._hh, S = s._ii, p = 0; p < n.length; p += 16) {
      var j = r, P = l, m = u, x = h;
      r = C(r, l, u, h, n[p + 0], 7, -680876936), h = C(h, r, l, u, n[p + 1], 12, -389564586), u = C(u, h, r, l, n[p + 2], 17, 606105819), l = C(l, u, h, r, n[p + 3], 22, -1044525330), r = C(r, l, u, h, n[p + 4], 7, -176418897), h = C(h, r, l, u, n[p + 5], 12, 1200080426), u = C(u, h, r, l, n[p + 6], 17, -1473231341), l = C(l, u, h, r, n[p + 7], 22, -45705983), r = C(r, l, u, h, n[p + 8], 7, 1770035416), h = C(h, r, l, u, n[p + 9], 12, -1958414417), u = C(u, h, r, l, n[p + 10], 17, -42063), l = C(l, u, h, r, n[p + 11], 22, -1990404162), r = C(r, l, u, h, n[p + 12], 7, 1804603682), h = C(h, r, l, u, n[p + 13], 12, -40341101), u = C(u, h, r, l, n[p + 14], 17, -1502002290), l = C(l, u, h, r, n[p + 15], 22, 1236535329), r = w(r, l, u, h, n[p + 1], 5, -165796510), h = w(h, r, l, u, n[p + 6], 9, -1069501632), u = w(u, h, r, l, n[p + 11], 14, 643717713), l = w(l, u, h, r, n[p + 0], 20, -373897302), r = w(r, l, u, h, n[p + 5], 5, -701558691), h = w(h, r, l, u, n[p + 10], 9, 38016083), u = w(u, h, r, l, n[p + 15], 14, -660478335), l = w(l, u, h, r, n[p + 4], 20, -405537848), r = w(r, l, u, h, n[p + 9], 5, 568446438), h = w(h, r, l, u, n[p + 14], 9, -1019803690), u = w(u, h, r, l, n[p + 3], 14, -187363961), l = w(l, u, h, r, n[p + 8], 20, 1163531501), r = w(r, l, u, h, n[p + 13], 5, -1444681467), h = w(h, r, l, u, n[p + 2], 9, -51403784), u = w(u, h, r, l, n[p + 7], 14, 1735328473), l = w(l, u, h, r, n[p + 12], 20, -1926607734), r = z(r, l, u, h, n[p + 5], 4, -378558), h = z(h, r, l, u, n[p + 8], 11, -2022574463), u = z(u, h, r, l, n[p + 11], 16, 1839030562), l = z(l, u, h, r, n[p + 14], 23, -35309556), r = z(r, l, u, h, n[p + 1], 4, -1530992060), h = z(h, r, l, u, n[p + 4], 11, 1272893353), u = z(u, h, r, l, n[p + 7], 16, -155497632), l = z(l, u, h, r, n[p + 10], 23, -1094730640), r = z(r, l, u, h, n[p + 13], 4, 681279174), h = z(h, r, l, u, n[p + 0], 11, -358537222), u = z(u, h, r, l, n[p + 3], 16, -722521979), l = z(l, u, h, r, n[p + 6], 23, 76029189), r = z(r, l, u, h, n[p + 9], 4, -640364487), h = z(h, r, l, u, n[p + 12], 11, -421815835), u = z(u, h, r, l, n[p + 15], 16, 530742520), l = z(l, u, h, r, n[p + 2], 23, -995338651), r = S(r, l, u, h, n[p + 0], 6, -198630844), h = S(h, r, l, u, n[p + 7], 10, 1126891415), u = S(u, h, r, l, n[p + 14], 15, -1416354905), l = S(l, u, h, r, n[p + 5], 21, -57434055), r = S(r, l, u, h, n[p + 12], 6, 1700485571), h = S(h, r, l, u, n[p + 3], 10, -1894986606), u = S(u, h, r, l, n[p + 10], 15, -1051523), l = S(l, u, h, r, n[p + 1], 21, -2054922799), r = S(r, l, u, h, n[p + 8], 6, 1873313359), h = S(h, r, l, u, n[p + 15], 10, -30611744), u = S(u, h, r, l, n[p + 6], 15, -1560198380), l = S(l, u, h, r, n[p + 13], 21, 1309151649), r = S(r, l, u, h, n[p + 4], 6, -145523070), h = S(h, r, l, u, n[p + 11], 10, -1120210379), u = S(u, h, r, l, n[p + 2], 15, 718787259), l = S(l, u, h, r, n[p + 9], 21, -343485551), r = r + j >>> 0, l = l + P >>> 0, u = u + m >>> 0, h = h + x >>> 0;
    }
    return e.endian([r, l, u, h]);
  };
  s._ff = function(a, i, n, d, r, l, u) {
    var h = a + (i & n | ~i & d) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, s._gg = function(a, i, n, d, r, l, u) {
    var h = a + (i & d | n & ~d) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, s._hh = function(a, i, n, d, r, l, u) {
    var h = a + (i ^ n ^ d) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, s._ii = function(a, i, n, d, r, l, u) {
    var h = a + (n ^ (i | ~d)) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, s._blocksize = 16, s._digestsize = 16, Q2.exports = function(a, i) {
    if (a == null)
      throw new Error("Illegal argument " + a);
    var n = e.wordsToBytes(s(a, i));
...
const t4 = {
  ...
  setup(e) {
    const c = e, t = Z(() => G2(Z0(c.hash || c.text))), o = Z(() => {
      const a = c.text.split(" ");
      return a.length > 1 ? a[0][0] + a[1][0] : c.text[0] + c.text[1];
    }), s = Z(() => "https://www.gravatar.com/avatar/" + Z0(c.gavatar.trim().toLowerCase()) + "?s=50");
    return (a, i) => (v(), f("div", {
      class: I(["nice-avatar", [
        c.size ? "size-" + c.size : "",
...
const a4 = (e) => (I0("data-v-d12df4cc"), e = e(), A0(), e), r4 = { class: "nice-checkbox-box" }, d4 = {
  key: 0,
  viewBox: "0 0 20 20"
}, u4 = /* @__PURE__ */ a4(() => /* @__PURE__ */ b("path", { d: "M0 11l2-2 5 5 11-11 2 2-13 13z" }, null, -1)), h4 = [
  u4
  ...
  setup(e, { emit: c }) {
    ...
    return (i, n) => (v(), f("div", {
      ...
      b("div", r4, [
        _(s) ? (v(), f("svg", d4, h4)) : y("", !0)
      ]),
      t.title ? (v(), f("div", {
        key: 0,
        class: "nice-checkbox-title",
        for: "nice-checkbox" + _(o)
      }, V(t.title), 9, v4)) : y("", !0),
      b("input", {
        type: "checkbox",
        id: "nice-checkbox" + _(o),
        disabled: t.disabled
      }, null, 8, p4)
    ], 2));
  }
}), V0 = /* @__PURE__ */ X(m4, [["__scopeId", "data-v-d12df4cc"]]);
const y4 = {
...
function w4(e, c, t, o, s, a) {
  return t.title || t.caption ? (v(), f("div", b4, [
    t.title ? (v(), f("div", M4, [
      p0(V(t.title) + " ", 1),
      t.required ? (v(), f("span", g4, " *")) : y("", !0)
    ])) : y("", !0),
    t.caption ? (v(), f("div", z4, V(t.caption), 1)) : y("", !0)
  ])) : y("", !0);
}
const z0 = /* @__PURE__ */ X(y4, [["render", w4], ["__scopeId", "data-v-6938ba71"]]);
var e0 = "top", o0 = "bottom", n0 = "right", t0 = "left", G0 = "auto", F0 = [e0, o0, n0, t0], C0 = "start", E0 = "end", x4 = "clippingParents", Q1 = "viewport", O0 = "popper", _4 = "reference", S1 = /* @__PURE__ */ F0.reduce(function(e, c) {
  return e.concat([c + "-" + C0, c + "-" + E0]);
}, []), K1 = /* @__PURE__ */ [].concat(F0, [G0]).reduce(function(e, c) {
  return e.concat([c, c + "-" + C0, c + "-" + E0]);
...
function T4(e) {
  ...
  Object.keys(c.elements).forEach(function(t) {
    var o = c.styles[t] || {}, s = c.attributes[t] || {}, a = c.elements[t];
    !c0(a) || !a0(a) || (Object.assign(a.style, o), Object.keys(s).forEach(function(i) {
      var n = s[i];
...
function E4(e) {
  ...
  return Object.assign(c.elements.popper.style, t.popper), c.styles = t, c.elements.arrow && Object.assign(c.elements.arrow.style, t.arrow), function() {
    Object.keys(c.elements).forEach(function(o) {
      var s = c.elements[o], a = c.attributes[o] || {}, i = Object.keys(c.styles.hasOwnProperty(o) ? c.styles[o] : t[o]), n = i.reduce(function(d, r) {
        return d[r] = "", d;
      }, {});
      !c0(s) || !a0(s) || (Object.assign(s.style, n), Object.keys(a).forEach(function(d) {
        s.removeAttribute(d);
      }));
    });
  };
...
var M0 = Math.max, X0 = Math.min, B0 = Math.round;
function l1() {
...
function k0(e, c, t) {
  ...
  c && c0(e) && (s = e.offsetWidth > 0 && B0(o.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && B0(o.height) / e.offsetHeight || 1);
  var i = g0(e) ? s0(e) : window, n = i.visualViewport, d = !J1() && t, r = (o.left + (d && n ? n.offsetLeft : 0)) / s, l = (o.top + (d && n ? n.offsetTop : 0)) / a, u = o.width / s, h = o.height / a;
  return {
    width: u,
    height: h,
    top: l,
...
function u1(e) {
  var c = k0(e), t = e.offsetWidth, o = e.offsetHeight;
...
function A4(e) {
  ...
  var s = Q0(e);
  for (d1(s) && (s = s.host); c0(s) && ["html", "body"].indexOf(a0(s)) < 0; ) {
    var a = i0(s);
...
function P0(e) {
  for (var c = s0(e), t = O1(e); t && I4(t) && i0(t).position === "static"; )
    t = O1(t);
...
var P4 = function(c, t) {
  ...
  })) : c, c2(typeof c != "number" ? c : s2(c, F0));
};
function j4(e) {
  var c, t = e.state, o = e.name, s = e.options, a = t.elements.arrow, i = t.modifiersData.popperOffsets, n = l0(t.placement), d = h1(n), r = [t0, n0].indexOf(n) >= 0, l = r ? "height" : "width";
  if (!(!a || !i)) {
    var u = P4(s.padding, t), h = u1(a), p = d === "y" ? e0 : t0, C = d === "y" ? o0 : n0, w = t.rects.reference[l] + t.rects.reference[d] - i[d] - t.rects.popper[l], z = i[d] - t.rects.reference[d], S = P0(a), j = S ? d === "y" ? S.clientHeight || 0 : S.clientWidth || 0 : 0, P = w / 2 - z / 2, m = u[p], x = j - h[l] - u[C], $ = j / 2 - h[l] / 2 + P, E = D0(m, $, x), L = d;
    t.modifiersData[o] = (c = {}, c[L] = E, c.centerOffset = E - $, c);
  }
}
function L4(e) {
  ...
  if (s != null && !(typeof s == "string" && (s = c.elements.popper.querySelector(s), !s))) {
    if (process.env.NODE_ENV !== "production" && (c0(s) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !e2(c.elements.popper, s)) {
...
function V1(e) {
  var c, t = e.popper, o = e.popperRect, s = e.placement, a = e.variation, i = e.offsets, n = e.position, d = e.gpuAcceleration, r = e.adaptive, l = e.roundOffsets, u = e.isFixed, h = i.x, p = h === void 0 ? 0 : h, C = i.y, w = C === void 0 ? 0 : C, z = typeof l == "function" ? l({
    x: p,
    y: w
  }) : {
    x: p,
  ...
  p = z.x, w = z.y;
  var S = i.hasOwnProperty("x"), j = i.hasOwnProperty("y"), P = t0, m = e0, x = window;
  if (r) {
    var $ = P0(t), E = "clientHeight", L = "clientWidth";
    if ($ === s0(t) && ($ = f0(t), i0($).position !== "static" && n === "absolute" && (E = "scrollHeight", L = "scrollWidth")), $ = $, s === e0 || (s === t0 || s === n0) && a === E0) {
      m = o0;
      var A = u && $ === x && x.visualViewport ? x.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        $[E]
      );
      w -= A - o.height, w *= d ? 1 : -1;
    }
    if (s === t0 || (s === e0 || s === o0) && a === E0) {
      P = n0;
      var R = u && $ === x && x.visualViewport ? x.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        $[L]
      );
      p -= R - o.width, p *= d ? 1 : -1;
  ...
  if (p = B.x, w = B.y, d) {
    var M;
    return Object.assign({}, N, (M = {}, M[m] = j ? "0" : "", M[P] = S ? "0" : "", M.transform = (x.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + w + "px)" : "translate3d(" + p + "px, " + w + "px, 0)", M));
  }
  return Object.assign({}, N, (c = {}, c[m] = j ? w + "px" : "", c[P] = S ? p + "px" : "", c.transform = "", c));
}
function U4(e) {
  var c = e.state, t = e.options, o = t.gpuAcceleration, s = o === void 0 ? !0 : o, a = t.adaptive, i = a === void 0 ? !0 : a, n = t.roundOffsets, d = n === void 0 ? !0 : n;
...
function Z4(e) {
  var c = e.state, t = e.instance, o = e.options, s = o.scroll, a = s === void 0 ? !0 : s, i = o.resize, n = i === void 0 ? !0 : i, d = s0(c.elements.popper), r = [].concat(c.scrollParents.reference, c.scrollParents.popper);
...
function p1(e) {
  return k0(f0(e)).left + v1(e).scrollLeft;
}
function K4(e, c) {
  var t = s0(e), o = f0(e), s = t.visualViewport, a = o.clientWidth, i = o.clientHeight, n = 0, d = 0;
  if (s) {
...
function J4(e) {
  var c, t = f0(e), o = v1(e), s = (c = e.ownerDocument) == null ? void 0 : c.body, a = M0(t.scrollWidth, t.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), i = M0(t.scrollHeight, t.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), n = -o.scrollLeft + p1(e), d = -o.scrollTop;
  return i0(s || t).direction === "rtl" && (n += M0(t.clientWidth, s ? s.clientWidth : 0) - a), {
    width: a,
    height: i,
    x: n,
    y: d
...
function o2(e) {
  return ["html", "body", "#document"].indexOf(a0(e)) >= 0 ? e.ownerDocument.body : c0(e) && f1(e) ? e : o2(Q0(e));
}
function T0(e, c) {
  var t;
  c === void 0 && (c = []);
  var o = o2(e), s = o === ((t = e.ownerDocument) == null ? void 0 : t.body), a = s0(o), i = s ? [a].concat(a.visualViewport || [], f1(o) ? o : []) : o, n = c.concat(i);
  return s ? n : (
...
function e3(e, c) {
  var t = k0(e, !1, c === "fixed");
  return t.top = t.top + e.clientTop, t.left = t.left + e.clientLeft, t.bottom = t.top + e.clientHeight, t.right = t.left + e.clientWidth, t.width = e.clientWidth, t.height = e.clientHeight, t.x = t.left, t.y = t.top, t;
}
function T1(e, c, t) {
  return c === Q1 ? i1(K4(e, t)) : g0(c) ? e3(c, t) : i1(J4(f0(e)));
}
function t3(e) {
  var c = T0(Q0(e)), t = ["absolute", "fixed"].indexOf(i0(e).position) >= 0, o = t && c0(e) ? P0(e) : e;
  return g0(o) ? c.filter(function(s) {
    return g0(s) && e2(s, o) && a0(s) !== "body";
  }) : [];
}
function c3(e, c, t, o) {
  var s = c === "clippingParents" ? t3(e) : [].concat(c), a = [].concat(s, [t]), i = a[0], n = a.reduce(function(d, r) {
    var l = T1(e, r, o);
    return d.top = M0(l.top, d.top), d.right = X0(l.right, d.right), d.bottom = X0(l.bottom, d.bottom), d.left = M0(l.left, d.left), d;
  }, T1(e, i, o));
  return n.width = n.right - n.left, n.height = n.bottom - n.top, n.x = n.left, n.y = n.top, n;
}
function n2(e) {
  var c = e.reference, t = e.element, o = e.placement, s = o ? l0(o) : null, a = o ? N0(o) : null, i = c.x + c.width / 2 - t.width / 2, n = c.y + c.height / 2 - t.height / 2, d;
  switch (s) {
    case e0:
      d = {
        x: i,
...
function q0(e, c) {
  c === void 0 && (c = {});
  var t = c, o = t.placement, s = o === void 0 ? e.placement : o, a = t.strategy, i = a === void 0 ? e.strategy : a, n = t.boundary, d = n === void 0 ? x4 : n, r = t.rootBoundary, l = r === void 0 ? Q1 : r, u = t.elementContext, h = u === void 0 ? O0 : u, p = t.altBoundary, C = p === void 0 ? !1 : p, w = t.padding, z = w === void 0 ? 0 : w, S = c2(typeof z != "number" ? z : s2(z, F0)), j = h === O0 ? _4 : O0, P = e.rects.popper, m = e.elements[C ? j : h], x = c3(g0(m) ? m : m.contextElement || f0(e.elements.popper), d, l, i), $ = k0(e.elements.reference), E = n2({
    reference: $,
    element: P,
    strategy: "absolute",
    placement: s
  }), L = i1(Object.assign({}, P, E)), A = h === O0 ? L : $, R = {
    top: x.top - A.top + S.top,
    bottom: A.bottom - x.bottom + S.bottom,
    left: x.left - A.left + S.left,
    right: A.right - x.right + S.right
  }, N = e.modifiersData.offset;
  if (h === O0 && N) {
    var B = N[s];
    Object.keys(R).forEach(function(M) {
      var k = [n0, o0].indexOf(M) >= 0 ? 1 : -1, O = [e0, o0].indexOf(M) >= 0 ? "y" : "x";
      R[M] += B[O] * k;
    });
  }
  return R;
...
function s3(e, c) {
  c === void 0 && (c = {});
  var t = c, o = t.placement, s = t.boundary, a = t.rootBoundary, i = t.padding, n = t.flipVariations, d = t.allowedAutoPlacements, r = d === void 0 ? K1 : d, l = N0(o), u = l ? n ? S1 : S1.filter(function(C) {
    return N0(C) === l;
  }) : F0, h = u.filter(function(C) {
  ...
  return Object.keys(p).sort(function(C, w) {
    return p[C] - p[w];
  });
}
function o3(e) {
...
function n3(e) {
  ...
  if (!c.modifiersData[o]._skip) {
    for (var s = t.mainAxis, a = s === void 0 ? !0 : s, i = t.altAxis, n = i === void 0 ? !0 : i, d = t.fallbackPlacements, r = t.padding, l = t.boundary, u = t.rootBoundary, h = t.altBoundary, p = t.flipVariations, C = p === void 0 ? !0 : p, w = t.allowedAutoPlacements, z = c.options.placement, S = l0(z), j = S === z, P = d || (j || !C ? [W0(z)] : o3(z)), m = [z].concat(P).reduce(function(x0, u0) {
      return x0.concat(l0(u0) === G0 ? s3(c, {
        placement: u0,
        boundary: l,
        rootBoundary: u,
        padding: r,
    ...
    }, []), x = c.rects.reference, $ = c.rects.popper, E = /* @__PURE__ */ new Map(), L = !0, A = m[0], R = 0; R < m.length; R++) {
      var N = m[R], B = l0(N), M = N0(N) === C0, k = [e0, o0].indexOf(B) >= 0, O = k ? "width" : "height", F = q0(c, {
        placement: N,
        boundary: l,
        rootBoundary: u,
        altBoundary: h,
      ...
      x[O] > $[O] && (D = W0(D));
      var g = W0(D), T = [];
      if (a && T.push(F[B] <= 0), n && T.push(F[D] <= 0, F[g] <= 0), T.every(function(x0) {
        return x0;
      })) {
        A = N, L = !1;
        break;
    ...
    if (L)
      for (var d0 = C ? 3 : 1, w0 = function(u0) {
        var S0 = m.find(function(L0) {
          var m0 = E.get(L0);
          if (m0)
            return m0.slice(0, u0).every(function(J0) {
              return J0;
            });
        });
        if (S0)
    ...
    c.placement !== A && (c.modifiersData[o]._skip = !0, c.placement = A, c.reset = !0);
  }
}
const l3 = {
  name: "flip",
...
function i3(e) {
  var c = e.state, t = e.name, o = c.rects.reference, s = c.rects.popper, a = c.modifiersData.preventOverflow, i = q0(c, {
    elementContext: "reference"
  }), n = q0(c, {
    altBoundary: !0
  }), d = E1(i, o), r = E1(n, s, a), l = q1(d), u = q1(r);
  c.modifiersData[t] = {
...
function r3(e, c, t) {
  var o = l0(e), s = [t0, e0].indexOf(o) >= 0 ? -1 : 1, a = typeof t == "function" ? t(Object.assign({}, c, {
    placement: e
  })) : t, i = a[0], n = a[1];
  return i = i || 0, n = (n || 0) * s, [t0, n0].indexOf(o) >= 0 ? {
    x: n,
    y: i
  } : {
    x: i,
...
function d3(e) {
  var c = e.state, t = e.options, o = e.name, s = t.offset, a = s === void 0 ? [0, 0] : s, i = K1.reduce(function(l, u) {
    return l[u] = r3(u, c.rects, a), l;
  }, {}), n = i[c.placement], d = n.x, r = n.y;
  c.modifiersData.popperOffsets != null && (c.modifiersData.popperOffsets.x += d, c.modifiersData.popperOffsets.y += r), c.modifiersData[o] = i;
}
const u3 = {
  name: "offset",
  enabled: !0,
...
function f3(e) {
  var c = e.state, t = e.options, o = e.name, s = t.mainAxis, a = s === void 0 ? !0 : s, i = t.altAxis, n = i === void 0 ? !1 : i, d = t.boundary, r = t.rootBoundary, l = t.altBoundary, u = t.padding, h = t.tether, p = h === void 0 ? !0 : h, C = t.tetherOffset, w = C === void 0 ? 0 : C, z = q0(c, {
    boundary: d,
    rootBoundary: r,
    padding: u,
    altBoundary: l
  }), S = l0(c.placement), j = N0(c.placement), P = !j, m = h1(S), x = p3(m), $ = c.modifiersData.popperOffsets, E = c.rects.reference, L = c.rects.popper, A = typeof w == "function" ? w(Object.assign({}, c.rects, {
    placement: c.placement
  })) : w, R = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
    ...
    mainAxis: 0,
    altAxis: 0
  }, A), N = c.modifiersData.offset ? c.modifiersData.offset[c.placement] : null, B = {
    x: 0,
    y: 0
  };
  if ($) {
    if (a) {
      var M, k = m === "y" ? e0 : t0, O = m === "y" ? o0 : n0, F = m === "y" ? "height" : "width", D = $[m], g = D + z[k], T = D - z[O], d0 = p ? -L[F] / 2 : 0, w0 = j === C0 ? E[F] : L[F], $0 = j === C0 ? -L[F] : -E[F], j0 = c.elements.arrow, x0 = p && j0 ? u1(j0) : {
        width: 0,
        height: 0
      }, u0 = c.modifiersData["arrow#persistent"] ? c.modifiersData["arrow#persistent"].padding : t2(), S0 = u0[k], L0 = u0[O], m0 = D0(0, E[F], x0[F]), J0 = P ? E[F] / 2 - d0 - m0 - S0 - R.mainAxis : w0 - m0 - S0 - R.mainAxis, r2 = P ? -E[F] / 2 + d0 + m0 + L0 + R.mainAxis : $0 + m0 + L0 + R.mainAxis, e1 = c.elements.arrow && P0(c.elements.arrow), d2 = e1 ? m === "y" ? e1.clientTop || 0 : e1.clientLeft || 0 : 0, b1 = (M = N == null ? void 0 : N[m]) != null ? M : 0, u2 = D + J0 - b1 - d2, h2 = D + r2 - b1, M1 = D0(p ? X0(g, u2) : g, D, p ? M0(T, h2) : T);
      $[m] = M1, B[m] = M1 - D;
    }
    if (n) {
      var g1, v2 = m === "x" ? e0 : t0, p2 = m === "x" ? o0 : n0, y0 = $[x], R0 = x === "y" ? "height" : "width", z1 = y0 + z[v2], w1 = y0 - z[p2], t1 = [e0, t0].indexOf(S) !== -1, x1 = (g1 = N == null ? void 0 : N[x]) != null ? g1 : 0, _1 = t1 ? z1 : y0 - E[R0] - L[R0] - x1 + R.altAxis, C1 = t1 ? y0 + E[R0] + L[R0] - x1 - R.altAxis : w1, B1 = p && t1 ? F4(_1, y0, C1) : D0(p ? _1 : z1, y0, p ? C1 : w1);
      $[x] = B1, B[x] = B1 - y0;
    }
    c.modifiersData[o] = B;
  }
...
function b3(e) {
  return e === s0(e) || !c0(e) ? v1(e) : y3(e);
}
function M3(e) {
  var c = e.getBoundingClientRect(), t = B0(c.width) / e.offsetWidth || 1, o = B0(c.height) / e.offsetHeight || 1;
  return t !== 1 || o !== 1;
}
function g3(e, c, t) {
  t === void 0 && (t = !1);
  var o = c0(c), s = c0(c) && M3(c), a = f0(c), i = k0(e, s, t), n = {
    scrollLeft: 0,
    scrollTop: 0
  }, d = {
    x: 0,
  ...
  f1(a)) && (n = b3(c)), c0(c) ? (d = k0(c, !0), d.x += c.clientLeft, d.y += c.clientTop) : a && (d.x = p1(a))), {
...
var b0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', _3 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', I1 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function C3(e) {
  e.forEach(function(c) {
    [].concat(Object.keys(c), I1).filter(function(t, o, s) {
      return s.indexOf(t) === o;
    }).forEach(function(t) {
      switch (t) {
        case "name":
          typeof c.name != "string" && console.error(h0(b0, String(c.name), '"name"', '"string"', '"' + String(c.name) + '"'));
          break;
        case "enabled":
          typeof c.enabled != "boolean" && console.error(h0(b0, c.name, '"enabled"', '"boolean"', '"' + String(c.enabled) + '"'));
          break;
        case "phase":
          n1.indexOf(c.phase) < 0 && console.error(h0(b0, c.name, '"phase"', "either " + n1.join(", "), '"' + String(c.phase) + '"'));
          break;
        case "fn":
          typeof c.fn != "function" && console.error(h0(b0, c.name, '"fn"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "effect":
          c.effect != null && typeof c.effect != "function" && console.error(h0(b0, c.name, '"effect"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "requires":
          c.requires != null && !Array.isArray(c.requires) && console.error(h0(b0, c.name, '"requires"', '"array"', '"' + String(c.requires) + '"'));
          break;
        case "requiresIfExists":
          Array.isArray(c.requiresIfExists) || console.error(h0(b0, c.name, '"requiresIfExists"', '"array"', '"' + String(c.requiresIfExists) + '"'));
          break;
        case "options":
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + c.name + '" modifier, valid properties are ' + I1.map(function(o) {
            return '"' + o + '"';
      ...
      c.requires && c.requires.forEach(function(o) {
        e.find(function(s) {
          return s.name === o;
        }) == null && console.error(h0(_3, String(c.name), o, o));
      });
    });
  });
}
...
function $3(e) {
  e === void 0 && (e = {});
  var c = e, t = c.defaultModifiers, o = t === void 0 ? [] : t, s = c.defaultOptions, a = s === void 0 ? F1 : s;
  return function(n, d, r) {
    ...
    var l = {
      ...
      setOptions: function(S) {
        var j = typeof S == "function" ? S(l.options) : S;
        w(), l.options = Object.assign({}, a, l.options, j), l.scrollParents = {
          reference: g0(n) ? T0(n) : n.contextElement ? T0(n.contextElement) : [],
          popper: T0(d)
        };
        var P = w3(k3([].concat(o, l.options.modifiers)));
        if (l.orderedModifiers = P.filter(function(N) {
          return N.enabled;
        }), process.env.NODE_ENV !== "production") {
          var m = B3([].concat(P, l.options.modifiers), function(N) {
            var B = N.name;
            return B;
          });
          if (C3(m), l0(l.options.placement) === G0) {
            var x = l.orderedModifiers.find(function(N) {
              var B = N.name;
              return B === "flip";
            });
            x || console.error(['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
          }
          var $ = i0(d), E = $.marginTop, L = $.marginRight, A = $.marginBottom, R = $.marginLeft;
          [E, L, A, R].some(function(N) {
            return parseFloat(N);
      ...
      forceUpdate: function() {
        if (!h) {
          var S = l.elements, j = S.reference, P = S.popper;
          if (!P1(j, P)) {
            process.env.NODE_ENV !== "production" && console.error(A1);
            return;
          }
          l.rects = {
            reference: g3(j, P0(P), l.options.strategy === "fixed"),
            popper: u1(P)
          ...
          for (var m = 0, x = 0; x < l.orderedModifiers.length; x++) {
            ...
            var $ = l.orderedModifiers[x], E = $.fn, L = $.options, A = L === void 0 ? {} : L, R = $.name;
    ...
    p.setOptions(r).then(function(z) {
      !h && r.onFirstUpdate && r.onFirstUpdate(z);
    });
    function C() {
      l.orderedModifiers.forEach(function(z) {
        var S = z.name, j = z.options, P = j === void 0 ? {} : j, m = z.effect;
  ...
  setup(e, { expose: c, emit: t }) {
    ...
    r0(() => {
      ...
      o.showArrow && z.push({
        ...
        modifiers: z
      }), document.addEventListener("click", w), document.addEventListener("touchend", w);
    }), m2(() => {
      document.removeEventListener("click", w), document.removeEventListener("touchend", w);
    });
    function u() {
      o.disabled || (s.value = !s.value, i.update(), t("change", s));
    }
    function h() {
      s.value = !1, t("change", s);
    }
    function p() {
      !o.openOnHover || o.disabled || (a.value = !0, s.value = !0, i.update());
    }
    function C() {
      !o.openOnHover || o.disabled || (a.value = !1, s.value = !1);
    }
    function w(z) {
      o.openOnHover || o.disabled || s.value && !z.composedPath().includes(l.value) && !z.composedPath().includes(d.value) && h();
    }
    return c({ close: h, toggle: u }), (z, S) => (v(), f("div", {
      class: I(["nice-popup", { "nice-popup-open": s.value, "nice-popup-focused": a.value, disabled: o.disabled }]),
      ref_key: "$el",
      ref: l
    }, [
      b("div", {
...
}), K0 = /* @__PURE__ */ X(D3, [["__scopeId", "data-v-67f29891"]]);
const m1 = (e) => (I0("data-v-a75a5e3e"), e = e(), A0(), e), T3 = { class: "input-group" }, E3 = ["placeholder", "disabled", "required"], q3 = { class: "nice-dropdown" }, I3 = { class: "month-wrapper" }, A3 = { class: "value" }, F3 = { class: "year" }, P3 = { class: "month" }, j3 = { class: "calendar" }, L3 = { class: "header" }, R3 = { class: "month" }, H3 = ["onClick", "title"], W3 = {
  key: 0,
  class: "time"
}, U3 = { class: "select-wrapper" }, Y3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ b("div", { class: "arrow-down" }, null, -1)), Z3 = ["value", "selected"], X3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ b("div", null, ":", -1)), G3 = { class: "select-wrapper" }, Q3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ b("div", { class: "arrow-down" }, null, -1)), K3 = ["value", "selected"], J3 = {
  name: "NiceDate"
  ...
  emits: ["change", "update:modelValue"],
  setup(e, { emit: c }) {
    const t = e, o = Q("$t"), s = W(null), a = W(""), i = W(/* @__PURE__ */ new Date()), n = W([]), d = W(null), r = [
      0,
      1,
      2,
      3,
    ...
    R1(() => t.modelValue, () => {
      t.modelValue && C(t.modelValue) && (s.value = new Date(t.modelValue), i.value = new Date(t.modelValue), M());
    }), r0(() => {
      E();
    });
    function C(k) {
      return !isNaN(new Date(k));
    }
    function w() {
    ...
    function j() {
      M(), c("update:modelValue", s.value), c("change", s.value);
    }
    function P() {
      if (a.value && a.value != "") {
        let k = a.value.split(" • "), O = /* @__PURE__ */ new Date(), F = k[0].split(".");
        if (O.setDate(F[0]), O.setMonth(F[1] - 1), O.setFullYear(F[2]), t.time) {
          let D = k[1].split(":");
          O.setHours(D[0]), O.setMinutes(D[1]), O.setSeconds(0, 0);
        } else
    ...
    function m(k) {
      ...
      i.value.setHours(O), s.value.setHours(O), j();
    }
    function x(k) {
      let O = k.target.value;
      i.value.setMinutes(O), s.value.setMinutes(O), j();
    }
    function $(k) {
      s.value.setYear(k.year), s.value.setMonth(k.month), s.value.setDate(k.day), j();
    }
    function E() {
      t.modelValue || (s.value = /* @__PURE__ */ new Date(), s.value.setSeconds(0, 0)), t.modelValue && C(t.modelValue) && (s.value = new Date(t.modelValue), s.value.setSeconds(0, 0), a.value = B(s.value));
    }
    function L(k) {
      let O = i.value.getMonth();
      k ? O += 1 : O -= 1, i.value.setMonth(O), A();
    }
    function A() {
      n.value = [];
      let k = new Date(
    ...
    function R(k, O, F) {
      const D = /* @__PURE__ */ new Date(), g = new Date(k, O, F);
      return {
        id: g.toString(),
        date: g,
        year: g.getFullYear(),
        ...
        day: g.getDate(),
        dayInWeek: g.getDay(),
        currentMonth: g.getMonth() == i.value.getMonth(),
        selected: N(s.value, g),
        today: N(D, g),
        text: B(g)
      };
    }
    ...
    function B(k) {
      let O = k.getDate(), F = k.getMonth() + 1, D = k.getFullYear(), g = k.getHours(), T = k.getMinutes();
      return T < 10 && (T = "0" + T), t.time ? `${O}.${F}.${D} • ${g}:${T}` : `${O}.${F}.${D}`;
    }
    function M() {
      s.value || (s.value = /* @__PURE__ */ new Date()), p.day = s.value.getDate(), p.month = s.value.getMonth(), p.year = s.value.getFullYear(), p.hour = s.value.getHours(), p.minute = s.value.getMinutes(), a.value = B(s.value), i.value.year = p.year, i.value.month = p.month, A();
    }
    return (k, O) => {
      const F = U("NiceIcon"), D = U("NiceButton");
      return v(), f("div", {
          ...
          trigger: J(() => [
            b("div", T3, [
              _0(b("input", {
                ...
                placeholder: e.placeholder || _(o)("Nice", "None"),
                disabled: e.disabled,
                required: e.required,
                onBlur: P
              }, null, 40, E3), [
          ...
          content: J(() => [
            b("div", q3, [
              b("div", I3, [
                q(D, {
                  class: "left",
                  onClick: O[1] || (O[1] = (g) => L(!1)),
                  icon: "icon-chevron-left",
                  naked: ""
                }),
                b("div", A3, [
                  b("div", F3, V(i.value.getFullYear()), 1),
                  b("div", P3, V(h[i.value.getMonth() + 1]), 1)
                ]),
                q(D, {
                  class: "right",
                  onClick: O[2] || (O[2] = (g) => L(!0)),
              ...
              b("div", j3, [
                ...
                b("div", R3, [
                  (v(!0), f(G, null, K(n.value, (g) => (v(), f("div", {
                    class: I(["day", {
              ...
              e.time ? (v(), f("div", W3, [
                b("div", U3, [
                  Y3,
                  b("select", { onChange: m }, [
                    (v(), f(G, null, K(r, (g) => b("option", {
                      value: g,
                      key: g,
                      selected: g == i.value.getHours()
                    }, V(g), 9, Z3)), 64))
                  ], 32)
                ]),
                X3,
                b("div", G3, [
                  Q3,
                  b("select", { onChange: x }, [
                    (v(), f(G, null, K(l, (g) => b("option", {
                      value: g,
                      key: g,
                      selected: g == i.value.getMinutes()
                    }, V(g), 9, K3)), 64))
                  ], 32)
                ]),
                q(F, {
...
}), t7 = /* @__PURE__ */ X(e7, [["__scopeId", "data-v-a75a5e3e"]]);
const c7 = { class: "input-group" }, s7 = ["required", "disabled", "modelValue"], o7 = ["selected"], n7 = ["value"], l7 = {
  ...
  setup(e, { emit: c }) {
    ...
    return (d, r) => {
      const l = U("NiceLoading"), u = U("NiceIcon");
      return v(), f("div", {
          ...
          b("div", {
            ...
            b("select", {
              ...
              e.nullable ? (v(), f("option", {
                ...
                value: null,
                selected: !_(s)
              }, V(e.nullText || _(o)("Nice", "None")), 9, o7)) : y("", !0),
              (v(!0), f(G, null, K(e.values, (h) => (v(), f("option", {
                value: h[e.keyName],
                key: h[e.keyName]
              }, V(h[e.valueName]), 9, n7))), 128))
            ], 40, s7),
            !e.nullable && !e.loading && (!e.values || e.values.length == 0) ? (v(), f("div", l7, V(_(o)("Nice", "No options")), 1)) : y("", !0),
            e.loading ? (v(), H(l, {
              key: 1,
              class: "no-options"
            })) : y("", !0),
...
}), d7 = /* @__PURE__ */ X(r7, [["__scopeId", "data-v-d2fc0d46"]]);
  ...
  setup(e) {
    ...
    return (t, o) => {
      ...
      return v(), f("div", {
        ...
        b("div", u7, [
          q(s, { icon: "icon-half-loading" }),
          q(s, { icon: "icon-half-loading" })
        ]),
        c.message ? (v(), f("div", h7, V(c.message), 1)) : y("", !0)
      ], 2);
    };
  }
}), y1 = /* @__PURE__ */ X(p7, [["__scopeId", "data-v-3d00153a"]]);
const f7 = { class: "nice-dropdown-wrapper" }, m7 = { class: "input-group" }, y7 = { class: "select-wrapper" }, b7 = ["required", "value", "disabled"], M7 = {
  ...
  setup(e, { emit: c }) {
    const t = e, o = Q("$t");
    let s = null;
    const a = 500, i = W(!1), n = W(null), d = W(null), r = W(null), l = W(null), u = W(!1), h = W(null), p = W(null), C = Z(() => t.keyOnly && !t.multiple ? h.value ? h.value.find((M) => M[t.keyName] == t.modelValue) : {} : (t.multiple && S(), t.modelValue)), w = Z(() => t.disabled ? !1 : !!t.modelValue && !!t.nullable), z = Z(() => h.value != null ? h.value.filter((M) => M._selected) : []), S = function() {
      h.value && t.modelValue != null && t.multiple && h.value.forEach((M) => {
        M._selected = !!t.modelValue.find((k) => k[t.keyName] == M[t.keyName]);
      });
    };
    r0(async () => {
      await N(), L();
    ...
    function j(M) {
      var k;
      (M.code == "Enter" || M.code == "Space") && (M.preventDefault(), (k = r.value) == null || k.toggle());
    }
    function P() {
      var M;
    ...
    async function $(M) {
      M ? (h.value || await N(), p.value != null ? l.value = h.value.findIndex(
        (k) => k[t.keyName] == p.value[t.keyName]
      ) : l.value = -1, setTimeout(() => {
        var k;
        (k = d.value) == null || k.focus();
      }, 100), document.addEventListener("keydown", B)) : (n.value = null, u.value = !1, document.removeEventListener("keydown", B));
    }
    function E(M) {
      if (M) {
        const k = M[t.keyName], O = h.value.find((F) => F[t.keyName] == k);
        A(O || null);
      } else
        A(null);
      t.multiple || P();
    ...
    function L() {
      h.value && h.value.length > 0 && !t.nullable && !t.modelValue ? A(h.value[0]) : S();
    }
    function A(M) {
      M ? t.multiple ? (M._selected = !M._selected, t.keyOnly ? (c("update:modelValue", z.value.filter.map((k) => k[t.keyName])), c("change", z.value.map((k) => k[t.keyName]))) : (c("update:modelValue", z.value), c("change", z.value))) : t.keyOnly ? (c("update:modelValue", M[t.keyName]), c("change", M[t.keyName])) : (c("update:modelValue", M), c("change", M)) : (c("update:modelValue", null), c("change", null));
    }
    function R() {
    ...
    function B(M) {
      M.key == "ArrowDown" ? (l.value < h.value.length - 1 && (l.value += 1), M.preventDefault()) : M.key == "ArrowUp" ? (l.value > 0 && (l.value -= 1), M.preventDefault()) : M.key == "Escape" ? (P(), M.preventDefault()) : M.key == "Enter" && (A(h.value[l.value]), P(), M.preventDefault());
    }
    return (M, k) => {
      const O = U("nice-icon"), F = U("NiceIcon");
      return v(), f("div", {
                ...
                b("div", y7, [
                  b("div", {
                    ...
                    b("input", {
                      ...
                      value: e.modelValue,
                      class: "hidden-input",
                      onFocus: k[0] || (k[0] = (D) => i.value = !0),
                      onBlur: k[1] || (k[1] = (D) => i.value = !1),
                      onKeypress: j,
                      disabled: e.disabled
                    }, null, 40, b7),
                    !e.loading && e.modelValue && !t.multiple ? (v(), f("div", M7, [
                      Y(M.$slots, "selected-option", { item: e.modelValue }, () => [
                        b("span", null, V(e.formatFunction ? e.formatFunction(e.modelValue) : _(C)[e.valueName]), 1)
                      ], !0)
                    ])) : y("", !0),
                    t.multiple ? (v(), f("div", g7, [
                      (v(!0), f(G, null, K(_(z), (D) => (v(), f("div", {
                        class: "option",
                        key: D
                      }, [
                        Y(M.$slots, "selected-option", H1({ item: D }, D), () => [
                          b("span", null, V(e.formatFunction ? e.formatFunction(D) : D[t.valueName]), 1)
                        ], !0),
                        b("button", {
                    ...
                    !e.loading && !e.modelValue || t.multiple && !_(z).length ? (v(), f("div", w7, V(e.nullText || _(o)("Nice", "None")), 1)) : y("", !0),
                    e.loading ? (v(), f("div", x7, V(_(o)("Nice", "Loading")), 1)) : y("", !0),
                    q(F, {
                      class: "arrow-down",
                      icon: "icon-chevron-down"
                    }),
            ...
            content: J(() => [
              b("div", _7, [
                e.searchFunction && !e.noSearch ? (v(), f("div", C7, [
                  _0(b("input", {
                    "onUpdate:modelValue": k[2] || (k[2] = (D) => n.value = D),
                    type: "text",
                    placeholder: _(o)("Nice", "Search..."),
                    name: _(o)("Nice", "Search"),
                    onInput: R,
                ...
                b("div", k7, [
                  e.nullable ? (v(), f("div", {
                    ...
                    onClick: k[3] || (k[3] = (D) => E(void 0))
                  }, V(e.nullText || _(o)("Nice", "None")), 3)) : y("", !0),
                  (v(!0), f(G, null, K(h.value, (D, g) => (v(), f("div", {
                    class: I(["element", {
                      hover: l.value == g,
                      selected: e.modelValue && (!t.multiple && D[e.keyName] == _(C)[e.keyName] || D._selected)
                    }]),
                    key: D[e.keyName],
                    onClick: (T) => E(D)
                  }, [
                    ...
                    Y(M.$slots, "option", { item: D }, () => [
                      p0(V(e.formatFunction ? e.formatFunction(D) : D[e.valueName]), 1)
                    ], !0)
                  ], 10, N7))), 128)),
                  !u.value && (!h.value || h.value.length == 0) ? (v(), f("div", $7, V(_(o)("Nice", "No options")), 1)) : y("", !0)
                ])
              ])
            ]),
            _: 3
          }, 8, ["disabled"]),
          e.addFunction ? (v(), H(v0, {
            key: 0,
...
}), V7 = /* @__PURE__ */ X(O7, [["__scopeId", "data-v-60c3d28c"]]);
const D7 = (e) => (I0("data-v-b3fd1522"), e = e(), A0(), e), T7 = { class: "nice-filters-wrapper" }, E7 = { class: "nice-component nice-filters" }, q7 = {
...
}, I7 = /* @__PURE__ */ D7(() => /* @__PURE__ */ b("div", { class: "f-grow" }, null, -1)), A7 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, F7 = ["title"], P7 = {
  name: "NiceFilters"
}, j7 = /* @__PURE__ */ Object.assign(P7, {
  props: {
    // filters: {
    //   type: Object,
    //   required: false,
  ...
  setup(e, { emit: c }) {
    const t = e, o = Q("clone"), s = Q("$t"), a = U1(), i = Y1(), n = W(""), d = W(t.modelValue), r = [
      { id: "true", name: s("Nice", "Yes") },
      { id: "false", name: s("Nice", "No") }
    ], l = (m) => m ? r.filter(
      (x) => x.name.toLowerCase().includes(m.toLowerCase())
    ) : r, u = Z(() => d.value ? d.value.filter((m) => m.value != null) : []), h = Z(() => {
      if (!d.value)
        return {};
      const m = {};
    ...
    function p(m) {
      const x = new Date(m.value), $ = x.getDate(), E = x.getMonth() + 1, L = x.getFullYear(), A = x.getHours(), R = x.getMinutes();
      return `${$}.${E}.${L} ${A}:${R < 10 ? "0" : ""}${R}`;
    }
    function C(m) {
      var x, $;
      return m.formatter ? m.formatter(m.value) : m.type == "date" ? p(m) : m.type == "boolean" ? m.value ? s("Nice", "Yes") : s("Nice", "No") : m.valueName ? m.value[m.valueName] : (x = m.value) != null && x.name ? m.value.name : ($ = m.value) != null && $.value ? m.value.value : m.value;
    }
    function w(m) {
      var x;
      return m ? m.type == "date" ? !m.value || isNaN(new Date(m.value)) ? null : m.value ? new Date(m.value).toISOString() : null : m.valueRaw || (m.getKey ? m.getKey(m.value) : null) || ((x = m.value) == null ? void 0 : x.id) || m.value : null;
    }
    async function z() {
      await i.isReady();
      const m = o(a.query);
      d.value.forEach(async (x) => {
        const $ = m[x.key];
        if (x.type == "yesno") {
          let E = r.find(
            (L) => L.id == m[x.key]
          );
          m[x.key] || (E = null), x.value = E;
        } else if (x.type == "date")
          x.value = new Date($);
        else if (x.type == "boolean")
          x.value = $ == "true";
        else if (x.type == "select" && x.fetch) {
          const E = await x.fetch($);
          x.value = E;
        } else
          console.log("[NiceFilters] Query not handled: ", x.key, $);
      }), setTimeout(() => {
        c("update:modelValue", d), c("change", d);
      });
    }
    async function S() {
      setTimeout(async () => {
        ...
        const x = Object.keys(m).filter(($) => m[$] != null && m[$] != "").reduce(($, E) => ({ ...$, [E]: m[E] }), {});
        i.push({ query: x }), await i.isReady(), setTimeout(() => {
          c("update:modelValue", d.value), c("change", d.value);
        });
      });
    }
    async function j() {
      const m = { ...a.query, id: "new" };
    ...
    return (m, x) => {
      const $ = U("NiceInput"), E = U("NiceSwitch"), L = U("NiceDate"), A = U("NiceDropdown"), R = U("NiceButton");
      return v(), f("div", T7, [
        b("div", E7, [
          q($, {
          ...
          d.value ? (v(), f("div", q7, [
            (v(!0), f(G, null, K(d.value, (N) => (v(), f("div", {
              class: "nice-filters-filter",
              key: N.key
            }, [
              N.type == "boolean" ? (v(), H(E, {
                key: 0,
                modelValue: N.value,
        ...
        e.showPills && _(u) && _(u).length ? (v(), f("div", A7, [
          (v(!0), f(G, null, K(_(u), (N) => (v(), f("div", {
            class: "nice-filters-pill badge badge-primary",
            key: N.key,
            title: N.description
          }, [
            b("div", null, [
              b("small", null, V(N.name), 1),
              b("div", null, V(C(N)), 1)
            ]),
            q(R, {
              icon: "icon-x",
...
}), L7 = /* @__PURE__ */ X(j7, [["__scopeId", "data-v-b3fd1522"]]);
const R7 = { class: "nice-icon" }, H7 = ["xlink:href"], W7 = {
  ...
  setup(e) {
    const c = e;
    return (t, o) => (v(), f("svg", R7, [
      b("use", {
        "xlink:href": "#" + c.icon
      }, null, 8, H7)
    ]));
  }
}), l2 = /* @__PURE__ */ X(U7, [["__scopeId", "data-v-aee3bde0"]]);
var i2 = Y7;
function Y7(e, c, t) {
  if (!e)
    return t;
...
const Z7 = { class: "input-group" }, X7 = ["placeholder", "autocomplete", "type", "required", "disabled"], G7 = {
  key: 1,
  ...
  setup(e, { emit: c }) {
    ...
    const a = Z({
      ...
      set(l) {
        c("update:modelValue", l), c("change", l), clearTimeout(s), s = setTimeout(() => {
          c("debounce", l);
        }, 500);
      }
    }), i = W(!0);
    ...
    const d = Z(() => {
      if (typeof t.error == "string")
        return t.error;
      const l = i2(t.error, ["response", "data", t.prop]);
    ...
    return (l, u) => {
      ...
      return v(), f("div", {
        ...
        b("div", Z7, [
          _(o).suffix || t.suffixText ? (v(), f("div", {
            key: 0,
          ...
          _0(b("input", {
            ...
            "onUpdate:modelValue": u[2] || (u[2] = (p) => Y0(a) ? a.value = p : null),
          ...
          _(o).append || t.appendText ? (v(), f("div", {
            key: 2,
        ...
        e.message ? (v(), f("div", Q7, V(e.message), 1)) : y("", !0),
        _(d) ? (v(), f("div", K7, V(_(d)), 1)) : y("", !0)
      ], 2);
    };
  }
}), t8 = /* @__PURE__ */ X(e8, [["__scopeId", "data-v-605e8426"]]);
  ...
  setup(e, { emit: c }) {
    ...
    return r0(() => {
      ...
      return v(), f("div", {
        ...
        b("div", c8, [
          t.notification.title ? (v(), f("div", s8, V(t.notification.title), 1)) : y("", !0),
          t.notification.message ? (v(), f("div", o8, V(t.notification.message), 1)) : y("", !0)
        ])
      ], 34);
    };
  }
}), a2 = /* @__PURE__ */ X(l8, [["__scopeId", "data-v-b366cb5b"]]);
const i8 = { class: "nice-notifications" }, a8 = {
  name: "NiceNotifications"
}, r8 = /* @__PURE__ */ Object.assign(a8, {
  setup(e) {
    const c = Q("$t"), t = Q("nice"), o = 3e3, s = W([]);
    ...
    return r0(() => {
      ...
      q(W1, {
        ...
        default: J(() => [
          (v(!0), f(G, null, K(s.value, (r) => (v(), H(a2, {
            key: r.id,
            notification: r,
            timeoutTime: o,
            onRemove: (l) => i(r)
...
}), d8 = /* @__PURE__ */ X(r8, [["__scopeId", "data-v-69de8d3e"]]);
const u8 = {
  name: "NicePanel"
  ...
  emits: ["close"],
  setup(e, { expose: c, emit: t }) {
    const o = e, s = Q("nice"), a = W(!1), i = W(!1), n = W(500), d = W(null);
    r0(() => {
      document.addEventListener("keyup", p), s.onPanel((C) => {
        o.name == C.name && (a.value = C.isOpen), C.isOpen && l();
      });
    }), b2(() => {
    ...
    function l() {
      setTimeout(() => {
        var w;
        const C = (w = d.value) == null ? void 0 : w.querySelectorAll("input");
    ...
    function h(C) {
      if (i.value) {
        let w = 300;
        o.position == "right" ? w = document.body.clientWidth - C.clientX : o.position == "left" ? w = C.clientX : o.position == "top" ? w = C.clientY : o.position == "bottom" && (w = document.body.clientHeight - C.clientY), w >= 300 && r(w);
      }
    }
    function p(C) {
      C.key == "Escape" && u();
    }
    return c({ close: u }), (C, w) => (v(), f("div", {
      class: I(["nice-side-view", [e.position, { "no-select": i.value }]]),
      onMousemove: h,
      onMouseup: w[1] || (w[1] = (z) => i.value = !1),
        ...
        default: J(() => [
          a.value ? (v(), f("div", {
            ...
            b("div", {
              ...
              ref: "handle",
              onMousedown: w[0] || (w[0] = (z) => i.value = !0)
            }, null, 34),
            Y(C.$slots, "default")
          ], 6)) : y("", !0)
        ]),
...
const M8 = /* @__PURE__ */ X(f8, [["render", b8]]);
const g8 = (e) => (I0("data-v-cb4d7c97"), e = e(), A0(), e), z8 = { class: "nice-switch-box-wrapper" }, w8 = ["disabled"], x8 = /* @__PURE__ */ g8(() => /* @__PURE__ */ b("div", { class: "nice-switch-handle" }, null, -1)), _8 = [
  x8
...
}), $8 = /* @__PURE__ */ X(N8, [["__scopeId", "data-v-cb4d7c97"]]);
const S8 = { class: "nice-table" }, O8 = { class: "nice-table-table-wrapper" }, V8 = { class: "nice-table-table" }, D8 = {
  ...
  setup(e, { emit: c }) {
    const t = e, o = U1(), s = Y1(), a = Q("getQuery");
    let i, n = 50;
    const d = [
      { id: 10, value: 10 },
      { id: 20, value: 20 },
    ...
    const u = Z(() => {
      var B, M;
      return ((M = (B = t.data) == null ? void 0 : B._metadata) == null ? void 0 : M.count) || 0;
    }), h = Z(() => Math.ceil(u.value / n) || 1), p = Z(() => Array.from({ length: h.value }, (B, M) => ({ id: M + 1, value: M + 1 }))), C = Z(() => t.columns), w = Z(() => C.value.filter((B) => !B.disabled)), z = Z(() => {
      let B = t.data;
      if (B.forEach((M) => {
        M._selected === void 0 && (M._selected = !1);
      }), i !== void 0) {
        const M = i.replace("-", "");
        B.sort((k, O) => {
          if (i[0] != "-") {
          ...
          return String(k[M]).localeCompare(String(O[M]));
        });
      }
      return B;
    }), S = Z(() => z.value.filter((B) => B._selected)), j = Z(() => S.value.length == z.value.length);
    function P() {
      let B = !0;
      j.value && (B = !1), z.value.forEach((M) => M._selected = B), x();
    }
    function m(B) {
      B._selected = !B._selected, x();
    }
    function x() {
      c("selected", S.value);
    }
    ...
    function E(B) {
      B.key == i ? i = "-" + B.key : i && i[0] === "-" && i === "-" + B.key ? i = void 0 : i = B.key, s.push({
        query: { ...o.query, ordering: i }
      }), setTimeout(() => {
        c("orderChange", i);
      }), N();
    }
    ...
    async function A(B) {
      r = B, s.replace({
        path: o.path,
        query: { ...o.query, page: B, offset: (B - 1) * n, limit: n }
      }), setTimeout(() => {
        c("pageChange", B);
      }), N();
    }
    ...
    function N() {
      setTimeout(() => {
        c("filterChange", { ordering: i, page: r, offset: (r - 1) * n, limit: n });
      });
    }
    return r0(async () => {
      const B = await a();
      i = B.ordering, t.paginated && (n = Number(B.limit) || 50, r = Number(B.page) || 1, l = p[Number(B.page) || 1], A(r));
    }), (B, M) => {
      const k = U("NiceIcon"), O = U("router-link"), F = U("NiceNoData"), D = U("NiceDropdown");
      return v(), f("div", S8, [
        b("div", O8, [
          b("table", V8, [
            b("thead", null, [
              b("tr", null, [
                ...
                (v(!0), f(G, null, K(_(w), (g) => (v(), f("th", {
                  ...
                  t.showOrder ? (v(), f("div", {
                    key: 0,
                    class: I(["table-th", {
                      "active asc": _(i) == g.key,
                      "active desc": _(i) == "-" + g.key
                    }]),
                    onClick: (T) => E(g)
                  }, [
                    b("span", null, V(g.name), 1),
                    t.showOrder ? (v(), H(k, {
                      key: 0,
                      icon: "icon-bar-chart",
                      class: "table-order"
                    })) : y("", !0)
                  ], 10, T8)) : (v(), f("span", E8, V(g.name), 1))
                ], 2))), 128)),
                t.actions.length ? (v(), f("th", {
                  key: 1,
                  class: I(["actions-td w-0", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  !t.showToggleColumns && !t.showFooter && _(z) && _(z).length ? (v(), f("span", q8, [
                    b("span", null, V(_(z).length), 1),
                    _(z)._metadata ? (v(), f("span", I8, " / " + V(_(z)._metadata.count), 1)) : y("", !0)
                  ])) : y("", !0),
                  t.showToggleColumns ? (v(), H(K0, {
                    key: 1,
                    ...
                    trigger: J(() => [
                      q(k, { icon: "icon-plus-circle" })
                    ]),
                    content: J(() => [
                      b("div", A8, [
                        (v(!0), f(G, null, K(_(C), (g) => (v(), f("div", {
                          class: "element",
                          key: g.key,
                          onClick: (T) => $(g)
                        }, [
            ...
            b("tbody", null, [
              (v(!0), f(G, null, K(_(z), (g) => (v(), f("tr", {
                ...
                (v(!0), f(G, null, K(_(w), (T) => {
                  var d0, w0;
                  return v(), f("td", {
                    key: T.key,
                    class: I(T.class)
                  }, [
                    T.component ? (v(), H(g2((d0 = T.component()) == null ? void 0 : d0.instance), z2(H1({ key: 0 }, (w0 = T.component(g[T.key], g)) == null ? void 0 : w0.props)), null, 16)) : y("", !0),
                    !T.component && T.html ? (v(), f("span", {
                      key: 1,
                      innerHTML: T.html(g[T.key], g)
                    }, null, 8, j8)) : y("", !0),
                    !T.component && !T.html ? (v(), f("span", {
                      key: 2,
                      class: I(T.fieldClass ? T.fieldClass(g[T.key], g) : "")
                    }, V(T.formatter ? T.formatter(g[T.key], g) : g[T.key]), 3)) : y("", !0)
                  ], 2);
                }), 128)),
                t.actions.length ? (v(), f("td", {
                  ...
                  (v(!0), f(G, null, K(t.actions, (T) => (v(), f("div", { key: T }, [
                    T.to ? (v(), H(O, {
                      key: 0,
                      to: T.to(g)
                    }, {
        ...
        e.loading ? (v(), H(y1, { key: 0 })) : y("", !0),
        !e.loading && t.data.length == 0 ? (v(), H(F, { key: 1 })) : y("", !0),
        t.showFooter ? (v(), f("div", L8, [
          b("div", R8, V(_(u)) + " " + V(B.$t("Nice", "total")), 1),
          t.paginated && _(h) > 1 && _(h) < 5 ? (v(), f("div", H8, [
            (v(!0), f(G, null, K(_(h), (g) => (v(), H(v0, {
              size: "small",
              plain: _(r) !== g,
              key: g,
              class: I(_(r) === g ? "btn-primary" : "btn-default"),
              onClick: (T) => A(g)
            }, {
              default: J(() => [
                p0(V(g), 1)
          ...
          t.paginated && _(h) > 1 && _(h) > 5 ? (v(), f("div", W8, [
            q(D, {
              modelValue: _(l),
              "onUpdate:modelValue": M[0] || (M[0] = (g) => Y0(l) ? l.value = g : l = g),
              values: _(p),
              noMargin: "",
              onChange: L
          ...
          t.showLimit ? (v(), H(D, {
            key: 2,
            modelValue: _(n),
            "onUpdate:modelValue": M[1] || (M[1] = (g) => Y0(n) ? n.value = g : n = g),
            class: I({ "dropdown-small": _(h) > 1 && _(h) < 5 }),
            values: d,
            keyOnly: "",
            noMargin: "",
            onChange: R
...
}), Z8 = /* @__PURE__ */ X(Y8, [["__scopeId", "data-v-beddfa88"]]);
const X8 = { class: "input-group" }, G8 = {
  ...
  setup(e, { emit: c }) {
    ...
    return (s, a) => {
      const i = U("NiceComponentHeader");
      return v(), f("div", {
        class: I(["nice-component nice-textarea", { "no-margin": e.noMargin, active: _(o), disabled: e.disabled }])
      }, [
        q(i, {
          title: e.title,
          required: e.required,
        ...
        b("div", X8, [
          s.$slots.suffix ? (v(), f("div", G8, [
            Y(s.$slots, "suffix", {}, void 0, !0)
          ])) : y("", !0),
          _0(b("textarea", {
            "onUpdate:modelValue": a[0] || (a[0] = (n) => Y0(o) ? o.value = n : null),
            placeholder: e.placeholder,
            autocomplete: e.autocomplete,
            type: e.type,
            rows: e.rows,
          ...
          e.icon ? (v(), f("div", K8, [
            q(l2, { icon: e.icon }, null, 8, ["icon"])
          ])) : y("", !0),
          s.$slots.append ? (v(), f("div", J8, [
            Y(s.$slots, "append", {}, void 0, !0)
          ])) : y("", !0)
        ]),
        e.message ? (v(), f("div", e5, V(e.message), 1)) : y("", !0)
      ], 2);
    };
  }
}), s5 = /* @__PURE__ */ X(c5, [["__scopeId", "data-v-483407b0"]]);
  ...
  setup(e) {
    ...
    return (i, n) => (v(), f("div", o5, [
      q(W1, {
        ...
        default: J(() => [
          (v(!0), f(G, null, K(t.value, (d) => (v(), f("div", {
...
}), i5 = /* @__PURE__ */ X(l5, [["__scopeId", "data-v-95aff90a"]]);
const a5 = {
  name: "NiceUpload",
  components: {
  ...
  computed: {
    ...
    errorMessage() {
      if (typeof this.error == "string")
        return this.error;
      const e = i2(this.error, ["response", "data", this.prop]);
...
function v5(e, c, t, o, s, a) {
  const i = U("NiceComponentHeader"), n = U("NiceIcon"), d = U("NiceLoading");
  return v(), f("div", {
    ...
    b("div", {
      ...
      a.localValue ? (v(), f("div", h5, [
        q(n, { icon: "icon-file" }),
        (v(!0), f(G, null, K(a.localValue, (r) => (v(), f("div", {
          class: "nice-upload-overlay-message",
          key: r.name
        }, V(r.name), 1))), 128))
      ])) : (v(), f("div", d5, [
        q(n, { icon: "icon-upload" }),
        b("div", u5, V(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      s.loading ? (v(), H(d, {
        key: 2,
        "full-div": ""
...
const p5 = /* @__PURE__ */ X(a5, [["render", v5], ["__scopeId", "data-v-aa7d7890"]]);
const f5 = {
  key: 0,
  ...
  setup(e) {
    const c = e, t = a1(), o = Z(() => t.title || c.title || c.icon);
    return (s, a) => {
      const i = U("NiceIcon"), n = U("NiceLoading");
      return v(), f("div", {
        class: I(["nice-view", { "nice-view-no-header": !_(o), "nice-view-flex-body": e.flexBody }])
      }, [
        _(o) ? (v(), f("div", f5, [
        ...
        _(t).footer ? (v(), f("div", y5, [
          Y(s.$slots, "footer", {}, void 0, !0)
        ])) : y("", !0)
      ], 2);
    };
  }
}), g5 = /* @__PURE__ */ X(M5, [["__scopeId", "data-v-10caa389"]]);
const z5 = (e) => (I0("data-v-bdde4e0c"), e = e(), A0(), e), w5 = {
...
}, B5 = /* @__PURE__ */ z5(() => /* @__PURE__ */ b("div", { class: "flex-grow" }, null, -1)), k5 = {
  key: 2,
  ...
  setup(e) {
    ...
    return (s, a) => (v(), f("div", {
      ...
      s.$slots.header || e.title || e.subtitle || e.collapsable ? (v(), f("div", w5, [
        e.title || e.subtitle ? (v(), f("div", x5, [
          e.title ? (v(), f("div", _5, V(e.title), 1)) : y("", !0),
          e.subtitle ? (v(), f("div", C5, V(e.subtitle), 1)) : y("", !0)
        ])) : y("", !0),
        Y(s.$slots, "header", {}, void 0, !0),
        B5,
        e.collapsable ? (v(), H(v0, {
          key: 1,
...
}), S5 = /* @__PURE__ */ X($5, [["__scopeId", "data-v-bdde4e0c"]]);
const O5 = { class: "nice-no-data" }, V5 = { class: "nice-no-data-message" }, D5 = {
  ...
  setup(e) {
    const c = e, t = Q("$t"), o = W(c.message || t("Nice", "No data"));
    return (s, a) => {
      const i = U("NiceIcon");
      return v(), f("div", O5, [
        q(i, {
        ...
        b("div", V5, V(o.value), 1)
      ]);
    };
  }
}), E5 = /* @__PURE__ */ X(T5, [["__scopeId", "data-v-a5c7ad13"]]), j1 = {
  NiceActions: F2,
  NiceAvatar: i4,
  NiceButton: v0,
  NiceCheckbox: V0,
