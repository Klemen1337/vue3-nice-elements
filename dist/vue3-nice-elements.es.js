import { useSlots as i1, resolveComponent as Y, openBlock as v, createElementBlock as f, normalizeClass as q, unref as C, createBlock as U, createCommentVNode as b, renderSlot as Z, toDisplayString as S, Teleport as m2, createVNode as T, Transition as U0, withCtx as e0, normalizeStyle as j1, createElementVNode as M, createTextVNode as f0, inject as K, Fragment as Q, computed as X, pushScopeId as I0, popScopeId as A0, ref as W, onMounted as d0, onBeforeUnmount as y2, withDirectives as C0, vShow as k1, watch as R1, vModelText as a1, renderList as J, mergeProps as H1, isRef as r1, vModelDynamic as b2, TransitionGroup as W1, onUnmounted as M2, createStaticVNode as g2, resolveDynamicComponent as U1, normalizeProps as z2 } from "vue";
import { useRoute as Y1, useRouter as Z1 } from "vue-router";
function w2(e) {
  return { all: e = e || /* @__PURE__ */ new Map(), on: function(c, t) {
    ...
    s && s.slice().map(function(o) {
      o(t);
    }), (s = e.get("*")) && s.slice().map(function(o) {
      o(c, t);
    });
  } };
}
const G = (e, c) => {
  ...
  setup(e) {
    const c = e, t = i1();
    return (s, o) => {
      const a = Y("NiceLoading"), i = Y("NiceIcon");
      return v(), f("button", {
        ...
        c.text ? (v(), f("span", C2, S(c.text), 1)) : b("", !0),
        c.appendIcon ? (v(), U(i, {
          key: 4,
          icon: c.appendIcon
        }, null, 8, ["icon"])) : b("", !0)
...
}), p0 = /* @__PURE__ */ G(k2, [["__scopeId", "data-v-5bdcb792"]]);
const N2 = {
  name: "NiceModal",
  props: {
    name: {
...
function D2(e, c, t, s, o, a) {
  const i = Y("NiceButton");
  return v(), U(m2, { to: "body" }, [
    T(U0, { name: "fade" }, {
      default: e0(() => [
        o.isOpen ? (v(), f("div", {
          key: 0,
          class: "nice-modal-overlay",
          onClick: c[0] || (c[0] = (...n) => a.close && a.close(...n))
        })) : b("", !0)
      ]),
      _: 1
    }),
    T(U0, { name: "flyin" }, {
      default: e0(() => [
        o.isOpen ? (v(), f("div", {
          key: 0,
          class: "nice-modal",
          style: j1([{ width: t.width, height: t.height }, o.startingPosition])
        }, [
...
const X1 = /* @__PURE__ */ G(N2, [["render", D2], ["__scopeId", "data-v-0bffddaa"]]), T2 = { class: "nice-actions" }, E2 = {
  name: "NiceConfirmModal"
}, G1 = /* @__PURE__ */ Object.assign(E2, {
  props: {
    name: {
      type: String,
  ...
  setup(e, { emit: c }) {
    const t = e, s = K("$t"), o = K("nice");
    function a() {
      o.modal(t.name, !1), c("cancel");
    }
    function i() {
      c("confirm");
    }
...
var R2 = j2;
const t1 = (e, c, t) => (t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? e + (c - e) * 6 * t : t < 1 / 2 ? c : t < 2 / 3 ? e + (c - e) * (2 / 3 - t) * 6 : e), H2 = (e, c, t) => {
  let s, o, a;
  if (e = e / 360, c == 0)
    s = o = a = t;
  else {
    const i = t < 0.5 ? t * (1 + c) : t + c - t * c, n = 2 * t - i;
    s = t1(n, i, e + 1 / 3), o = t1(n, i, e), a = t1(n, i, e - 1 / 3);
  }
  return [
...
var W2 = H2;
const U2 = L2, Y2 = R2, N1 = W2, Z2 = () => Math.floor(Math.random() * Date.now()), X2 = (e, c) => {
  const t = U2(e), s = Y2(t % 360, 1, 0.5), o = N1(s[0][0], s[0][1], s[0][2]), a = N1(s[1][0], s[1][1], s[1][2]), i = `rgb(${o[0]}, ${o[1]}, ${o[2]})`, n = `rgb(${a[0]}, ${a[1]}, ${a[2]})`, d = Z2();
...
(function() {
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = {
    ...
    bytesToWords: function(t) {
      for (var s = [], o = 0, a = 0; o < t.length; o++, a += 8)
        s[a >>> 5] |= t[o] << 24 - a % 32;
      return s;
    },
    // Convert big-endian 32-bit words to a byte array
    wordsToBytes: function(t) {
      for (var s = [], o = 0; o < t.length * 32; o += 8)
        s.push(t[o >>> 5] >>> 24 - o % 32 & 255);
      return s;
    },
    // Convert a byte array to a hex string
    bytesToHex: function(t) {
      for (var s = [], o = 0; o < t.length; o++)
        s.push((t[o] >>> 4).toString(16)), s.push((t[o] & 15).toString(16));
      return s.join("");
    },
    // Convert a hex string to a byte array
    hexToBytes: function(t) {
      for (var s = [], o = 0; o < t.length; o += 2)
        s.push(parseInt(t.substr(o, 2), 16));
      return s;
    },
    // Convert a byte array to a base-64 string
    bytesToBase64: function(t) {
      for (var s = [], o = 0; o < t.length; o += 3)
        for (var a = t[o] << 16 | t[o + 1] << 8 | t[o + 2], i = 0; i < 4; i++)
          o * 8 + i * 6 <= t.length * 8 ? s.push(e.charAt(a >>> 6 * (3 - i) & 63)) : s.push("=");
      return s.join("");
    },
    // Convert a base-64 string to a byte array
    base64ToBytes: function(t) {
      t = t.replace(/[^A-Z0-9+\/]/ig, "");
      for (var s = [], o = 0, a = 0; o < t.length; a = ++o % 4)
        a != 0 && s.push((e.indexOf(t.charAt(o - 1)) & Math.pow(2, -2 * a + 8) - 1) << a * 2 | e.indexOf(t.charAt(o)) >>> 6 - a * 2);
      return s;
    }
  };
  K2.exports = c;
...
var s1 = {
  ...
  utf8: {
    ...
    stringToBytes: function(e) {
      return s1.bin.stringToBytes(unescape(encodeURIComponent(e)));
    },
    // Convert a byte array to a string
    bytesToString: function(e) {
      return decodeURIComponent(escape(s1.bin.bytesToString(e)));
    }
  },
  // Binary encoding
  bin: {
 ...
 */
var J2 = function(e) {
  return e != null && (Q1(e) || e4(e) || !!e._isBuffer);
};
function Q1(e) {
...
(function() {
  var e = c1, c = $1.utf8, t = J2, s = $1.bin, o = function(a, i) {
    a.constructor == String ? i && i.encoding === "binary" ? a = s.stringToBytes(a) : a = c.stringToBytes(a) : t(a) ? a = Array.prototype.slice.call(a, 0) : !Array.isArray(a) && a.constructor !== Uint8Array && (a = a.toString());
    for (var n = e.bytesToWords(a), d = a.length * 8, r = 1732584193, l = -271733879, u = -1732584194, h = 271733878, p = 0; p < n.length; p++)
      n[p] = (n[p] << 8 | n[p] >>> 24) & 16711935 | (n[p] << 24 | n[p] >>> 8) & 4278255360;
    n[d >>> 5] |= 128 << d % 32, n[(d + 64 >>> 9 << 4) + 14] = d;
    for (var x = o._ff, z = o._gg, _ = o._hh, k = o._ii, p = 0; p < n.length; p += 16) {
      var L = r, F = l, y = u, w = h;
      r = x(r, l, u, h, n[p + 0], 7, -680876936), h = x(h, r, l, u, n[p + 1], 12, -389564586), u = x(u, h, r, l, n[p + 2], 17, 606105819), l = x(l, u, h, r, n[p + 3], 22, -1044525330), r = x(r, l, u, h, n[p + 4], 7, -176418897), h = x(h, r, l, u, n[p + 5], 12, 1200080426), u = x(u, h, r, l, n[p + 6], 17, -1473231341), l = x(l, u, h, r, n[p + 7], 22, -45705983), r = x(r, l, u, h, n[p + 8], 7, 1770035416), h = x(h, r, l, u, n[p + 9], 12, -1958414417), u = x(u, h, r, l, n[p + 10], 17, -42063), l = x(l, u, h, r, n[p + 11], 22, -1990404162), r = x(r, l, u, h, n[p + 12], 7, 1804603682), h = x(h, r, l, u, n[p + 13], 12, -40341101), u = x(u, h, r, l, n[p + 14], 17, -1502002290), l = x(l, u, h, r, n[p + 15], 22, 1236535329), r = z(r, l, u, h, n[p + 1], 5, -165796510), h = z(h, r, l, u, n[p + 6], 9, -1069501632), u = z(u, h, r, l, n[p + 11], 14, 643717713), l = z(l, u, h, r, n[p + 0], 20, -373897302), r = z(r, l, u, h, n[p + 5], 5, -701558691), h = z(h, r, l, u, n[p + 10], 9, 38016083), u = z(u, h, r, l, n[p + 15], 14, -660478335), l = z(l, u, h, r, n[p + 4], 20, -405537848), r = z(r, l, u, h, n[p + 9], 5, 568446438), h = z(h, r, l, u, n[p + 14], 9, -1019803690), u = z(u, h, r, l, n[p + 3], 14, -187363961), l = z(l, u, h, r, n[p + 8], 20, 1163531501), r = z(r, l, u, h, n[p + 13], 5, -1444681467), h = z(h, r, l, u, n[p + 2], 9, -51403784), u = z(u, h, r, l, n[p + 7], 14, 1735328473), l = z(l, u, h, r, n[p + 12], 20, -1926607734), r = _(r, l, u, h, n[p + 5], 4, -378558), h = _(h, r, l, u, n[p + 8], 11, -2022574463), u = _(u, h, r, l, n[p + 11], 16, 1839030562), l = _(l, u, h, r, n[p + 14], 23, -35309556), r = _(r, l, u, h, n[p + 1], 4, -1530992060), h = _(h, r, l, u, n[p + 4], 11, 1272893353), u = _(u, h, r, l, n[p + 7], 16, -155497632), l = _(l, u, h, r, n[p + 10], 23, -1094730640), r = _(r, l, u, h, n[p + 13], 4, 681279174), h = _(h, r, l, u, n[p + 0], 11, -358537222), u = _(u, h, r, l, n[p + 3], 16, -722521979), l = _(l, u, h, r, n[p + 6], 23, 76029189), r = _(r, l, u, h, n[p + 9], 4, -640364487), h = _(h, r, l, u, n[p + 12], 11, -421815835), u = _(u, h, r, l, n[p + 15], 16, 530742520), l = _(l, u, h, r, n[p + 2], 23, -995338651), r = k(r, l, u, h, n[p + 0], 6, -198630844), h = k(h, r, l, u, n[p + 7], 10, 1126891415), u = k(u, h, r, l, n[p + 14], 15, -1416354905), l = k(l, u, h, r, n[p + 5], 21, -57434055), r = k(r, l, u, h, n[p + 12], 6, 1700485571), h = k(h, r, l, u, n[p + 3], 10, -1894986606), u = k(u, h, r, l, n[p + 10], 15, -1051523), l = k(l, u, h, r, n[p + 1], 21, -2054922799), r = k(r, l, u, h, n[p + 8], 6, 1873313359), h = k(h, r, l, u, n[p + 15], 10, -30611744), u = k(u, h, r, l, n[p + 6], 15, -1560198380), l = k(l, u, h, r, n[p + 13], 21, 1309151649), r = k(r, l, u, h, n[p + 4], 6, -145523070), h = k(h, r, l, u, n[p + 11], 10, -1120210379), u = k(u, h, r, l, n[p + 2], 15, 718787259), l = k(l, u, h, r, n[p + 9], 21, -343485551), r = r + L >>> 0, l = l + F >>> 0, u = u + y >>> 0, h = h + w >>> 0;
    }
    return e.endian([r, l, u, h]);
  };
  o._ff = function(a, i, n, d, r, l, u) {
    var h = a + (i & n | ~i & d) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, o._gg = function(a, i, n, d, r, l, u) {
    var h = a + (i & d | n & ~d) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, o._hh = function(a, i, n, d, r, l, u) {
    var h = a + (i ^ n ^ d) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, o._ii = function(a, i, n, d, r, l, u) {
    var h = a + (n ^ (i | ~d)) + (r >>> 0) + u;
    return (h << l | h >>> 32 - l) + i;
  }, o._blocksize = 16, o._digestsize = 16, Q2.exports = function(a, i) {
    if (a == null)
      throw new Error("Illegal argument " + a);
    var n = e.wordsToBytes(o(a, i));
...
const t4 = {
  ...
  setup(e) {
    const c = e, t = X(() => G2(Y0(c.hash || c.text))), s = X(() => {
      const a = c.text.split(" ");
      return a.length > 1 ? a[0][0] + a[1][0] : c.text[0] + c.text[1];
    }), o = X(() => "https://www.gravatar.com/avatar/" + Y0(c.gavatar.trim().toLowerCase()) + "?s=50");
    return (a, i) => (v(), f("div", {
      class: q(["nice-avatar", [
        c.size ? "size-" + c.size : "",
      ...
      c.text ? (v(), f("div", n4, S(C(s)), 1)) : b("", !0)
    ], 2));
  }
});
const a4 = (e) => (I0("data-v-d12df4cc"), e = e(), A0(), e), r4 = { class: "nice-checkbox-box" }, d4 = {
  key: 0,
  viewBox: "0 0 20 20"
  ...
  setup(e, { emit: c }) {
    const t = e, s = Math.random().toString(36).slice(2, 7), o = X({
      get() {
        return t.modelValue;
      },
      set(i) {
    ...
    return (i, n) => (v(), f("div", {
      class: q(["nice-component nice-checkbox", { "no-margin": t.noMargin, active: C(o), disabled: t.disabled }]),
      onClick: a
    }, [
      M("div", r4, [
        C(o) ? (v(), f("svg", d4, h4)) : b("", !0)
      ]),
      t.title ? (v(), f("div", {
        key: 0,
...
}), V0 = /* @__PURE__ */ G(m4, [["__scopeId", "data-v-d12df4cc"]]);
const y4 = {
...
function w4(e, c, t, s, o, a) {
  return t.title || t.caption ? (v(), f("div", b4, [
    t.title ? (v(), f("div", M4, [
      f0(S(t.title) + " ", 1),
      t.required ? (v(), f("span", g4, " *")) : b("", !0)
    ])) : b("", !0),
    t.caption ? (v(), f("div", z4, S(t.caption), 1)) : b("", !0)
  ])) : b("", !0);
}
const x0 = /* @__PURE__ */ G(y4, [["render", w4], ["__scopeId", "data-v-6938ba71"]]);
var t0 = "top", n0 = "bottom", l0 = "right", c0 = "left", X0 = "auto", F0 = [t0, n0, l0, c0], B0 = "start", E0 = "end", x4 = "clippingParents", K1 = "viewport", O0 = "popper", _4 = "reference", S1 = /* @__PURE__ */ F0.reduce(function(e, c) {
  return e.concat([c + "-" + B0, c + "-" + E0]);
}, []), J1 = /* @__PURE__ */ [].concat(F0, [X0]).reduce(function(e, c) {
  return e.concat([c, c + "-" + B0, c + "-" + E0]);
}, []), C4 = "beforeRead", B4 = "read", k4 = "afterRead", N4 = "beforeMain", $4 = "main", S4 = "afterMain", O4 = "beforeWrite", V4 = "write", D4 = "afterWrite", o1 = [C4, B4, k4, N4, $4, S4, O4, V4, D4];
function r0(e) {
...
function T4(e) {
  ...
  Object.keys(c.elements).forEach(function(t) {
    var s = c.styles[t] || {}, o = c.attributes[t] || {}, a = c.elements[t];
    !s0(a) || !r0(a) || (Object.assign(a.style, s), Object.keys(o).forEach(function(i) {
      var n = o[i];
      n === !1 ? a.removeAttribute(i) : a.setAttribute(i, n === !0 ? "" : n);
    }));
  });
}
function E4(e) {
  ...
  return Object.assign(c.elements.popper.style, t.popper), c.styles = t, c.elements.arrow && Object.assign(c.elements.arrow.style, t.arrow), function() {
    Object.keys(c.elements).forEach(function(s) {
      var o = c.elements[s], a = c.attributes[s] || {}, i = Object.keys(c.styles.hasOwnProperty(s) ? c.styles[s] : t[s]), n = i.reduce(function(d, r) {
        return d[r] = "", d;
      }, {});
      !s0(o) || !r0(o) || (Object.assign(o.style, n), Object.keys(a).forEach(function(d) {
        o.removeAttribute(d);
      }));
    });
  };
...
var z0 = Math.max, Z0 = Math.min, k0 = Math.round;
function n1() {
...
function N0(e, c, t) {
  ...
  var s = e.getBoundingClientRect(), o = 1, a = 1;
  c && s0(e) && (o = e.offsetWidth > 0 && k0(s.width) / e.offsetWidth || 1, a = e.offsetHeight > 0 && k0(s.height) / e.offsetHeight || 1);
  var i = w0(e) ? o0(e) : window, n = i.visualViewport, d = !e2() && t, r = (s.left + (d && n ? n.offsetLeft : 0)) / o, l = (s.top + (d && n ? n.offsetTop : 0)) / a, u = s.width / o, h = s.height / a;
  return {
    width: u,
    height: h,
    top: l,
...
function u1(e) {
  var c = N0(e), t = e.offsetWidth, s = e.offsetHeight;
...
function I4(e) {
  return ["table", "td", "th"].indexOf(r0(e)) >= 0;
}
function m0(e) {
  return ((w0(e) ? e.ownerDocument : (
...
function O1(e) {
  return !s0(e) || // https://github.com/popperjs/popper-core/issues/837
  a0(e).position === "fixed" ? null : e.offsetParent;
}
function A4(e) {
  var c = /firefox/i.test(n1()), t = /Trident/i.test(n1());
  if (t && s0(e)) {
    var s = a0(e);
    if (s.position === "fixed")
      return null;
  ...
  var o = G0(e);
  for (d1(o) && (o = o.host); s0(o) && ["html", "body"].indexOf(r0(o)) < 0; ) {
    var a = a0(o);
...
function P0(e) {
  for (var c = o0(e), t = O1(e); t && I4(t) && a0(t).position === "static"; )
    t = O1(t);
  return t && (r0(t) === "html" || r0(t) === "body" && a0(t).position === "static") ? c : t || A4(e) || c;
}
function h1(e) {
...
var P4 = function(c, t) {
  ...
  })) : c, s2(typeof c != "number" ? c : o2(c, F0));
};
function L4(e) {
  var c, t = e.state, s = e.name, o = e.options, a = t.elements.arrow, i = t.modifiersData.popperOffsets, n = i0(t.placement), d = h1(n), r = [c0, l0].indexOf(n) >= 0, l = r ? "height" : "width";
  if (!(!a || !i)) {
    var u = P4(o.padding, t), h = u1(a), p = d === "y" ? t0 : c0, x = d === "y" ? n0 : l0, z = t.rects.reference[l] + t.rects.reference[d] - i[d] - t.rects.popper[l], _ = i[d] - t.rects.reference[d], k = P0(a), L = k ? d === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, F = z / 2 - _ / 2, y = u[p], w = L - h[l] - u[x], N = L / 2 - h[l] / 2 + F, D = D0(y, N, w), H = d;
    t.modifiersData[s] = (c = {}, c[H] = D, c.centerOffset = D - N, c);
  }
}
function j4(e) {
  var c = e.state, t = e.options, s = t.element, o = s === void 0 ? "[data-popper-arrow]" : s;
  if (o != null && !(typeof o == "string" && (o = c.elements.popper.querySelector(o), !o))) {
    if (process.env.NODE_ENV !== "production" && (s0(o) || console.error(['Popper: "arrow" element must be an HTMLElement (not an SVGElement).', "To use an SVG arrow, wrap it in an HTMLElement that will be used as", "the arrow."].join(" "))), !t2(c.elements.popper, o)) {
...
function W4(e, c) {
  var t = e.x, s = e.y, o = c.devicePixelRatio || 1;
  return {
    x: k0(t * o) / o || 0,
    y: k0(s * o) / o || 0
  };
...
function V1(e) {
  var c, t = e.popper, s = e.popperRect, o = e.placement, a = e.variation, i = e.offsets, n = e.position, d = e.gpuAcceleration, r = e.adaptive, l = e.roundOffsets, u = e.isFixed, h = i.x, p = h === void 0 ? 0 : h, x = i.y, z = x === void 0 ? 0 : x, _ = typeof l == "function" ? l({
    x: p,
    y: z
  }) : {
    x: p,
  ...
  p = _.x, z = _.y;
  var k = i.hasOwnProperty("x"), L = i.hasOwnProperty("y"), F = c0, y = t0, w = window;
  if (r) {
    var N = P0(t), D = "clientHeight", H = "clientWidth";
    if (N === o0(t) && (N = m0(t), a0(N).position !== "static" && n === "absolute" && (D = "scrollHeight", H = "scrollWidth")), N = N, o === t0 || (o === c0 || o === l0) && a === E0) {
      y = n0;
      var P = u && N === w && w.visualViewport ? w.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        N[D]
      );
      z -= P - s.height, z *= d ? 1 : -1;
    }
    if (o === c0 || (o === t0 || o === n0) && a === E0) {
      F = l0;
      var R = u && N === w && w.visualViewport ? w.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        N[H]
      );
      p -= R - s.width, p *= d ? 1 : -1;
  ...
  if (p = j.x, z = j.y, d) {
    var m;
    return Object.assign({}, B, (m = {}, m[y] = L ? "0" : "", m[F] = k ? "0" : "", m.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + z + "px)" : "translate3d(" + p + "px, " + z + "px, 0)", m));
  }
  return Object.assign({}, B, (c = {}, c[y] = L ? z + "px" : "", c[F] = k ? p + "px" : "", c.transform = "", c));
}
function U4(e) {
  var c = e.state, t = e.options, s = t.gpuAcceleration, o = s === void 0 ? !0 : s, a = t.adaptive, i = a === void 0 ? !0 : a, n = t.roundOffsets, d = n === void 0 ? !0 : n;
  if (process.env.NODE_ENV !== "production") {
    var r = a0(c.elements.popper).transitionProperty || "";
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
  ...
  var l = {
    placement: i0(c.placement),
    variation: $0(c.placement),
    popper: c.elements.popper,
    popperRect: c.rects.popper,
    gpuAcceleration: o,
    isFixed: c.options.strategy === "fixed"
  };
  c.modifiersData.popperOffsets != null && (c.styles.popper = Object.assign({}, c.styles.popper, V1(Object.assign({}, l, {
    offsets: c.modifiersData.popperOffsets,
    position: c.options.strategy,
    adaptive: i,
    roundOffsets: d
  })))), c.modifiersData.arrow != null && (c.styles.arrow = Object.assign({}, c.styles.arrow, V1(Object.assign({}, l, {
...
function Z4(e) {
  var c = e.state, t = e.instance, s = e.options, o = s.scroll, a = o === void 0 ? !0 : o, i = s.resize, n = i === void 0 ? !0 : i, d = o0(c.elements.popper), r = [].concat(c.scrollParents.reference, c.scrollParents.popper);
  return a && r.forEach(function(l) {
    l.addEventListener("scroll", t.update, H0);
  }), n && d.addEventListener("resize", t.update, H0), function() {
    a && r.forEach(function(l) {
      l.removeEventListener("scroll", t.update, H0);
    }), n && d.removeEventListener("resize", t.update, H0);
  };
}
const X4 = {
  name: "eventListeners",
...
function p1(e) {
  return N0(m0(e)).left + v1(e).scrollLeft;
}
function K4(e, c) {
  var t = o0(e), s = m0(e), o = t.visualViewport, a = s.clientWidth, i = s.clientHeight, n = 0, d = 0;
  if (o) {
    a = o.width, i = o.height;
    var r = e2();
    (r || !r && c === "fixed") && (n = o.offsetLeft, d = o.offsetTop);
  }
  return {
    width: a,
    height: i,
...
function J4(e) {
  var c, t = m0(e), s = v1(e), o = (c = e.ownerDocument) == null ? void 0 : c.body, a = z0(t.scrollWidth, t.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), i = z0(t.scrollHeight, t.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), n = -s.scrollLeft + p1(e), d = -s.scrollTop;
  return a0(o || t).direction === "rtl" && (n += z0(t.clientWidth, o ? o.clientWidth : 0) - a), {
    width: a,
    height: i,
    x: n,
    y: d
...
function f1(e) {
  var c = a0(e), t = c.overflow, s = c.overflowX, o = c.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + o + s);
}
function n2(e) {
  return ["html", "body", "#document"].indexOf(r0(e)) >= 0 ? e.ownerDocument.body : s0(e) && f1(e) ? e : n2(G0(e));
}
function T0(e, c) {
  var t;
  c === void 0 && (c = []);
  var s = n2(e), o = s === ((t = e.ownerDocument) == null ? void 0 : t.body), a = o0(s), i = o ? [a].concat(a.visualViewport || [], f1(s) ? s : []) : s, n = c.concat(i);
  return o ? n : (
...
function e3(e, c) {
  var t = N0(e, !1, c === "fixed");
  return t.top = t.top + e.clientTop, t.left = t.left + e.clientLeft, t.bottom = t.top + e.clientHeight, t.right = t.left + e.clientWidth, t.width = e.clientWidth, t.height = e.clientHeight, t.x = t.left, t.y = t.top, t;
}
function T1(e, c, t) {
  return c === K1 ? l1(K4(e, t)) : w0(c) ? e3(c, t) : l1(J4(m0(e)));
}
function t3(e) {
  var c = T0(G0(e)), t = ["absolute", "fixed"].indexOf(a0(e).position) >= 0, s = t && s0(e) ? P0(e) : e;
  return w0(s) ? c.filter(function(o) {
    return w0(o) && t2(o, s) && r0(o) !== "body";
  }) : [];
}
function c3(e, c, t, s) {
  var o = c === "clippingParents" ? t3(e) : [].concat(c), a = [].concat(o, [t]), i = a[0], n = a.reduce(function(d, r) {
    var l = T1(e, r, s);
    return d.top = z0(l.top, d.top), d.right = Z0(l.right, d.right), d.bottom = Z0(l.bottom, d.bottom), d.left = z0(l.left, d.left), d;
  }, T1(e, i, s));
  return n.width = n.right - n.left, n.height = n.bottom - n.top, n.x = n.left, n.y = n.top, n;
}
function l2(e) {
  var c = e.reference, t = e.element, s = e.placement, o = s ? i0(s) : null, a = s ? $0(s) : null, i = c.x + c.width / 2 - t.width / 2, n = c.y + c.height / 2 - t.height / 2, d;
  switch (o) {
    case t0:
      d = {
        x: i,
...
function q0(e, c) {
  c === void 0 && (c = {});
  var t = c, s = t.placement, o = s === void 0 ? e.placement : s, a = t.strategy, i = a === void 0 ? e.strategy : a, n = t.boundary, d = n === void 0 ? x4 : n, r = t.rootBoundary, l = r === void 0 ? K1 : r, u = t.elementContext, h = u === void 0 ? O0 : u, p = t.altBoundary, x = p === void 0 ? !1 : p, z = t.padding, _ = z === void 0 ? 0 : z, k = s2(typeof _ != "number" ? _ : o2(_, F0)), L = h === O0 ? _4 : O0, F = e.rects.popper, y = e.elements[x ? L : h], w = c3(w0(y) ? y : y.contextElement || m0(e.elements.popper), d, l, i), N = N0(e.elements.reference), D = l2({
    reference: N,
    element: F,
    strategy: "absolute",
    placement: o
  }), H = l1(Object.assign({}, F, D)), P = h === O0 ? H : N, R = {
    top: w.top - P.top + k.top,
    bottom: P.bottom - w.bottom + k.bottom,
    left: w.left - P.left + k.left,
    right: P.right - w.right + k.right
  }, B = e.modifiersData.offset;
  if (h === O0 && B) {
    var j = B[o];
    Object.keys(R).forEach(function(m) {
      var g = [l0, n0].indexOf(m) >= 0 ? 1 : -1, $ = [t0, n0].indexOf(m) >= 0 ? "y" : "x";
      R[m] += j[$] * g;
    });
  }
  return R;
...
function s3(e, c) {
  c === void 0 && (c = {});
  var t = c, s = t.placement, o = t.boundary, a = t.rootBoundary, i = t.padding, n = t.flipVariations, d = t.allowedAutoPlacements, r = d === void 0 ? J1 : d, l = $0(s), u = l ? n ? S1 : S1.filter(function(x) {
    return $0(x) === l;
  }) : F0, h = u.filter(function(x) {
  ...
  return Object.keys(p).sort(function(x, z) {
    return p[x] - p[z];
  });
}
function o3(e) {
...
function n3(e) {
  ...
  if (!c.modifiersData[s]._skip) {
    for (var o = t.mainAxis, a = o === void 0 ? !0 : o, i = t.altAxis, n = i === void 0 ? !0 : i, d = t.fallbackPlacements, r = t.padding, l = t.boundary, u = t.rootBoundary, h = t.altBoundary, p = t.flipVariations, x = p === void 0 ? !0 : p, z = t.allowedAutoPlacements, _ = c.options.placement, k = i0(_), L = k === _, F = d || (L || !x ? [W0(_)] : o3(_)), y = [_].concat(F).reduce(function(_0, h0) {
      return _0.concat(i0(h0) === X0 ? s3(c, {
        placement: h0,
        boundary: l,
        rootBoundary: u,
        padding: r,
    ...
    }, []), w = c.rects.reference, N = c.rects.popper, D = /* @__PURE__ */ new Map(), H = !0, P = y[0], R = 0; R < y.length; R++) {
      var B = y[R], j = i0(B), m = $0(B) === B0, g = [t0, n0].indexOf(j) >= 0, $ = g ? "width" : "height", A = q0(c, {
        placement: B,
        boundary: l,
        rootBoundary: u,
        altBoundary: h,
      ...
      w[$] > N[$] && (V = W0(V));
      var E = W0(V), O = [];
      if (a && O.push(A[j] <= 0), n && O.push(A[V] <= 0, A[E] <= 0), O.every(function(_0) {
        return _0;
      })) {
        P = B, H = !1;
        break;
    ...
    if (H)
      for (var I = x ? 3 : 1, y0 = function(h0) {
        var S0 = y.find(function(j0) {
          var b0 = D.get(j0);
          if (b0)
            return b0.slice(0, h0).every(function(K0) {
              return K0;
            });
        });
        if (S0)
    ...
    c.placement !== P && (c.modifiersData[s]._skip = !0, c.placement = P, c.reset = !0);
  }
}
const l3 = {
  name: "flip",
...
function q1(e) {
  return [t0, l0, n0, c0].some(function(c) {
    return e[c] >= 0;
  });
}
function i3(e) {
  var c = e.state, t = e.name, s = c.rects.reference, o = c.rects.popper, a = c.modifiersData.preventOverflow, i = q0(c, {
    elementContext: "reference"
  }), n = q0(c, {
    altBoundary: !0
  }), d = E1(i, s), r = E1(n, o, a), l = q1(d), u = q1(r);
  c.modifiersData[t] = {
...
function r3(e, c, t) {
  var s = i0(e), o = [c0, t0].indexOf(s) >= 0 ? -1 : 1, a = typeof t == "function" ? t(Object.assign({}, c, {
    placement: e
  })) : t, i = a[0], n = a[1];
  return i = i || 0, n = (n || 0) * o, [c0, l0].indexOf(s) >= 0 ? {
    x: n,
    y: i
  } : {
    x: i,
...
function d3(e) {
  var c = e.state, t = e.options, s = e.name, o = t.offset, a = o === void 0 ? [0, 0] : o, i = J1.reduce(function(l, u) {
    return l[u] = r3(u, c.rects, a), l;
  }, {}), n = i[c.placement], d = n.x, r = n.y;
...
function f3(e) {
  var c = e.state, t = e.options, s = e.name, o = t.mainAxis, a = o === void 0 ? !0 : o, i = t.altAxis, n = i === void 0 ? !1 : i, d = t.boundary, r = t.rootBoundary, l = t.altBoundary, u = t.padding, h = t.tether, p = h === void 0 ? !0 : h, x = t.tetherOffset, z = x === void 0 ? 0 : x, _ = q0(c, {
    boundary: d,
    rootBoundary: r,
    padding: u,
    altBoundary: l
  }), k = i0(c.placement), L = $0(c.placement), F = !L, y = h1(k), w = p3(y), N = c.modifiersData.popperOffsets, D = c.rects.reference, H = c.rects.popper, P = typeof z == "function" ? z(Object.assign({}, c.rects, {
    placement: c.placement
  })) : z, R = typeof P == "number" ? {
    mainAxis: P,
    altAxis: P
    ...
    mainAxis: 0,
    altAxis: 0
  }, P), B = c.modifiersData.offset ? c.modifiersData.offset[c.placement] : null, j = {
    x: 0,
    y: 0
  };
  if (N) {
    if (a) {
      var m, g = y === "y" ? t0 : c0, $ = y === "y" ? n0 : l0, A = y === "y" ? "height" : "width", V = N[y], E = V + _[g], O = V - _[$], I = p ? -H[A] / 2 : 0, y0 = L === B0 ? D[A] : H[A], u0 = L === B0 ? -H[A] : -D[A], L0 = c.elements.arrow, _0 = p && L0 ? u1(L0) : {
        width: 0,
        height: 0
      }, h0 = c.modifiersData["arrow#persistent"] ? c.modifiersData["arrow#persistent"].padding : c2(), S0 = h0[g], j0 = h0[$], b0 = D0(0, D[A], _0[A]), K0 = F ? D[A] / 2 - I - b0 - S0 - R.mainAxis : y0 - b0 - S0 - R.mainAxis, d2 = F ? -D[A] / 2 + I + b0 + j0 + R.mainAxis : u0 + b0 + j0 + R.mainAxis, J0 = c.elements.arrow && P0(c.elements.arrow), u2 = J0 ? y === "y" ? J0.clientTop || 0 : J0.clientLeft || 0 : 0, b1 = (m = B == null ? void 0 : B[y]) != null ? m : 0, h2 = V + K0 - b1 - u2, v2 = V + d2 - b1, M1 = D0(p ? Z0(E, h2) : E, V, p ? z0(O, v2) : O);
      N[y] = M1, j[y] = M1 - V;
    }
    if (n) {
      var g1, p2 = y === "x" ? t0 : c0, f2 = y === "x" ? n0 : l0, M0 = N[w], R0 = w === "y" ? "height" : "width", z1 = M0 + _[p2], w1 = M0 - _[f2], e1 = [t0, c0].indexOf(k) !== -1, x1 = (g1 = B == null ? void 0 : B[w]) != null ? g1 : 0, _1 = e1 ? z1 : M0 - D[R0] - H[R0] - x1 + R.altAxis, C1 = e1 ? M0 + D[R0] + H[R0] - x1 - R.altAxis : w1, B1 = p && e1 ? F4(_1, M0, C1) : D0(p ? _1 : z1, M0, p ? C1 : w1);
      N[w] = B1, j[w] = B1 - M0;
    }
    c.modifiersData[s] = j;
  }
...
function b3(e) {
  return e === o0(e) || !s0(e) ? v1(e) : y3(e);
}
function M3(e) {
  var c = e.getBoundingClientRect(), t = k0(c.width) / e.offsetWidth || 1, s = k0(c.height) / e.offsetHeight || 1;
  return t !== 1 || s !== 1;
}
function g3(e, c, t) {
  t === void 0 && (t = !1);
  var s = s0(c), o = s0(c) && M3(c), a = m0(c), i = N0(e, o, t), n = {
    scrollLeft: 0,
    scrollTop: 0
  }, d = {
    x: 0,
  ...
  return (s || !s && !t) && ((r0(c) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  f1(a)) && (n = b3(c)), s0(c) ? (d = N0(c, !0), d.x += c.clientLeft, d.y += c.clientTop) : a && (d.x = p1(a))), {
    x: i.left + n.scrollLeft - d.x,
    y: i.top + n.scrollTop - d.y,
    width: i.width,
    height: i.height
  };
}
...
function w3(e) {
  var c = z3(e);
  return o1.reduce(function(t, s) {
    return t.concat(c.filter(function(o) {
      return o.phase === s;
    }));
  }, []);
}
...
function v0(e) {
  for (var c = arguments.length, t = new Array(c > 1 ? c - 1 : 0), s = 1; s < c; s++)
    t[s - 1] = arguments[s];
  return [].concat(t).reduce(function(o, a) {
    return o.replace(/%s/, a);
  }, e);
}
var g0 = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s', _3 = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available', I1 = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function C3(e) {
  e.forEach(function(c) {
    [].concat(Object.keys(c), I1).filter(function(t, s, o) {
      return o.indexOf(t) === s;
    }).forEach(function(t) {
      switch (t) {
        case "name":
          typeof c.name != "string" && console.error(v0(g0, String(c.name), '"name"', '"string"', '"' + String(c.name) + '"'));
          break;
        case "enabled":
          typeof c.enabled != "boolean" && console.error(v0(g0, c.name, '"enabled"', '"boolean"', '"' + String(c.enabled) + '"'));
          break;
        case "phase":
          o1.indexOf(c.phase) < 0 && console.error(v0(g0, c.name, '"phase"', "either " + o1.join(", "), '"' + String(c.phase) + '"'));
          break;
        case "fn":
          typeof c.fn != "function" && console.error(v0(g0, c.name, '"fn"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "effect":
          c.effect != null && typeof c.effect != "function" && console.error(v0(g0, c.name, '"effect"', '"function"', '"' + String(c.fn) + '"'));
          break;
        case "requires":
          c.requires != null && !Array.isArray(c.requires) && console.error(v0(g0, c.name, '"requires"', '"array"', '"' + String(c.requires) + '"'));
          break;
        case "requiresIfExists":
          Array.isArray(c.requiresIfExists) || console.error(v0(g0, c.name, '"requiresIfExists"', '"array"', '"' + String(c.requiresIfExists) + '"'));
          break;
        case "options":
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + c.name + '" modifier, valid properties are ' + I1.map(function(s) {
            return '"' + s + '"';
      ...
      c.requires && c.requires.forEach(function(s) {
        e.find(function(o) {
          return o.name === s;
        }) == null && console.error(v0(_3, String(c.name), s, s));
      });
    });
  });
}
...
function k3(e) {
  var c = e.reduce(function(t, s) {
    var o = t[s.name];
    return t[s.name] = o ? Object.assign({}, o, s, {
...
var A1 = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.", N3 = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.", F1 = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
};
...
function $3(e) {
  e === void 0 && (e = {});
  var c = e, t = c.defaultModifiers, s = t === void 0 ? [] : t, o = c.defaultOptions, a = o === void 0 ? F1 : o;
  return function(n, d, r) {
    r === void 0 && (r = a);
    var l = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, F1, a),
      modifiersData: {},
      elements: {
        reference: n,
        popper: d
      ...
      setOptions: function(k) {
        var L = typeof k == "function" ? k(l.options) : k;
        z(), l.options = Object.assign({}, a, l.options, L), l.scrollParents = {
          reference: w0(n) ? T0(n) : n.contextElement ? T0(n.contextElement) : [],
          popper: T0(d)
        };
        var F = w3(k3([].concat(s, l.options.modifiers)));
        if (l.orderedModifiers = F.filter(function(B) {
          return B.enabled;
        }), process.env.NODE_ENV !== "production") {
          var y = B3([].concat(F, l.options.modifiers), function(B) {
            var j = B.name;
            return j;
          });
          if (C3(y), i0(l.options.placement) === X0) {
            var w = l.orderedModifiers.find(function(B) {
              var j = B.name;
              return j === "flip";
            });
            w || console.error(['Popper: "auto" placements require the "flip" modifier be', "present and enabled to work."].join(" "));
          }
          var N = a0(d), D = N.marginTop, H = N.marginRight, P = N.marginBottom, R = N.marginLeft;
          [D, H, P, R].some(function(B) {
            return parseFloat(B);
      ...
      forceUpdate: function() {
        if (!h) {
          var k = l.elements, L = k.reference, F = k.popper;
          if (!P1(L, F)) {
            process.env.NODE_ENV !== "production" && console.error(A1);
            return;
          }
          l.rects = {
            reference: g3(L, P0(F), l.options.strategy === "fixed"),
            popper: u1(F)
          ...
          for (var y = 0, w = 0; w < l.orderedModifiers.length; w++) {
            ...
            var N = l.orderedModifiers[w], D = N.fn, H = N.options, P = H === void 0 ? {} : H, R = N.name;
    ...
    if (!P1(n, d))
      return process.env.NODE_ENV !== "production" && console.error(A1), p;
    p.setOptions(r).then(function(_) {
      !h && r.onFirstUpdate && r.onFirstUpdate(_);
    });
    function x() {
      l.orderedModifiers.forEach(function(_) {
        var k = _.name, L = _.options, F = L === void 0 ? {} : L, y = _.effect;
...
const V3 = {
  ...
  setup(e, { expose: c, emit: t }) {
    const s = e, o = W(!1), a = W(!1);
    let i = null;
    const n = W(null), d = W(null), r = W(null), l = W(null);
    d0(() => {
      const _ = [
        {
          name: "preventOverflow",
    ...
    function u() {
      s.disabled || (o.value = !o.value, i.update(), t("change", o));
    }
    function h() {
      o.value = !1, t("change", o);
    }
    function p() {
      !s.openOnHover || s.disabled || (a.value = !0, o.value = !0, i.update());
    }
    function x() {
      !s.openOnHover || s.disabled || (a.value = !1, o.value = !1);
    }
    function z(_) {
      s.openOnHover || s.disabled || o.value && !_.composedPath().includes(l.value) && !_.composedPath().includes(d.value) && h();
    }
    return c({ close: h, toggle: u }), (_, k) => (v(), f("div", {
      class: q(["nice-popup", { "nice-popup-open": o.value, "nice-popup-focused": a.value, disabled: s.disabled }]),
      ref_key: "$el",
      ref: l
    }, [
      M("div", {
...
}), Q0 = /* @__PURE__ */ G(D3, [["__scopeId", "data-v-67f29891"]]);
const m1 = (e) => (I0("data-v-a75a5e3e"), e = e(), A0(), e), T3 = { class: "input-group" }, E3 = ["placeholder", "disabled", "required"], q3 = { class: "nice-dropdown" }, I3 = { class: "month-wrapper" }, A3 = { class: "value" }, F3 = { class: "year" }, P3 = { class: "month" }, L3 = { class: "calendar" }, j3 = { class: "header" }, R3 = { class: "month" }, H3 = ["onClick", "title"], W3 = {
  key: 0,
  class: "time"
}, U3 = { class: "select-wrapper" }, Y3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ M("div", { class: "arrow-down" }, null, -1)), Z3 = ["value", "selected"], X3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ M("div", null, ":", -1)), G3 = { class: "select-wrapper" }, Q3 = /* @__PURE__ */ m1(() => /* @__PURE__ */ M("div", { class: "arrow-down" }, null, -1)), K3 = ["value", "selected"], J3 = {
  name: "NiceDate"
  ...
  emits: ["change", "update:modelValue"],
  setup(e, { emit: c }) {
    const t = e, s = K("$t"), o = W(null), a = W(""), i = W(/* @__PURE__ */ new Date()), n = W([]), d = W(null), r = [
      0,
      1,
      2,
      3,
    ...
    R1(() => t.modelValue, () => {
      t.modelValue && x(t.modelValue) && (o.value = new Date(t.modelValue), i.value = new Date(t.modelValue), m());
    }), d0(() => {
      D();
    });
    function x(g) {
    ...
    function L() {
      m(), c("update:modelValue", o.value), c("change", o.value);
    }
    function F() {
      if (a.value && a.value != "") {
        let g = a.value.split(" • "), $ = /* @__PURE__ */ new Date(), A = g[0].split(".");
        if ($.setDate(A[0]), $.setMonth(A[1] - 1), $.setFullYear(A[2]), t.time) {
          let V = g[1].split(":");
          $.setHours(V[0]), $.setMinutes(V[1]), $.setSeconds(0, 0);
        } else
    ...
    function y(g) {
      let $ = g.target.value;
      i.value.setHours($), o.value.setHours($), L();
    }
    function w(g) {
      let $ = g.target.value;
      i.value.setMinutes($), o.value.setMinutes($), L();
    }
    function N(g) {
      o.value.setYear(g.year), o.value.setMonth(g.month), o.value.setDate(g.day), L();
    }
    function D() {
      t.modelValue || (o.value = /* @__PURE__ */ new Date(), o.value.setSeconds(0, 0)), t.modelValue && x(t.modelValue) && (o.value = new Date(t.modelValue), o.value.setSeconds(0, 0), a.value = j(o.value));
    }
    function H(g) {
      let $ = i.value.getMonth();
      g ? $ += 1 : $ -= 1, i.value.setMonth($), P();
    }
    function P() {
      n.value = [];
      let g = new Date(
    ...
    function R(g, $, A) {
      const V = /* @__PURE__ */ new Date(), E = new Date(g, $, A);
      return {
        id: E.toString(),
        date: E,
        year: E.getFullYear(),
        ...
        day: E.getDate(),
        dayInWeek: E.getDay(),
        currentMonth: E.getMonth() == i.value.getMonth(),
        selected: B(o.value, E),
        today: B(V, E),
        text: j(E)
      };
    }
    function B(g, $) {
      return g.getDate() == $.getDate() && g.getMonth() == $.getMonth() && g.getFullYear() == $.getFullYear();
    }
    function j(g) {
      let $ = g.getDate(), A = g.getMonth() + 1, V = g.getFullYear(), E = g.getHours(), O = g.getMinutes();
      return O < 10 && (O = "0" + O), t.time ? `${$}.${A}.${V} • ${E}:${O}` : `${$}.${A}.${V}`;
    }
    function m() {
      o.value || (o.value = /* @__PURE__ */ new Date()), p.day = o.value.getDate(), p.month = o.value.getMonth(), p.year = o.value.getFullYear(), p.hour = o.value.getHours(), p.minute = o.value.getMinutes(), a.value = j(o.value), i.value.year = p.year, i.value.month = p.month, P();
    }
    return (g, $) => {
      const A = Y("NiceIcon"), V = Y("NiceButton");
      return v(), f("div", {
        ...
        T(Q0, {
          ...
          trigger: e0(() => [
            M("div", T3, [
              C0(M("input", {
                "onUpdate:modelValue": $[0] || ($[0] = (E) => a.value = E),
          ...
          content: e0(() => [
            M("div", q3, [
              M("div", I3, [
                ...
                M("div", A3, [
                  M("div", F3, S(i.value.getFullYear()), 1),
                  M("div", P3, S(h[i.value.getMonth() + 1]), 1)
                ]),
                T(V, {
                  class: "right",
                  onClick: $[2] || ($[2] = (E) => H(!0)),
              ...
              M("div", L3, [
                ...
                M("div", R3, [
                  (v(!0), f(Q, null, J(n.value, (E) => (v(), f("div", {
                    class: q(["day", {
                      "previous-month": !E.currentMonth,
                      today: E.today,
                      selected: E.selected
                    }]),
                    onClick: (O) => N(E),
              ...
              e.time ? (v(), f("div", W3, [
                M("div", U3, [
                  Y3,
                  M("select", { onChange: y }, [
                    (v(), f(Q, null, J(r, (E) => M("option", {
                      value: E,
                      key: E,
                      selected: E == i.value.getHours()
                    }, S(E), 9, Z3)), 64))
                  ], 32)
                ]),
                X3,
                M("div", G3, [
                  Q3,
                  M("select", { onChange: w }, [
                    (v(), f(Q, null, J(l, (E) => M("option", {
                      value: E,
                      key: E,
                      selected: E == i.value.getMinutes()
                    }, S(E), 9, K3)), 64))
                  ], 32)
                ]),
                T(A, {
...
}), t7 = /* @__PURE__ */ G(e7, [["__scopeId", "data-v-a75a5e3e"]]);
const c7 = { class: "input-group" }, s7 = ["required", "disabled", "modelValue"], o7 = ["selected"], n7 = ["value"], l7 = {
  ...
  setup(e, { emit: c }) {
    ...
    function i() {
      setTimeout(() => {
        !o.value && t.values.length > 0 && !t.nullable && n(t.values[0]);
      });
    }
    function n(d) {
      d ? t.keyOnly ? o.value = d[t.keyName] : o.value = d : o.value = void 0;
    }
    return (d, r) => {
      const l = Y("NiceLoading"), u = Y("NiceIcon");
      return v(), f("div", {
        ...
        M("div", c7, [
          M("div", {
            class: q(["select-wrapper", { "no-value": C(o) == null }])
          }, [
            M("select", {
              required: e.required,
              disabled: e.disabled,
              ...
              e.nullable ? (v(), f("option", {
                ...
                value: null,
                selected: !C(o)
              }, S(e.nullText || C(s)("Nice", "None")), 9, o7)) : b("", !0),
              (v(!0), f(Q, null, J(e.values, (h) => (v(), f("option", {
                value: h[e.keyName],
                key: h[e.keyName]
              }, S(h[e.valueName]), 9, n7))), 128))
            ], 40, s7),
            !e.nullable && !e.loading && (!e.values || e.values.length == 0) ? (v(), f("div", l7, S(C(s)("Nice", "No options")), 1)) : b("", !0),
            e.loading ? (v(), U(l, {
              key: 1,
              class: "no-options"
            })) : b("", !0),
...
}), d7 = /* @__PURE__ */ G(r7, [["__scopeId", "data-v-d2fc0d46"]]);
  ...
  setup(e) {
    ...
    return (t, s) => {
      ...
      return v(), f("div", {
        ...
        M("div", u7, [
          T(o, { icon: "icon-half-loading" }),
          T(o, { icon: "icon-half-loading" })
        ]),
        c.message ? (v(), f("div", h7, S(c.message), 1)) : b("", !0)
      ], 2);
    };
  }
}), y1 = /* @__PURE__ */ G(p7, [["__scopeId", "data-v-3d00153a"]]);
const f7 = { class: "nice-dropdown-wrapper" }, m7 = { class: "input-group" }, y7 = { class: "select-wrapper" }, b7 = ["required", "value", "disabled"], M7 = {
  ...
  key: 3,
  class: "no-options"
}, _7 = { class: "nice-dropdown-popup" }, C7 = {
  key: 0,
  class: "input-group"
}, B7 = ["placeholder", "name", "disabled"], k7 = { class: "list" }, N7 = ["onClick"], $7 = {
  key: 1,
  class: "element no-options"
}, S7 = {
  name: "NiceDropdown"
}, O7 = /* @__PURE__ */ Object.assign(S7, {
  props: {
    modelValue: {
  ...
  setup(e, { emit: c }) {
    const t = e, s = K("$t");
    let o = null;
    const a = 500, i = W(!1), n = W(null), d = W(null), r = W(null), l = W(null), u = W(!1), h = W(null), p = W(null), x = X(() => t.keyOnly && !t.multiple ? h.value ? h.value.find((m) => m[t.keyName] == t.modelValue) : {} : (t.multiple && k(), t.modelValue)), z = X(() => t.disabled ? !1 : !!t.modelValue && !!t.nullable), _ = X(() => h.value != null ? h.value.filter((m) => m._selected) : []), k = function() {
      h.value && t.modelValue != null && t.multiple && h.value.forEach((m) => {
        m._selected = !!t.modelValue.find((g) => g[t.keyName] == m[t.keyName]);
      });
    };
    d0(async () => {
      await B(), H();
    ...
    function L(m) {
      var g;
      (m.code == "Enter" || m.code == "Space") && (m.preventDefault(), (g = r.value) == null || g.toggle());
    }
    function F() {
      var m;
      (m = r.value) == null || m.close();
    }
    function y() {
      D(null), setTimeout(() => {
        F();
    ...
    async function N(m) {
      m ? (h.value || await B(), p.value != null ? l.value = h.value.findIndex(
        (g) => g[t.keyName] == p.value[t.keyName]
      ) : l.value = -1, setTimeout(() => {
        var g;
        (g = d.value) == null || g.focus();
      }, 100), document.addEventListener("keydown", j)) : (n.value = null, u.value = !1, document.removeEventListener("keydown", j));
    }
    function D(m) {
      if (m) {
        const g = m[t.keyName], $ = h.value.find((A) => A[t.keyName] == g);
        P($ || null);
      } else
        P(null);
      t.multiple || F();
    ...
    function H() {
      h.value && h.value.length > 0 && !t.nullable && !t.modelValue ? P(h.value[0]) : k();
    }
    function P(m) {
      m ? t.multiple ? (m._selected = !m._selected, t.keyOnly ? (c("update:modelValue", _.value.filter.map((g) => g[t.keyName])), c("change", _.value.map((g) => g[t.keyName]))) : (c("update:modelValue", _.value), c("change", _.value))) : t.keyOnly ? (c("update:modelValue", m[t.keyName]), c("change", m[t.keyName])) : (c("update:modelValue", m), c("change", m)) : (c("update:modelValue", null), c("change", null));
    }
    function R() {
      return clearTimeout(o), o = setTimeout(async () => {
        await B();
      }, a);
    }
    async function B() {
      if (t.values && (h.value = t.values), t.searchFunction) {
        u.value = !0;
        const m = await t.searchFunction(n.value);
        return l.value = 0, u.value = !1, h.value = m, m;
      } else
        return null;
    }
    function j(m) {
      m.key == "ArrowDown" ? (l.value < h.value.length - 1 && (l.value += 1), m.preventDefault()) : m.key == "ArrowUp" ? (l.value > 0 && (l.value -= 1), m.preventDefault()) : m.key == "Escape" ? (F(), m.preventDefault()) : m.key == "Enter" && (P(h.value[l.value]), F(), m.preventDefault());
    }
    return (m, g) => {
      const $ = Y("nice-icon"), A = Y("NiceIcon");
      return v(), f("div", {
          ...
          T(Q0, {
            ...
            trigger: e0(() => [
              M("div", m7, [
                M("div", y7, [
                  M("div", {
                    class: q(["selected-value", { focus: i.value }])
                  }, [
                    M("input", {
                      required: e.required,
                      value: e.modelValue,
                      class: "hidden-input",
                      onFocus: g[0] || (g[0] = (V) => i.value = !0),
                      onBlur: g[1] || (g[1] = (V) => i.value = !1),
                      onKeypress: L,
                      disabled: e.disabled
                    }, null, 40, b7),
                    !e.loading && e.modelValue && !t.multiple ? (v(), f("div", M7, [
                      Z(m.$slots, "selected-option", { item: e.modelValue }, () => [
                        M("span", null, S(e.formatFunction ? e.formatFunction(e.modelValue) : C(x)[e.valueName]), 1)
                      ], !0)
                    ])) : b("", !0),
                    t.multiple ? (v(), f("div", g7, [
                      (v(!0), f(Q, null, J(C(_), (V) => (v(), f("div", {
                        class: "option",
                        key: V
                      }, [
                        Z(m.$slots, "selected-option", H1({ item: V }, V), () => [
                          M("span", null, S(e.formatFunction ? e.formatFunction(V) : V[t.valueName]), 1)
                        ], !0),
                        M("button", {
                    ...
                    !e.loading && !e.modelValue || t.multiple && !C(_).length ? (v(), f("div", w7, S(e.nullText || C(s)("Nice", "None")), 1)) : b("", !0),
                    e.loading ? (v(), f("div", x7, S(C(s)("Nice", "Loading")), 1)) : b("", !0),
                    T(A, {
                      class: "arrow-down",
                      icon: "icon-chevron-down"
                    }),
            ...
            content: e0(() => [
              M("div", _7, [
                e.searchFunction && !e.noSearch ? (v(), f("div", C7, [
                  C0(M("input", {
                ...
                M("div", k7, [
                  e.nullable ? (v(), f("div", {
                    ...
                    onClick: g[3] || (g[3] = (V) => D(void 0))
                  }, S(e.nullText || C(s)("Nice", "None")), 3)) : b("", !0),
                  (v(!0), f(Q, null, J(h.value, (V, E) => (v(), f("div", {
                    class: q(["element", {
                      hover: l.value == E,
                      selected: e.modelValue && (!t.multiple && V[e.keyName] == C(x)[e.keyName] || V._selected)
                    }]),
                    key: V[e.keyName],
                    onClick: (O) => D(V)
                  }, [
                    e.multiple ? (v(), U(V0, {
                      key: 0,
                      modelValue: V._selected,
                      noMargin: !0,
                      class: "nice-dropdown-item-checkbox"
                    }, null, 8, ["modelValue"])) : b("", !0),
                    Z(m.$slots, "option", { item: V }, () => [
                      f0(S(e.formatFunction ? e.formatFunction(V) : V[e.valueName]), 1)
                    ], !0)
                  ], 10, N7))), 128)),
                  !u.value && (!h.value || h.value.length == 0) ? (v(), f("div", $7, S(C(s)("Nice", "No options")), 1)) : b("", !0)
                ])
              ])
            ]),
            _: 3
          }, 8, ["disabled"]),
          e.addFunction ? (v(), U(p0, {
            key: 0,
...
}), V7 = /* @__PURE__ */ G(O7, [["__scopeId", "data-v-60c3d28c"]]);
const D7 = (e) => (I0("data-v-b3fd1522"), e = e(), A0(), e), T7 = { class: "nice-filters-wrapper" }, E7 = { class: "nice-component nice-filters" }, q7 = {
  key: 0,
  class: "nice-filters-options"
}, I7 = /* @__PURE__ */ D7(() => /* @__PURE__ */ M("div", { class: "f-grow" }, null, -1)), A7 = {
  key: 0,
  class: "nice-component nice-filters-pills"
}, F7 = ["title"], P7 = {
  name: "NiceFilters"
}, L7 = /* @__PURE__ */ Object.assign(P7, {
  props: {
    // filters: {
    //   type: Object,
    //   required: false,
  ...
  setup(e, { emit: c }) {
    const t = e, s = K("clone"), o = K("$t"), a = Y1(), i = Z1(), n = W(""), d = W(t.modelValue), r = [
      { id: "true", name: o("Nice", "Yes") },
      { id: "false", name: o("Nice", "No") }
    ], l = (y) => y ? r.filter(
    ...
    function p(y) {
      const w = new Date(y.value), N = w.getDate(), D = w.getMonth() + 1, H = w.getFullYear(), P = w.getHours(), R = w.getMinutes();
      return `${N}.${D}.${H} ${P}:${R < 10 ? "0" : ""}${R}`;
    }
    function x(y) {
      var w, N;
      return y.formatter ? y.formatter(y.value) : y.type == "date" ? p(y) : y.type == "boolean" ? y.value ? o("Nice", "Yes") : o("Nice", "No") : y.valueName ? y.value[y.valueName] : (w = y.value) != null && w.name ? y.value.name : (N = y.value) != null && N.value ? y.value.value : y.value;
    }
    function z(y) {
      var w;
    ...
    async function _() {
      await i.isReady();
      const y = s(a.query);
      d.value.forEach(async (w) => {
        const N = y[w.key];
        if (w.type == "yesno") {
          let D = r.find(
            (H) => H.id == y[w.key]
          );
          y[w.key] || (D = null), w.value = D;
        } else if (w.type == "date")
          w.value = new Date(N);
        else if (w.type == "boolean")
          w.value = N == "true";
        else if (w.type == "select" && w.fetch) {
          const D = await w.fetch(N);
          w.value = D;
        } else
          console.log("[NiceFilters] Query not handled: ", w.key, N);
      }), setTimeout(() => {
        c("update:modelValue", d), c("change", d);
      });
    }
    async function k() {
      setTimeout(async () => {
        ...
        const w = Object.keys(y).filter((N) => y[N] != null && y[N] != "").reduce((N, D) => ({ ...N, [D]: y[D] }), {});
        i.push({ query: w }), await i.isReady(), setTimeout(() => {
    ...
    async function L() {
      ...
      i.push({ query: y }), await i.isReady(), c("create");
    }
    function F(y) {
      y.value = null, k();
    }
    return (y, w) => {
      const N = Y("NiceInput"), D = Y("NiceSwitch"), H = Y("NiceDate"), P = Y("NiceDropdown"), R = Y("NiceButton");
      return v(), f("div", T7, [
        M("div", E7, [
          T(N, {
            title: C(o)("Nice", "Search"),
          ...
          d.value ? (v(), f("div", q7, [
            (v(!0), f(Q, null, J(d.value, (B) => (v(), f("div", {
              class: "nice-filters-filter",
              key: B.key
            }, [
              B.type == "boolean" ? (v(), U(D, {
                key: 0,
                modelValue: B.value,
          ...
          e.showCreateButton ? (v(), U(R, {
            key: 1,
            text: C(o)("Nice", "Create"),
            onClick: L,
            icon: "icon-plus"
          }, null, 8, ["text"])) : b("", !0)
        ]),
        e.showPills && C(u) && C(u).length ? (v(), f("div", A7, [
          (v(!0), f(Q, null, J(C(u), (B) => (v(), f("div", {
            class: "nice-filters-pill badge badge-primary",
            key: B.key,
            title: B.description
          }, [
            M("div", null, [
              M("small", null, S(B.name), 1),
              M("div", null, S(x(B)), 1)
            ]),
            T(R, {
              icon: "icon-x",
...
}), j7 = /* @__PURE__ */ G(L7, [["__scopeId", "data-v-b3fd1522"]]);
const R7 = { class: "nice-icon" }, H7 = ["xlink:href"], W7 = {
  name: "NiceIcon"
}, U7 = /* @__PURE__ */ Object.assign(W7, {
  props: {
    icon: {
      type: String,
      required: !0
  ...
  setup(e) {
    const c = e;
    return (t, s) => (v(), f("svg", R7, [
      M("use", {
        "xlink:href": "#" + c.icon
      }, null, 8, H7)
    ]));
  }
}), i2 = /* @__PURE__ */ G(U7, [["__scopeId", "data-v-aee3bde0"]]);
var a2 = Y7;
function Y7(e, c, t) {
  if (!e)
    return t;
  ...
  for (; s.length; )
    if (o = s.shift(), !e || (e = e[o], e === void 0))
      return t;
  return e;
}
const Z7 = { class: "input-group" }, X7 = ["placeholder", "autocomplete", "type", "required", "disabled", "min", "max", "min-length", "max-length", "regex-pattern"], G7 = {
  key: 1,
  ...
  setup(e, { emit: c }) {
    ...
    const a = X({
      ...
      set(l) {
        c("update:modelValue", l), c("change", l), clearTimeout(o), o = setTimeout(() => {
          c("debounce", l);
        }, 500);
      }
    }), i = W(!0);
    ...
    const d = X(() => {
      if (typeof t.error == "string")
        return t.error;
      const l = a2(t.error, ["response", "data", t.prop]);
    ...
    return (l, u) => {
      ...
      return v(), f("div", {
        ...
        M("div", Z7, [
          C(s).suffix || t.suffixText ? (v(), f("div", {
            key: 0,
          ...
          C0(M("input", {
            onBlur: u[0] || (u[0] = (p) => n(!0)),
            onFocus: u[1] || (u[1] = (p) => n(!1)),
            "onUpdate:modelValue": u[2] || (u[2] = (p) => r1(a) ? a.value = p : null),
          ...
          C(s).append || t.appendText ? (v(), f("div", {
            key: 2,
        ...
        e.message ? (v(), f("div", Q7, S(e.message), 1)) : b("", !0),
        C(d) ? (v(), f("div", K7, S(C(d)), 1)) : b("", !0)
      ], 2);
    };
  }
}), t8 = /* @__PURE__ */ G(e8, [["__scopeId", "data-v-bc7cd04e"]]);
  ...
  setup(e, { emit: c }) {
    ...
    return d0(() => {
      ...
      return v(), f("div", {
        ...
        t.notification.icon ? (v(), U(d, {
          key: 0,
          class: "notification-icon",
          icon: t.notification.icon
        }, null, 8, ["icon"])) : b("", !0),
        M("div", c8, [
          t.notification.title ? (v(), f("div", s8, S(t.notification.title), 1)) : b("", !0),
          t.notification.message ? (v(), f("div", o8, S(t.notification.message), 1)) : b("", !0)
        ])
      ], 34);
    };
  }
}), r2 = /* @__PURE__ */ G(l8, [["__scopeId", "data-v-b366cb5b"]]);
const i8 = { class: "nice-notifications" }, a8 = {
  name: "NiceNotifications"
}, r8 = /* @__PURE__ */ Object.assign(a8, {
  setup(e) {
    const c = K("$t"), t = K("nice"), s = 3e3, o = W([]);
    function a({ message: n, type: d, title: r, icon: l }) {
      var u = {
      ...
      r || (d == "danger" ? (u.title = c("Nice", "Error"), u.icon = "icon-alert-triangle") : d == "success" ? (u.title = c("Nice", "Success"), u.icon = "icon-smile") : d == "warning" && (u.title = c("Nice", "Warning"), u.icon = "icon-alert-circle")), o.value.unshift(u);
    }
    function i(n) {
      let d = o.value.findIndex((r) => r.id == n.id);
    ...
    return d0(() => {
      ...
      T(W1, {
        ...
        default: e0(() => [
          (v(!0), f(Q, null, J(o.value, (r) => (v(), U(r2, {
            key: r.id,
            notification: r,
            timeoutTime: s,
            onRemove: (l) => i(r)
...
}), d8 = /* @__PURE__ */ G(r8, [["__scopeId", "data-v-69de8d3e"]]);
const u8 = {
  name: "NicePanel"
  ...
  emits: ["close"],
  setup(e, { expose: c, emit: t }) {
    const s = e, o = K("nice"), a = W(!1), i = W(!1), n = W(500), d = W(null);
    d0(() => {
      document.addEventListener("keyup", p), o.onPanel((x) => {
        s.name == x.name && (a.value = x.isOpen), x.isOpen && l();
      });
    }), M2(() => {
    ...
    return c({ close: u }), (x, z) => (v(), f("div", {
      class: q(["nice-side-view", [e.position, { "no-select": i.value }]]),
      onMousemove: h,
      onMouseup: z[1] || (z[1] = (_) => i.value = !1),
      ...
      T(U0, { name: "side-view" }, {
        default: e0(() => [
          a.value ? (v(), f("div", {
            ...
            style: j1({ "--side-view-width": n.value + "px" })
          }, [
            M("div", {
              class: q(["handle", { active: i.value }]),
              ref: "handle",
              onMousedown: z[0] || (z[0] = (_) => i.value = !0)
            }, null, 34),
            Z(x.$slots, "default")
          ], 6)) : b("", !0)
        ]),
...
const M8 = /* @__PURE__ */ G(f8, [["render", b8]]);
const g8 = (e) => (I0("data-v-cb4d7c97"), e = e(), A0(), e), z8 = { class: "nice-switch-box-wrapper" }, w8 = ["disabled"], x8 = /* @__PURE__ */ g8(() => /* @__PURE__ */ M("div", { class: "nice-switch-handle" }, null, -1)), _8 = [
  x8
    ...
    return (i, n) => {
      ...
      return v(), f("div", {
        class: q(["nice-component nice-switch", [
          ...
          { "no-margin": t.noMargin, active: C(o), disabled: t.disabled, "nice-is-inline": t.isInline, "nice-is-block": t.isBlock, "nice-is-title-left": e.titleLeft }
        ]])
      }, [
        t.isInline ? (v(), U(d, {
          key: 0,
...
}), $8 = /* @__PURE__ */ G(N8, [["__scopeId", "data-v-cb4d7c97"]]);
const S8 = { class: "nice-table" }, O8 = { class: "nice-table-table-wrapper" }, V8 = { class: "nice-table-table" }, D8 = {
  key: 0,
  class: "w-0"
}, T8 = ["onClick"], E8 = { key: 1 }, q8 = { key: 0 }, I8 = { key: 0 }, A8 = { class: "list" }, F8 = ["onClick"], P8 = {
  key: 0,
  class: "w-0"
}, L8 = ["innerHTML"], j8 = {
  key: 2,
  ...
  setup(e, { emit: c }) {
    const t = e, s = Y1(), o = Z1(), a = K("getQuery"), i = W(void 0), n = W(50), d = [
      { id: 10, value: 10 },
      { id: 20, value: 20 },
      { id: 50, value: 50 },
      { id: 100, value: 100 }
    ...
    let l = null;
    const u = X(() => (r.value - 1) * n.value), h = X(() => {
      var m, g;
      return ((g = (m = t.data) == null ? void 0 : m._metadata) == null ? void 0 : g.count) || 0;
    }), p = X(() => Math.ceil(h.value / n.value) || 1), x = X(() => Array.from({ length: p.value }, (m, g) => ({ id: g + 1, value: g + 1 }))), z = X(() => t.columns), _ = X(() => z.value.filter((m) => !m.disabled)), k = X(() => {
      let m = t.data;
      if (m.forEach((g) => {
        g._selected === void 0 && (g._selected = !1);
      }), i.value !== void 0) {
        const g = i.value.replace("-", "");
        m.sort(($, A) => {
          if (i.value[0] != "-") {
            const V = $;
            $ = A, A = V;
          }
          return String($[g]).localeCompare(String(A[g]));
        });
      }
      return m;
    }), L = X(() => k.value.filter((m) => m._selected)), F = X(() => L.value.length == k.value.length);
    function y() {
      let m = !0;
      F.value && (m = !1), k.value.forEach((g) => g._selected = m), N();
    }
    function w(m) {
      m._selected = !m._selected, N();
    }
    function N() {
      c("selected", L.value);
    }
    ...
    function H(m) {
      m.key == i.value ? i.value = "-" + m.key : i.value && i.value[0] === "-" && i.value === "-" + m.key ? i.value = void 0 : i.value = m.key, o.push({
    ...
    async function R(m) {
      s.query.page != m && (r.value = m, o.replace({
        path: s.path,
        query: { ...s.query, page: r.value, offset: u.value, limit: n.value }
      }), setTimeout(() => {
        c("pageChange", m);
      }), j());
    }
    function B(m) {
      s.query.limit != m && (n.value = m, o.push({
        path: s.path,
        query: { ...s.query, limit: n.value }
      }), setTimeout(() => {
        c("limitChange", n);
      }), j());
    }
    function j() {
      setTimeout(() => {
        c("filterChange", { ordering: i.value, page: r.value, offset: u.value, limit: n.value });
      });
    }
    return d0(async () => {
      const m = await a();
      i.value = m.ordering, t.paginated && (n.value = Number(m.limit) || 50, r.value = Number(m.page) || 1, l = x[Number(m.page) || 1], R(r.value));
    }), (m, g) => {
      const $ = Y("NiceIcon"), A = Y("router-link"), V = Y("NiceNoData"), E = Y("NiceDropdown");
      return v(), f("div", S8, [
        M("div", O8, [
          M("table", V8, [
            M("thead", null, [
              M("tr", null, [
                ...
                (v(!0), f(Q, null, J(C(_), (O) => (v(), f("th", {
                  ...
                  t.showOrder ? (v(), f("div", {
                    ...
                    M("span", null, S(O.name), 1),
                    t.showOrder ? (v(), U($, {
                      key: 0,
                      icon: "icon-bar-chart",
                      class: "table-order"
                    })) : b("", !0)
                  ], 10, T8)) : (v(), f("span", E8, S(O.name), 1))
                ], 2))), 128)),
                t.actions.length ? (v(), f("th", {
                  key: 1,
                  class: q(["actions-td w-0", { "freeze-column-right": t.freezeLastColumn }])
                }, [
                  !t.showToggleColumns && !t.showFooter && C(k) && C(k).length ? (v(), f("span", q8, [
                    M("span", null, S(C(k).length), 1),
                    C(k)._metadata ? (v(), f("span", I8, " / " + S(C(k)._metadata.count), 1)) : b("", !0)
                  ])) : b("", !0),
                  t.showToggleColumns ? (v(), U(Q0, {
                    key: 1,
                    ...
                    trigger: e0(() => [
                      T($, { icon: "icon-plus-circle" })
                    ]),
                    content: e0(() => [
                      M("div", A8, [
                        (v(!0), f(Q, null, J(C(z), (O) => (v(), f("div", {
                          class: "element",
                          key: O.key,
                          onClick: (I) => D(O)
                        }, [
            ...
            M("tbody", null, [
              (v(!0), f(Q, null, J(C(k), (O) => (v(), f("tr", {
                key: O.id
              }, [
                t.selectMultiple ? (v(), f("td", P8, [
                  T(V0, {
                ...
                (v(!0), f(Q, null, J(C(_), (I) => {
                  var y0, u0;
                  return v(), f("td", {
                    key: I.key,
                    class: q(I.class)
                  }, [
                    I.component ? (v(), U(U1((y0 = I.component()) == null ? void 0 : y0.instance), z2(H1({ key: 0 }, (u0 = I.component(O[I.key], O)) == null ? void 0 : u0.props)), null, 16)) : b("", !0),
                    !I.component && I.html ? (v(), f("span", {
                      key: 1,
                      innerHTML: I.html(O[I.key], O)
                    }, null, 8, L8)) : b("", !0),
                    !I.component && !I.html ? (v(), f("span", {
                      key: 2,
                      class: q(I.fieldClass ? I.fieldClass(O[I.key], O) : "")
                    }, S(I.formatter ? I.formatter(O[I.key], O) : O[I.key]), 3)) : b("", !0)
                  ], 2);
                }), 128)),
                t.actions.length ? (v(), f("td", {
                  ...
                  (v(!0), f(Q, null, J(t.actions, (I) => (v(), f("div", { key: I }, [
                    I.to ? (v(), U(A, {
                      key: 0,
                      to: I.to(O)
                    }, {
        ...
        e.loading ? (v(), U(y1, { key: 0 })) : b("", !0),
        !e.loading && t.data.length == 0 ? (v(), U(V, { key: 1 })) : b("", !0),
        t.showFooter ? (v(), f("div", j8, [
          M("div", R8, S(C(h)) + " " + S(m.$t("Nice", "total")), 1),
          t.paginated && C(p) > 1 && C(p) < 5 ? (v(), f("div", H8, [
            (v(!0), f(Q, null, J(C(p), (O) => (v(), U(p0, {
              size: "small",
              plain: r.value !== O,
              key: O,
          ...
          t.paginated && C(p) > 1 && C(p) > 5 ? (v(), f("div", W8, [
            T(E, {
              modelValue: C(l),
              "onUpdate:modelValue": g[0] || (g[0] = (O) => r1(l) ? l.value = O : l = O),
              values: C(x),
              noMargin: "",
              onChange: P
          ...
          t.showLimit ? (v(), U(E, {
            key: 2,
            modelValue: n.value,
            "onUpdate:modelValue": g[1] || (g[1] = (O) => n.value = O),
            class: q({ "dropdown-small": C(p) > 1 && C(p) < 5 }),
            values: d,
            keyOnly: "",
            noMargin: "",
            onChange: B
...
}), Z8 = /* @__PURE__ */ G(Y8, [["__scopeId", "data-v-20ae4ca0"]]);
  ...
  setup(e, { emit: c }) {
    ...
    return (o, a) => {
      ...
      return v(), f("div", {
        ...
        M("div", X8, [
          o.$slots.suffix ? (v(), f("div", G8, [
            Z(o.$slots, "suffix", {}, void 0, !0)
          ])) : b("", !0),
          C0(M("textarea", {
            "onUpdate:modelValue": a[0] || (a[0] = (n) => r1(s) ? s.value = n : null),
            placeholder: e.placeholder,
            autocomplete: e.autocomplete,
            type: e.type,
            rows: e.rows,
          ...
          e.icon ? (v(), f("div", K8, [
            T(i2, { icon: e.icon }, null, 8, ["icon"])
          ])) : b("", !0),
          o.$slots.append ? (v(), f("div", J8, [
            Z(o.$slots, "append", {}, void 0, !0)
          ])) : b("", !0)
        ]),
        e.message ? (v(), f("div", e5, S(e.message), 1)) : b("", !0)
      ], 2);
    };
  }
}), s5 = /* @__PURE__ */ G(c5, [["__scopeId", "data-v-483407b0"]]);
const o5 = { class: "nice-toasts" }, n5 = {
  ...
  setup(e) {
    ...
    function a(i) {
      const n = t.value.findIndex((d) => d.id == i.id);
      n >= 0 && t.value.splice(n, 1);
    }
    return (i, n) => (v(), f("div", o5, [
      T(W1, {
        name: "toast",
        key: "div"
      }, {
        default: e0(() => [
          (v(!0), f(Q, null, J(t.value, (d) => (v(), f("div", {
...
}), i5 = /* @__PURE__ */ G(l5, [["__scopeId", "data-v-95aff90a"]]);
const a5 = {
  name: "NiceUpload",
  components: {
    NiceComponentHeader: x0
  },
  props: {
    modelValue: {
  ...
  computed: {
    ...
    errorMessage() {
      if (typeof this.error == "string")
        return this.error;
      const e = a2(this.error, ["response", "data", this.prop]);
...
function v5(e, c, t, s, o, a) {
  const i = Y("NiceComponentHeader"), n = Y("NiceIcon"), d = Y("NiceLoading");
  return v(), f("div", {
    ...
    M("div", {
      class: q(["input-group", { dragging: o.isDragging, "on-target": o.isOnTarget }]),
      onDragenter: c[1] || (c[1] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDragleave: c[2] || (c[2] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDragover: c[3] || (c[3] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDragend: c[4] || (c[4] = (...r) => a.dragChanged && a.dragChanged(...r)),
      onDrop: c[5] || (c[5] = (...r) => a.dragChanged && a.dragChanged(...r))
    }, [
      M("input", {
        modelValue: o.file,
      ...
      a.localValue ? (v(), f("div", h5, [
        T(n, { icon: "icon-file" }),
        (v(!0), f(Q, null, J(a.localValue, (r) => (v(), f("div", {
          class: "nice-upload-overlay-message",
          key: r.name
        }, S(r.name), 1))), 128))
      ])) : (v(), f("div", d5, [
        T(n, { icon: "icon-upload" }),
        M("div", u5, S(t.placeholder || e.$t("Nice", "Upload file")), 1)
      ])),
      o.loading ? (v(), U(d, {
        key: 2,
        "full-div": ""
...
const p5 = /* @__PURE__ */ G(a5, [["render", v5], ["__scopeId", "data-v-aa7d7890"]]);
const f5 = {
  key: 0,
  ...
  setup(e) {
    const c = e, t = i1(), s = X(() => t.title || c.title || c.icon);
    return (o, a) => {
      const i = Y("NiceIcon"), n = Y("NiceLoading");
      return v(), U(U1(e.isForm ? "form" : "div"), {
        class: q(["nice-view", { "nice-view-no-header": !C(s), "nice-view-flex-body": e.flexBody }])
      }, {
        default: e0(() => [
          C(s) ? (v(), f("div", f5, [
            e.icon && !e.loading ? (v(), U(i, {
              key: 0,
              icon: e.icon,
...
}), g5 = /* @__PURE__ */ G(M5, [["__scopeId", "data-v-cffab31e"]]);
const z5 = (e) => (I0("data-v-bdde4e0c"), e = e(), A0(), e), w5 = {
  key: 0,
...
}, B5 = /* @__PURE__ */ z5(() => /* @__PURE__ */ M("div", { class: "flex-grow" }, null, -1)), k5 = {
  key: 2,
  ...
  setup(e) {
    ...
    return (o, a) => (v(), f("div", {
      ...
      o.$slots.header || e.title || e.subtitle || e.collapsable ? (v(), f("div", w5, [
        e.title || e.subtitle ? (v(), f("div", x5, [
          e.title ? (v(), f("div", _5, S(e.title), 1)) : b("", !0),
          e.subtitle ? (v(), f("div", C5, S(e.subtitle), 1)) : b("", !0)
        ])) : b("", !0),
        Z(o.$slots, "header", {}, void 0, !0),
        B5,
        e.collapsable ? (v(), U(p0, {
          key: 1,
      ...
      t.value ? (v(), f("div", {
        key: 1,
        class: q(["wrapper-body", { "no-top-padding": o.$slots.header || e.title || e.subtitle, "no-padding": e.noBodyPadding }])
      }, [
        Z(o.$slots, "default", {}, void 0, !0)
      ], 2)) : b("", !0),
      o.$slots.footer && t.value ? (v(), f("div", k5, [
        Z(o.$slots, "footer", {}, void 0, !0)
      ])) : b("", !0)
    ], 2));
  }
}), S5 = /* @__PURE__ */ G($5, [["__scopeId", "data-v-bdde4e0c"]]);
const O5 = { class: "nice-no-data" }, V5 = { class: "nice-no-data-message" }, D5 = {
  ...
  setup(e) {
    const c = e, t = K("$t"), s = W(c.message || t("Nice", "No data"));
    return (o, a) => {
      const i = Y("NiceIcon");
      return v(), f("div", O5, [
        T(i, {
        ...
        M("div", V5, S(s.value), 1)
      ]);
    };
  }
}), E5 = /* @__PURE__ */ G(T5, [["__scopeId", "data-v-a5c7ad13"]]), L1 = {
  NiceActions: F2,
  NiceAvatar: i4,
  NiceButton: p0,
  NiceCheckbox: V0,
...
const A5 = {
  install(e, c) {
    ...
    const t = w2(), s = {
      ...
      notification: (i, n, d, r) => {
        t.emit("notification", { message: i, type: n, title: d, icon: r });
      },
      // Toast
      onToast: (i) => t.on("toast", i),
      toast: (i, n) => {
        t.emit("toast", { message: i, type: n });
      },
      // Panel
      onPanel: (i) => t.on("panel", i),
      panel: (i, n) => {
        t.emit("panel", { name: i, isOpen: n });
      },
      // Modal
      onModal: (i) => t.on("modal", i),
      modal: (i, n, d) => {
        t.emit("modal", { name: i, isOpen: n, event: d });
      }
    };
    e.config.globalProperties.$nice = s, e.provide("nice", s);
    async function o() {
      await c.router.isReady();
      const i = a(c.router.currentRoute.value.query);
      return delete i.id, i;
    }
    function a(i) {
      return Object.assign({}, i);
    }
    e.config.globalProperties.$query = o, e.provide("getQuery", o), e.config.globalProperties.$clone = a, e.provide("clone", a), e.config.globalProperties.$t = c.gettext.$pgettext, e.provide("$t", c.gettext.$pgettext);
  }
};
function F5() {
  return K("nice");
